---
title: Talkdesk Microsoft Teams Connector by Talkdesk， Inc. 的应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/11/2022
...
description: Talkdesk Microsoft Teams Connector 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "64881039"
---
# <a name="talkdesk-microsoft-teams-connector"></a>Talkdesk Microsoft Teams连接器
...
| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | Talkdesk Microsoft Teams连接器 |
...
| 应用的核心功能 | Microsoft Teams集成到可启用目录和直接路由的 Talkdesk |
| 公司总部位置 | 美国美国 |
| 应用信息页 | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read.All | 委托 | 收集 MS Teams用户配置文件数据所需的 | [10d8604b-e6ea-4c59-8414-aca1bf1ffda8](../azure/10d8604b-e6ea-4c59-8414-aca1bf1ffda8.md) |
