...
Talkdesk， Inc. 提供给 Microsoft 的信息：
...
| 公司网站 | [https://www.talkdesk.com](https://www.talkdesk.com) |
| 应用的使用条款 | [https://www.talkdesk.com/terms-of-service](https://www.talkdesk.com/terms-of-service) |
| 应用的核心功能 | Microsoft Teams与 Talkdesk 集成，从而启用目录和直接路由 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
...
这些信息由 Talkdesk， Inc. 提供，用于说明此应用如何收集和存储组织数据，以及组织将拥有对应用收集的数据的控制。
...
| 最新 SOC2 认证日期 |  2021-02-22 |
| 应用是否遵守 SOC 3 (服务组织) ？ | 是 |
| 最新 SOC3 认证日期 |  2021-02-22 |
