---
title: Talkdesk Microsoft Teams Connector by Talkdesk， Inc. 的 Talkdesk Microsoft Teams 连接器的应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/07/2022
...
description: Talkdesk Microsoft Teams 连接器的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://appsource.microsoft.com/product/web-apps/talkdeskinc1579824950513.talkdesk_for_teams" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Talkdesk 公司向 Microsoft 提供的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | Talkdesk Microsoft Teams 连接器 |
| ID | talkdeskinc1579824950513.talkdesk_for_teams |
| 合作伙伴公司名称 | Talkdesk， Inc. |
| 公司的网站 | [https://www.talkdesk.com](https://www.talkdesk.com) |
| 应用的使用条款 | [https://www.talkdesk.com/terms-of-service](https://www.talkdesk.com/terms-of-service) |
| 应用的核心功能 | Microsoft Teams 与可启用目录和直接路由的 Talkdesk 集成 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | |
...
Talkdesk 公司提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 用户配置文件数据 - 名字、姓氏、全名、电子邮件地址、电话号码 |
...
| 最新的 SOC2 认证日期 | 2021-02-22 |
| 应用是否符合服务组织控制 (SOC 3) ？ | 是 |
| 最新的 SOC3 认证日期 | 2021-02-22 |
...
| 如果你的应用不使用上述库之一，它使用什么身份验证库或库？ | https://rubygems.org/gems/oauth2，v1.4.4 |
| 应用是否支持条件访问策略？ | 不支持 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read.All | 委托 | 收集 MS Teams 用户的个人资料数据所需的 | [10d8604b-e6ea-4c59-8414-aca1bf1ffda8](../azure/10d8604b-e6ea-4c59-8414-aca1bf1ffda8.md) |
>| offline_access | 委托 | 即使未登录授予访问权限的用户，也允许应用查看数据。 | [10d8604b-e6ea-4c59-8414-aca1bf1ffda8](../azure/10d8604b-e6ea-4c59-8414-aca1bf1ffda8.md) |
