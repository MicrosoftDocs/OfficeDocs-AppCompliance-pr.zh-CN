---
title: CallCabinet Corporation 的 CallCabinet Atmos 合规性记录和分析的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/16/2022
...
description: CallCabinet Atmos 合规性记录和分析的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66785156"
---
# <a name="callcabinet-atmos-compliance-recording-and-analytics"></a>CallCabinet Atmos 合规性记录和分析

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 1 月 26 日</p>

* <a href="https://appsource.microsoft.com/product/web-apps/callcabinetcorporation1584393576335.atmos" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

CallCabinet Corporation 提供给 Microsoft 的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | CallCabinet Atmos 合规性记录和分析 |
| ID | callcabinetcorporation1584393576335.atmos |
| 合作伙伴公司名称 | CallCabinet Corporation |
| 公司的网站 | [https://www.callcabinet.com](https://www.callcabinet.com) |
| 应用的使用条款 | [https://www.callcabinet.com/terms-and-conditions/](https://www.callcabinet.com/terms-and-conditions/) |
| 应用的核心功能 | Atmos by CallCabinet 是适用于 Microsoft Teams 和其他协作或联系中心系统的 Azure 本机合规性呼叫录制、AI 分析和 QA SaaS 解决方案。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://www.callcabinet.com/compliance-microsoft-teams-call...](https://www.callcabinet.com/compliance-microsoft-teams-call-recording/) |
...
CallCabinet Corporation 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 录制的 Teams 对话、视频和屏幕共享 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 录制的 Teams 对话、视频和屏幕共享 |
