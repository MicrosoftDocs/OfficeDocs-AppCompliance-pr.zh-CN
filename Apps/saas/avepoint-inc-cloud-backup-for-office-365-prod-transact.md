---
title: 云备份的应用程序信息 Office 365 - (AvePoint) 交易。
ms.author: elmalova
author: elenamalova
ms.date: 10/27/2021
ms.topic: article
...
description: Office 365 云备份的所有可用安全性和合规性信息 - Prod (交易) 、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
