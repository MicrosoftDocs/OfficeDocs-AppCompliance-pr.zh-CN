...
| 你是否在支持应用的网络 (外围部署了入侵检测和) IDPS 和 IDPS 软件？ | 不适用 |
...
>| Sites.Read.All | delegated | 启用库创建验证 |
>| Directory.Read.All | delegated | 启用同意状态的显示 |
>| Group.Read.All | delegated | 启用限制库访问群体 |
>| User.ReadBasic.All | delegated | 启用显示用户属性 |
