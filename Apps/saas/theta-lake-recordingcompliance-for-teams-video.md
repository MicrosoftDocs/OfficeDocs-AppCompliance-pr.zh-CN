---
title: Theta Lake 的 Teams 视频的 Theta Lake 录制 &amp; 符合性的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/07/2022
...
description: 适用于 Teams 视频的 Theta Lake 录制&amp;合规性、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息的所有可用安全性和符合性信息。
...
ms.locfileid: "66705844"
---
# <a name="theta-lake-recording-amp-compliance-for-teams-video"></a>Teams 视频的 Theta Lake 录制 &amp; 符合性

<p></p><a href="https://aka.ms/appcertification" alt="This Microsoft 365 Certified app has been reviewed by Microsoft against industry standards and controls for security, compliance, and data handling practices. Where applicable, Microsoft has verified the developer's claims of compliance with reasonable and effective practices." target="_blank"><img alt="Click here for more information on the Microsoft Certified app program." src="../media/certified.png" width="650" /></a>
<p>开发人员上次更新时间：2022 年 3 月 29 日</p>

* <a href="https://appsource.microsoft.com/product/web-apps/thetalake.thetalake_recording_and_compliance_for_teams" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Theta Lake 提供给 Microsoft 的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | Teams 视频的 Theta Lake 录制 &amp; 符合性 |
| ID | thetalake.thetalake_recording_and_compliance_for_teams |
| 合作伙伴公司名称 | Theta Lake |
| 公司的网站 | [https://thetalake.com](https://thetalake.com) |
| 应用的使用条款 | [https://thetalake.com/privacy-policy](https://thetalake.com/privacy-policy) |
| 应用的核心功能 | Microsoft Teams 音频和视频会议的录制、存档、合规性和风险缓解 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | |
...
Theta Lake 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | Microsoft 视频、Microsoft Teams 聊天 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | Microsoft 视频、Microsoft Teams 聊天 |
...
| 隐私策略 URL | https://thetalake.com/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calls.JoinGroupCall.All | 委托 | 图形 API需要访问才能接收呼叫记录 | [1cc8eecf-56f3-4137-a0fe-4b0466ca0677](../azure/1cc8eecf-56f3-4137-a0fe-4b0466ca0677.md) |
