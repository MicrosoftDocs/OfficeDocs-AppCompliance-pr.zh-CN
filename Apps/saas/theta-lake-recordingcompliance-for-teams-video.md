---
title: Theta Lake Recording Compliance &amp; for Teams Video by Theta Lake 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/16/2022
...
description: 有关 Teams 视频的 Theta Lake Recording &amp; Compliance 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | Theta Lake Recording &amp; Compliance for Teams Video |
| ID | thetalake.thetalake_recording_and_compliance_for_teams |
| 合作伙伴公司名称 | Theta Lake |
| 公司网站 | [https://thetalake.com](https://thetalake.com) |
| 应用的使用条款 | [https://thetalake.com/privacy-policy](https://thetalake.com/privacy-policy) |
| 应用的核心功能 | 音频和视频会议的录制、存档、合规性Microsoft Teams风险缓解 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
...
此信息由 Theta Lake 提供，有关此应用程序如何收集和存储组织数据以及您的组织将拥有对应用收集的数据的控制。
...
| 数据库中存储了哪些数据？ | Microsoft 视频Microsoft Teams聊天 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calls.JoinGroupCall.All | delegated | Graph API 需要访问以接收呼叫记录 | [1cc8eecf-56f3-4137-a0fe-4b0466ca0677](../azure/1cc8eecf-56f3-4137-a0fe-4b0466ca0677.md) |
