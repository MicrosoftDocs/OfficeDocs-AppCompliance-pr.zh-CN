---
title: Onna Discovery for MS365 的应用程序信息（由 Onna 提供）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/22/2021
...
description: 适用于 MS365 的 Onna Discovery 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "63552221"
---
# <a name="onna-discovery-for-ms365"></a>适用于 MS365 的 Onna Discovery

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 11 月 2 日</p>

* <a href="https://appsource.microsoft.com/product/web-apps/onna1600902517721.onna-discovery-1" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Onna 提供给 Microsoft 的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | 适用于 MS365 的 Onna Discovery |
| ID | onna1600902517721.onna-discovery-1 |
| 合作伙伴公司名称 | Onna |
| 公司网站 | [https://onna.com](https://onna.com) |
| 应用的使用条款 | [https://onna.com/master-subscription-agreement](https://onna.com/master-subscription-agreement) |
| 应用的核心功能 | Onna 为用户提供了可防御的数据收集、搜索和早期Microsoft 365 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://onna.com/features](https://onna.com/features) |
...
Onna 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及您的组织将拥有对应用收集的数据的控制有关。
...
| 数据库中存储了哪些数据？ | 电子邮件、电子邮件地址、用户 ID、聊天、文件。 保留和删除策略由最终用户配置。  |
...
| 隐私策略 URL | https://onna.com/privacy-policy/ |
