---
title: '&amp;AvePoint Inc Insights策略Microsoft Office 365应用程序信息'
ms.author: elmalova
author: elenamalova
ms.date: 11/01/2021
ms.topic: article
...
description: 针对 Microsoft Office 365 策略策略的所有可用安全性和合规性Insights、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全 &amp; /合规性信息。
...
>|   **Graph权限**  | **权限类型** |          **字距调整**          |
>|:------------------------|:--------------------|:------------------------------------|
>| Sites.FullControl.All | 应用程序 | 检索和更新网站集和组/团队&#8217;的信息。 |
>| User.Read.All | 应用程序 | 读取所有用户的设置 |
>| User.ReadWrite.All | 应用程序 | 读取和写入用户的设置 |
>| Group.Read.All | 应用程序 | 读取组的成员和设置 |
>| Group.ReadWrite.All | 应用程序 | 更新组的成员和设置 |
>| Directory.ReadWrite.All | 应用程序 |   读取和写入组织目录中的用户和组数据。 |
