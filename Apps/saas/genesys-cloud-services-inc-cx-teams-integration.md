---
title: Genesys 云服务、 Inc 的 Genesys Cloud CX Teams 集成的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/07/2022
...
description: Genesys Cloud CX Teams 集成的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
---
# <a name="genesys-cloud-cx-teams-integration"></a>Genesys Cloud CX Teams 集成

<p></p><a href="https://aka.ms/appcertification" alt="This Microsoft 365 Certified app has been reviewed by Microsoft against industry standards and controls for security, compliance, and data handling practices. Where applicable, Microsoft has verified the developer's claims of compliance with reasonable and effective practices." target="_blank"><img alt="Click here for more information on the Microsoft Certified app program." src="../media/certified.png" width="650" /></a>
<p>开发人员上次更新时间：2022 年 2 月 28 日</p>

* <a href="https://appsource.microsoft.com/product/web-apps/genesyslabs.genesys-cloud_teams_integration" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Genesys 云服务公司向 Microsoft 提供的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | Genesys Cloud CX Teams 集成 |
| ID | genesyslabs.genesys-cloud_teams_integration |
| 合作伙伴公司名称 | Genesys 云服务， Inc |
| 公司的网站 | [https://www.genesys.com](https://www.genesys.com) |
| 应用的使用条款 | [https://help.mypurecloud.com/articles/global-genesys-cloud-...](https://help.mypurecloud.com/articles/global-genesys-cloud-service-terms-and-conditions/) |
| 应用的核心功能 | Microsoft Teams 的 Genesys 云 CX&#8482;集成 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://appsource.microsoft.com/en-us/product/web-apps/gene...](https://appsource.microsoft.com/en-us/product/web-apps/genesyslabs.genesys-cloud_teams_integration) |
...
Genesys 云服务公司提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
| 隐私策略 URL | https://help.mypurecloud.com/wp-content/uploads/2021/11/Genesys-Cloud-Privacy-Policy-Nov-2021.pdf |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Presence.Read.All | 两者 | 在接听电话之前，联系中心代理必须能够查看其同事的状态 | [728ece5a-0f26-4c43-9705-cea9debe3fb5](../azure/728ece5a-0f26-4c43-9705-cea9debe3fb5.md) |
