---
title: WORKSTREAMPEOPLE BV Teams BV 的 Anywhere365 联系人中心的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: 适用于 Teams 的 Anywhere365 联系人中心的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "64602389"
---
# <a name="anywhere365-contact-center-for-teams"></a>适用于联系人的 Anywhere365 Teams
...
| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | 适用于联系人的 Anywhere365 Teams |
...
| 应用的核心功能 | Omnichannel Communications 的 Anywhere365&#174; 对话云平台，这是全球第一个 Microsoft 认证的 Teams 联系中心，与 Microsoft eocystem 完全集成：从 Azure、Sharepoint 和 Teams 到 Dynamics 365、PowerApps 和 PowerBI。 借助低代码通信自动化平台的 Adition，We can integrate with any API-based bot frameworks， communication layers and intelligence systems. |
| 公司总部位置 | 荷兰 ()  |
| 应用信息页面 | [https://anywhere365.io/category/anywhere365-dialogue-cloud/](https://anywhere365.io/category/anywhere365-dialogue-cloud/) |
...
| 数据库中存储了哪些数据？ | 通信 &amp; 状态数据 |
| 如果基础结构处理或存储 Microsoft 客户数据，那么此数据在地理位置上存储在哪里？ | 荷兰 (美国) 美国新加坡 |
| 你是否已制定数据租用和处置流程？ | 是 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | delegated | 收集客户域 | [d1762bac-3696-429d-ab0b-2a61463d6b7a](../azure/d1762bac-3696-429d-ab0b-2a61463d6b7a.md) |
>| Presence.Read.All | delegated | 收集客户状态详细信息。 | [d1762bac-3696-429d-ab0b-2a61463d6b7a](../azure/d1762bac-3696-429d-ab0b-2a61463d6b7a.md) |
>| User.ReadBasic.All | delegated | 收集客户显示名称 | [d1762bac-3696-429d-ab0b-2a61463d6b7a](../azure/d1762bac-3696-429d-ab0b-2a61463d6b7a.md) |
