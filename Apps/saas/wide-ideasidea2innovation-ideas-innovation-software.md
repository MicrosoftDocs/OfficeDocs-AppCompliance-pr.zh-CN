---
title: 广泛的想法的应用程序信息 - 通过广泛的想法/想法2Innovation 创新软件
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/08/2021
...
* <a href="https://appsource.microsoft.com/product/web-apps/wideideaspoweredbyidea2innovaitonswedenab.innovation_cloud_application" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

由 Wide Ideas/Idea2Innovation 提供给 Microsoft 的信息：
...
| 应用的核心功能 | 通过将广泛的想法中的创新管理软件嵌入Microsoft 365 Teams，分享挑战、客户体验和新解决方案的想法将成为员工工作文化中的一部分。 |
| 公司总部位置 | 瑞典 |
| 应用信息页面 | |
...
此信息由 Wide Ideas/Idea2Innovation 提供，这些信息与此应用程序如何收集和存储组织数据以及您的组织将拥有对应用程序收集的数据的控制有关。
...
| 数据库中存储了哪些数据？ | 用户名和电子邮件地址 |
| 如果基础结构处理或存储 Microsoft 客户数据，那么此数据在地理位置上存储在哪里？ | 瑞典 |
| 你是否已制定数据租用和处置流程？ | 是 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.Create | delegated | 允许广泛的想法管理中心代表登录用户在任何团队中创建频道。  | [0d56e89d-8356-457f-89a2-618386a39eb8](../azure/0d56e89d-8356-457f-89a2-618386a39eb8.md) |
>| Directory.Read.All | delegated | 允许广泛的想法管理中心读取组织&#8217;（如用户、组和应用）的数据 | [0d56e89d-8356-457f-89a2-618386a39eb8](../azure/0d56e89d-8356-457f-89a2-618386a39eb8.md) |
>| Group.Read.All | delegated | 允许广泛的想法管理中心代表登录用户列出组并读取其属性和所有组成员身份 | [0d56e89d-8356-457f-89a2-618386a39eb8](../azure/0d56e89d-8356-457f-89a2-618386a39eb8.md) |
>| TeamsAppInstallation.ReadWriteForTeam | delegated | 允许宽创意管理中心读取、安装、升级和卸载Teams登录用户可以访问的团队中的应用。  | [0d56e89d-8356-457f-89a2-618386a39eb8](../azure/0d56e89d-8356-457f-89a2-618386a39eb8.md) |
>| TeamsTab.Create | delegated |  允许广泛的想法管理中心代表登录用户Microsoft Teams团队中的任意团队创建选项卡。 | [0d56e89d-8356-457f-89a2-618386a39eb8](../azure/0d56e89d-8356-457f-89a2-618386a39eb8.md) |
>| User.Read | delegated | 允许用户登录到宽创意管理中心，并允许应用读取已登录用户的个人资料。  | [0d56e89d-8356-457f-89a2-618386a39eb8](../azure/0d56e89d-8356-457f-89a2-618386a39eb8.md) |
