...
description: 在 CSA STAR 注册表中，对 MURAL 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及安全/合规性信息。
...
* <a href="https://appsource.microsoft.com/product/web-apps/tactivosincdbamural1608253315049.sol-43803-aek" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

MURAL 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | MURAL |
| 公司的网站 | [https://www.mural.co](https://www.mural.co) |
| 应用的使用条款 | [https://www.mural.co/terms/terms-of-use](https://www.mural.co/terms/terms-of-use) |
| 应用的核心功能 | 直观思考和协作 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://support.mural.co](https://support.mural.co) |
...
此信息已由 MURAL 提供，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 对于登录目的，MURAL 仅需要名称、姓氏和电子邮件地址。 要处理/存储的数据类型取决于客户。 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 对于登录目的，MURAL 仅存储用户的名字、姓氏和电子邮件。 存储的任何其他信息都取决于客户在其壁画中存储的信息。 |
...
| 最新的 SOC2 认证日期 | 2021-04-01 |
| 应用是否符合服务组织控制 (SOC 3) ？ | 是 |
| 最新的 SOC3 认证日期 | 2021-04-01 |
...
| 隐私策略 URL | https://www.mural.co/terms/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.Read | 委托 | 将文档上传到 MURAL 所需的 Files.read。 | [a1ef3a23-74fc-4c91-909f-691cc47a1c8e](../azure/a1ef3a23-74fc-4c91-909f-691cc47a1c8e.md) |
>| User.Read | 委托 | User.read，因为壁画需要名字、姓氏和电子邮件才能创建帐户。 | [a1ef3a23-74fc-4c91-909f-691cc47a1c8e](../azure/a1ef3a23-74fc-4c91-909f-691cc47a1c8e.md) |
