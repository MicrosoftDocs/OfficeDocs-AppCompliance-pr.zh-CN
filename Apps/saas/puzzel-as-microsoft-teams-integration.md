---
title: Puzzel Microsoft Teams集成的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/09/2022
...
description: Puzzel Microsoft Teams集成的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "65982590"
---
# <a name="puzzel-microsoft-teams-integration"></a>Puzzel Microsoft Teams集成

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 6 月 9 日</p>

* <a href="https://appsource.microsoft.com/product/web-apps/puzzel-5257631.puzzel_teams_integration" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Puzzel AS 提供给 Microsoft 的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | Puzzel Microsoft Teams集成 |
| ID | puzzel-5257631.puzzel_teams_integration |
| 合作伙伴公司名称 | Puzzel AS |
| 公司的网站 | [https://www.puzzel.com](https://www.puzzel.com) |
| 应用的使用条款 | [https://www.puzzel.com/neighbourhood/trust-centre/privacy-p...](https://www.puzzel.com/neighbourhood/trust-centre/privacy-policy) |
| 应用的核心功能 | Puzzel 与 Microsoft Teams 的集成使代理更加紧密地结合在一起，使协作更加轻松。 代理可以进行Teams调用、发送消息、搜索和传输联系人，而无需离开 Puzzel 代理应用程序。 用户可以看到其他代理是在线、忙碌、外出还是在呼叫中，以及组织中所有其他同事的状态。 代理可以在Teams中查看联系人&#8217;日历和日程安排，以便更好地使计划、会议和呼叫保持一致。 |
| 公司总部位置 | 挪威 |
| 应用信息页 | [https://www.puzzel.com/microsoft-teams](https://www.puzzel.com/microsoft-teams) |
...
Puzzel AS 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 状态数据、用户数据、日历数据 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 用户数据、日历数据 |
| 如果基础结构处理或存储 Microsoft 客户数据，则此数据在地理上存储在哪里？ | 挪威、英国联合王国和北爱尔兰 ()  |
| 是否已建立数据出租和处置流程？ | 是 |
| 帐户终止后数据保留多长时间？ | 不保留 |
| 是否已建立数据访问管理过程？ | 是 |
...
| 隐私策略 URL | https://www.puzzel.com/neighbourhood/trust-centre |
