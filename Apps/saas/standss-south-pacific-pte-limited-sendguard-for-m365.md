---
title: SendGuard for M365 的应用程序信息（ (太平洋) PTE Limited）
ms.author: elmalova
author: elenamalova
ms.date: 12/10/2021
ms.topic: article
...
description: SendGuard for M365 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "61420827"
---
# <a name="sendguard-for-m365"></a>适用于 M365 的 SendGuard
...
>|   **Graph权限**  | **权限类型** |          **字距调整**          |
>|:------------------------|:--------------------|:------------------------------------|
>| Calendars.ReadWrite | delegated | 从主题、正文、附加到会议请求的附件内容中读取内容  |
>| Mail.ReadWrite | delegated | 从主题、正文、附加到邮件项目的附件内容中读取内容  |
>| openid | delegated | SSO 单一登录 (SSO) 的要求 |
>| 个人资料 | delegated | SSO 单一登录 (SSO) 的要求 |
>| User.Read | delegated | 这是读取用户数据以验证其域/用户帐户的许可信息 |
