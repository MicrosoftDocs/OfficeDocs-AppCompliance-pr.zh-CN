---
title: Storm Cloud Contact Center Teams 集成的应用程序信息（按内容大师）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/11/2022
...
description: Storm Cloud Contact Center Teams 集成的所有可用安全性和符合性信息、其数据处理策略、Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66806323"
---
# <a name="storm-cloud-contact-center-teams-integration"></a>storm Cloud Contact Center Teams 集成

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 3 月 10 日</p>

* <a href="https://appsource.microsoft.com/product/web-apps/contentguru1616168120869.storm_cloud_contact_center_teams_integration" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

内容古鲁提供给 Microsoft 的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | storm Cloud Contact Center Teams 集成 |
| ID | contentguru1616168120869.storm_cloud_contact_center_teams_integration |
| 合作伙伴公司名称 | 内容古鲁 |
| 公司的网站 | [https://www.contentguru.com/microsoft-teams-integration/.](https://www.contentguru.com/microsoft-teams-integration/.) |
| 应用的使用条款 | [https://www.contentguru.com/about-us/terms-of-use/](https://www.contentguru.com/about-us/terms-of-use/) |
| 应用的核心功能 | 将 Storm Cloud Contact Center 与 Microsoft Teams 集成以实现统一的 CCaaS 解决方案。 |
| 公司总部位置 | 大不列颠及北爱尔兰联合王国 ()  |
| 应用信息页 | [https://www.contentguru.com/microsoft-teams-integration/](https://www.contentguru.com/microsoft-teams-integration/) |
...
内容古鲁提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 美国用户参考 (EUII) 、MS 组织参考 (OII) 、呼叫详细信息和用户配置文件数据 (EUII)  |
...
| 隐私策略 URL | https://www.contentguru.com/about-us/privacy-cookies-policy/ |
