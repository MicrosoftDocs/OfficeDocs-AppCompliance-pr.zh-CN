...
| 应用会处理哪些数据？ | AzureADGuid (帐户链接) 。  Email地址和电话号码可以从 AAD 导入。 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | AzureADGuid (帐户链接) 。  Email地址和电话号码可以从 AAD 导入。 |
