---
title: Ice Contact Center by ComputerTalk 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/07/2022
...
description: Ice Contact Center 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
---
# <a name="ice-contact-center"></a>冰联系人中心

<p></p><a href="https://aka.ms/appcertification" alt="This Microsoft 365 Certified app has been reviewed by Microsoft against industry standards and controls for security, compliance, and data handling practices. Where applicable, Microsoft has verified the developer's claims of compliance with reasonable and effective practices." target="_blank"><img alt="Click here for more information on the Microsoft Certified app program." src="../media/certified.png" width="650" /></a>
<p>开发人员上次更新时间：2022 年 2 月 14 日</p>

* <a href="https://appsource.microsoft.com/product/web-apps/computertalk.ice-contact-center" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

ComputerTalk 提供给 Microsoft 的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | 冰联系人中心 |
| ID | computertalk.ice-contact-center |
| 合作伙伴公司名称 | ComputerTalk |
| 公司的网站 | [https://www.computer-talk.com](https://www.computer-talk.com) |
| 应用的使用条款 | [https://www.computer-talk.com/product/enterprise-contact-ce...](https://www.computer-talk.com/product/enterprise-contact-center/ice-contact-center-for-teams) |
| 应用的核心功能 | ice 提供联系人中心作为服务功能，包括呼叫路由、录制、监视和报告。 |
| 公司总部位置 | 加拿大 |
| 应用信息页 | [https://www.computer-talk.com/product/enterprise-contact-ce...](https://www.computer-talk.com/product/enterprise-contact-center/ice-contact-center-for-teams) |
...
ComputerTalk 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | AzureADGuid (帐户链接) 。  可以从 AAD 导入电子邮件地址和电话号码。 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | AzureADGuid (帐户链接) 。  可以从 AAD 导入电子邮件地址和电话号码。 |
...
| **Information** | **响应** |
|:----------------|:-------------|
| 是否具有 GDPR 或其他隐私或数据保护要求或义务 (，如 CCPA) ？ | 不支持 |
...
|:------------|:---------------------------------------|
| [**应用程序安全性**](../docs/certification-submission-guide.md#application-security) | **FAIL** |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;渗透测试 | 在作用域中 |
