...
ms.locfileid: "62794053"
---
# <a name="saas-apps-security-and-compliance"></a>SaaS 应用安全性和合规性

Microsoft 与Microsoft 365合作伙伴合作，为组织提供加速和告知有关其使用的 SaaS 应用和外接程序的决策所需的信息。 这些有关安全性、数据处理和合规性的信息旨在帮助组织评估和管理使用这些应用时的风险。
...
| [EmailNotes for Outlook](./standss-south-pacific-pte-limited-emailnotes-for-outlook.md) | 代表 (太平洋) PTE Limited | **✓** | <img alt="Certified application badge" src="../media/certified-badge.png" height="25" width="25" /> |
...
| [适用于 Microsoft Teams 的 Luware 合规性记录](./luware-ag-compliance-recording-for-microsoft-teams.md) | Luware AG | **✓** |  |
