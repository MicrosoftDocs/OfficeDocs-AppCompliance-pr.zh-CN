---
title: 杜伯公司针对 Microsoft Teams 的杜伯统一呼叫录制的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/07/2022
...
description: 适用于 Microsoft Teams 的杜伯统一呼叫录制的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
---
# <a name="dubber-unified-call-recording-for-microsoft-teams"></a>Microsoft Teams 的配音器统一呼叫录制

<p></p><a href="https://aka.ms/appcertification" alt="This Microsoft 365 Certified app has been reviewed by Microsoft against industry standards and controls for security, compliance, and data handling practices. Where applicable, Microsoft has verified the developer's claims of compliance with reasonable and effective practices." target="_blank"><img alt="Click here for more information on the Microsoft Certified app program." src="../media/certified.png" width="650" /></a>
<p>开发人员上次更新时间：2022 年 4 月 13 日</p>

* <a href="https://appsource.microsoft.com/product/web-apps/dubbercorp1603082091027.dubber01" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

杜伯公司向 Microsoft 提供的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | Microsoft Teams 的配音器统一呼叫录制 |
| ID | dubbercorp1603082091027.dubber01 |
| 合作伙伴公司名称 | 杜伯公司 |
| 公司的网站 | [https://www.dubber.net](https://www.dubber.net) |
| 应用的使用条款 | [https://www.dubber.net/terms](https://www.dubber.net/terms) |
| 应用的核心功能 | 世界&#8217;#1 统一云呼叫录制 &amp; 语音 AI 以实现合规性、销售 &amp; 服务性能 |
| 公司总部位置 | 澳大利亚 |
| 应用信息页 | |
...
杜伯公司提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
| 数据库中存储了哪些数据？ | 客户名称和 Microsoft ID、呼叫录制/会议数据 |
...
| 隐私策略 URL | https://www.dubber.net/privacy-policy |
