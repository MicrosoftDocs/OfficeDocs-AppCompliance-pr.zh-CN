---
title: 杜伯公司针对Microsoft Teams的杜伯统一呼叫录制的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/13/2022
...
description: 适用于Microsoft Teams的杜伯统一呼叫录制的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "64838789"
---
# <a name="dubber-unified-call-recording-for-microsoft-teams"></a>调用器统一呼叫录制Microsoft Teams
