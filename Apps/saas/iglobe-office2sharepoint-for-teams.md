...
| 应用的核心功能 | Office2SharePoint - 使用SharePoint Teams和Outlook和Office轻松操作。 打破团队成员之间的通信障碍，使所有团队成员均可访问文档和 &amp; SharePoint Teams。 将电子邮件和邮件附件直接从 Outlook 保存到SharePoint或Teams和平台上。 Office2SharePoint 应用程序服务权限级别同时为 Outlook 和 Office 外接程序设置。 |
| 公司总部位置 | 丹麦 |
| 应用信息页面 | |
...
>| Sites.ReadWrite.All | delegated | 获取SharePoint、库和文件。 将文件保存到SharePoint列表。 |
