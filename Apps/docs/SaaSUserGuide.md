...
ms.author: legerrar
manager: tonybal
description: Microsoft 365应用符合性计划 SaaS 的 ISV 用户指南
...
![合作伙伴中心内的商业市场](../media/NewPChomepage.png)
...
![商业市场中的应用符合性](../media/PCappcompliance3.png)
...
**步骤 5**：完成后，单击“提交”，评估现在为“正在审查”。
 ...
 ![提交Publisher提交确认](../media/UserGuidePhotos/07.png) ![](../media/UserGuidePhotos/08.png)
...
![Publisher证明已拒绝](../media/UserGuidePhotos/09.png)
...
![正在审查的初始文档提交](../media/UserGuidePhotos/16.png)
...
![完整的控制要求](../media/UserGuidePhotos/18.png)
...
![哪些控件需要更新](../media/UserGuidePhotos/23.png)
  
![正在查看](../media/UserGuidePhotos/24.png) 
 
如果提交不符合审批标准，分析师将拒绝提交。
  
合作伙伴可以与分析师合作，提供相关信息和文档。

![认证被拒绝](../media/UserGuidePhotos/25.png)
  
满足所有安全标准后，分析师将批准提交，合作伙伴将Microsoft 365认证。

![已批准Microsoft 365应用认证](../media/UserGuidePhotos/26.png)
  
**认证后审批：AppSource 中Microsoft 365认证徽章的示例。** 

![认证后审批](../media/UserGuidePhotos/27.png)
...
![Renewel 已批准](../media/UserGuidePhotos/31.png)
...
![提交以进行续订](../media/UserGuidePhotos/30.png)
...
![证明 Renewel](../media/UserGuidePhotos/32.png) 
...
![认证续订程序](../media/UserGuidePhotos/33.png) 
