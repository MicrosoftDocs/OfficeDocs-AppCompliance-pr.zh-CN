...
本文档作为合作伙伴的分步用户指南，已注册 Microsoft 365 应用合规性计划，旨在通过合作伙伴中心门户为 SaaS 应用进行 Publisher 证明和认证。

## <a name="2-acronyms--definitions"></a>2. 首字母缩略&定义
| | |
|----|----|
|首字母缩略词 | 定义 |
|电脑 (合作伙伴中心) 合作伙伴中心 (https://partner.microsoft.com/)|所有 Microsoft 合作伙伴的门户。 合作伙伴登录到合作伙伴中心并提交Self-Assessment调查表。 应用合规性Microsoft 365合作伙伴中心 (microsoft.com)  (https://partner.microsoft.com/en-us/dashboard/home)|
|ISV | 独立软件供应商 a.k.a. 合作伙伴或开发人员 |
|应用源 | AppSource (的) 示例：现在虚拟代理 (https://appsource.microsoft.com/en-us/product/office/WA104381816) |
...
**步骤 1：** 在页面左侧的导航栏上：a.    选择商业市场 b。    选择概述
...
A.  Publisher证明拒绝一个。  如果拒绝，合作伙伴可以：• 查看失败报告 o 合作伙伴将通过电子邮件收到通知，他们可以查看合作伙伴中心中的故障报告 • 更新并重新提交Self-Assessment调查表。
  
 ![10 ](https://github.com/MicrosoftDocs/OfficeDocs-AppCompliance-pr/blob/master/Apps/media/UserGuidePhotos/10.png)
  
B.  Publisher证明审批 a.  批准后，合作伙伴可以：• 更新并重新提交证明 • 查看Publisher证明 • 启动 M365 认证流程
...
**优点：** 
  ...
  • 在 AppSource 和团队应用商店中维护你的认证锁屏提醒，以将你的应用与其他应用区分。 
  
  • 提高客户对使用认证应用的信心。 
  
  • 通过更新的认证信息帮助 IT 管理员做出明智的决策。

新续订过程在合作伙伴中心 (https://partner.microsoft.com/en-us/dashboard/home) 提供无缝体验。 从到期日期前 90 天开始，将在合作伙伴中心中显示续订提醒。 定期提醒也会在到期前的 90、60 和 30 天内通过电子邮件发送。 
...
准备好Publisher提交证明进行续订。 M365 应用合规性分析师将审核它。
...
需要在到期日期之前续订应用的信息，以维护 Microsoft 文档上的Publisher证明页面。及时续订还将确保在 AppSource 和团队应用商店中为应用持续提供标记和图标。
...
方案 1A：证书续订拒绝：如果：• 应用没有所需的工具、流程或配置，并且将无法在认证窗口中实施所需更改，则可能会拒绝认证。 • 应用具有未解决的漏洞，无法在认证窗口中修复。 
