...
description: 适用于 Commuty 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
从 Commuty 到 Microsoft 提供的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | 通勤 |
| ID | WA200003325 |
| 支持Office 365客户端 | Outlook 2016或更高版本，Windows、Outlook 2016或更高版本的 Mac 上，Outlook 网页版 |
| 合作伙伴公司名称 | 通勤 |
| 公司的网站 | [https://www.commuty.net](https://www.commuty.net) |
| 应用的使用条款 | [https://support.commuty.net/article/32-terms-conditions](https://support.commuty.net/article/32-terms-conditions) |
| 应用的核心功能 | 优化员工上下班 &amp;&#8217;便于 (停车、移动、预订) 的新工作方式。 |
| 公司总部位置 | 比利时 |
| 应用信息页 | [https://www.commuty.net](https://www.commuty.net) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
Commuty 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 委托 | 日历事件 | [7c90e3d4-5233-4e49-8753-36cd5feb7fa0](../azure/7c90e3d4-5233-4e49-8753-36cd5feb7fa0.md) |
>| 电子邮件 | 委托 | 电子邮件地址 | [7c90e3d4-5233-4e49-8753-36cd5feb7fa0](../azure/7c90e3d4-5233-4e49-8753-36cd5feb7fa0.md) |
>| offline_access | 委托 | 不适用 | [7c90e3d4-5233-4e49-8753-36cd5feb7fa0](../azure/7c90e3d4-5233-4e49-8753-36cd5feb7fa0.md) |
>| openid | 委托 | 身份验证 | [7c90e3d4-5233-4e49-8753-36cd5feb7fa0](../azure/7c90e3d4-5233-4e49-8753-36cd5feb7fa0.md) |
>| 个人资料 | 委托 | 标识 | [7c90e3d4-5233-4e49-8753-36cd5feb7fa0](../azure/7c90e3d4-5233-4e49-8753-36cd5feb7fa0.md) |
