...
description: officeatwork 的所有可用安全性和符合性信息|Outlook的邮件签名、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "64784021"
---
# <a name="outlook-mail-signature-overview"></a>Outlook邮件签名概述
...
| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | officeatwork - Outlook的邮件签名 |
| ID | WA200003062 |
| 支持Office 365客户端 | Windows Outlook 2016或更高版本，Outlook 网页版 |
...
| 应用的核心功能 | 邮件签名，简单安全，集中管理， &amp; 品牌个性化在整个组织。 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | 启用已登录用户的显示，使用用户属性启用动态邮件签名 | [722e11e1-c87f-4f97-803f-3d012d532427](../azure/722e11e1-c87f-4f97-803f-3d012d532427.md) |
>| offline_access | 委托 | 为较旧的Office主机启用自动登录 | [722e11e1-c87f-4f97-803f-3d012d532427](../azure/722e11e1-c87f-4f97-803f-3d012d532427.md) |
>| openid | 委托 | 启用登录 | [722e11e1-c87f-4f97-803f-3d012d532427](../azure/722e11e1-c87f-4f97-803f-3d012d532427.md) |
>| 个人资料 | 委托 | 启用登录 | [722e11e1-c87f-4f97-803f-3d012d532427](../azure/722e11e1-c87f-4f97-803f-3d012d532427.md) |
