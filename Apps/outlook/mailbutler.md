---
title: Mailbutler Mailbutler 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/09/2021
...
description: Mailbutler 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "63540920"
---
# <a name="mailbutler"></a>Mailbutler

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 11 月 4 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200001031" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Mailbutler 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Mailbutler |
| 公司网站 | [https://www.mailbutler.io](https://www.mailbutler.io) |
| 应用的使用条款 | [https://www.mailbutler.io/terms-and-conditions](https://www.mailbutler.io/terms-and-conditions) |
| 应用的核心功能 | Mailbutler 是电子邮件插件，为你提供了最大限度提高工作效率并保持电子邮件的可用所需的一切。 Mailbutler 提供了大量有用的、可提高工作效率的功能，你可以直接在收件箱中访问这些功能。 它的功能可帮助你改进客户沟通、保持品牌、优化电子邮件游戏等。 |
| 公司总部位置 | 德国 |
| 应用信息页面 | [https://www.mailbutler.io](https://www.mailbutler.io) |
...
此信息由 Mailbutler 提供有关此应用程序如何收集和存储组织数据以及您的组织将拥有对应用收集的数据的控制的信息。
...
| 数据库中存储了哪些数据？ | 电子邮件 ID、电子邮件元数据 (主题、发件人/收件人（如果客户授权) 联系人数据 (由用户导入)  |
...
| 隐私策略 URL | https://www.mailbutler.io/privacy-policy-mailbutler/ |
