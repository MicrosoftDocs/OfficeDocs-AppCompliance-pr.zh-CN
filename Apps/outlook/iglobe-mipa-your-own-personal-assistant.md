...
>| openid | delegated | 数据不会存储在应用数据库 | 允许用户使用工作或学校帐户登录应用，并允许应用查看 SSO (的基本) 。 | [e854ea05-68ab-4204-如果为 db4a784fb4d8](https://docs.microsoft.com/microsoft-365-app-certification/azure/e854ea05-68ab-4204-babe-db4a784fb4d8) |
