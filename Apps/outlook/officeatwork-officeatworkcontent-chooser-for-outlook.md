...
description: officeatwork 的所有可用安全性和符合性信息|用于Outlook的内容选择器、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "64784011"
---
# <a name="content-chooser-for-outlook-application-information"></a>应用程序信息Outlook内容选择器
...
| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | officeatwork - Outlook的内容选择器 |
| ID | WA104380690 |
