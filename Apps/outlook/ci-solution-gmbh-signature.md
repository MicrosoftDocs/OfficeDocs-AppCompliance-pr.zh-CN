---
title: 按 ci 解决方案 GmbH CI-Signature的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/24/2021
...
description: CI-Signature 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://appsource.microsoft.com/product/office/WA200002458" target="_blank">在 AppSource 中查看</a>
...
| 应用的核心功能 | 通过CI-Sign在服务器端Outlook和 OWA 中添加可见签名，如果在服务器上添加签名，则CI-Disclaimer以满足公司标识要求和法律要求的要求，则添加预览。  |
| 公司总部位置 | 德国 |
| 应用信息页 | [https://www.ci-solution.com/support/de/](https://www.ci-solution.com/support/de/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
