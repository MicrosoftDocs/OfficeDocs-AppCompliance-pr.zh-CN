...
| 应用的核心功能 | 在 Outlook 和 OWA 中添加由 CI-Sign 在服务器端生成的可见签名;如果签名由 CI-Disclaimer 在服务器端添加以满足公司标识要求和法律要求，则添加预览。  |
| 公司总部位置 | 德国 |
| 应用信息页面 | [https://www.ci-solution.com/support/de/](https://www.ci-solution.com/support/de/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
