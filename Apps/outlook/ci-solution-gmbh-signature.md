...
description: 用于 CI 签名的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| 公司网站 | [https://www.ci-solution.com](https://www.ci-solution.com) |
| 应用的使用条款 | [https://www.ci-solution.com/agb](https://www.ci-solution.com/agb) |
| 应用的核心功能 | 在 Outlook 和 OWA 中添加由 CI-Sign 在服务器端生成的可见签名;如果签名是按 CI-Disclaimer 在服务器端添加的，则添加预览，以满足公司标识要求和法律要求。  |
| 公司总部位置 | 德国 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
