---
title: Adobe Sign for Add-In 应用程序信息Outlook Adobe Inc.
ms.author: elmalova
author: elenamalova
ms.date: 10/19/2021
ms.topic: article
...
| 应用的核心功能 | 将 Adobe Sign 添加到工作流时，保持文档签名工作流Outlook。 现在，在Outlook中，您可以签署文档，发送文档，以通过 Microsoft 首选电子签名解决方案&#8212;绑定电子签名和审批。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
