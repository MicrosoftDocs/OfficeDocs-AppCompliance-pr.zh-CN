---
title: Dynamo By Dynamo Software 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/09/2022
...
description: Dynamo 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "65312260"
---
# <a name="dynamo"></a>发电机

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 5 月 9 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200004007" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Dynamo Software 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Dynamo Software |
| 公司的网站 | [https://www.dynamosoftware.com](https://www.dynamosoftware.com) |
| 应用的使用条款 | [https://www.dynamosoftware.com/End-User-Terms](https://www.dynamosoftware.com/End-User-Terms) |
| 应用的核心功能 | Dynamo&#8217;的Office外接程序用于Outlook是一个支持程序，允许现有 Dynamo 用户通过桌面Outlook应用程序使用 Dynamo 以Windows，并在 Web (Office 365和 Outlook.com) 上Outlook。 你可以发送邮件合并草稿，将约会和活动及其附件添加到 Dynamo，并在不打开 Dynamo 的情况下创建类型为 Contact、Company、Deal 和 Fund 的新项目。  |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://help.dynamosoftware.com/about-dynamo-web-add-in-for...](https://help.dynamosoftware.com/about-dynamo-web-add-in-for-outlook/) |
...
Dynamo Software 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
| 隐私策略 URL | https://www.dynamosoftware.com/privacy-policy/ |
