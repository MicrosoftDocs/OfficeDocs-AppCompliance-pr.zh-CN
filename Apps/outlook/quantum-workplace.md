...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteSelfForUser.All | 应用程序 | 使用 ChatId。 | [be93046b-63ab-4216-9bcc-78faa55eeaa7](https://docs.microsoft.com/microsoft-365-app-certification/azure/be93046b-63ab-4216-9bcc-78faa55eeaa7) |
>| User.Read.All | 应用程序 | User.Id (存储) - 用于关联发送到我们的 Bot 终结点的用户;User.UserPrincipalName (未) - 当前未使用;User.Mail (未) - 用于将系统中用户使用我们存储的 AzureAD ID 进行匹配。 | [be93046b-63ab-4216-9bcc-78faa55eeaa7](https://docs.microsoft.com/microsoft-365-app-certification/azure/be93046b-63ab-4216-9bcc-78faa55eeaa7) |
