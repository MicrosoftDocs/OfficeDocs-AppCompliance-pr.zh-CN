...
| 公司网站 | [https://www.quantumworkplace.com](https://www.quantumworkplace.com) |
...
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://www.quantumworkplace.com/product/employee-engagemen...](https://www.quantumworkplace.com/product/employee-engagement-software) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
>| User.Read.All | 应用程序 | User.Id (存储) - 用于关联发送到我们的 Bot 终结点的用户;User.UserPrincipalName (未) - 当前未使用;User.Mail (未) - 用于将系统中用户使用我们存储的 AzureAD ID 进行匹配。 | [be93046b-63ab-4216-9bcc-78faa55eeaa7](../azure/be93046b-63ab-4216-9bcc-78faa55eeaa7.md) |
