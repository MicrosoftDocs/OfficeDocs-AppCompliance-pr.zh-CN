---
title: Quantum Workplace by Quantum Workplace 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/25/2021
...
description: Quantum Workplace 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| 公司的网站 | [https://www.quantumworkplace.com](https://www.quantumworkplace.com) |
| 应用的使用条款 | [https://www.quantumworkplace.com/terms-of-use](https://www.quantumworkplace.com/terms-of-use) |
| 应用的核心功能 | 帮助员工成功处理 Quantum Workplace 警报和通知。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://www.quantumworkplace.com/product/employee-engagemen...](https://www.quantumworkplace.com/product/employee-engagement-software) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
Quantum Workplace 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteSelfForUser.All | 应用程序 | 使用 ChatId。 | [be93046b-63ab-4216-9bcc-78faa55eeaa7](../azure/be93046b-63ab-4216-9bcc-78faa55eeaa7.md) |
>| User.Read.All | 应用程序 | User.Id (存储) - 用于关联发送到机器人终结点的用户;User.UserPrincipalName (未存储) - 当前未使用;User.Mail (未存储) - 用于将系统中的用户与我们存储的 AzureAD ID 匹配。 | [be93046b-63ab-4216-9bcc-78faa55eeaa7](../azure/be93046b-63ab-4216-9bcc-78faa55eeaa7.md) |
