---
title: iGlobe Pro Office 365 iPlanner 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/16/2021
...
description: iPlanner Pro Office 365的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | iPlanner Pro Office 365 |
| ID | WA104380464 |
| 支持Office 365客户端 | Outlook 2013 年或更高版本，Windows、Outlook 2016或更高版本，Outlook在 iOS 上Outlook 网页版 |
| 合作伙伴公司名称 | iGlobe |
