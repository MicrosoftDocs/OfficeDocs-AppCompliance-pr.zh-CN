---
title: 通过外展Outlook的外展销售参与的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: 适用于 Outlook 的外展 Sales Engagement 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "64879469"
---
# <a name="outreach-sales-engagement-for-outlook"></a>Outlook的外展销售活动
...
| 合作伙伴公司名称 | 外 展 |
| 公司的网站 | [https://www.outreach.io](https://www.outreach.io) |
| 应用的使用条款 | [https://www.outreach.io/terms](https://www.outreach.io/terms) |
| 应用的核心功能 | 外展是最大且增长最快的销售参与平台，可帮助公司大幅提高生产力，并推动更智能、更深入地与客户互动。 从销售自动化到对话智能、买方情绪分析、团队绩效报告&#8212;和更多&#8212;外展是一个集成式销售参与平台，可帮助销售代表和领导者提高生产力、创造更多销售机会并实现销售目标 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://www.outreach.io/product](https://www.outreach.io/product) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure、GCP、AWS |
...
外展提供了有关此应用如何收集和存储组织数据以及组织对应用收集的数据的控制的信息。
