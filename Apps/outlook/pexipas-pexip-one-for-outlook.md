---
title: Pexip One for Outlook的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/29/2021
...
description: Pexip One for Outlook 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| 合作伙伴公司名称 | PexipAS |
| 公司的网站 | [https://www.pexip.com](https://www.pexip.com) |
| 应用的使用条款 | [https://www.pexip.com/terms](https://www.pexip.com/terms) |
| 应用的核心功能 | Pexip One 允许用户在使用现有会议安排工作流时轻松创建安全会议。 Pexip one 提供屏幕共享、语音和视频聊天功能。 |
| 公司总部位置 | 挪威 |
| 应用信息页 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | GCP |
...
PexipAS 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 委托 | 用户的事件数据用于在平台上安排会议并跟踪对会议元数据的更改 | [69609b5a-e416-4d72-b10b-8903e84780c3](../azure/69609b5a-e416-4d72-b10b-8903e84780c3.md) |
