...
>|:----------------|:------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|:--------------------|
>| Calendars.Read | delegated | 用户的事件数据用于在平台上安排会议并跟踪对会议元数据的更改 | 我们存储所有加密会议 (会议标题、) 。 它们用于向 Pexip One 上的会议提供元数据 | [69609b5a-e416-4d72-b10b-8903e84780c3](https://docs.microsoft.com/microsoft-365-app-certification/azure/69609b5a-e416-4d72-b10b-8903e84780c3) |
