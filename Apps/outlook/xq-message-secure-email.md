---
title: XQ 安全电子邮件的应用程序信息（按 XQ 消息）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/10/2021
...
description: XQ Secure Email 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| 合作伙伴公司名称 | XQ 消息 |
| 公司的网站 | [https://xqmsg.co](https://xqmsg.co) |
| 应用的使用条款 | [https://xqmsg.com/terms.html](https://xqmsg.com/terms.html) |
| 应用的核心功能 | 保护所有通信&#8212;从电子邮件到文件。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://xqmsg.co/about](https://xqmsg.co/about) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
XQ Message 提供了此信息，说明此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
