---
title: CodeTwo Outlook的 CodeTwo 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: 适用于 Outlook 的 CodeTwo 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | CodeTwo for Outlook |
| ID | WA200003022 |
| 支持Office 365客户端 | Outlook 2016或更高版本，Windows、Outlook 2016或更高版本的 Mac 上，Outlook 网页版 |
| 合作伙伴公司名称 | CodeTwo |
| 公司的网站 | [https://www.codetwo.com](https://www.codetwo.com) |
| 应用的使用条款 | [https://www.codetwo.com/license-agreement](https://www.codetwo.com/license-agreement) |
| 应用的核心功能 | 自动电子邮件签名、法律免责声明 &amp; 在邮件中营销横幅。 |
| 公司总部位置 | Poland（波兰） |
| 应用信息页 | [https://www.codetwo.com/email-signatures/](https://www.codetwo.com/email-signatures/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
CodeTwo 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
