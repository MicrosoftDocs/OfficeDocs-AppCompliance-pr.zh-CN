---
title: CodeTwo for Outlook CodeTwo 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: CodeTwo for Outlook 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| 应用的核心功能 | 自动电子邮件签名，邮件 &amp; 中的法律免责声明营销横幅。 |
| 公司总部位置 | Poland（波兰） |
