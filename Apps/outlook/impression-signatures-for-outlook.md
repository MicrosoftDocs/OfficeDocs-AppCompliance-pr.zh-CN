---
title: 按印象签名显示Outlook展示次数签名的应用程序信息
ms.author: elmalova
author: elenamalova
ms.date: 10/04/2021
ms.topic: article
...
description: 有关 Outlook 展示签名、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息的所有可用安全性和合规性信息。
...
| 合作伙伴公司名称 | 印象签名 |
| 公司网站 | [https://www.impression-signatures.com](https://www.impression-signatures.com) |
| 应用的使用条款 | [https://www.iubenda.com/terms-and-conditions/8039352](https://www.iubenda.com/terms-and-conditions/8039352) |
| 应用的核心功能 | 展示签名提供符合 ECT 法案的 eSignatures 和安全文档传递。 管理签名工作流并返回附加到已签名文档的安全"一链"。  |
| 公司总部位置 | 南非 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| openid | 两者 | 身份验证数据和目录数据。 | [be181d9c-9060-40a0-a692-b29f2e314d16](https://docs.microsoft.com/microsoft-365-app-certification/azure/be181d9c-9060-40a0-a692-b29f2e314d16) |
