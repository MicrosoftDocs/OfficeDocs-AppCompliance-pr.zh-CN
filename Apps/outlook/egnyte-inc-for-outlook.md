---
title: Egnyte for Outlook by Egnyte， Inc. 的 Egnyte 应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/01/2022
...
description: Egnyte for Outlook 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66656047"
---
# <a name="egnyte-for-outlook"></a>Egnyte for Outlook

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 3 月 8 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200004177" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Egnyte 公司向 Microsoft 提供的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | Egnyte for Outlook |
| ID | WA200004177 |
| 支持Office 365客户端 | Windows 上的 Outlook 2013 或更高版本，Outlook 2016或更高版本的 Mac，Outlook 网页版 |
| 合作伙伴公司名称 | 埃格尼特公司 |
| 公司的网站 | [https://www.egnyte.com](https://www.egnyte.com) |
| 应用的使用条款 | [https://www.egnyte.com/terms-and-conditions/01-2020](https://www.egnyte.com/terms-and-conditions/01-2020) |
| 应用的核心功能 | 在 Outlook 中轻松共享从 Egnyte 到电子邮件的文件，或将电子邮件和附件从 Outlook 直接保存到 Egnyte 文件夹中，而无需离开收件箱 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://helpdesk.egnyte.com/hc/en-us/articles/4427124922125](https://helpdesk.egnyte.com/hc/en-us/articles/4427124922125) |
...
Egnyte， Inc. 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 用户配置文件数据、用户邮件数据 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 电子邮件地址、租户 ID、令牌、邮件和附件 ID 及其内容 |
...
| 隐私策略 URL | https://www.egnyte.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Mail.Read.Shared | 委托 | 需要阅读用户有权访问的电子邮件详细信息 | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
>| User.Read | 委托 | 验证用户以实现授权目的所必需 | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
>| 电子邮件 | 委托 | 验证访问令牌所需的 | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
>| offline_access | 委托 | 使用 OAuth 2.0 时显式请求刷新令牌所必需 | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
>| openid | 委托 | 读取用户基本信息所必需 | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
>| 个人资料 | 委托 | 读取基本用户信息所必需 | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
