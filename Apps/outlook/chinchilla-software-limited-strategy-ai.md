---
title: Chinchilla Software Limited 针对 Strategy-AI 的应用程序信息
ms.author: elmalova
author: elenamalova
ms.date: 12/14/2021
ms.topic: article
...
description: 有关 Strategy-AI 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
