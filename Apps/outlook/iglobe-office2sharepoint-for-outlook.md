---
title: 适用于 iGlobe Outlook的 Office2SharePoint 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/28/2021
...
description: 适用于 Outlook 的 Office2SharePoint 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
