...
| 应用的核心功能 | 在任何设备上，Office 365 Planner &amp; Teams获取 Planner Outlook任务。 管理和创建任务从未如此简单。 从 Planner Office 365获取&amp;Teams Planner 任务，位于 Outlook for Windows、MAC、IOS 或 Web 邮件的提示下。 |
| 公司总部位置 | 丹麦 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
