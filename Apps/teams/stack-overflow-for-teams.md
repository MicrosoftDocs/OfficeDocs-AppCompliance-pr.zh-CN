---
title: 适用于 Teams 的 Stack Overflow 的应用程序信息（按 Stack 溢出）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: 适用于 Teams 的 Stack Overflow 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66655906"
---
# <a name="stack-overflow-for-teams"></a>Stack Overflow for Teams

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 10 月 11 日</p>

* <a href="https://teams.microsoft.com/l/app/4783e622-5303-4ea7-a211-ef0dd405da73" target="_blank">在 Teams 应用商店中查看</a>
...
| 公司的网站 | [https://www.stackoverflow.com](https://www.stackoverflow.com) |
| 应用的使用条款 | [https://stackoverflow.com/legal/terms-of-service/teams](https://stackoverflow.com/legal/terms-of-service/teams) |
| 应用的核心功能 | 适用于 Teams 的 Stack Overflow 是团队&#8217;问题和答案的专用安全主页。 不再挖掘过时的 Wiki 和丢失的电子邮件&#8212;让团队重新获得生成更好产品所需的时间。 适用于 Teams 的 Stack Overflow&#8217;与 Microsoft Teams 的集成可连接 Microsoft Teams 聊天和内部知识存储库。 随时了解有关新信息的通知，搜索现有答案，甚至直接从 Microsoft Teams 平台启动问题。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://stackoverflow.co/teams/integrations/microsoft-teams](https://stackoverflow.co/teams/integrations/microsoft-teams) |
...
Stack Overflow 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | MS Teams 信息由应用收集和处理，以便在客户的 Stack Overflow for Teams 环境中显示和引用。 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | MS Teams API 访问信息 |
...
| 隐私策略 URL | https://stackoverflow.com/legal/privacy-policy/integrations/ms-teams/teams-basic-business |
