---
title: 适用于 Polumana Tour Route Planner by blue-zone GmbH 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: 适用于 Polumana Tour Route Planner 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66655892"
---
# <a name="polumana-tour-route-planner"></a>polumana 旅游路线规划器

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 4 月 5 日</p>

* <a href="https://teams.microsoft.com/l/app/4b4b3e3d-a1eb-4b52-b0b9-ba1a79b6be79" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004331" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

蓝区 GmbH 提供给 Microsoft 的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | polumana 旅游路线规划器 |
| ID | WA200004331 |
| 支持Office 365客户端 | Microsoft Teams |
| 合作伙伴公司名称 | 蓝区 GmbH |
| 公司的网站 | [https://blue-zone.de](https://blue-zone.de) |
| 应用的使用条款 | [https://azaap-disp-route-planning.azurewebsites.net/#/terms...](https://azaap-disp-route-planning.azurewebsites.net/#/termsofuse) |
| 应用的核心功能 | Polumana 旅游 &amp; 路线规划器，提高客户访问效率 |
| 公司总部位置 | 德国 |
| 应用信息页 | |
...
蓝区 GmbH 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 联系人、电子邮件地址 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 电子邮件、联系人地址 |
...
| 你有一个用于缩进和风险排名安全漏洞的既定过程吗？ | 不支持 |
| 是否具有管理服务级别协议 (SLA) 的策略来应用修补程序？ | 不支持 |
| 是否根据修补策略 SLA 执行修补程序管理活动？ | 不支持 |
| 环境是否有不受支持的操作系统或软件？ | 不支持 |
| 是否对应用以及支持它的构造进行季度漏洞扫描？ | 不支持 |
| 外部网络边界上是否安装了防火墙？ | 是 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 应用程序 | 路由优化后，我们需要创建新的约会并删除现有约会 | [d361752a-c257-474d-bb79-324fbe4898b5](../azure/d361752a-c257-474d-bb79-324fbe4898b5.md) |
>| Contacts.Read | 应用程序 | 我们需要阅读联系人才能创建约会 | [d361752a-c257-474d-bb79-324fbe4898b5](../azure/d361752a-c257-474d-bb79-324fbe4898b5.md) |
>| User.Read | 应用程序 | 我们需要获取用户的电子邮件来保留设置 | [d361752a-c257-474d-bb79-324fbe4898b5](../azure/d361752a-c257-474d-bb79-324fbe4898b5.md) |
