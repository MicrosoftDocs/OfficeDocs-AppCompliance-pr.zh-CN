---
title: APR 加入"开始"菜单的应用程序信息 - 管理解决方案 Lda。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/17/2022
...
description: 用于载入"开始"菜单的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "65454972"
---
# <a name="onboarding-start"></a>载入"开始"菜单

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 4 月 8 日</p>

* <a href="https://teams.microsoft.com/l/app/35729029-db8c-4cf5-b71f-9dc9511e0563" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004025" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

APR 提供的信息 - 管理解决方案 Lda。 到 Microsoft：
...
| 合作伙伴公司名称 | APR - 管理解决方案 Lda。 |
| 公司的网站 | [https://www.apr.pt](https://www.apr.pt) |
| 应用的使用条款 | [https://www.apr.pt/terms-and-conditions/](https://www.apr.pt/terms-and-conditions/) |
| 应用的核心功能 | 自动执行组织的加入过程，并轻松地与新员工沟通。 |
| 公司总部位置 | 葡萄牙 |
| 应用信息页 | |
...
APR - 管理解决方案 Lda 提供了此信息。 关于此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
| 隐私策略 URL | https://www.apr.pt/privacy-statement/ |
