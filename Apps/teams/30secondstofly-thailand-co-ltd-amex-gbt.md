---
title: AMEX GBT by 30SecondsToFly (泰国) 有限公司的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/28/2021
...
description: AMEX GBT 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/157b5ffb-b183-453c-b072-9c94bb6c694c" target="_blank">Teams存储区中的视图</a>
...
30SecondsToFly (泰国) 有限公司提供给 Microsoft 的信息：
...
| 公司的网站 | [https://www.amexglobalbusinesstravel.com](https://www.amexglobalbusinesstravel.com) |
| 应用的使用条款 | [https://www.amexglobalbusinesstravel.com/terms-service/](https://www.amexglobalbusinesstravel.com/terms-service/) |
| 应用的核心功能 | 与旅行顾问聊天。 无论你需要帮助找到住宿地点还是刚错过航班，我们的旅行顾问都可以24/7聊天。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
此信息由 30SecondsToFly (泰国) 有限公司提供，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
