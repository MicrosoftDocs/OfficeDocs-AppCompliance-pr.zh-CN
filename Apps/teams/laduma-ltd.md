---
title: Laduma Ltd 的 Laduma 应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/11/2022
...
description: Laduma 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/3bcb0d8a-5ec8-4637-a946-958e5c0277fd" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003907" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Laduma Ltd. 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | 拉杜马有限公司 |
| 公司的网站 | [https://laduma.com](https://laduma.com) |
| 应用的使用条款 | [https://laduma.com/terms-of-service/](https://laduma.com/terms-of-service/) |
| 应用的核心功能 | 无限制的白板、文档和应用程序共享Microsoft Teams |
...
Laduma Ltd. 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 用户配置文件数据、用户事件数据、GraphAPI 访问令牌、Microsoft Teams通道、日历和会议室资源 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 用户配置文件数据、用户事件数据、GraphAPI 访问令牌、Microsoft Teams通道、日历和会议室资源 |
...
| 隐私策略 URL | https://laduma.com/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Application.Read.All | 应用程序 | 在尝试将会议添加到日历时，请确保已安装应用程序 | [21759f96-a64d-450b-bf2a-b5e932d6ea01](../azure/21759f96-a64d-450b-bf2a-b5e932d6ea01.md) |
>| Calendars.Read | 两者 | 我们需要将会议添加到用户的日历 | [21759f96-a64d-450b-bf2a-b5e932d6ea01](../azure/21759f96-a64d-450b-bf2a-b5e932d6ea01.md) |
