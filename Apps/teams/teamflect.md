...
* <a href="https://teams.microsoft.com/l/app/e46015e9-f2ae-4dbc-be6b-f05043192e62" target="_blank">在 Teams 应用商店中查看</a>
...
| 应用的核心功能 | Teamflect 是为 Microsoft Teams 构建的一对一性能管理和员工参与解决方案。 它使人们更高效，更参与其 1 对 1 会议，目标/确定，反馈，识别和任务模块 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
Teamflect 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
