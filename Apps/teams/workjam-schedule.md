---
title: WorkJam 计划按 WorkJam 提供的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: WorkJam 计划的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/02cc7d46-7636-4f30-bae2-c5dfde32751c" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | WorkJam |
| 公司的网站 | [https://www.workjam.com](https://www.workjam.com) |
| 应用的使用条款 | [https://appcontent.workjam.com/en/terms-of-use/](https://appcontent.workjam.com/en/terms-of-use/) |
| 应用的核心功能 | WorkJam 是数字工作场所解决方案行业领导者，他们选择&#8212;作为一线生产力平台或在一线员工解决方案中协调一线员工。 WorkJam 以超过 37 种语言提供，部署在 38 个国家/地区，通过市场领先的任务管理、轮班管理、调查和微学习工具提供总劳动力业务流程。  |
| 公司总部位置 | 加拿大 |
| 应用信息页 | [https://www.workjam.com/portfolio-items/workjam-microsoft-t...](https://www.workjam.com/portfolio-items/workjam-microsoft-teams/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
WorkJam 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
>| User.Read | 委托 | 用于标识和身份验证 | [0b87cb84-073e-4cf6-a1ef-45d864ef2918](../azure/0b87cb84-073e-4cf6-a1ef-45d864ef2918.md) |
