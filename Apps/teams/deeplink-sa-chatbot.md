---
title: Deeplink SA 的 Deeplink Chatbot 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/13/2022
...
description: Deeplink Chatbot 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/9f859fc4-0b17-4bf7-abff-f50a73cbe5ab" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004200" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Deeplink SA 提供给 Microsoft 的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | Deeplink Chatbot |
| ID | WA200004200 |
| 支持Office 365客户端 | Microsoft Teams |
| 合作伙伴公司名称 | Deeplink SA |
| 公司的网站 | [https://www.deeplink.ai](https://www.deeplink.ai) |
| 应用的使用条款 | [https://www.deeplink.ai/en/terms/](https://www.deeplink.ai/en/terms/) |
| 应用的核心功能 | 使用 Deeplink 可以设置一个完全可自定义的聊天机器人（也称为对话代理），该聊天机器人由 AI 提供支持，并在 Microsoft Teams 中访问它，这是日常交互的核心。 借助 Teams，可将新的触摸点添加到现有助手，并提供对增强服务（如 IT 帮助程序、教程机器人或配置代理）的直接访问。 |
| 公司总部位置 | Switzerland（瑞士） |
| 应用信息页 | [https://www.deeplink.ai/en/integrations/msteams/](https://www.deeplink.ai/en/integrations/msteams/) |
...
Deeplink SA 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
| 数据库中存储了哪些数据？ | 租户 ID |
| 如果基础结构处理或存储 Microsoft 客户数据，则此数据在地理上存储在哪里？ | Switzerland（瑞士） |
| 是否已建立数据出租和处置流程？ | 是 |
