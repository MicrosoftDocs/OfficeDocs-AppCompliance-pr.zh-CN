---
title: SaltFlat Limited 的 SkilledHuman 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/24/2021
...
description: SkilledHuman 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/7c44d518-b820-461c-bbbd-2cbbd83aa3bc" target="_blank">Teams存储区中的视图</a>
...
SaltFlat Limited 提供给 Microsoft 的信息：
...
| 公司的网站 | [https://skilledhuman.org](https://skilledhuman.org) |
| 应用的使用条款 | [https://skilledhuman.org/terms](https://skilledhuman.org/terms) |
| 应用的核心功能 | Professional技能框架 |
| 公司总部位置 | 大不列颠及北爱尔兰联合王国 ()  |
| 应用信息页 | [https://skilledhuman.org/teamsapp](https://skilledhuman.org/teamsapp) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
SaltFlat Limited 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
