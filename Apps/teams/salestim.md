...
| 合作伙伴公司名称 | SalesTim |
| 公司网站 | [https://www.salestim.com](https://www.salestim.com) |
| 应用的使用条款 | [https://www.salestim.com/legal/tos](https://www.salestim.com/legal/tos) |
| 应用的核心功能 | SalesTim 可帮助每个组织通过无代码和模板创建Microsoft Teams自动化大规模改进其协作流程。 |
| 公司总部位置 | 法国 |
| 应用信息页面 | |
...
| 你的应用是否支持条件访问策略？ | 是 |
| 列出支持的策略类型 | Multi-Factor Authentication。 仅允许 Intune 注册的设备访问特定服务。 限制用户位置和 IP 范围 |
| 你的应用是否支持 CAE (连续访问)  |  |
| 你的应用是否将任何凭据存储在代码中？ |  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMember.ReadWrite.All | delegated | 由成员身份策略邀请加入频道的用户的 ID | [2a651f59-97ce-42bb-97d7-cf7a2af4b635](https://docs.microsoft.com/microsoft-365-app-certification/azure/2a651f59-97ce-42bb-97d7-cf7a2af4b635) |
>| Directory.AccessAsUser.All | delegated | 用户 ID。 允许用户在应用程序内的各个位置选择其他用户，例如选择工作流中的审批者。 | [2a651f59-97ce-42bb-97d7-cf7a2af4b635](https://docs.microsoft.com/microsoft-365-app-certification/azure/2a651f59-97ce-42bb-97d7-cf7a2af4b635) |
>| Group.ReadWrite.All | 两者 | 我们&#8217;存储组/团队的 ID，&#8217;不存储任何组/团队内容。 允许应用代表登录用户创建组、读取所有组属性和成员身份。 此外，还允许组所有者管理他们的组并允许组成员更新组内容。 | [2a651f59-97ce-42bb-97d7-cf7a2af4b635](https://docs.microsoft.com/microsoft-365-app-certification/azure/2a651f59-97ce-42bb-97d7-cf7a2af4b635) |
>| Mail.Send | delegated | 用户 ID。 我们将&#8217;此操作的元数据，如通知日期、收件人、请求 ID。 | [2a651f59-97ce-42bb-97d7-cf7a2af4b635](https://docs.microsoft.com/microsoft-365-app-certification/azure/2a651f59-97ce-42bb-97d7-cf7a2af4b635) |
>| User.Read.All | 两者 | 用户 ID 和配置文件数据。 允许用户在应用程序内的各个位置选择其他用户，例如选择工作流中的审批者。 | [2a651f59-97ce-42bb-97d7-cf7a2af4b635](https://docs.microsoft.com/microsoft-365-app-certification/azure/2a651f59-97ce-42bb-97d7-cf7a2af4b635) |
>| offline_access | delegated | 刷新令牌。 允许应用以用户方式执行一些后台操作和操作。 | [2a651f59-97ce-42bb-97d7-cf7a2af4b635](https://docs.microsoft.com/microsoft-365-app-certification/azure/2a651f59-97ce-42bb-97d7-cf7a2af4b635) |
