...
* <a href="https://teams.microsoft.com/l/app/14510476-fa9d-4dad-add9-aa5975a60a8b" target="_blank">在应用商店Teams视图</a>
...
ScrumGenius 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及组织将拥有对应用收集的数据的控制有关。
...
>|:----------------|:------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|:--------------------|
>| Calendars.Read | delegated | 用户日历中设置的休假日期。 | 用于用户将假期与 ScrumGenius 同步。 | [](https://docs.microsoft.com/microsoft-365-app-certification/azure/) |
>| User.Read | delegated | 用户名和电子邮件地址。 | 允许用户使用 Microsoft 登录登录。 | [](https://docs.microsoft.com/microsoft-365-app-certification/azure/) |
...
>是的，我们的应用程序数据在传输过程中和其余时间进行加密。 只有 Web 应用才能直接访问 DB。 外部访问受限，我们使用 IP 范围来保护访问。
...
<iframe height='1020' title='Microsoft Cloud App Security信息' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/35745' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/35745" target="_blank">在新建选项卡中查看</a>
