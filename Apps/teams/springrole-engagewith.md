...
| 合作伙伴公司名称 | SpringRole |
| 公司网站 | [https://www.springworks.in](https://www.springworks.in) |
| 应用的使用条款 | [https://engagewith.springworks.in/terms-and-conditions](https://engagewith.springworks.in/terms-and-conditions) |
| 应用的核心功能 | EngageWith 是一个对等员工奖励和认可平台，有助于培养认知文化、增强员工参与度并帮助组织取得巨大成就-无论大小。 员工可以通过为同事、三级或经理提供"Kudos"或"Canouts"来认可他们出色地完成工作。 Kudos 和 Rewardsouts 都有一组与之关联的点数，它们随着时间的推移而增加为有意义的奖励。  |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://www.springworks.in/engagewith/](https://www.springworks.in/engagewith/) |
...
| 隐私策略 URL | https://www.springworks.in/gdpr |
