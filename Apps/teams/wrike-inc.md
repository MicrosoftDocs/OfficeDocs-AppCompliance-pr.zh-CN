---
title: Wrike Inc. 的 Wrike 应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/05/2021
...
description: Wrike 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/05274a45-7312-4c23-8f64-d57fe4a28d6d" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | Wrike Inc. |
| 公司的网站 | [https://wrike.com](https://wrike.com) |
| 应用的使用条款 | [https://www.wrike.com/security/terms/](https://www.wrike.com/security/terms/) |
| 应用的核心功能 | 在Teams中管理所有 Wrike 项目、协作处理任务和接收通知。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://wrike.com](https://wrike.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
