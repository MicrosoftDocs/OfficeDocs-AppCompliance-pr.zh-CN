...
| 合作伙伴公司名称 | Wrike Inc. |
| 公司网站 | [https://wrike.com](https://wrike.com) |
| 应用的使用条款 | [https://www.wrike.com/security/terms/](https://www.wrike.com/security/terms/) |
| 应用的核心功能 | 管理所有 Wrike 项目、协作执行任务并接收通知，Teams。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://wrike.com](https://wrike.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
