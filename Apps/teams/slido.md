...
description: Slido 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/1517b59d-6d65-4316-a708-035adc659394" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | Slido |
| 公司的网站 | [https://www.sli.do](https://www.sli.do) |
| 应用的使用条款 | [https://www.sli.do/terms](https://www.sli.do/terms) |
| 应用的核心功能 | Slido 是实时和虚拟会议和活动的最终 QA&amp; 和轮询平台。 它提供交互式 QA&amp;、实时投票和有关受众的见解。 |
| 公司总部位置 | Slovakia（斯洛伐克） |
| 应用信息页 | [https://www.sli.do/product](https://www.sli.do/product) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
Slido 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
