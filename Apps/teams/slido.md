...
| 合作伙伴公司名称 | Slido |
| 公司网站 | [https://www.sli.do](https://www.sli.do) |
| 应用的使用条款 | [https://www.sli.do/terms](https://www.sli.do/terms) |
| 应用的核心功能 | Slido 是实时和虚拟会议和事件的最终 QA&amp; 和轮询平台。 它提供交互式 QA&amp;、实时投票和受众见解。 |
| 公司总部位置 | Slovakia（斯洛伐克） |
| 应用信息页面 | [https://www.sli.do/product](https://www.sli.do/product) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
