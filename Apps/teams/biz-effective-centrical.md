---
title: Centrical 的应用程序信息（按Biz-Effective）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/08/2021
...
description: Centrical 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/7a70b8e4-43ca-46a7-b7c3-eb31b33de397" target="_blank">Teams存储区中的视图</a>
...
Biz-Effective提供给 Microsoft 的信息：
...
| 公司的网站 | [https://centrical.com](https://centrical.com) |
| 应用的使用条款 | [https://centrical.com/terms](https://centrical.com/terms) |
| 应用的核心功能 | 中心平台可让员工专注于需要完成的工作，重要的是，如何完成此操作。 它使用测量工作中的数据来提示生成熟练程度的微学习。 它利用人工智能来提高员工的参与度、性能以及微学习。 中心平台通过 Web 应用程序、移动应用、Microsoft Teams应用、Salesforce 和 SuccessFactors 应用提供。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://centrical.com/solutions/solutions-by-use-case-2/mic...](https://centrical.com/solutions/solutions-by-use-case-2/microsoft-teams-gamification/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
Biz-Effective提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
