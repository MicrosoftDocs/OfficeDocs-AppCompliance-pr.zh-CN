...
由 microsoft Biz-Effective提供的信息：
...
| 公司网站 | [https://centrical.com](https://centrical.com) |
| 应用的使用条款 | [https://centrical.com/terms](https://centrical.com/terms) |
| 应用的核心功能 | 以中心为中心的平台使员工专注于需要完成的工作，重要的是如何继续工作。 它使用来自测量的工作的数据来提示建立熟练程度的微学习。 它利用人工智能来提高员工参与度、绩效以及微学习。 通过 Web 应用程序、移动应用程序、Microsoft Teams、Salesforce 和 SuccessFactors 应用，可以使用以中心为中心的平台。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://centrical.com/solutions/solutions-by-use-case-2/mic...](https://centrical.com/solutions/solutions-by-use-case-2/microsoft-teams-gamification/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
