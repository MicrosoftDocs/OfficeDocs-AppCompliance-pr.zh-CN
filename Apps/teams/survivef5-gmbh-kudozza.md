---
title: Kudozza by surviveF5 GmbH 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/03/2022
...
description: Kudozza 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
<p>开发人员上次更新时间：2022 年 2 月 2 日</p>

* <a href="https://teams.microsoft.com/l/app/61a58a9f-3474-4d14-bda6-6547194a7381" target="_blank">Teams存储区中的视图</a>
...
surviveF5 GmbH 提供给 Microsoft 的信息：
...
| 公司的网站 | [https://surviveF5.com](https://surviveF5.com) |
| 应用的使用条款 | [https://kudozza.com/terms](https://kudozza.com/terms) |
| 应用的核心功能 | Kudozza 允许将 Kudos 授予其他团队成员，以向他们表达你的感激之情。 它提供各种工具，如表情符号参与，类别或排名，以激励 Kudos 的给予。 |
| 公司总部位置 | 德国 |
| 应用信息页 | [https://kudozza.com](https://kudozza.com) |
...
surviveF5 GmbH 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 用户配置文件数据，消息数据 (处理到机器人)  |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | userid， teamid， teamname， username， tenantid， messageid， messagetext |
...
| 隐私策略 URL | https://www.kudozza.com/privacy/ |
...
| 如果你的应用不使用上述库之一，它使用什么身份验证库或库？ | MSAL，但仍需升级到最新版本以供Teams |
| 应用是否支持条件访问策略？ | 否 |
| 应用是否支持持续访问评估 (CAE)  | 否 |
| 应用是否在代码中存储任何凭据？ | 可访问 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 委托 | 阅读团队的频道，让用户能够选择要在其中发布 kudos 的频道 | [69e59100-2fb7-4f6e-a311-987f52b3007b](../azure/69e59100-2fb7-4f6e-a311-987f52b3007b.md) |
>| Teams.ReadBasic.All | 委托 | 用户可以选择一个团队和一个频道，他希望在其中发布 kudos。 读取团队需要团队读取权限。 | [69e59100-2fb7-4f6e-a311-987f52b3007b](../azure/69e59100-2fb7-4f6e-a311-987f52b3007b.md) |
>| User.Read | 委托 | 获取用户所属的团队 | [69e59100-2fb7-4f6e-a311-987f52b3007b](../azure/69e59100-2fb7-4f6e-a311-987f52b3007b.md) |
>| User.ReadBasic.All | 委托 | 读取用户名 | [69e59100-2fb7-4f6e-a311-987f52b3007b](../azure/69e59100-2fb7-4f6e-a311-987f52b3007b.md) |
