...
| 合作伙伴公司名称 | Sliday LTD |
| 公司网站 | [https://karmabot.chat/ms](https://karmabot.chat/ms) |
| 应用的使用条款 | [https://karmabot.readme.io/docs/karma-end-user-license-agre...](https://karmabot.readme.io/docs/karma-end-user-license-agreement-eula) |
| 应用的核心功能 | 真正为远程团队提供支持。 |
| 公司总部位置 | 新西兰 |
| 应用信息页面 | [https://karmabot.chat/ms](https://karmabot.chat/ms) |
...
此信息由 Sliday LTD 提供，用于了解此应用程序如何收集和存储组织数据，以及您的组织将拥有对应用收集的数据的控制。
...
| 隐私策略 URL | https://karmabot.readme.io/docs/privacy-policy-for-microsoft-teams |
