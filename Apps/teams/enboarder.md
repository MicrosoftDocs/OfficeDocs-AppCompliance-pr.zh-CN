---
title: Enboarder by Enboarder 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Enboarder 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/f6b1f54a-3e72-404f-9085-1d77c4151be0" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | 载入程序 |
| 公司的网站 | [https://enboarder.com](https://enboarder.com) |
| 应用的使用条款 | [https://enboarder.com/terms/](https://enboarder.com/terms/) |
| 应用的核心功能 | Enboarder 是领先的Experience-Driven载入平台，可更改载入体验。 |
| 公司总部位置 | 澳大利亚 |
| 应用信息页 | [https://enboarder.com/why-enboarder/](https://enboarder.com/why-enboarder/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
Enboarder 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
