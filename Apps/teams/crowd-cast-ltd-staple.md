...
description: 适用于斯台普的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/ac9ca94a-e666-4f61-959a-12c063e13e69" target="_blank">Teams存储区中的视图</a>
...
| 公司的网站 | [https://crowdcast.jp/ja/](https://crowdcast.jp/ja/) |
| 应用的使用条款 | [https://go.microsoft.com](https://go.microsoft.com) |
| 应用的核心功能 | 使用实时费用管理更改工作风格。 斯台普允许为公司轻松提交、审批和跟踪费用。 与Microsoft 服务链接，以便轻松与产品交互。 |
| 公司总部位置 | 日本 |
| 应用信息页 | [https://intercom.help/staple/ja](https://intercom.help/staple/ja) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
Crowd Cast， Ltd. 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Organization.Read.All | 应用程序 | 用于收集租户 ID。用于确保使用我们的平台进行身份验证的用户是特定租户的成员。 | [ac9ca94a-e666-4f61-959a-12c063e13e69](../azure/ac9ca94a-e666-4f61-959a-12c063e13e69.md) |
>| TeamsAppInstallation.ReadWriteSelfForUser.All | 应用程序 | Teams应用将自我安装到用户的团队 | [ac9ca94a-e666-4f61-959a-12c063e13e69](../azure/ac9ca94a-e666-4f61-959a-12c063e13e69.md) |
>| AppCatalog.Read.All | 委托 | 读取用户的应用目录，查看是否安装了 Teams 应用。 | [bbdcd676-7448-453c-bec7-70e5384bc290](../azure/bbdcd676-7448-453c-bec7-70e5384bc290.md) |
>| User.Read | 委托 | 用于读取用户 ID 以确保将消息发送到正确的用户。 | [bbdcd676-7448-453c-bec7-70e5384bc290](../azure/bbdcd676-7448-453c-bec7-70e5384bc290.md) |
>| openid | 委托 | 登录用户以读取其基本配置文件信息 | [bbdcd676-7448-453c-bec7-70e5384bc290](../azure/bbdcd676-7448-453c-bec7-70e5384bc290.md) |
