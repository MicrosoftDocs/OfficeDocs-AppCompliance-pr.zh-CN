...
description: 装订的所有可用安全和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| 应用程序Teams页的 URL | [https://intercom.help/staple/ja](https://intercom.help/staple/ja) |
...
>| TeamsAppInstallation.ReadWriteSelfForUser.All | 应用程序 | Teams将自身安装到用户团队 | 不适用 | [ac9ca94a-e666-4f61-959a-12c063e13e69](https://docs.microsoft.com/microsoft-365-app-certification/azure/ac9ca94a-e666-4f61-959a-12c063e13e69) |
