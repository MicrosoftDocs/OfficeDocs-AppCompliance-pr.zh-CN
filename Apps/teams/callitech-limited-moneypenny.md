...
description: 有关 Moneype数据源的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "60874843"
---
# <a name="moneypenny"></a>Moneype一
...
>|   **Graph权限**  | **权限类型** |          **字距调整**          |
>|:------------------------|:--------------------|:------------------------------------|
>| Calls.Initiate.All | 应用程序 | 通过自动程序Teams呼叫用户 |
>| Calls.AccessMedia.All | 应用程序 | 将媒体从自动程序流式传输Teams用户 |
