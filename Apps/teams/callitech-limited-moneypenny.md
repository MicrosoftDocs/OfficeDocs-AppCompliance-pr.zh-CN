---
title: CallITECH LIMITED 的 Moneype创建的应用程序信息
ms.author: elmalova
author: elenamalova
ms.date: 11/08/2021
ms.topic: article
...
description: Moneype进行的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/ff5b7b81-ef94-441d-bc7c-eb04e53a188f" target="_blank">在应用商店Teams视图</a>
...
| 公司网站 | [https://www.moneypenny.com](https://www.moneypenny.com) |
...
| 应用的核心功能 | 该应用的核心功能是使Teams加入其组织，以通过 Bot 接收来自 Moneype进行呼叫 |
| 公司总部位置 | 英国大英和爱尔兰 ()  |
| 应用信息页面 | |
...
此信息由 CALLITECH LIMITED 提供，用于了解此应用程序如何收集和存储组织数据，以及您的组织将拥有对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calls.AccessMedia.All | 应用程序 | 将媒体从自动程序流式传输Teams用户 | [8277a51c-3ad6-446c-9b7e-e3f6e27257c1](https://docs.microsoft.com/microsoft-365-app-certification/azure/8277a51c-3ad6-446c-9b7e-e3f6e27257c1) |
>| Calls.Initiate.All | 应用程序 | 通过自动程序Teams呼叫用户 | [8277a51c-3ad6-446c-9b7e-e3f6e27257c1](https://docs.microsoft.com/microsoft-365-app-certification/azure/8277a51c-3ad6-446c-9b7e-e3f6e27257c1) |
