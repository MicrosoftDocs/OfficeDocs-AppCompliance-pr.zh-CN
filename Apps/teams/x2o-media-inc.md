---
title: X2O Media， Inc. 的 X2O 应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: X2O 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/647624e1-056f-43cb-a112-b9bc64c81ef4" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003735" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

X2O Media， Inc. 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | X2O Media， Inc. |
| 公司的网站 | [https://www.x2omedia.com](https://www.x2omedia.com) |
| 应用的使用条款 | [https://www.x2omedia.com/en/terms-of-use/](https://www.x2omedia.com/en/terms-of-use/) |
| 应用的核心功能 | 通过 X2O 渠道向全球员工传达业务信息。 |
| 公司总部位置 | 加拿大 |
| 应用信息页 | |
...
X2O Media， Inc. 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
| 最新的 SOC1 认证日期 | 2020-05-14 |
| 应用是否符合服务组织控制 (SOC 2) ？ | 是 |
| 你实现了哪个 SOC 2 认证？ | type2 |
| 最新的 SOC2 认证日期 | 2020-05-14 |
...
| 隐私策略 URL | https://www.x2omedia.com/privacy |
