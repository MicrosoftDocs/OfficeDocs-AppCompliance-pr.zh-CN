...
description: CSA STAR 注册表中的所有可用安全性和符合性信息、其数据处理策略、Microsoft Cloud App Security应用目录信息以及安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/1250b735-e9df-4d5b-ae82-da96c55c64e4" target="_blank">Teams存储区中的视图</a>
...
| 公司的网站 | [https://standuply.com](https://standuply.com) |
| 应用的使用条款 | [https://standuply.com/terms](https://standuply.com/terms) |
| 应用的核心功能 | 独立自动执行管理流程，并提供内部 QA&amp; 系统来提高团队的工作效率。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://standuply.com](https://standuply.com) |
...
Standuply Inc. 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | P.3 https://standuply.com/privacy-policy |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 可访问 |
| 数据库中存储了哪些数据？ | P.3 https://standuply.com/privacy-policy |
...
| 隐私策略 URL | https://standuply.com/privacy-policy |
...
| 如果你的应用不使用上述库之一，它使用什么身份验证库或库？ | OAuth 2.0 |
| 应用是否支持条件访问策略？ | 否 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| MailboxSettings.Read | 应用程序 | 发送有关用户单个时区的报表 | [e9f5cb58-89eb-4f80-9a6c-b73823b62176](../azure/e9f5cb58-89eb-4f80-9a6c-b73823b62176.md) |
>| User.Read | 委托 | 授权产品中的用户 | [e9f5cb58-89eb-4f80-9a6c-b73823b62176](../azure/e9f5cb58-89eb-4f80-9a6c-b73823b62176.md) |
