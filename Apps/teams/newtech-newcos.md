...
| 应用的核心功能 | 快速、轻松地在服务模式下部署智能通信解决方案。 NewCOS 平台允许你快速、轻松地运行、管理、监视和支持安装，而无需 IT 干预。  我们将与你们一起，确保采用技术的过程获得成功。 我们缓解了当今协作工作区中的变化。 通过采用Microsoft 365我们可以在组织中加速数字转型过程。  |
| 公司总部位置 | 阿根廷 |
| 应用信息页面 | [https://N.A](https://N.A) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| profile | 两者 | 此数据用于对应用程序权限进行身份验证 | [07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e](../azure/07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e.md) |
>| openid | 两者 | Microsoft Teams使用情况，以报告和管理 | [ea4de024-dd5f-4d3e-a092-3b8de6c64200](../azure/ea4de024-dd5f-4d3e-a092-3b8de6c64200.md) |
