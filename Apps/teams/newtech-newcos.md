---
title: Newtech 提供的 NewCOS 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/27/2021
...
description: NewCOS 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/205214d0-e04b-11e9-9332-5b5c97b60069" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | Newtech |
| 公司的网站 | [https://newtech.com.ar](https://newtech.com.ar) |
| 应用的使用条款 | [https://newtech.com.ar/termsofservice](https://newtech.com.ar/termsofservice) |
| 应用的核心功能 | 在服务模式下快速、轻松地部署智能通信解决方案。 通过 NewCOS 平台，你可以快速、轻松地运行、管理、监视和支持安装，而无需 IT 干预。  我们与你一起去，使采用技术的过程是成功的。 我们简化了当今协作工作区中更改的适应。 通过采用Microsoft 365我们可以加快组织内的数字化转型过程。  |
| 公司总部位置 | 阿根廷 |
| 应用信息页 | [https://N.A](https://N.A) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
Newtech 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| 个人资料 | 两者 | 此数据用于应用权限的身份验证 | [07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e](../azure/07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e.md) |
>| openid | 两者 | Microsoft Teams使用情况，以报告和治理 | [ea4de024-dd5f-4d3e-a092-3b8de6c64200](../azure/ea4de024-dd5f-4d3e-a092-3b8de6c64200.md) |
