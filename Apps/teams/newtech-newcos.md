---
title: Newtech 针对 NewCOS 的应用程序信息
ms.author: elmalova
author: elenamalova
ms.date: 07/27/2021
ms.topic: article
...
* <a href="https://teams.microsoft.com/l/app/205214d0-e04b-11e9-9332-5b5c97b60069" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001104" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Newtech 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Newtech |
| 公司网站 | [https://newtech.com.ar](https://newtech.com.ar) |
| 应用的使用条款 | [https://newtech.com.ar/termsofservice](https://newtech.com.ar/termsofservice) |
| 应用的核心功能 | 快速、轻松地在服务模式下部署智能通信解决方案。 NewCOS 平台允许你快速、轻松地运行、管理、监视和支持安装，而无需 IT 干预。  我们将与你们一起，确保采用技术的过程获得成功。 我们缓解了当今协作工作区中的变化。 通过采用Microsoft 365我们可以在组织中加速数字化转型过程。  |
| 公司总部位置 | 阿根廷 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
Newtech 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及您的组织将拥有对应用收集的数据的控制有关。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| 个人资料 | 两者 | 此数据用于对应用程序权限进行身份验证 | [07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e](https://docs.microsoft.com/microsoft-365-app-certification/azure/07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e) |
>| openid | 两者 | Microsoft Teams使用情况，以报告和管理 | [ea4de024-dd5f-4d3e-a092-3b8de6c64200](https://docs.microsoft.com/microsoft-365-app-certification/azure/ea4de024-dd5f-4d3e-a092-3b8de6c64200) |
