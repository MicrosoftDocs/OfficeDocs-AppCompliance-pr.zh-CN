---
title: Avista 技术解决方案为 AnnounceBot 提供的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/17/2022
...
description: AnnounceBot 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/d13120dd-5961-4589-b470-19d9d01c6668" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003321" target="_blank">在 AppSource 中查看</a>
...
| 公司网站 | [https://announcebot.in](https://announcebot.in) |
| 应用的使用条款 | [https://announcebot.in/terms.html](https://announcebot.in/terms.html) |
| 应用的核心功能 | 使用 AnnounceBot 及时向同事提供生日、周年纪念和欢迎 |
| 公司总部位置 | 印度 |
| 应用信息页面 | [https://announcebot.in](https://announcebot.in) |
