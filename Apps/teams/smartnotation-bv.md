---
title: Smartnotation B.V 的 Smartnotation 应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/09/2021
...
description: Smartnotation 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/424b1333-fbf0-4941-acbe-336bf1f316ae" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000681" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Smartnotation B.V 提供的信息。 到 Microsoft：
...
| 公司的网站 | [https://www.smartnotation.com/landing/](https://www.smartnotation.com/landing/) |
| 应用的使用条款 | [https://www.smartnotation.com/public/tos.pdf](https://www.smartnotation.com/public/tos.pdf) |
| 应用的核心功能 | 智能表示是一种易于使用的、启用语音的会议分钟数解决方案。 笔记、操作和决策易于管理，信息始终可用。 最重要的是，它消除了不必要的开销，使你和你的团队能够专注于你的核心业务。 可以将 Smartnotation 与 MS Teams 完全集成。 添加连接器以获取有关特定项目的所有重要更新、新笔记、操作和决策的通知、配置选项卡或直接使用 Smartnotation。 |
| 公司总部位置 | 荷兰 ()  |
| 应用信息页 | [https://www.smartnotation.com/landing/integrations/](https://www.smartnotation.com/landing/integrations/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Totaaldomein B.V. |
...
Smartnotation B.V 提供了此信息。 关于此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
