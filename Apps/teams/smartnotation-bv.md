...
| 公司网站 | [https://www.smartnotation.com/landing/](https://www.smartnotation.com/landing/) |
| 应用的使用条款 | [https://www.smartnotation.com/public/tos.pdf](https://www.smartnotation.com/public/tos.pdf) |
| 应用的核心功能 | Smartnotation 是一种易于使用的启用语音的会议分钟数解决方案。 笔记、操作和决策易于管理，并且信息始终可用。 最重要的是，它无需不必要的开销，使你和团队专注于你的核心业务。 可以将 Smartnotation 完全与 MS Teams。 添加连接器以接收有关特定项目的所有重要更新、新注释、操作和决策的通知，配置选项卡或直接使用 Smartnotation。 |
| 公司总部位置 | 荷兰 ()  |
| 应用信息页面 | [https://www.smartnotation.com/landing/integrations/](https://www.smartnotation.com/landing/integrations/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
