...
| 应用的核心功能 | Good4work 是一个团队参与工具，适用于分布式团队以提高团队合作。 同时，它还提供有关团队和人员见解。 它从你目前的地方工作，包括Microsoft Teams。 通过发送 kudos，&#8217;团队成员对优势和正面影响进行识别。 Good4work 旨在通过传播信任和感同文化来培养一个创新虚拟环境。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
