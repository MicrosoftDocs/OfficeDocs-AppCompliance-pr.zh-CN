---
title: RingCentral，Inc. 的 RingCentral 应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/16/2021
...
description: RingCentral 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/2f285d77-896a-4c5f-901e-0902316003b5" target="_blank">Teams存储区中的视图</a>
...
RingCentral 公司向 Microsoft 提供的信息：
...
| 公司的网站 | [https://www.ringcentral.com](https://www.ringcentral.com) |
| 应用的使用条款 | [https://www.ringcentral.com/legal/last-update-October-15-20...](https://www.ringcentral.com/legal/last-update-October-15-2019/eulatos.html) |
| 应用的核心功能 | 使用快速机器人命令和消息传送功能启动和加入 RingCentral 视频或音频调用。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://www.ringcentral.com/apps/ringcentral-for-microsoft-...](https://www.ringcentral.com/apps/ringcentral-for-microsoft-teams) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
RingCentral 公司提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
| 最新的 SOC2 认证日期 | 2020-05-11 |
| 应用是否符合服务组织控制 (SOC 3) ？ | 可访问 |
| 最新的 SOC3 认证日期 | 2020-05-11 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 委托 |  允许应用程序通过其日历发送会议邀请事件 | [ 0dd4bfdf-dc86-4f05-9991-a14bc0144ebf](../azure/ 0dd4bfdf-dc86-4f05-9991-a14bc0144ebf.md) |
>| offline_access | 委托 |  允许应用程序获取和更新 oauth 令牌 | [ 0dd4bfdf-dc86-4f05-9991-a14bc0144ebf](../azure/ 0dd4bfdf-dc86-4f05-9991-a14bc0144ebf.md) |
>| User.Read | 委托 |  允许应用读取用户&#8217;的基本配置文件 (电子邮件、名称) ，以便在末尾执行联系人匹配。 并允许用户登录并将其 O365 帐户与 RingCentral 帐户链接 | [0dd4bfdf-dc86-4f05-9991-a14bc0144ebf](../azure/0dd4bfdf-dc86-4f05-9991-a14bc0144ebf.md) |
>| User.Read.All | 委托 | 允许应用程序使用电话号码读取用户的完整配置文件，以便通过我们的服务进行电话呼叫。 | [0dd4bfdf-dc86-4f05-9991-a14bc0144ebf](../azure/0dd4bfdf-dc86-4f05-9991-a14bc0144ebf.md) |
