---
title: Grytics Companion by 1339 SAS 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/15/2022
...
description: Grytics Companion 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66547082"
---
# <a name="grytics-companion"></a>Grytics 助手

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 6 月 3 日</p>

* <a href="https://teams.microsoft.com/l/app/54ab7c02-a92f-4a87-9f59-764e42009fbc" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004217" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

1339 SAS 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | 1339 SAS |
| 公司的网站 | [https://grytics.com](https://grytics.com) |
| 应用的使用条款 | [https://grytics.com/terms](https://grytics.com/terms) |
| 应用的核心功能 | 用户可以比较 &amp; 已添加到其 Grytics 帐户的业务社交网络的趋势 &amp; 活动 |
| 公司总部位置 | 法国 |
| 应用信息页 | |
...
1339 SAS 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
| 数据库中存储了哪些数据？ | 名称，应用用户的电子邮件。  |
| 如果基础结构处理或存储 Microsoft 客户数据，则此数据在地理上存储在哪里？ | 爱尔兰、法国 |
| 是否已建立数据出租和处置流程？ | 是 |
...
| 隐私策略 URL | https://grytics.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 应用程序 | 需要让 Grytics 管理员授权其 Grytics 用户在 Teams 上使用应用，并在 AAD 上匹配其用户 ID | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| User.Read | 委托 | SSO 身份验证流所需的 | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| User.Read.All | 应用程序 | 需要让 Grytics 管理员授权其 Grytics 用户在 Teams 上使用应用，并在 AAD 上匹配其用户 ID | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| 电子邮件 | 委托 | SSO 身份验证流所需的 | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| offline_access | 委托 | SSO 身份验证流所需的 | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| 个人资料 | 委托 | SSO 身份验证流所需的 | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
