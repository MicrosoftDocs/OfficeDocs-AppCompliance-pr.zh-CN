...
description: 有关 Quicklinks 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| 应用程序Teams页的 URL | [https://www.chitchattr.com/quicklinks/](https://www.chitchattr.com/quicklinks/) |
