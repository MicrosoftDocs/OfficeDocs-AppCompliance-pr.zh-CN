---
title: Clixie 媒体 LLC 的 Clixie 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/24/2022
...
description: Clixie 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "64463668"
---
# <a name="clixie"></a>Clixie

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 3 月 23 日</p>

* <a href="https://teams.microsoft.com/l/app/3ff43e1b-180b-4aab-916e-e49aaaefbccb" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003880" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Clixie 媒体 LLC 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Clixie 媒体 LLC |
| 公司网站 | [https://clixiemedia.com](https://clixiemedia.com) |
| 应用的使用条款 | [https://clixiemedia.com/terms-and-conditions/](https://clixiemedia.com/terms-and-conditions/) |
| 应用的核心功能 | Clixie 采用实时或混合会议会话录制，并转换为有用、具有吸引力且令人记忆的按需培训模块，Clixie 会实时更新这些模块;具有可用于实际决策的认证和数据概览。 微学习、锁章、视频内评估/投票、自适应学习和游戏是旨在推动参与的一些强大功能。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://clixiemedia.com](https://clixiemedia.com) |
...
Clixie 媒体 LLC 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及组织将拥有对应用收集的数据的控制有关。
...
| 隐私策略 URL | https://clixiemedia.com/privacy-policy/ |
