...
description: 适用于思维模式的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/fdc91943-4341-41e6-b4e7-b4625ab8c8f7" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003000" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

思维模式向 Microsoft 提供的信息Learning：
...
| 合作伙伴公司名称 | 思维方式学习 |
| 公司的网站 | [https://www.mindsets.com](https://www.mindsets.com) |
| 应用的使用条款 | [https://www.mindsets.com/terms](https://www.mindsets.com/terms) |
| 应用的核心功能 | 思维模式Learning是基于查询&amp;项目的学习平台。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://www.mindsets.com](https://www.mindsets.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
这些信息由思维模式Learning提供，这些信息涉及此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
