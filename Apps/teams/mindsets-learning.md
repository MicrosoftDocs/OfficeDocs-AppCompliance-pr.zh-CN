...
| 合作伙伴公司名称 | 思维方式学习 |
| 公司网站 | [https://www.mindsets.com](https://www.mindsets.com) |
| 应用的使用条款 | [https://www.mindsets.com/terms](https://www.mindsets.com/terms) |
| 应用的核心功能 | 意识Learning是一个基于学习平台&amp;的查询项目。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://www.mindsets.com](https://www.mindsets.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
