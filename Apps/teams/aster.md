...
* <a href="https://teams.microsoft.com/l/app/2d8e8042-66df-4605-8c3a-9ca8962f3e99" target="_blank">Teams存储区中的视图</a>
...
| 应用的核心功能 | 节省时间的会议分钟数！ |
| 公司总部位置 | 法国 |
| 应用信息页 | [https://asterapp.co/solution/](https://asterapp.co/solution/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
Aster 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>| Notes.ReadWrite.All | 委托 | 用于写入OneNote的备注内容 | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
