---
title: NetForce 365 GmbH 的 HubSite 365 的应用程序信息
ms.author: elmalova
author: elenamalova
ms.date: 01/27/2022
ms.topic: article
...
description: HubSite 365 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/ef56f507-2c71-4bb1-ba4a-0a7016f7a210" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003704" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

NetForce 365 GmbH 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | NetForce 365 GmbH |
| 公司网站 | [https://www.netforce365.com](https://www.netforce365.com) |
| 应用的使用条款 | [https://netforce365.com/en/tus](https://netforce365.com/en/tus) |
| 应用的核心功能 | 查找并共享有关事件的最新新闻、Microsoft 365。 |
| 公司总部位置 | 德国 |
| 应用信息页面 | |
...
NetForce 365 GmbH 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及组织将拥有对应用收集的数据的控制有关。
...
| 隐私策略 URL | https://teams.hubsite365.com/privacy-policy |
