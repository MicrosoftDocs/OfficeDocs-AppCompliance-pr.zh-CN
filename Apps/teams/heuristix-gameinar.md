---
title: 由 Heuristix 表示的 Gameinar 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/19/2022
...
description: Gameinar 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/10a3a812-c72d-47d4-b9b5-6425c6fed158" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003379" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Heuristix 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Heuristix |
| 公司网站 | [https://www.disprz.com](https://www.disprz.com) |
| 应用的使用条款 | [https://www.disprz.com/terms-of-service-gameinar/](https://www.disprz.com/terms-of-service-gameinar/) |
| 应用的核心功能 | 创建极具吸引力的虚拟主机！ |
| 公司总部位置 | 印度 |
| 应用信息页面 | [https://disprz.com/gameinar/](https://disprz.com/gameinar/) |
...
此信息由 Heuristix 提供有关此应用程序如何收集和存储组织数据以及您的组织将拥有对应用收集的数据的控制的信息。
