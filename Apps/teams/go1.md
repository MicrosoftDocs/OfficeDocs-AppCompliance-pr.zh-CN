...
description: Go1 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/c859de61-8a6b-42e6-ba88-f639df33bc72" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | Go1 |
| 公司的网站 | [https://www.go1.com/user/login](https://www.go1.com/user/login) |
| 应用的使用条款 | [https://www.go1.com/en-au/terms/user-terms](https://www.go1.com/en-au/terms/user-terms) |
| 应用的核心功能 | GO1 Teams应用有助于从Microsoft Teams中查找、使用、共享和讨论学习资源 |
| 公司总部位置 | 澳大利亚 |
| 应用信息页 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
Go1 提供了有关此应用如何收集和存储组织数据以及组织对应用收集的数据的控制的信息。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | 应用程序 | 应用不存储文件数据 | [c859de61-8a6b-42e6-ba88-f639df33bc72](../azure/c859de61-8a6b-42e6-ba88-f639df33bc72.md) |
>| Group.ReadWrite.All | 应用程序 | Teams和频道名称以及唯一 ID 的存储，以支持应用管理学习环境 | [c859de61-8a6b-42e6-ba88-f639df33bc72](../azure/c859de61-8a6b-42e6-ba88-f639df33bc72.md) |
>| User.Read.All | 应用程序 | 用于提供直接个人学习体验的用户姓名、电子邮件和 UPN 存储 | [c859de61-8a6b-42e6-ba88-f639df33bc72](../azure/c859de61-8a6b-42e6-ba88-f639df33bc72.md) |
