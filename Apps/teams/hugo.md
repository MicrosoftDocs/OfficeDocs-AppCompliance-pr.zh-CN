...
* <a href="https://teams.microsoft.com/l/app/e14ce411-84d7-4bb5-94e9-92536320f0b1" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003616" target="_blank">在 AppSource 中查看</a>
...
| 合作伙伴公司名称 | 百分百 |
| 公司网站 | [https://www.hugo.team](https://www.hugo.team) |
| 应用的使用条款 | [https://www.hugo.team/terms](https://www.hugo.team/terms) |
| 应用的核心功能 | 对于专为使用 &#8211; 团队设计的会议、笔记和任务，Microsoft Teams。 通过以日历为中心的笔记记录平台，你和团队可以集中处理会议议程和笔记、任务和操作&#8211;所有由你开会的联系人和公司自动组织，并连接到你每天使用的 20 多个应用。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
...
此信息由以下人员提供：此应用如何收集和存储组织数据，以及组织将拥有对应用收集的数据的控制。
...
| 你是否在支持应用的网络 (外围部署了入侵检测和) IDPS 和 IDPS 软件？ | 是 |
...
| 隐私策略 URL | https://www.hugo.team/privacy |
