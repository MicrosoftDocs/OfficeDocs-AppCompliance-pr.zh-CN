---
title: Wanda by Unit4 Business Software 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/15/2022
...
description: Wanda 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/73642721-0f64-4d3a-ab6c-2c1fe053aa80" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004038" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Unit4 Business Software 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Unit4 Business Software |
| 公司的网站 | [https://www.unit4.com](https://www.unit4.com) |
| 应用的使用条款 | [https://www.unit4.com/terms-and-conditions](https://www.unit4.com/terms-and-conditions) |
| 应用的核心功能 | Wanda 可帮助你处理最常规的 ERP 任务。 |
| 公司总部位置 | 荷兰 ()  |
| 应用信息页 | [https://get-wanda-help.u4pp.com](https://get-wanda-help.u4pp.com) |
...
Unit4 Business Software 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 特定于机器人的Microsoft Teams用户 ID |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 特定于机器人的Microsoft Teams用户 ID |
...
| 最新的 SOC1 认证日期 | 2021-11-05 |
| 应用是否符合服务组织控制 (SOC 2) ？ | 是 |
| 你实现了哪个 SOC 2 认证？ | type2 |
| 最新的 SOC2 认证日期 | 2021-11-23 |
...
| 隐私策略 URL | https://info.unit4.com/rs/400-HYB-295/images/Unit4-People-Platform-Service-Description-v.1.1-September-2021-%28EN%29-%281%29.pdf |
