...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| ChannelMember.ReadWrite.All | 两者 | 为 OAuth 2.0 隐式授权收集租户应用程序 ID 和应用程序密码以同步用户信息 | 租户 ID、租户应用程序 ID、应用程序密码和用户信息存储在数据库中，数据库中用于获取 Teams 中的用户的频道文件信息并操作这些文件 | 3407e97c-3eed-4eca-add5-2549ed881269 |
