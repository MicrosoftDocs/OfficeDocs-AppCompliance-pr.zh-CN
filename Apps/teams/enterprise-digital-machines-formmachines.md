...
| 公司网站 | [https://www.formmachines.com](https://www.formmachines.com) |
| 应用的使用条款 | [https://www.formmachines.com/dist/docs#/statements_and_agre...](https://www.formmachines.com/dist/docs#/statements_and_agreements/terms_of_service) |
| 应用的核心功能 | 为用户提供Teams轻松生成企业表单的能力 |
| 公司总部位置 | 澳大利亚 |
| 应用信息页面 | [https://www.formmachines.com](https://www.formmachines.com) |
...
此信息已由 Enterprise Digital Machines 提供有关此应用如何收集和存储组织数据以及您的组织将拥有对应用收集的数据的控制的信息。
...
| 隐私策略 URL | https://www.formmachines.com/dist/docs#/statements_and_agreements/privacy |
