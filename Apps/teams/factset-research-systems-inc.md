...
| 应用的核心功能 | 使用 FactSet for Microsoft Teams，您将收到来自 StreetAccount 的特图新闻摘要，以便你可以了解影响全球市场的关键案例。 您可以查询 FactSet&#8217;行业领先的内容，获取详细的公司信息，并与同事和组共享此信息，从而轻松地进行协作，而无需在应用程序之间切换。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 应用程序 | 用于验证和日志记录的名称和电子邮件、用于主动邮件发送的对话 ID | [95fb5da0-6ced-4247-9d62-294f8fcb75df](../azure/95fb5da0-6ced-4247-9d62-294f8fcb75df.md) |
