...
* <a href="https://teams.microsoft.com/l/app/95fb5da0-6ced-4247-9d62-294f8fcb75df" target="_blank">在应用商店Teams视图</a>
...
| 公司网站 | [https://www.factset.com](https://www.factset.com) |
...
| 应用的核心功能 | 使用 FactSet for Microsoft Teams，您将收到来自 StreetAccount 的特图新闻摘要，以便你可以了解影响全球市场的关键案例。 您可以查询 FactSet&#8217;行业领先的内容，获取详细的公司信息，并与同事和组共享此信息，从而实现轻松协作，而无需在应用程序之间切换。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
此信息由 FactSet Research Systems Inc. 提供，用于了解此应用程序如何收集和存储组织数据，以及您的组织将拥有对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 应用程序 | 用于验证和日志记录的名称和电子邮件、用于主动邮件发送的对话 ID | [95fb5da0-6ced-4247-9d62-294f8fcb75df](https://docs.microsoft.com/microsoft-365-app-certification/azure/95fb5da0-6ced-4247-9d62-294f8fcb75df) |
