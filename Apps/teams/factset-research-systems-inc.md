---
title: FactSet Research Systems Inc. 的 FactSet 应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/24/2021
...
description: FactSet 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/95fb5da0-6ced-4247-9d62-294f8fcb75df" target="_blank">Teams存储区中的视图</a>
...
FactSet Research Systems Inc. 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | FactSet Research Systems Inc. |
| 公司的网站 | [https://www.factset.com](https://www.factset.com) |
| 应用的使用条款 | [https://www.factset.com/hubfs/Misc/FactSet%20Teams%20Terms%...](https://www.factset.com/hubfs/Misc/FactSet%20Teams%20Terms%20of%20Use.pdf) |
| 应用的核心功能 | 使用 FactSet for Microsoft Teams，你将收到来自 StreetAccount 的精选新闻摘要，以便你可以随时了解影响全球市场的关键故事。 可以查询 FactSet&#8217;行业领先的内容以获取详细的公司信息，并与同事和组共享，无需在应用程序之间切换即可轻松协作。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
FactSet Research Systems Inc. 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 应用程序 | 用于验证和日志记录的名称和电子邮件、主动发送邮件的对话 ID | [95fb5da0-6ced-4247-9d62-294f8fcb75df](../azure/95fb5da0-6ced-4247-9d62-294f8fcb75df.md) |
