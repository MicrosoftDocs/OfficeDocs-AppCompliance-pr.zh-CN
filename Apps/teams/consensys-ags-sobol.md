...
* <a href="https://teams.microsoft.com/l/app/659f0ad6-8b3d-4846-8c4c-00ea9dfd64c8" target="_blank">在应用商店Teams视图</a>
...
| 公司网站 | [https://sobol.io](https://sobol.io) |
| 应用的使用条款 | [https://sobol.io/terms-of-service/](https://sobol.io/terms-of-service/) |
| 应用的核心功能 | Sobol 是一个 Web 应用程序，可帮助组织可视化和映射其角色、团队、目标、用户和协议。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://sobol.io/features](https://sobol.io/features) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
此信息由 ConsenSys AG&#8217;Sobol 提供有关此应用程序如何收集和存储组织数据以及您的组织将拥有对应用收集的数据的控制的信息。
