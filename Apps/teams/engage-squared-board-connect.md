...
| 应用的核心功能 | 板连接可帮助组织更高效地运行会议。 一Microsoft Teams Microsoft 团队关联的应用程序，使组织能够创建会议、管理议程、投票、文档等。 此应用程序还集成了Outlook日历和 office 365 组，以创建新的日历事件，并可帮助开发板组织和管理事件。 |
| 公司总部位置 | 澳大利亚 |
| 应用信息页面 | [https://boardconnect.app](https://boardconnect.app) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | delegated | 允许应用更新用户日历以反映其通过应用提交的与会者响应。 | [4a6873f6-8360-4023-bd6f-2923d1eb2e94](../azure/4a6873f6-8360-4023-bd6f-2923d1eb2e94.md) |
>| Group.ReadWrite.All | delegated | 允许应用创建、更新和删除组日历事件。 | [4a6873f6-8360-4023-bd6f-2923d1eb2e94](../azure/4a6873f6-8360-4023-bd6f-2923d1eb2e94.md) |
>| Sites.Manage.All | delegated | 若要允许应用创建列表和库，请管理列表项和工作组网站集上的文档。 | [4a6873f6-8360-4023-bd6f-2923d1eb2e94](../azure/4a6873f6-8360-4023-bd6f-2923d1eb2e94.md) |
>| User.Read | delegated | 允许用户登录应用并允许应用读取当前登录用户的个人资料。 | [4a6873f6-8360-4023-bd6f-2923d1eb2e94](../azure/4a6873f6-8360-4023-bd6f-2923d1eb2e94.md) |
>| User.ReadBasic.All | delegated | 允许应用代表已登录用户读取其他用户的一组基本个人资料属性，以便在此应用中显示。 这包括显示名称姓名、名字和姓氏、电子邮件地址和照片。 | [4a6873f6-8360-4023-bd6f-2923d1eb2e94](../azure/4a6873f6-8360-4023-bd6f-2923d1eb2e94.md) |
>| offline_access | delegated | 使应用能够获取刷新令牌，该令牌可用于在当前访问令牌过期时获取新的访问令牌。 | [4a6873f6-8360-4023-bd6f-2923d1eb2e94](../azure/4a6873f6-8360-4023-bd6f-2923d1eb2e94.md) |
