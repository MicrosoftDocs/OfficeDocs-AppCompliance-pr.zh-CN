---
title: Hermis by Hermis， Inc. 的趣味性应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/20/2022
...
description: Hermis 的 Funtivity 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
---
# <a name="funtivity-by-hermis"></a>赫米斯的趣味性

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 6 月 19 日</p>

* <a href="https://teams.microsoft.com/l/app/d75e14a9-9bfd-43b4-8430-7264da3b6995" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004244" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Hermis 公司向 Microsoft 提供的信息：
...
| 合作伙伴公司名称 | 赫米斯公司 |
| 公司的网站 | [https://www.herm.is](https://www.herm.is) |
| 应用的使用条款 | [https://www.herm.is/terms](https://www.herm.is/terms) |
| 应用的核心功能 | Hermis 的趣味性为各种场合提供了大量活动 &amp; 内容，包括团队建设、会议突破会议、文化活动等。 每周有十几个不同的活动和精心制作的新活动，每个人都可以享受&#8217;。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://www.herm.is/integrations/funtivity-msteams](https://www.herm.is/integrations/funtivity-msteams) |
...
Hermis， Inc. 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 客户的 ID、名称 &amp; 电子邮件用于在 Hermis 上注册用户。 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 用户名 &amp; 电子邮件存储在我们的数据库中。 使用 AES-256-CBC 加密用户电子邮件 |
...
| 隐私策略 URL | https://www.herm.is/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | 我们使用用户的个人资料详细信息在平台上注册用户。 | [d75e14a9-9bfd-43b4-8430-7264da3b6995](../azure/d75e14a9-9bfd-43b4-8430-7264da3b6995.md) |
>| 电子邮件 | 委托 | 我们使用用户的个人资料详细信息在平台上注册用户。 | [d75e14a9-9bfd-43b4-8430-7264da3b6995](../azure/d75e14a9-9bfd-43b4-8430-7264da3b6995.md) |
>| openid | 委托 | 我们使用用户的个人资料详细信息在平台上注册用户。 | [d75e14a9-9bfd-43b4-8430-7264da3b6995](../azure/d75e14a9-9bfd-43b4-8430-7264da3b6995.md) |
>| 个人资料 | 委托 | 我们使用用户的个人资料详细信息在平台上注册用户。 | [d75e14a9-9bfd-43b4-8430-7264da3b6995](../azure/d75e14a9-9bfd-43b4-8430-7264da3b6995.md) |
