---
title: Lucid Software 的 Lucidspark Whiteboard 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/14/2021
...
description: Lucidspark Whiteboard 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/e9ab21fa-5fd5-48bb-a85d-4de7ced89cd1" target="_blank">Teams存储区中的视图</a>
...
| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | Lucidspark Whiteboard |
| ID | WA200002583 |
| 支持Office 365客户端 | Microsoft Teams |
| 合作伙伴公司名称 | Lucid Software |
| 公司的网站 | [https://lucid.co](https://lucid.co) |
| 应用的使用条款 | [https://lucid.co/tos](https://lucid.co/tos) |
| 应用的核心功能 | Lucidspark 是基于云的虚拟白板，团队可以在其中阐明他们的最佳想法。 无论是远程工作还是亲自工作，都&#8217;以团队身份进行实时的集思广益和协作。 Lucidspark 可帮助人们整理笔记和涂鸦，并将其转换为演示就绪的概念。 当&#8217;后续步骤的时间时，团队可以开发工作流并处理文档，以将想法变为现实。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://lucidchart.zendesk.com](https://lucidchart.zendesk.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
Lucid Software 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| 电子邮件 | 委托 | 名称和电子邮件地址。 | [3557d5c0-bcab-410b-8a03-f7045aa48de0](../azure/3557d5c0-bcab-410b-8a03-f7045aa48de0.md) |
>| openid | 委托 | 名称和电子邮件地址。 | [3557d5c0-bcab-410b-8a03-f7045aa48de0](../azure/3557d5c0-bcab-410b-8a03-f7045aa48de0.md) |
>| 个人资料 | 委托 | 名称和电子邮件地址。 | [3557d5c0-bcab-410b-8a03-f7045aa48de0](../azure/3557d5c0-bcab-410b-8a03-f7045aa48de0.md) |
