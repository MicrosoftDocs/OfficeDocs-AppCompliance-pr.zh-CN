---
title: 优先级矩阵政府版由 Appfluence Inc 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/14/2022
...
description: 优先级矩阵政府的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66248780"
---
# <a name="priority-matrix-government"></a>优先级矩阵政府

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 6 月 1 日</p>

* <a href="https://teams.microsoft.com/l/app/ffca97e5-0569-c88c-ac30-7c5717e2e5ae" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004231" target="_blank">在 AppSource 中查看</a>
...
| 应用的使用条款 | [https://gov.prioritymatrix.com/eula](https://gov.prioritymatrix.com/eula) |
| 应用的核心功能 | 政府优先级矩阵是一种功能齐全的项目管理软件，存储在Azure 政府基础结构中，并深入集成到 Outlook 和 Microsoft Teams 中。 优先级矩阵可帮助团队更智能地确定优先级、专注和工作。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://appfluence.com/government](https://appfluence.com/government) |
