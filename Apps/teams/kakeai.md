...
description: Kakeai 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/714dce8d-d78a-470d-9d4a-8db9118a2106" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | KAKEAI |
| 公司的网站 | [https://kakeai.co.jp](https://kakeai.co.jp) |
| 应用的使用条款 | [https://kakeai.com/terms](https://kakeai.com/terms) |
| 应用的核心功能 | 云系统 KAKEAI; 提高通信&#8220;质量&#8221; |
| 公司总部位置 | 日本 |
| 应用信息页 | [https://help.kakeai.com/ja/articles/4230882](https://help.kakeai.com/ja/articles/4230882) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
KAKEAI 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
