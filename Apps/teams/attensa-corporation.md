...
| 公司网站 | [https://attensa.com](https://attensa.com) |
| 应用的使用条款 | [https://attensa.com/terms/](https://attensa.com/terms/) |
| 应用的核心功能 | 通过 Attensa 简介了解项目聚焦新闻和信息，使团队了解最新信息 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://attensa.com/product/](https://attensa.com/product/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
