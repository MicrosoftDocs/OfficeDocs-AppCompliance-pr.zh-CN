...
description: Attensa 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/0c42cdbf-56a5-4cdb-ae89-9253cb8138f0" target="_blank">Teams存储区中的视图</a>
...
| 公司的网站 | [https://attensa.com](https://attensa.com) |
| 应用的使用条款 | [https://attensa.com/terms/](https://attensa.com/terms/) |
| 应用的核心功能 | 通过 Attensa 简报，让团队随时了解以项目为中心的新闻和信息 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://attensa.com/product/](https://attensa.com/product/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
Attensa Corporation 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
