---
title: IdeaScale 的应用程序信息（由 IdeaScale）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/21/2022
...
description: IdeaScale 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/a4de8de4-33b1-4e55-97ac-9f87b5978c0f" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003868" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

IdeaScale 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | IdeaScale |
| 公司网站 | [https://ideascale.com](https://ideascale.com) |
| 应用的使用条款 | [https://ideascale.com/terms-and-conditions-of-use](https://ideascale.com/terms-and-conditions-of-use) |
| 应用的核心功能 | IdeaScale 是创新团队的主要想法管理平台。 您组织的任何人都可以共享对社区中其他人可见的想法，并收集反馈和资源以将那些想法转变为新产品或项目。 现在，你可以将 IdeaScale 社区连接到Microsoft Teams工作区来管理想法，而无需离开Teams。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://ideascale.com/teams/](https://ideascale.com/teams/) |
...
此信息由 IdeaScale 提供，与此应用程序如何收集和存储组织数据以及组织对应用收集的数据的控制有关。
...
| 隐私策略 URL | https://ideascale.com/privacy-policy |
