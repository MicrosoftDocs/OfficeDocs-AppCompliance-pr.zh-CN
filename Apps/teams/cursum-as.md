---
title: Cursum by Cursum A/S 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: 适用于 Cursum 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/11db7a4c-d454-41b5-a9be-35a5acdd5c9e" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004407" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Cursum A/S 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Cursum A/S |
| 公司的网站 | [https://cursum.com](https://cursum.com) |
| 应用的使用条款 | [https://go.microsoft.com/fwlink/?linkid=2041178](https://go.microsoft.com/fwlink/?linkid=2041178) |
| 应用的核心功能 | Cursum Core - 在工作流中学习 |
| 公司总部位置 | 丹麦 |
| 应用信息页 | |
...
Cursum A/S 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read.All | 两者 | 读取用户信息 | [962ef41c-0088-4cf2-b8ac-df68a8111022](../azure/962ef41c-0088-4cf2-b8ac-df68a8111022.md) |
