---
title: Eylean 的 Teamhood 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: 适用于 Teamhood 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/22372c30-c5de-483e-85b4-8d51db246eda" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | Eylean |
| 公司的网站 | [https://teamhood.com](https://teamhood.com) |
| 应用的使用条款 | [https://teamhood.com/terms-of-use/](https://teamhood.com/terms-of-use/) |
| 应用的核心功能 | 团队合作是一个项目和任务管理一体软件，用于高效的日常协作。 团队身份为每个项目经理和团队成员提供必要的功能来规划、执行和报告工作数据。 |
| 公司总部位置 | 立陶宛 |
| 应用信息页 | [https://teamhood.com/features/teamhood-and-microsoft-teams-...](https://teamhood.com/features/teamhood-and-microsoft-teams-integration/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
Eylean 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
