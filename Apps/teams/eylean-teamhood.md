...
| 合作伙伴公司名称 | Eylean |
| 公司网站 | [https://teamhood.com](https://teamhood.com) |
| 应用的使用条款 | [https://teamhood.com/terms-of-use/](https://teamhood.com/terms-of-use/) |
| 应用的核心功能 | Team一是一种项目和任务管理一体式软件，用于实现高效的日常协作。 Team一向每个项目经理和工作组成员提供必需的功能，以规划、执行并报告工作数据。 |
| 公司总部位置 | 立陶宛 |
| 应用信息页面 | [https://teamhood.com/features/teamhood-and-microsoft-teams-...](https://teamhood.com/features/teamhood-and-microsoft-teams-integration/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
此信息由 Eylean 提供有关此应用程序如何收集和存储组织数据以及您的组织将拥有对应用收集的数据的控制的信息。
