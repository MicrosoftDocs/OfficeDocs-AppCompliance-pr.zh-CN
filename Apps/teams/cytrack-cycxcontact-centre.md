---
title: CyCX 联系人中心由 CyTrack 提供的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/01/2022
...
description: CyCX 联系人中心的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66655908"
---
# <a name="cycx--contact-centre"></a>CyCX 联系中心

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 5 月 27 日</p>

* <a href="https://teams.microsoft.com/l/app/4d7b80a9-d64d-4b54-a1db-259cc204b15d" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004350" target="_blank">在 AppSource 中查看</a>
...
| 应用的核心功能 | CyCX 面向需要提升客户语音呼叫和联系中心功能（除了会议、聊天和协作）的业务用户。  CyCX 是 Microsoft Teams 的通信和协作平台。  CyTrack CyCX 在 Microsoft Teams 中选择的频道上与客户见面，为代理提供单个统一的界面，并提供客户的整体视图，以实现更深入的交互。 |
| 公司总部位置 | 澳大利亚 |
| 应用信息页 | [https://web.cytrack.com/microsoft-teams/contact-centre-for-...](https://web.cytrack.com/microsoft-teams/contact-centre-for-microsoft-teams/) |
