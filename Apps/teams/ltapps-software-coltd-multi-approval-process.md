---
title: LTAPP SOFTWARE CO.，LTD 的多审批过程 LTAPP 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/31/2021
...
description: 多审批流程 LTAP 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/c1ab19ab-6a95-4f02-b42f-c1df3415e8a8" target="_blank">Teams存储区中的视图</a>
...
| 公司的网站 | [https://ltaddins.com](https://ltaddins.com) |
| 应用的使用条款 | [https://ltaddins.com/terms.html](https://ltaddins.com/terms.html) |
| 应用的核心功能 | 多审批过程是一种易于使用的应用程序，允许最终用户发出请求。 该应用完全可自定义，使管理员能够与其组织规范保持一致性。 |
| 公司总部位置 | 越南 |
| 应用信息页 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
LTAPP SOFTWARE CO.，LTD 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | 用户信息 &amp; 租户 ID | [d2682b2a-2037-4545-94b6-3e7216ecca5f](../azure/d2682b2a-2037-4545-94b6-3e7216ecca5f.md) |
