...
| 公司网站 | [https://ltaddins.com](https://ltaddins.com) |
| 应用的使用条款 | [https://ltaddins.com/terms.html](https://ltaddins.com/terms.html) |
| 应用的核心功能 | 多审批流程是一个易于使用的应用程序，它允许最终用户提出请求。 应用可完全自定义，允许管理员保持其组织规范的一致性。 |
| 公司总部位置 | 越南 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegated | 用户信息 &amp; 租户 ID | [d2682b2a-2037-4545-94b6-3e7216ecca5f](https://docs.microsoft.com/microsoft-365-app-certification/azure/d2682b2a-2037-4545-94b6-3e7216ecca5f) |
