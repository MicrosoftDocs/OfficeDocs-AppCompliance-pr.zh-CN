---
title: Grepsi Software 的 Teamflect 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
description: Teamflect 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/e46015e9-f2ae-4dbc-be6b-f05043192e62" target="_blank">Teams存储区中的视图</a>
...
Grepsi Software 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Grepsi 软件 |
| 公司的网站 | [https://teamflect.com](https://teamflect.com) |
| 应用的使用条款 | [https://teamflect.com/terms](https://teamflect.com/terms) |
| 应用的核心功能 | Teamflect 是为Microsoft Teams构建的一对一性能管理和员工参与解决方案。 它使人们更高效，更参与其 1 对 1 会议，目标/确定，反馈，识别和任务模块 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
Grepsi Software 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 应用程序 | 我们使用此权限访问用户日历来标识 1 对 1 会议 | [c5da92a9-873e-4ea1-86c7-03ec9c1384f0](../azure/c5da92a9-873e-4ea1-86c7-03ec9c1384f0.md) |
>| Directory.Read.All | 委托 | 公司目录 - 我们使用此权限向最终用户显示其同事在执行搜索时的列表 | [c5da92a9-873e-4ea1-86c7-03ec9c1384f0](../azure/c5da92a9-873e-4ea1-86c7-03ec9c1384f0.md) |
