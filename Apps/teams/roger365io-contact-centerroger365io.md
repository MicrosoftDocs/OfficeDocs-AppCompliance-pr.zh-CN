...
description: 联系人中心服务的所有可用安全性和合规性|ROGER365.io、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
此信息已由用户 ROGER365.io，这些信息与此应用程序如何收集和存储组织数据以及组织将拥有对应用收集的数据的控制有关。
