...
description: DataMiner 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/9a09d087-5d07-4481-b34f-cd053eab7925" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003501" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

由Microsoft 通信提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Skyline 通信 |
| 公司网站 | [https://www.skyline.be](https://www.skyline.be) |
| 应用的使用条款 | [https://dataminer.services/terms/terms-of-service.html](https://dataminer.services/terms/terms-of-service.html) |
| 应用的核心功能 | 作为针对 ICT 媒体和宽带行业的端到端多供应商 NMS、OSS 和业务流程软件解决方案的全球领先的供应商，则使用 Communications。 我们构建的 DataMiner 网络管理平台接收了各种技术奖励，支持对最复杂的技术生态系统进行端到端集成，并且已由全球领先的运营商进行部署。 |
| 公司总部位置 | 比利时 |
| 应用信息页面 | [https://www.skyline.be/dataminer/cloud-services](https://www.skyline.be/dataminer/cloud-services) |
...
此信息由设备通信提供，有关此应用如何收集和存储组织数据以及你的组织将拥有对应用收集的数据的控制。
...
| 隐私策略 URL | https://dataminer.services/terms/privacy.html |
