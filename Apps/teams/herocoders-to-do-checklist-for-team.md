---
title: HeroCoders 团队的“操作”清单的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/05/2022
...
description: 适用于团队的“即点清单”的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66655891"
---
# <a name="to-do-checklist-for-team"></a>团队的“操作清单”

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 6 月 16 日</p>

* <a href="https://teams.microsoft.com/l/app/b08b0225-1f4b-4e82-879e-d4ef15b5bbda" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004362" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

HeroCoders 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | HeroCoders |
| 公司的网站 | [https://herocoders.com](https://herocoders.com) |
| 应用的使用条款 | [https://herocoders.com/legal/checklist-for-team#EULA](https://herocoders.com/legal/checklist-for-team#EULA) |
| 应用的核心功能 | 每个规模的团队的高级清单。 |
| 公司总部位置 | Poland（波兰） |
| 应用信息页 | [https://herocoders.com](https://herocoders.com) |
...
HeroCoders 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | Azure AD ID |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | Azure AD ID |
...
| 隐私策略 URL | https://herocoders.com/legal/checklist-for-team#Privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| 电子邮件 | 委托 | 若要使用单Sign-On (SSO)  | [777d9a9f-feef-48dd-b62d-562ff21aeda2](../azure/777d9a9f-feef-48dd-b62d-562ff21aeda2.md) |
>| offline_access | 委托 | 若要能够在用户未登录时向其他用户显示有关清单项的信息。 | [777d9a9f-feef-48dd-b62d-562ff21aeda2](../azure/777d9a9f-feef-48dd-b62d-562ff21aeda2.md) |
>| openid | 委托 | 使用其 Azure Ad 帐户登录用户 | [777d9a9f-feef-48dd-b62d-562ff21aeda2](../azure/777d9a9f-feef-48dd-b62d-562ff21aeda2.md) |
>| 个人资料 | 委托 | 在清单的历史记录中显示用户的名称。 | [777d9a9f-feef-48dd-b62d-562ff21aeda2](../azure/777d9a9f-feef-48dd-b62d-562ff21aeda2.md) |
