...
| 公司网站 | [https://www.smarterbusiness.at](https://www.smarterbusiness.at) |
...
| 应用的核心功能 | 帮助团队使用彩色标记在频道中对对话进行分类，以便他们花费更少的时间搜索正确的信息。 他们尤其喜欢只需一次单击即可将所有相关信息放在指尖上。 |
| 公司总部位置 | 奥地利 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Read.All | delegated | 我们不会收集此数据 - 仅用于显示带标记的对话。 我们喜欢将它更改为搜索 API，Graph API 目前不支持此功能。  | [6d7f01cb-cfa5-48d9-beed-363d381ae32b](https://docs.microsoft.com/microsoft-365-app-certification/azure/6d7f01cb-cfa5-48d9-beed-363d381ae32b) |
>| User.Read | delegated | 显示User-Information (，例如选项卡) 名称 | [6d7f01cb-cfa5-48d9-beed-363d381ae32b](https://docs.microsoft.com/microsoft-365-app-certification/azure/6d7f01cb-cfa5-48d9-beed-363d381ae32b) |
>| User.ReadBasic.All | delegated | 显示User-Avatars选项卡中的选项卡 | [6d7f01cb-cfa5-48d9-beed-363d381ae32b](https://docs.microsoft.com/microsoft-365-app-certification/azure/6d7f01cb-cfa5-48d9-beed-363d381ae32b) |
>| openid | delegated | 仅适用于 SignIn - 不存储任何数据 | [6d7f01cb-cfa5-48d9-beed-363d381ae32b](https://docs.microsoft.com/microsoft-365-app-certification/azure/6d7f01cb-cfa5-48d9-beed-363d381ae32b) |
