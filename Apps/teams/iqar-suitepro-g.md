...
| 应用的核心功能 | SuitePro-G est un outil collaboratif et intuitif pour la gestion de votre portefeuille de projets. Connectez votre outil de pilotage de projets en 3 cliques et ezez une &#233;quipe projet impliqu&#233;e， it&#233;e et connect&#233;e.  SuitePro-G 是一个协作且直观的解决方案，允许您管理项目组合。 连接单击 3 次即可使用项目管理工具，并保持项目团队参与、组织并保持联系。  |
| 公司总部位置 | 法国 |
| 应用信息页面 | |
