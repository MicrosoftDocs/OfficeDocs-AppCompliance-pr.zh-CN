...
description: Creately 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/dddf988d-00af-480f-b419-76a357a72460" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004335" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Creately 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Creately |
| 公司的网站 | [https://creately.com](https://creately.com) |
| 应用的使用条款 | [https://creately.com/tos](https://creately.com/tos) |
| 应用的核心功能 | 借助 Creately，你可以体验前所未有的视觉协作。 现在，请在不离开 Microsoft Teams 的情况下规划、分析和执行所有工作。 Creately 提供了一个自由形式的无限视觉画布，用于实时组织思想、集思广益解决方案、设计流程以及与团队成员协作。 |
| 公司总部位置 | 澳大利亚 |
| 应用信息页 | |
...
Creately 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 用户电子邮件，用户全名 |
...
| 隐私策略 URL | https://creately.com/privacy/ |
