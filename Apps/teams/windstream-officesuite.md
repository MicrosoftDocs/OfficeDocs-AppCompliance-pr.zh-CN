---
title: Windstream 的 OfficeSuite 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/03/2022
...
description: OfficeSuite 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/bf9c1c49-a529-451e-a81d-ac94cfdbec3e" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000618" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Windstream 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Windstream |
| 公司网站 | [https://www.windstreamenterprise.com](https://www.windstreamenterprise.com) |
| 应用的使用条款 | [https://www.windstream.com/about/legal/Terms-and-Conditions](https://www.windstream.com/about/legal/Terms-and-Conditions) |
| 应用的核心功能 | 通话、会议及通话通知应用 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
...
Windstream 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及组织将拥有对应用收集的数据的控制有关。
...
| 最新 SOC2 认证日期 |  2021-11-03 |
| 应用是否遵守 SOC 3 (服务组织) ？ | 是 |
| 最新 SOC3 认证日期 |  2021-11-04 |
...
| 隐私策略 URL | https://www.windstream.com/about/legal/privacy-policy |
