---
title: Process Street by Process Street 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/13/2022
...
description: Process Street 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "64838790"
---
# <a name="process-street"></a>进程街

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 3 月 4 日</p>

* <a href="https://teams.microsoft.com/l/app/6910821c-1244-4a0b-9d64-f0fc396b8e7c" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003933" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Process Street 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | 进程街 |
| 公司的网站 | [https://www.process.st](https://www.process.st) |
| 应用的使用条款 | [https://www.process.st/terms/](https://www.process.st/terms/) |
| 应用的核心功能 | 用于构建、共享和自动化核心进程的新式流程管理平台。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | |
...
Process Street 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
| 隐私策略 URL | https://www.process.st/help/docs/gdpr-statement/ |
