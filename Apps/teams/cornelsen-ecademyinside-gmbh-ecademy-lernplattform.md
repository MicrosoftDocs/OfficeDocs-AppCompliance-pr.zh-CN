---
title: 康内尔森 eCademy &amp; 在 GmbH 内的 eCademy Lernplattform 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/20/2021
...
description: eCademy Lernplattform 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/8b1066b0-59c2-4a7b-8ac6-f43edcfe5eef" target="_blank">Teams存储区中的视图</a>
...
从 GmbH 内部的 Cornelsen eCademy &amp; 提供给 Microsoft 的信息：
...
| 公司的网站 | [https://www.ecademy-learning.com](https://www.ecademy-learning.com) |
| 应用的使用条款 | [https://www.ecademy-learning.com/agb/](https://www.ecademy-learning.com/agb/) |
| 应用的核心功能 | 对于想要启用创新教学和学习的培训师和学员来说，eCademy Lernplattform 是一种数字学习解决方案，可随时随地打开个人和实践学习路径。 我们帮助公司和教育机构成功地为未来的劳动力市场培养和发展熟练工人和员工，使他们能够在需求不断增加和异质人才库日益增多时表现更好。 |
| 公司总部位置 | 德国 |
| 应用信息页 | [https://www.ecademy-learning.com](https://www.ecademy-learning.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
GmbH 中的 Cornelsen eCademy &amp; 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
