...
ELEARNINGFORCE 国际 APS 向 Microsoft 提供的信息：
...
| 公司网站 | [https://lms365.com](https://lms365.com) |
| 应用的使用条款 | [https://lms365.com/lms365-saas-terms/](https://lms365.com/lms365-saas-terms/) |
| 应用的核心功能 | LMS365 使你的组织可以通过 SharePoint、Teams 和移动设备在 Microsoft 365 平台上提供和管理培训，为员工、合作伙伴和客户提供熟悉的环境 |
| 公司总部位置 | 丹麦 |
| 应用信息页面 | [https://www.elearningforce.com/teams](https://www.elearningforce.com/teams) |
...
此信息由 ELEARNINGFORCE 国际 APS 提供有关此应用程序如何收集和存储组织数据以及您的组织将拥有对应用收集的数据的控制的信息。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础基础结构是否处理与 Microsoft 客户或他们的设备相关的任何数据？ | 是 |
| 你的应用将处理哪些数据？ | 用户配置文件数据 - 请参阅 https://trustcenter.elearningforce.com/hc/en-us/articles/360017659377 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 用户配置文件数据 &amp; 培训记录 - 请参阅 https://trustcenter.elearningforce.com/hc/en-us/articles/360009394437 |
| 如果基础结构处理或存储 Microsoft 客户数据，那么此数据在地理位置上存储在哪里？ | 荷兰 () 、德国、英国、英国和爱尔兰 () 、日本、澳大利亚、加拿大、爱尔兰 |
| 你是否已制定数据租用和处置流程？ | 是 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| GroupMember.Read.All | 应用程序 | 允许应用展开 AD 组的成员以注册一组用户参加培训 | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| Mail.Send | delegated | 允许应用发送通知电子邮件。 在配置用于通知的电子邮件帐户期间动态请求权限。 | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| OnlineMeetings.ReadWrite | delegated | 允许应用创建、读取、更新和删除联机会议事件。 在配置用于通知的电子邮件帐户期间动态请求权限。 | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| RoleManagement.Read.Directory | 应用程序 | 应用需要能够读取用户具有的角色，以及他们是全局管理员Office 365管理员还是SharePoint管理员。 | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| User.Invite.All | delegated | 可选功能：允许目录管理员邀请来宾用户加入培训目录。 | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| User.Read | delegated | 允许用户使用客户的&#8217;登录到Azure AD，并允许应用读取已登录用户的配置文件和基本公司信息。 | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| User.Read.All | delegated | 允许应用读取完整的用户配置文件。 需要&#8217;报表管理器仪表板&#8217;用户和 &amp; 构建层次结构 | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| User.Read.All | 应用程序 | 允许应用读取完整的用户配置文件。 需要&#8217;报表管理器仪表板&#8217;用户和 &amp; 构建层次结构 | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| 个人资料 | delegated | 为了能够向用户显示用于登录的帐户，LMS365 需要此权限才能显示基本个人资料信息，包括 显示名称、名字和姓氏、电子邮件地址和照片。 | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
