...
| 应用会处理哪些数据？ | 用户配置文件数据 - 请参阅 https://trustcenter.elearningforce.com/hc/en-us/articles/360017659377 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 用户配置文件数据 &amp; 训练记录 - 请参阅 https://trustcenter.elearningforce.com/hc/en-us/articles/360009394437 |
| 如果基础结构处理或存储 Microsoft 客户数据，则此数据在地理上存储在哪里？ | 荷兰 () 、德国、英国联合王国和北爱尔兰 () 、日本、澳大利亚、加拿大、爱尔兰 |
| 是否已建立数据出租和处置流程？ | 是 |
