---
title: KoareTech S.L 的 Koare 仪表板的应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: Koare 仪表板的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66817599"
---
# <a name="koare-dashboard"></a>Koare 仪表板

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 6 月 4 日</p>

* <a href="https://teams.microsoft.com/l/app/08a78d62-ec3b-4800-b51a-9ffd823273cd" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004403" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

KoareTech S.L 提供的信息。 到 Microsoft：
...
| 合作伙伴公司名称 | KoareTech S.L. |
| 公司的网站 | [https://koaretech.com](https://koaretech.com) |
| 应用的使用条款 | [https://koaretech.com/termsofuse.php](https://koaretech.com/termsofuse.php) |
| 应用的核心功能 | 清单管理是用于记录和跟踪组织中的硬件和软件资产以及 IT 清单的工具。 非常适合 IT 分隔和管理。 KoareTech 清单管理工具提供的报表显示有关分配给每个员工的项目状态和使用的详细信息。 Microsoft Teams 和 SharePoint 支持。 要求：与 Microsoft Teams 组或频道关联并订阅 Azure 市场。 |
| 公司总部位置 | 西班牙 |
| 应用信息页 | |
...
KoareTech S.L 提供了此信息。 关于此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.AccessAsUser.All | 委托 | 对 sharepoint 列表的访问权限 | [45aa6c59-3764-4c2f-abef-178757957e62](../azure/45aa6c59-3764-4c2f-abef-178757957e62.md) |
>| Group.ReadWrite.All | 委托 | 对 sharepoint 列表的访问权限 | [45aa6c59-3764-4c2f-abef-178757957e62](../azure/45aa6c59-3764-4c2f-abef-178757957e62.md) |
>| Sites.Manage.All | 委托 | 创建 sharepoint 列表 | [45aa6c59-3764-4c2f-abef-178757957e62](../azure/45aa6c59-3764-4c2f-abef-178757957e62.md) |
>| User.Read.All | 委托 | 对 sharepoint 列表的访问权限 | [45aa6c59-3764-4c2f-abef-178757957e62](../azure/45aa6c59-3764-4c2f-abef-178757957e62.md) |
