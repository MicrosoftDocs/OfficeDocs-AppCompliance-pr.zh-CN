...
| 数据库中存储了哪些数据？ | Graph数据、Office 365管理数据 |
...
>|   **Graph权限**  | **权限类型** |          **字距调整**          |
>|:------------------------|:--------------------|:------------------------------------|
>| User.Read.All | 应用程序 | 用于选择要向其发送电子邮件的人。 |
>| TeamSettings.Read.All | 应用程序 | 用于选择要从消息中心发布消息的团队。 |
>| Mail.Send | 应用程序 | 用于直接从应用程序向频道或个人人员发送邮件。  |
>| Channel.ReadBasic.All | 应用程序 | 用于选择要从消息中心发布消息的频道。 |
