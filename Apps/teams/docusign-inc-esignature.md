...
| 公司网站 | [https://www.docusign.com](https://www.docusign.com) |
| 应用的使用条款 | [https://www.docusign.com/company/terms-and-conditions/web](https://www.docusign.com/company/terms-and-conditions/web) |
| 应用的核心功能 | 轻松发送和签署文档。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://docs.docusign.com/supportdocs/ds-for-MS-teams/Conte...](https://docs.docusign.com/supportdocs/ds-for-MS-teams/Content/overview-docusign-for-ms-teams.htm) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
| 应用是否遵守 SOC 1 (服务组织) ？ | 是 |
| 最新 SOC1 认证日期 |  2019-11-01 |
| 应用是否遵守 SOC 2 (服务组织) ？ | 是 |
| 你获得哪种 SOC 2 认证？ |   |
| 最新 SOC2 认证日期 |  2019-11-01 |
| 应用是否遵守 SOC 3 (服务组织) ？ | 否 |
| 最新 SOC3 认证日期 | |
