---
title: DocuSign eSignature by DocuSign， Inc. 的应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/01/2021
...
description: DocuSign eSignature 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "64881329"
---
# <a name="docusign-esignature"></a>DocuSign eSignature

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 5 月 14 日</p>

* <a href="https://teams.microsoft.com/l/app/e3e1c0f3-e2b3-492f-8944-d551b6dd71b9" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002755" target="_blank">在 AppSource 中查看</a>
...
| 应用的核心功能 | 轻松发送和签名文档。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://docs.docusign.com/supportdocs/ds-for-MS-teams/Conte...](https://docs.docusign.com/supportdocs/ds-for-MS-teams/Content/overview-docusign-for-ms-teams.htm) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
| 最新的 SOC1 认证日期 | 2019-11-01 |
| 应用是否符合服务组织控制 (SOC 2) ？ | 是 |
| 最新的 SOC2 认证日期 | 2019-11-01 |
