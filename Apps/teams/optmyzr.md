---
title: Optmyzr 的应用程序信息（由 Optmyzr 提供）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/26/2021
...
description: Optmyzr 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/a8aefb12-8635-4f30-9759-e889fee14d28" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003395" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Optmyzr 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Optmyzr |
| 公司网站 | [https://www.optmyzr.com](https://www.optmyzr.com) |
| 应用的使用条款 | [https://www.optmyzr.com/information/terms-of-use/](https://www.optmyzr.com/information/terms-of-use/) |
| 应用的核心功能 | https://www.optmyzr.com/information/terms-of-use/ |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://www.optmyzr.com/capabilities/reporting/](https://www.optmyzr.com/capabilities/reporting/) |
...
Optmyzr 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及您的组织将拥有对应用收集的数据的控制有关。
...
| 数据库中存储了哪些数据？ | 用户配置文件 - 用作标识符的电子邮件地址 |
...
| 隐私策略 URL | https://www.optmyzr.com/information/privacy-policy/ |
