...
| 合作伙伴公司名称 | Atlassian |
| 公司网站 | [https://www.atlassian.com](https://www.atlassian.com) |
...
| 应用的核心功能 | 使用 Confluence Cloud for Teams 轻松记录会议笔记、共享页面并Teams。
 |
| 公司总部位置 | 澳大利亚 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
| 应用是否遵守 SOC 2 (服务组织) ？ | 是 |
| 你获得哪种 SOC 2 认证？ |   |
| 最新 SOC2 认证日期 |  2020-10-31 |
| 应用是否遵守 SOC 3 (服务组织) ？ | 是 |
| 最新 SOC3 认证日期 |  2020-10-31 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | delegated | - 我们读取了会议中的聊天成员列表，因此我们知道被邀请者列表。   - 我们会读取用户&#8217;在会议应用中有条件地显示的名称和电子邮件地址。 例如，显示记录会议笔记的当前用户的名称。   - 我们的应用会&#8217;我们的应用添加到会议中的日历事件，以便我们获得有关会议的基本信息，如会议标题。 | [4aa38041-66a2-41a4-ac97-55bc828a9803](https://docs.microsoft.com/microsoft-365-app-certification/azure/4aa38041-66a2-41a4-ac97-55bc828a9803) |
>| Chat.ReadBasic | delegated |  - 我们读取了会议中的聊天成员列表，因此我们知道被邀请者列表。   - 我们会读取用户&#8217;在会议应用中有条件地显示的名称和电子邮件地址。 例如，显示记录会议笔记的当前用户的名称。   - 我们的应用会&#8217;我们的应用添加到会议中的日历事件，以便我们获得有关会议的基本信息，如会议标题。 | [4aa38041-66a2-41a4-ac97-55bc828a9803](https://docs.microsoft.com/microsoft-365-app-certification/azure/4aa38041-66a2-41a4-ac97-55bc828a9803) |
>| User.ReadBasic.All | delegated | - 我们读取了会议中的聊天成员列表，因此我们知道被邀请者列表。   - 我们会读取用户&#8217;在会议应用中有条件地显示的名称和电子邮件地址。 例如，显示记录会议笔记的当前用户的名称。   - 我们的应用会&#8217;我们的应用添加到会议中的日历事件，以便我们获得有关会议的基本信息，如会议标题。 | [4aa38041-66a2-41a4-ac97-55bc828a9803](https://docs.microsoft.com/microsoft-365-app-certification/azure/4aa38041-66a2-41a4-ac97-55bc828a9803) |
>| 电子邮件 | delegated | - 我们读取了会议中的聊天成员列表，因此我们知道被邀请者列表。   - 我们会读取用户&#8217;在会议应用中有条件地显示的名称和电子邮件地址。 例如，显示记录会议笔记的当前用户的名称。   - 我们的应用会&#8217;我们的应用添加到会议中的日历事件，以便我们获得有关会议的基本信息，如会议标题。 | [4aa38041-66a2-41a4-ac97-55bc828a9803](https://docs.microsoft.com/microsoft-365-app-certification/azure/4aa38041-66a2-41a4-ac97-55bc828a9803) |
>| offline_access | delegated | - 我们读取了会议中的聊天成员列表，因此我们知道被邀请者列表。   - 我们会读取用户&#8217;在会议应用中有条件地显示的名称和电子邮件地址。 例如，显示记录会议笔记的当前用户的名称。   - 我们的应用会&#8217;我们的应用添加到会议中的日历事件，以便我们获得有关会议的基本信息，如会议标题。 | [4aa38041-66a2-41a4-ac97-55bc828a9803](https://docs.microsoft.com/microsoft-365-app-certification/azure/4aa38041-66a2-41a4-ac97-55bc828a9803) |
>| openid | delegated |  - 我们读取了会议中的聊天成员列表，因此我们知道被邀请者列表。   - 我们会读取用户&#8217;在会议应用中有条件地显示的名称和电子邮件地址。 例如，显示记录会议笔记的当前用户的名称。   - 我们的应用会&#8217;我们的应用添加到会议中的日历事件，以便我们获得有关会议的基本信息，如会议标题。 | [4aa38041-66a2-41a4-ac97-55bc828a9803](https://docs.microsoft.com/microsoft-365-app-certification/azure/4aa38041-66a2-41a4-ac97-55bc828a9803) |
>| 个人资料 | delegated |  - 我们读取了会议中的聊天成员列表，因此我们知道被邀请者列表。   - 我们会读取用户&#8217;在会议应用中有条件地显示的名称和电子邮件地址。 例如，显示记录会议笔记的当前用户的名称。   - 我们的应用会&#8217;我们的应用添加到会议中的日历事件，以便我们获得有关会议的基本信息，如会议标题。 | [4aa38041-66a2-41a4-ac97-55bc828a9803](https://docs.microsoft.com/microsoft-365-app-certification/azure/4aa38041-66a2-41a4-ac97-55bc828a9803) |
