...
>| profile | 委托 | - 我们阅读了会议中聊天成员的列表，因此我们知道会议的受邀者列表。 - 我们读取了用户&#8217;姓名和电子邮件地址，这些姓名和电子邮件地址在会议应用中有条件地显示。 例如，显示正在做会议笔记的当前用户的名称。 - 我们的应用读取用户&#8217;的日历事件，其中我们的应用已添加到会议中，因此我们有有关会议的基本信息，例如会议标题。 | [4aa38041-66a2-41a4-ac97-55bc828a9803](../azure/4aa38041-66a2-41a4-ac97-55bc828a9803.md) |
