...
| 应用的核心功能 | 通过持续识别和反馈解锁文化。 Hi5 是一款超级简单、有趣的应用，供经理和同行进行识别 &amp; 。 有人&#8217;出色工作？ 这&#8217;很简单 - 为它们提供一个 Hi5，分享成功庆祝！ 团队成员可以进行对等或团队识别、查看 Hi5 排行榜等 |
| 公司总部位置 | 南非 |
| 应用信息页面 | [https://help.get5.io](https://help.get5.io) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegated | 我们仅存储来自 Teams 用户会话信息，并且用户需要通过添加通知来批准 (他们可以随时删除) 。 不存储其他信息。 | [7cb50e3e-0427-409e-90d2-638eb28217c3](../azure/7cb50e3e-0427-409e-90d2-638eb28217c3.md) |
>| 电子邮件 | delegated | 我们仅存储来自 Teams 用户会话信息，并且用户需要通过添加通知来批准 (他们可以随时删除) 。 不存储其他信息。 | [7cb50e3e-0427-409e-90d2-638eb28217c3](../azure/7cb50e3e-0427-409e-90d2-638eb28217c3.md) |
>| offline_access | delegated | 我们仅存储来自 Teams 用户会话信息，并且用户需要通过添加通知来批准 (他们可以随时删除) 。 不存储其他信息。 | [7cb50e3e-0427-409e-90d2-638eb28217c3](../azure/7cb50e3e-0427-409e-90d2-638eb28217c3.md) |
>| openid | delegated | 我们仅存储来自 Teams 用户会话信息，并且用户需要通过添加通知来批准 (他们可以随时删除) 。 不存储其他信息。 | [7cb50e3e-0427-409e-90d2-638eb28217c3](../azure/7cb50e3e-0427-409e-90d2-638eb28217c3.md) |
>| profile | delegated | 我们仅存储来自 Teams 用户会话信息，并且用户需要通过添加通知来批准 (他们可以随时删除) 。 不存储其他信息。 | [7cb50e3e-0427-409e-90d2-638eb28217c3](../azure/7cb50e3e-0427-409e-90d2-638eb28217c3.md) |
