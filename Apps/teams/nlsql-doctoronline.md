---
title: 由 NLSQL 提供的 DoctorOnline 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/12/2022
...
description: 适用于 DoctorOnline 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/f9555238-64f3-4ec2-a8fc-3787baa157aa" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004082" target="_blank">在 AppSource 中查看</a>
...
| 应用的使用条款 | [https://doctoronline.bsmu.edu.ua/terms](https://doctoronline.bsmu.edu.ua/terms) |
| 应用的核心功能 | 预订免费的医疗保健在线支持。 超过500个授权的乌克兰医生与不同的类别。 |
| 公司总部位置 | 大不列颠及北爱尔兰联合王国 ()  |
| 应用信息页 | [https://doctoronline.bsmu.edu.ua](https://doctoronline.bsmu.edu.ua) |
