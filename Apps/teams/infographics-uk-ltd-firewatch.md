---
title: FireWatch by Infographics UK Ltd 的应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/30/2021
...
description: FireWatch 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/822055b4-508e-49c8-b7cc-c891ccb5c4eb" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003303" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Infographics UK Ltd. 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Infographics UK Ltd. |
| 公司的网站 | [https://www.infographics.co.uk](https://www.infographics.co.uk) |
| 应用的使用条款 | [https://www.infographics.co.uk/terms-and-conditions/](https://www.infographics.co.uk/terms-and-conditions/) |
| 应用的核心功能 | FireWatch 连接使消防和救援服务能够将 FireWatch 应用程序与Microsoft Teams集成，以便用户可以直接在Microsoft Teams内完成任务。 它目前通过Microsoft Teams机器人提供用户支持和帮助，直接在Microsoft Teams用户环境中预订/下班。 将来的版本将包括支持通过机器人和卡片执行进一步操作，包括 FireWatch 假日请求、任务提醒等。 |
| 公司总部位置 | 大不列颠及北爱尔兰联合王国 ()  |
| 应用信息页 | [https://www.firewatch.co.uk](https://www.firewatch.co.uk) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
Infographics UK Ltd. 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
