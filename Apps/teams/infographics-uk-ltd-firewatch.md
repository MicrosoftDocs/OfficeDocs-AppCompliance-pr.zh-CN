---
title: 信息图英国公司针对 FireWatch 的应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/30/2021
...
description: FireWatch 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/822055b4-508e-49c8-b7cc-c891ccb5c4eb" target="_blank">在应用商店Teams视图</a>
...
| 公司网站 | [https://www.infographics.co.uk](https://www.infographics.co.uk) |
| 应用的使用条款 | [https://www.infographics.co.uk/terms-and-conditions/](https://www.infographics.co.uk/terms-and-conditions/) |
| 应用的核心功能 | FireWatch 连接使消防和消防服务能够将 FireWatch 应用程序与Microsoft Teams，以便用户可以直接从 Microsoft Teams 中完成任务。 它目前通过自动程序提供用户支持和Microsoft Teams，直接从用户环境中预订Microsoft Teams义务。 未来版本将包括对通过自动程序和卡片执行进一步操作的支持，包括 FireWatch 假日请求、任务提醒等。 |
| 公司总部位置 | 英国大英和爱尔兰 ()  |
| 应用信息页面 | [https://www.firewatch.co.uk](https://www.firewatch.co.uk) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
此信息由信息图英国公司提供，用于了解此应用程序如何收集和存储组织数据，以及您的组织将拥有对应用收集的数据的控制。
