...
| 应用的核心功能 | FireWatch 连接使消防和消防服务能够将 FireWatch 应用程序与 Microsoft Teams，以便用户可以直接从 Microsoft Teams 中完成任务。 它目前通过自动程序提供用户支持和Microsoft Teams，直接从用户环境中预订Microsoft Teams义务。 未来版本将包括对通过自动程序和卡片执行进一步操作的支持，包括 FireWatch 假日请求、任务提醒等。 |
| 公司总部位置 | 英国大英和爱尔兰 ()  |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
