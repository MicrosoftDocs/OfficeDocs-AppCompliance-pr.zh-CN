...
description: 日历Pro的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/19a29a41-cbca-4152-a2af-dd9728ea35f1" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | Witivio |
| 公司的网站 | [https://www.witivio.com](https://www.witivio.com) |
| 应用的使用条款 | [https://www.teams-pro.com/en/terms-of-use/](https://www.teams-pro.com/en/terms-of-use/) |
| 应用的核心功能 | 日历Pro是Microsoft Teams的协作日历。 将日历Pro添加到频道或聊天中，以便与其成员创建共享日历。 |
| 公司总部位置 | 法国 |
| 应用信息页 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
Witivio 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | 使用数据 | [fb507a6d-2eaa-4f1f-b43a-140f388c4445](../azure/fb507a6d-2eaa-4f1f-b43a-140f388c4445.md) |
>| User.ReadBasic.All | 委托 | 使用数据 | [fb507a6d-2eaa-4f1f-b43a-140f388c4445](../azure/fb507a6d-2eaa-4f1f-b43a-140f388c4445.md) |
>| 电子邮件 | 委托 | 使用电子邮件 | [fb507a6d-2eaa-4f1f-b43a-140f388c4445](../azure/fb507a6d-2eaa-4f1f-b43a-140f388c4445.md) |
>| offline_access | 委托 | 使用数据 | [fb507a6d-2eaa-4f1f-b43a-140f388c4445](../azure/fb507a6d-2eaa-4f1f-b43a-140f388c4445.md) |
>| openid | 委托 | 身份验证 | [fb507a6d-2eaa-4f1f-b43a-140f388c4445](../azure/fb507a6d-2eaa-4f1f-b43a-140f388c4445.md) |
>| 个人资料 | 委托 | 使用数据 | [fb507a6d-2eaa-4f1f-b43a-140f388c4445](../azure/fb507a6d-2eaa-4f1f-b43a-140f388c4445.md) |
