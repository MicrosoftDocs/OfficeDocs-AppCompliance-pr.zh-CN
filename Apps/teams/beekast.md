...
| 合作伙伴公司名称 | Beekast |
| 公司网站 | [https://www.beekast.com](https://www.beekast.com) |
| 应用的使用条款 | [https://www.beekast.com/terms/](https://www.beekast.com/terms/) |
| 应用的核心功能 | Beekast 是加快会议速度的协作平台。 |
| 公司总部位置 | 法国 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegated | 电子邮件、名字和姓氏：这些数据用于在 beekast 应用程序中进行协作。 | [4d0997dc-df53-4b18-9df1-bb283f8a0377](https://docs.microsoft.com/microsoft-365-app-certification/azure/4d0997dc-df53-4b18-9df1-bb283f8a0377) |
