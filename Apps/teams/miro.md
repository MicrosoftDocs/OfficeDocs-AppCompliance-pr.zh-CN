...
description: M更新的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/8216e453-3db5-48ee-a3d6-5122f505c8a3" target="_blank">在应用商店Teams视图</a>
...
| 合作伙伴公司名称 | M一 |
| 公司网站 | [https://miro.com](https://miro.com) |
...
M一直提供有关此应用如何收集和存储组织数据以及组织将拥有对应用收集的数据的控制的信息。
...
| 应用是否遵守运行状况信息信任联盟、HITRUST CSF (Common Security Framework) ？ | 否 |
| 应用是否遵守 SOC 1 (服务组织) ？ | 否 |
| 最新 SOC1 认证日期 |   |
| 应用是否遵守 SOC 2 (服务组织) ？ | 是 |
