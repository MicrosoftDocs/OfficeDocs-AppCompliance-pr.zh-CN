...
* <a href="https://teams.microsoft.com/l/app/64d24486-30aa-4fae-8bdc-2680a85dcbb5" target="_blank">在应用商店Teams视图</a>
...
| 合作伙伴公司名称 | 所有蓝色解决方案 |
| 公司网站 | [https://ngdesk.com](https://ngdesk.com) |
| 应用的使用条款 | [https://ngdesk.com/terms-of-service/](https://ngdesk.com/terms-of-service/) |
| 应用的核心功能 | ngDesk 包括支持、销售、资产管理、营销和寻呼机，它位于一个随时可供使用且易于使用的一切应用程序中。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://ngdesk.com](https://ngdesk.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
