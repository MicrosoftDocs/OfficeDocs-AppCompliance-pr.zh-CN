...
* <a href="https://teams.microsoft.com/l/app/64d24486-30aa-4fae-8bdc-2680a85dcbb5" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002968" target="_blank">在 AppSource 中查看</a>
...
| 合作伙伴公司名称 | 所有蓝色解决方案 |
| 公司的网站 | [https://ngdesk.com](https://ngdesk.com) |
| 应用的使用条款 | [https://ngdesk.com/terms-of-service/](https://ngdesk.com/terms-of-service/) |
| 应用的核心功能 | ngDesk 在一体应用程序中包括支持、销售、资产管理、营销和寻呼机，这些应用程序已准备就绪且易于使用。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://ngdesk.com](https://ngdesk.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
所有蓝色解决方案都提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
