...
description: 你是否保险箱？的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/884e521a-dadc-41e9-a8af-fcaa907e783e" target="_blank">Teams存储区中的视图</a>
...
| 公司的网站 | [https://safetybot.in](https://safetybot.in) |
| 应用的使用条款 | [https://safetybot.in/terms.html](https://safetybot.in/terms.html) |
| 应用的核心功能 | &quot;是 YouSafe 吗？&quot; 机器人是个性化的危机管理助手。 非常适合在紧急情况下设置和使用安全管理员和人力资源人员。  无需任何其他软件或服务即可使用此应用。 在整个危机期间，我们的机器人易于使用并避免在Teams和外部应用之间进行交换。  使用我们的机器人了解受重大事件影响的员工的状态。 &quot;是 YouSafe 吗？&quot; 机器人通过提供实时更新来帮助你向有需要的人提供帮助。 |
| 公司总部位置 | 印度 |
| 应用信息页 | [https://safetybot.in](https://safetybot.in) |
...
Avista 技术解决方案提供了有关此应用如何收集和存储组织数据以及组织对应用收集的数据的控制的信息。
