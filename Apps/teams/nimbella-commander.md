---
title: 由 Nimbella 的一名高级将领的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
* <a href="https://teams.microsoft.com/l/app/be4751a5-db56-4e45-bb27-397e0aa614b1" target="_blank">在应用商店Teams视图</a>
...
| 合作伙伴公司名称 | Nimbella |
| 公司网站 | [https://www.nimbella.com](https://www.nimbella.com) |
| 应用的使用条款 | [https://nimbella.com/terms](https://nimbella.com/terms) |
| 应用的核心功能 | 生成、运行和共享自定义命令。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://nimbella.com/integrations/commander/microsoft-teams](https://nimbella.com/integrations/commander/microsoft-teams) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
Nimbella 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及组织将拥有对应用收集的数据的控制有关。
