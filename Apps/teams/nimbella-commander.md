...
description: 适用于指挥官的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/be4751a5-db56-4e45-bb27-397e0aa614b1" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002015" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Nimbella 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Nimbella |
| 公司的网站 | [https://www.nimbella.com](https://www.nimbella.com) |
| 应用的使用条款 | [https://nimbella.com/terms](https://nimbella.com/terms) |
| 应用的核心功能 | 生成、运行和共享自定义命令。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://nimbella.com/integrations/commander/microsoft-teams](https://nimbella.com/integrations/commander/microsoft-teams) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure、GCP、DigitalOcean |
...
Nimbella 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
