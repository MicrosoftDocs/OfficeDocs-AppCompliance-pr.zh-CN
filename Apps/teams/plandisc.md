---
title: Plandisc 的应用程序信息（按 Plandisc）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/29/2022
...
description: Plandisc 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
<p>开发人员上次更新时间：2022 年 3 月 29 日</p>

* <a href="https://teams.microsoft.com/l/app/0d794393-0f87-4c37-ac82-1d2822794372" target="_blank">在应用商店Teams视图</a>
...
| 合作伙伴公司名称 | Plandisc |
| 公司网站 | [https://plandisc.com](https://plandisc.com) |
| 应用的使用条款 | [https://plandisc.com/en/terms-and-conditions-of-use-4/](https://plandisc.com/en/terms-and-conditions-of-use-4/) |
| 应用的核心功能 | Plan and Collaborate with an Annual Planner Accessible in Microsoft Teams |
| 公司总部位置 | 丹麦 |
| 应用信息页面 | |
...
此信息由 Plandisc 提供，用于了解此应用程序如何收集和存储组织数据，以及您的组织将拥有对应用收集的数据的控制。
...
| 数据库中存储了哪些数据？ | customer tenantId、customer userId、Outlook日历数据 |
...
| 隐私策略 URL | https://plandisc.com/en/personal-data-policy-4/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | delegated | 日历同步 | [08da38c2-089b-4c58-9995-60bc2ca54561](../azure/08da38c2-089b-4c58-9995-60bc2ca54561.md) |
>| Calendars.ReadWrite.Shared | delegated | 日历同步 | [08da38c2-089b-4c58-9995-60bc2ca54561](../azure/08da38c2-089b-4c58-9995-60bc2ca54561.md) |
>| User.Read | delegated | 读取用户配置文件 | [08da38c2-089b-4c58-9995-60bc2ca54561](../azure/08da38c2-089b-4c58-9995-60bc2ca54561.md) |
>| openid | delegated | 让用户登录 | [08da38c2-089b-4c58-9995-60bc2ca54561](../azure/08da38c2-089b-4c58-9995-60bc2ca54561.md) |
