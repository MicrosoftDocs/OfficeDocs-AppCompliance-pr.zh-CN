---
title: SuperQuickQuestion 的 SQQ 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/09/2021
...
* <a href="https://teams.microsoft.com/l/app/25379fc8-577f-4935-b681-6f027977fbe3" target="_blank">在应用商店Teams视图</a>
...
SuperQuickQuestion 提供给 Microsoft 的信息：
...
| 应用的核心功能 | SuperQuickQuestion 是一个实时一对一视频会议平台，时间限制为 60 秒。 我们希望鼓励更高效的对话，消除不必要的会议，并帮助你提高解决问题的速度并回收日历，一次一分钟。 正如我们在与十几个人一起尝试相互交谈的会议中所花时间证明的那样，较长的会议不一定等同于更多协作，&#8217;SQQ 可以提供帮助。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://superquickquestion.com/UserGuide/msteams](https://superquickquestion.com/UserGuide/msteams) |
...
SuperQuickQuestion 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及您的组织将拥有对应用收集的数据的控制有关。
...
| 隐私策略 URL | https://superquickquestion.com/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Chat.ReadBasic | delegated | 获取聊天中的参与者数量 | [25379fc8-577f-4935-b681-6f027977fbe3](../azure/25379fc8-577f-4935-b681-6f027977fbe3.md) |
>| User.Read | delegated | 读取用户租户名称 | [25379fc8-577f-4935-b681-6f027977fbe3](../azure/25379fc8-577f-4935-b681-6f027977fbe3.md) |
>| openid | delegated | 从应用登录用户以访问 Graph 终结点 | [25379fc8-577f-4935-b681-6f027977fbe3](../azure/25379fc8-577f-4935-b681-6f027977fbe3.md) |
