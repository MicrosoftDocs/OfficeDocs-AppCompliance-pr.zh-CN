...
| "Teams应用程序信息"页的 URL | [https://coffeepals.co/product](https://coffeepals.co/product) |
...
>|:-----------------------------------------------------|:------------------------------|:----------------------------------------|
>| Google Analytics、Stripe、Mailchimp、Heroku、MongoDB Atlas、AWS、Logentries | 用户电子邮件地址、付款信息 (、名字) 、名字和姓氏处理 | 我们的应用已付款，因此需要信用卡信息和联系信息。 |
