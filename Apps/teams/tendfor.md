---
title: Tendfor by Tendfor 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/16/2022
...
description: Tendfor 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/212fcd92-bc06-4746-85c4-f7b5d39579ba" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002996" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Tendfor 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Tendfor |
| 公司的网站 | [https://www.tendfor.com](https://www.tendfor.com) |
...
| 应用的核心功能 | 一个功能齐全的联系人中心和助理控制台，用于Microsoft Teams。 |
| 公司总部位置 | 瑞典 |
| 应用信息页 | [https://www.tendfor.com](https://www.tendfor.com) |
...
Tendfor 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 用户配置文件数据、用户日历数据、呼叫媒体 |
...
| 隐私策略 URL | https://tendfor.com/en/contact/tendfor-privacy-notice/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | 能够登录用户 | [b7e8237f-d86d-4874-8f8b-7faa8f768436](../azure/b7e8237f-d86d-4874-8f8b-7faa8f768436.md) |
>| User.Read.All | 应用程序 | 能够导入用户信息 | [b7e8237f-d86d-4874-8f8b-7faa8f768436](../azure/b7e8237f-d86d-4874-8f8b-7faa8f768436.md) |
>| User.Read.All | 委托 | 能够导入用户信息 | [b7e8237f-d86d-4874-8f8b-7faa8f768436](../azure/b7e8237f-d86d-4874-8f8b-7faa8f768436.md) |
