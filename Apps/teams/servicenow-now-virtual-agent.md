---
title: 立即虚拟代理的应用程序信息（按 ServiceNow）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/18/2022
...
description: Now Virtual Agent 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66852686"
---
# <a name="now-virtual-agent"></a>Now Virtual Agent

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 7 月 16 日</p>

* <a href="https://teams.microsoft.com/l/app/49471a10-fdbc-4ffb-b0b8-944f3df985d9" target="_blank">在 Teams 应用商店中查看</a>
...
| 合作伙伴公司名称 | ServiceNow |
| 公司的网站 | [https://www.servicenow.com](https://www.servicenow.com) |
| 应用的使用条款 | [https://www.servicenow.com/terms-of-use.html](https://www.servicenow.com/terms-of-use.html) |
| 应用的核心功能 | 现在虚拟代理允许你直接在 Microsoft Teams 中执行常规 ServiceNow 任务，以便可以使用聊天更高效地工作。  |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://store.servicenow.com](https://store.servicenow.com) |
...
ServiceNow 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
| 应用是否支持条件访问策略？ | 是 |
| 列出支持的策略类型 | 管理员可以选择阻止/取消阻止应用的特定 MS Teams 租户 |
| 应用是否支持持续访问评估 (CAE)  | 否 |
| 应用是否在代码中存储任何凭据？ | 否 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteForUser | 委托 | 现在，虚拟代理使用此权限读取、安装、升级和卸载为已登录用户安装的 Teams 应用。  | [5a87eaa0-a00c-4382-9bdd-cdada0b6820f](../azure/5a87eaa0-a00c-4382-9bdd-cdada0b6820f.md) |
>| User.ReadBasic.All | 委托 | 应用使用此权限读取用户的配置文件 | [5a87eaa0-a00c-4382-9bdd-cdada0b6820f](../azure/5a87eaa0-a00c-4382-9bdd-cdada0b6820f.md) |
>| offline_access | 委托 | 这是获取刷新令牌所必需的。 我们使用的是 /authorize 终结点 | [5a87eaa0-a00c-4382-9bdd-cdada0b6820f](../azure/5a87eaa0-a00c-4382-9bdd-cdada0b6820f.md) |
>| openid | 委托 | 现在，虚拟代理应用使用 OpenID Connect (OIDC) 身份验证协议 | [5a87eaa0-a00c-4382-9bdd-cdada0b6820f](../azure/5a87eaa0-a00c-4382-9bdd-cdada0b6820f.md) |
