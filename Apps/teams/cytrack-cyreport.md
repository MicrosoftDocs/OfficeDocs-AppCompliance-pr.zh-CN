---
title: CyReport by CyTrack 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/24/2022
...
description: CyReport 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/10b18ffa-155e-4b1f-89d5-88401ba0aa64" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004272" target="_blank">在 AppSource 中查看</a>
...
| 应用的核心功能 | 对 Microsoft 团队&#8217;工作效率 &amp; 交互的业务见解进行工作场所分析和报告。  易于使用的分析和报告解决方案，可让企业深入了解团队&#8217;的工作效率、客户互动、趋势、通话质量、通信成本等。 CyReport for Microsoft Teams 可提高协作、业务通信性能和效率，从而获得卓越的客户体验。 |
| 公司总部位置 | 澳大利亚 |
| 应用信息页 | [https://web.cytrack.com/microsoft-teams/call-reporting-for-...](https://web.cytrack.com/microsoft-teams/call-reporting-for-microsoft-teams/) |
