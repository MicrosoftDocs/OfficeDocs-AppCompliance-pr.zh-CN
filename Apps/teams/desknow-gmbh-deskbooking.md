---
title: DeskBooking 的应用程序信息 by DeskNow GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/25/2022
...
description: DeskBooking 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/d118c110-6d5d-4fa1-8151-1ebb10b0091c" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003866" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

DeskNow GmbH 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | DeskNow GmbH |
| 公司网站 | [https://desk-now.com](https://desk-now.com) |
| 应用的使用条款 | [https://desk-now.com/en/useful/terms-conditions/](https://desk-now.com/en/useful/terms-conditions/) |
| 应用的核心功能 | 完全控制办公室、会议室等！ HybridWork 全部一体，无论有多少国家/地区、办公室、会议室、服务台或人员。  |
| 公司总部位置 | 德国 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ | Iaas |
| 应用使用哪些托管云提供商？ | Aws、Other |
...
DeskNow GmbH 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及您的组织将拥有对应用收集的数据的控制有关。
...
| 数据库中存储了哪些数据？ | 用户的预订详细信息。 用户配置文件数据、用户权限 |
...
| 隐私策略 URL | https://desk-now.com/en/useful/general-privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite.Shared | 两者 | 日历同步 | [e5d4c7df-50aa-4c15-aa06-c108d0225832](../azure/e5d4c7df-50aa-4c15-aa06-c108d0225832.md) |
>| GroupMember.ReadWrite.All | 两者 | 用户权限、预订权限 | [e5d4c7df-50aa-4c15-aa06-c108d0225832](../azure/e5d4c7df-50aa-4c15-aa06-c108d0225832.md) |
>| TeamMember.ReadWrite.All | 两者 | 用户权限、预订权限、  | [e5d4c7df-50aa-4c15-aa06-c108d0225832](../azure/e5d4c7df-50aa-4c15-aa06-c108d0225832.md) |
