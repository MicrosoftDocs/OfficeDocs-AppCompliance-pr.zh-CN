---
title: Cornerstone OnDemand 的 CSOD Learn 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: CSOD Learn 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/81726ee9-4d27-47ad-8b22-08147c6f8613" target="_blank">Teams存储区中的视图</a>
...
Cornerstone OnDemand 提供给 Microsoft 的信息：
...
| 公司的网站 | [https://www.cornerstoneondemand.com](https://www.cornerstoneondemand.com) |
| 应用的使用条款 | [https://www.microsoft.com/en-us/microsoft-teams/group-chat-...](https://www.microsoft.com/en-us/microsoft-teams/group-chat-software) |
| 应用的核心功能 | 直接在Teams内Learning管理系统的要点 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS、SelfHosted |
...
Cornerstone OnDemand 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
| 最新的 SOC1 认证日期 | 2020-01-01 |
| 应用是否符合服务组织控制 (SOC 2) ？ | 是 |
| 最新的 SOC2 认证日期 | 2020-01-01 |
