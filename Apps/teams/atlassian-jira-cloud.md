...
>|   **Graph权限**  | **权限类型** |          **字距调整**          |
>|:------------------------|:--------------------|:------------------------------------|
>| offline_access | delegated | 代表用户长时间提供对资源的访问权限，以确保获得最佳用户体验。 |
>| openid | delegated | 获取用户的给定名称、姓氏、首选用户名和对象 ID。 |
>| 个人资料 | delegated | 获取用户的给定名称、姓氏、首选用户名和对象 ID。 |
