---
title: EnableUC 的 Trivia 引擎的应用程序信息
ms.author: elmalova
author: elenamalova
ms.date: 11/09/2021
ms.topic: article
...
description: Trivia Engine 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "60922899"
---
# <a name="trivia-engine"></a>Trivia 引擎

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 10 月 1 日</p>

* <a href="https://teams.microsoft.com/l/app/3bd813fa-a19a-4c06-b130-450b24b8ee08" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003412" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

EnableUC 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | EnableUC |
| 公司网站 | [https://www.triviaengine.com](https://www.triviaengine.com) |
| 应用的使用条款 | [https://www.triviaengine.com/termsofuse.html](https://www.triviaengine.com/termsofuse.html) |
| 应用的核心功能 | 使用游戏功能增强现有培训&#8220;知识&#8221;。 |
| 公司总部位置 | 加拿大 |
| 应用信息页面 | |
...
EnableUC 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及组织将拥有对应用收集的数据的控制有关。
