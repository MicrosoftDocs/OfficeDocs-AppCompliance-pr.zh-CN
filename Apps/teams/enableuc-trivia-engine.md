---
title: EnableUC 提供的 Trivia 引擎应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/09/2021
...
description: Trivia Engine 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/3bd813fa-a19a-4c06-b130-450b24b8ee08" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | EnableUC |
| 公司的网站 | [https://www.triviaengine.com](https://www.triviaengine.com) |
| 应用的使用条款 | [https://www.triviaengine.com/termsofuse.html](https://www.triviaengine.com/termsofuse.html) |
| 应用的核心功能 | 使用&#8220;游戏化&#8221;增强现有培训并改进知识保留。 |
| 公司总部位置 | 加拿大 |
| 应用信息页 | [https://www.triviaengine.com](https://www.triviaengine.com) |
...
EnableUC 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
| 如果你的应用不使用上述库之一，它使用什么身份验证库或库？ | N/A - 使用最新版本的 MSAL。 |
| 应用是否支持条件访问策略？ | 否 |
| 应用是否支持持续访问评估 (CAE)  | 否 |
| 应用是否在代码中存储任何凭据？ | 否 |
