---
title: Futureworks AS 的 Futureworks 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/03/2022
...
description: Futureworks 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/80a90c8c-6199-454b-b0ff-bd5fba480275" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003510" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Futureworks AS 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | 未来工作 AS |
| 公司网站 | [https://app.futureworks.com](https://app.futureworks.com) |
| 应用的使用条款 | [https://www.futureworks.com/terms-of-service](https://www.futureworks.com/terms-of-service) |
| 应用的核心功能 | 基于 OKR 的目标和性能管理平台 - 目标和关键结果。 |
| 公司总部位置 | 挪威 |
| 应用信息页面 | [https://futureworks.no](https://futureworks.no) |
...
Futureworks AS 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及您的组织将拥有对应用程序收集的数据的控制有关。
