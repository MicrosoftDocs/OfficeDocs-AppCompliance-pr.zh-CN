...
| 公司总部位置 | 澳大利亚 |
| 应用信息页面 | [https://www.neelix.team](https://www.neelix.team) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | GCP |
...
此信息由用户 Neelix.IO，这些信息与此应用程序如何收集和存储组织数据以及组织将拥有对应用收集的数据的控制有关。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | delegated | 应用使用频道 ID 和名称，以便为用户提供在从 MS Treams 发送反馈时管理其默认首选项的便利 | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| Team.ReadBasic.All | delegated | 应用使用团队 ID 和名称，以便用户方便在从 MS Treams 发送反馈时管理其默认首选项 | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| 电子邮件 | delegated | 电子邮件用作 Neelix 内用户注册的一部分。 初始注册后，电子邮件用于通知。  | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| offline_access | delegated | 这用于获取刷新令牌 | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| profile | delegated | 用户名用于在向 Neelix 注册时创建用户帐户。  | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| User.Read | delegated | 自动程序应用使用 user.read，以便能够发送信息用户，以便 Neelix 核心平台可以识别用户 | [一个 170ee-dbd7-4efa-b48e-b0937ded1689](../azure/bed170ee-dbd7-4efa-b48e-b0937ded1689.md) |
