...
description: Neelix.Team 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/bed170ee-dbd7-4efa-b48e-b0937ded1689" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | Neelix.IO |
| 公司的网站 | [https://www.neelix.team](https://www.neelix.team) |
| 应用的使用条款 | [https://www.neelix.io/terms-of-use-en](https://www.neelix.io/terms-of-use-en) |
| 应用的核心功能 | Neelix 平台将反馈循环作为一个完整的周期进行管理。 用户可以将持续体验、回顾性反馈和情绪引导到团队的日记中。 |
| 公司总部位置 | 澳大利亚 |
| 应用信息页 | [https://www.neelix.team](https://www.neelix.team) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | GCP |
...
Neelix.IO 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 委托 | 应用使用通道 ID 和名称，以便为用户在从 MS Treams 发送反馈时管理其默认首选项提供便利 | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| Team.ReadBasic.All | 委托 | 应用使用团队 ID 和名称，以便为用户在从 MS Treams 发送反馈时管理其默认首选项提供便利 | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| 电子邮件 | 委托 | 电子邮件用作 Neelix 中用户注册的一部分。 初始注册后，电子邮件用于通知。  | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| offline_access | 委托 | 用于获取刷新令牌 | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| 个人资料 | 委托 | 在向 Neelix 注册时，用户名用于创建用户帐户。  | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| User.Read | 委托 | 机器人应用使用 user.read 来发送用户信息，以便 Neelix 核心平台能够识别用户 | [bed170ee-dbd7-4efa-b48e-b0937ded1689](../azure/bed170ee-dbd7-4efa-b48e-b0937ded1689.md) |
