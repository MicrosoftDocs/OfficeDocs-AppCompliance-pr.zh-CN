...
description: Neelix.Team 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| 合作伙伴公司名称 | Neelix.IO |
| 公司网站 | [https://www.neelix.team](https://www.neelix.team) |
| 应用的使用条款 | [https://www.neelix.io/terms-of-use-en](https://www.neelix.io/terms-of-use-en) |
| 应用的核心功能 | Neelix 平台作为完整周期管理反馈循环。 用户可以将持续体验、反馈和情绪传播到团队的日记中。 |
| 公司总部位置 | 澳大利亚 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | delegated | 应用使用频道 ID 和名称，以便为用户提供在从 MS Treams 发送反馈时管理其默认首选项的便利 | [6996cad6-a969-487a-9182-f4dc4c6c8803](https://docs.microsoft.com/microsoft-365-app-certification/azure/6996cad6-a969-487a-9182-f4dc4c6c8803) |
>| Team.ReadBasic.All | delegated | 应用使用团队 ID 和名称，以便用户方便在从 MS Treams 发送反馈时管理其默认首选项 | [6996cad6-a969-487a-9182-f4dc4c6c8803](https://docs.microsoft.com/microsoft-365-app-certification/azure/6996cad6-a969-487a-9182-f4dc4c6c8803) |
>| 电子邮件 | delegated | 电子邮件用作 Neelix 内用户注册的一部分。 初始注册后，电子邮件用于通知。  | [6996cad6-a969-487a-9182-f4dc4c6c8803](https://docs.microsoft.com/microsoft-365-app-certification/azure/6996cad6-a969-487a-9182-f4dc4c6c8803) |
>| offline_access | delegated | 这用于获取刷新令牌 | [6996cad6-a969-487a-9182-f4dc4c6c8803](https://docs.microsoft.com/microsoft-365-app-certification/azure/6996cad6-a969-487a-9182-f4dc4c6c8803) |
>| 个人资料 | delegated | 用户名用于在向 Neelix 注册时创建用户帐户。  | [6996cad6-a969-487a-9182-f4dc4c6c8803](https://docs.microsoft.com/microsoft-365-app-certification/azure/6996cad6-a969-487a-9182-f4dc4c6c8803) |
>| User.Read | delegated | 自动程序应用使用 user.read，以便能够发送信息用户，以便 Neelix 核心平台可以识别用户 | [一个 170ee-dbd7-4efa-b48e-b0937ded1689](https://docs.microsoft.com/microsoft-365-app-certification/azure/bed170ee-dbd7-4efa-b48e-b0937ded1689) |
