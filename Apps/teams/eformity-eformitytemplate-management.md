---
title: eformity | 的应用程序信息按 eformity 管理模板
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/11/2022
...
description: 适用于 eformity 的所有可用安全性和符合性信息|模板管理、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "64771441"
---
# <a name="eformity--template-management"></a>eformity |模板管理

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 11 月 19 日</p>

* <a href="https://teams.microsoft.com/l/app/74843469-2e76-45e6-acdc-b755a4a4adf0" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003519" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Eformity 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | eformity |
| 公司的网站 | [https://eformity.nl](https://eformity.nl) |
| 应用的使用条款 | [https://eformity.net/policies/terms-of-use](https://eformity.net/policies/terms-of-use) |
| 应用的核心功能 | 使用集中管理的模板从Microsoft Teams创建文档和演示文稿。 |
| 公司总部位置 | 荷兰 ()  |
| 应用信息页 | |
...
此信息由有关此应用如何收集和存储组织数据以及组织对应用收集的数据将具有的控件的格式提供。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 用户邮件、用户名、用户名字、用户姓氏 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 用户邮件、用户名、用户名字、用户姓氏 |
...
| 隐私策略 URL | https://eformity.net/policies/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | 委托 | 保存生成的模板 | [ff50870f-b19b-489c-9766-4bcee4e843eb](../azure/ff50870f-b19b-489c-9766-4bcee4e843eb.md) |
>| User.Read | 委托 | 收集数据以更新平台上的用户配置文件 | [ff50870f-b19b-489c-9766-4bcee4e843eb](../azure/ff50870f-b19b-489c-9766-4bcee4e843eb.md) |
>| openid | 委托 | 登录用户 | [ff50870f-b19b-489c-9766-4bcee4e843eb](../azure/ff50870f-b19b-489c-9766-4bcee4e843eb.md) |
>| 个人资料 | 委托 | 登录用户 | [ff50870f-b19b-489c-9766-4bcee4e843eb](../azure/ff50870f-b19b-489c-9766-4bcee4e843eb.md) |
