...
description: CSA STAR 注册表中有关 连接+、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息和安全/合规性信息的所有可用安全性和合规性信息。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.Read.All | delegated | 不收集数据 | [5e4dadf5-9f90-449b-9e39-934fd10b7c23](https://docs.microsoft.com/microsoft-365-app-certification/azure/5e4dadf5-9f90-449b-9e39-934fd10b7c23) |
