...
description: A一一o Interpretation 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "64480528"
---
# <a name="akouo-interpretation"></a>A一o Interpretation

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 2 月 8 日</p>

* <a href="https://teams.microsoft.com/l/app/d863a24b-7cdd-46c9-8309-a15878f4f7bf" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003814" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

A一一o Technologies Inc. 提供给 Microsoft 的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | A一o Interpretation |
| ID | WA200003814 |
| Office 365客户端 | Microsoft Teams |
| 合作伙伴公司名称 | A一o Technologies Inc. |
| 公司网站 | [https://akouo.io](https://akouo.io) |
| 应用的使用条款 | [https://akouo.io/terms](https://akouo.io/terms) |
| 应用的核心功能 | 使会议多语言，同时进行翻译。 |
| 公司总部位置 | 阿拉伯联合酋长国 ()  |
| 应用信息页面 | [https://akouo.io](https://akouo.io) |
...
A一o Technologies Inc. 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及您的组织将拥有对应用收集的数据的控制有关。
...
| 隐私策略 URL | https://akouo.io/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| OnlineMeetings.Read | delegated | 用于获取会议详细信息，如开始时间等。仅请求会议"用户"。 | [d863a24b-7cdd-46c9-8309-a15878f4f7bf](../azure/d863a24b-7cdd-46c9-8309-a15878f4f7bf.md) |
>| offline_access | 应用程序 | Microsoft 自动&#8217;单一登录框架。 https://docs.microsoft.com/en-us/graph/permissions-reference#remarks-15  | [d863a24b-7cdd-46c9-8309-a15878f4f7bf](../azure/d863a24b-7cdd-46c9-8309-a15878f4f7bf.md) |
>| openid | 应用程序 | 使用 Microsoft/Azure 登录会话对用户进行身份验证 | [d863a24b-7cdd-46c9-8309-a15878f4f7bf](../azure/d863a24b-7cdd-46c9-8309-a15878f4f7bf.md) |
