---
title: 按 monday.com monday.com 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/05/2021
...
description: CSA STAR 注册表中 monday.com 的所有可用安全性和符合性信息、其数据处理策略、Microsoft Cloud App Security应用目录信息以及安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/eab2d3ce-6d6a-4415-abc4-5f40a8317b1f" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | monday.com |
| 公司的网站 | [https://monday.com](https://monday.com) |
| 应用的使用条款 | [https://monday.com/l/legal/tos/](https://monday.com/l/legal/tos/) |
| 应用的核心功能 | monday.com 是一个多功能的工作 OS，支持远程团队合作 - 组织、结构和简化所有程序、项目和流程。  通过 monday.com，可以使用构建基块&#8211;（如板、视图、图表、自动化和集成）创建自定义工作流应用来运行进程、项目和日常工作。 直接在Microsoft Teams中创建新的 monday.com 板或添加到现有板，并轻松地将团队&#8217;在一个协作工作区中的工作可视化。 |
| 公司总部位置 | Israel（以色列） |
| 应用信息页 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
monday.com 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
| 最新的 SOC1 认证日期 | 2021-05-01 |
| 应用是否符合服务组织控制 (SOC 2) ？ | 是 |
| 最新的 SOC2 认证日期 | 2021-05-01 |
| 应用是否符合服务组织控制 (SOC 3) ？ | 是 |
| 最新的 SOC3 认证日期 | 2021-05-01 |
