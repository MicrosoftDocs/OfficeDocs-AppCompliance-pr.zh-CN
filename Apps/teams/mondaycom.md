...
| 应用的核心功能 | monday.com 是一种通用工作操作系统，可支持远程团队合作，以组织、组织和简化所有计划、项目和流程。  通过 monday.com，您可以使用构建基块&#8211;板、视图、图表、自动化和集成）创建自定义工作流应用程序以运行流程、项目和日常工作。 从 monday.com 内创建新仪表板或将其添加到现有开发板Microsoft Teams并在一个协作工作区中轻松&#8217;团队工作。 |
| 公司总部位置 | Israel（以色列） |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
