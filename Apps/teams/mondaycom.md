...
| 合作伙伴公司名称 | monday.com |
| 公司网站 | [https://monday.com](https://monday.com) |
| 应用的使用条款 | [https://monday.com/l/legal/tos/](https://monday.com/l/legal/tos/) |
| 应用的核心功能 | monday.com 是一种支持远程团队合作的通用工作操作系统，用于组织、组织和简化所有计划、项目和流程。  通过 monday.com，您可以使用构建基块&#8211;板、视图、图表、自动化和集成）创建自定义工作流应用程序以运行流程、项目和日常工作。 从 monday.com 内创建新开发板或将其添加到现有开发板Microsoft Teams并在一个协作工作区中轻松&#8217;团队工作。 |
| 公司总部位置 | Israel（以色列） |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
| 应用是否遵守 SOC 1 (服务组织) ？ | 是 |
| 最新 SOC1 认证日期 |  2021-05-01 |
| 应用是否遵守 SOC 2 (服务组织) ？ | 是 |
| 你获得哪种 SOC 2 认证？ |   |
| 最新 SOC2 认证日期 |  2021-05-01 |
| 应用是否遵守 SOC 3 (服务组织) ？ | 是 |
| 最新 SOC3 认证日期 |  2021-05-01 |
