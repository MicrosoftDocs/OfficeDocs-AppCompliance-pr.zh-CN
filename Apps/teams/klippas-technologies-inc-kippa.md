...
| 公司网站 | [https://www.kippa.app](https://www.kippa.app) |
| 应用的使用条款 | [https://www.kippa.app/terms-of-service/](https://www.kippa.app/terms-of-service/) |
| 应用的核心功能 | 从用户内部快速设置一次性或定期的个人、共享或频道Microsoft Teams |
| 公司总部位置 | 加拿大 |
| 应用信息页面 | [https://www.kippa.app/kippa-app/](https://www.kippa.app/kippa-app/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
| 你的应用是否支持条件访问策略？ | 是 |
| 列出支持的策略类型 | 与Microsoft Teams一样，因为用户必须登录Teams才能访问 Kippa。 |
| 你的应用是否支持 CAE (连续访问)  |  |
| 你的应用是否将任何凭据存储在代码中？ |  |
