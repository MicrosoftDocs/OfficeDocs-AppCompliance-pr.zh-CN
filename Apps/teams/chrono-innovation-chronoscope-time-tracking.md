...
description: 有关 Chronoscope 时间跟踪、其数据处理策略、其 Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息的所有可用安全性和合规性信息。
...
| 合作伙伴公司名称 | Chrono 创新 |
| 公司网站 | [https://www.chronoinnovation.com](https://www.chronoinnovation.com) |
| 应用的使用条款 | [https://www.chronoscope.app/terms-of-service](https://www.chronoscope.app/terms-of-service) |
| 应用的核心功能 | Chronoscope 是一个智能时间管理平台，可提高数据准确性并减少时间输入错误。 通过与现有生态系统集成在一起智能助手，Chronoscope 便于输入时间并查看数据，以便做出更好的业务决策。 |
| 公司总部位置 | 加拿大 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AccessReview.Read.All | 应用程序 | teams tenantId 、teams addObjectId 和 teams 用户帐户信息。 链接 Chronoscope 用户时，我们验证电子邮件是否与 Teams 帐户匹配，以便无需用户手动步骤即可链接帐户 | [9bc8244d-a186-4b12-809e-c47b3eee73c6](https://docs.microsoft.com/microsoft-365-app-certification/azure/9bc8244d-a186-4b12-809e-c47b3eee73c6) |
