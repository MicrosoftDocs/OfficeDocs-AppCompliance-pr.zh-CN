---
title: Chrono Innovation 的 Chronoscope 时间跟踪应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Chronoscope 时间跟踪的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/5b3ded07-fa1a-4fd8-a323-e5fe3f8cf740" target="_blank">Teams存储区中的视图</a>
...
Chrono Innovation 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Chrono 创新 |
| 公司的网站 | [https://www.chronoinnovation.com](https://www.chronoinnovation.com) |
| 应用的使用条款 | [https://www.chronoscope.app/terms-of-service](https://www.chronoscope.app/terms-of-service) |
| 应用的核心功能 | Chronoscope 是一种智能时间管理平台，可提高数据准确性并减少时间输入错误。 通过与现有生态系统集成的智能助手，Chronoscope 可促进时间输入，并提供对数据的可见性，以便做出更好的业务决策。 |
| 公司总部位置 | 加拿大 |
| 应用信息页 | [https://www.chronoscope.app](https://www.chronoscope.app) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | GCP |
...
Chrono Innovation 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AccessReview.Read.All | 应用程序 | teams tenantId、teams addObjectId 和 teams 用户帐户信息。 链接 Chronoscope 用户时，我们将验证电子邮件是否与Teams帐户匹配，以便我们可以链接帐户，而无需用户手动执行步骤 | [9bc8244d-a186-4b12-809e-c47b3eee73c6](../azure/9bc8244d-a186-4b12-809e-c47b3eee73c6.md) |
