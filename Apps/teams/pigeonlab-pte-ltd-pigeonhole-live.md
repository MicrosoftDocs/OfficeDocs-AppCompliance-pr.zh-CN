---
title: 鸽子板 Pte Ltd 的鸽子洞 Live 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/26/2022
...
description: 鸽子洞 Live 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "65749380"
---
# <a name="pigeonhole-live"></a>鸽子洞直播

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 5 月 23 日</p>

* <a href="https://teams.microsoft.com/l/app/96ecd0d3-9351-4fcb-ac50-08c85e36ab26" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001472" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

鸽子实验室 Pte Ltd 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | 鸽子实验室 Pte Ltd |
| 公司的网站 | [https://pigeonholelive.com](https://pigeonholelive.com) |
| 应用的使用条款 | [https://pigeonholelive.com/terms](https://pigeonholelive.com/terms) |
| 应用的核心功能 | 通过 Q&amp;As、轮询和测验增强会议中的交互性 |
| 公司总部位置 | 新加坡 |
| 应用信息页 | [https://pigeonholelive.com/microsoft-teams-meetings/](https://pigeonholelive.com/microsoft-teams-meetings/) |
...
该信息由 PigeonLab Pte Ltd 提供，介绍此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 电子邮件和名称，在使用鸽子洞 Live 的受众交互时捕获的其他数据 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 电子邮件和名称，在使用鸽子洞 Live 的受众交互时捕获的其他数据 |
...
| 隐私策略 URL | https://www.pigeonholelive.com/privacy |
