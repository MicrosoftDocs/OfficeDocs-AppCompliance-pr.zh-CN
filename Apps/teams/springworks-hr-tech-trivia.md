...
| 应用的核心功能 | 一起比赛的团队，可以更好地协作。 通过"三角"，与团队成员进行实时测验和游戏，与团队成员互动，并参与工作中的社交中断。 Trivia&#8217;一套功能：Quizzes - 在 MCQ 格式测验中与团队成员竞争、Word 问题 - 通过重新设置字母以形成有意义的单词和 (Un) 热门意见 - 通过有趣的投票帮助团队中激发出一些快乐 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
