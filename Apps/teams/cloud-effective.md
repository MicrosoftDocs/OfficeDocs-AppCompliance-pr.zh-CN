...
description: 云有效版的所有可用安全性和符合性信息、其数据处理策略、Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/c976a771-1aa9-4e98-b87d-32f271bd6e7f" target="_blank">Teams存储区中的视图</a>
...
Cloud Effective 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | 云有效 |
| 公司的网站 | [https://CloudEffective.com](https://CloudEffective.com) |
| 应用的使用条款 | [https://cloudeffective.com/term-of-use.php](https://cloudeffective.com/term-of-use.php) |
| 应用的核心功能 | 优化协作。 管理团队、目标、项目和任务，将想法转化为结果！ |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://cloudeffective.com/products-pricing](https://cloudeffective.com/products-pricing) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
Cloud Effective 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.ReadWrite.All | 委托 | 同步团队名称和成员，确保来自MS-Teams的团队成员对 Cloud Effective 中的相应团队具有相同的访问权限。  | [50356ee3-b48b-424b-a7a7-35e53c2ce736](../azure/50356ee3-b48b-424b-a7a7-35e53c2ce736.md) |
