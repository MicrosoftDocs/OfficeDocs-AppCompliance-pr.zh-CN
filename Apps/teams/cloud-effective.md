...
| 合作伙伴公司名称 | 云有效 |
| 公司网站 | [https://CloudEffective.com](https://CloudEffective.com) |
| 应用的使用条款 | [https://cloudeffective.com/term-of-use.php](https://cloudeffective.com/term-of-use.php) |
| 应用的核心功能 | 优化协作。 管理团队、目标、项目和任务将想法转变为结果！ |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://cloudeffective.com/products-pricing](https://cloudeffective.com/products-pricing) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.ReadWrite.All | delegated | 同步团队名称和成员，以确保团队成员MS-Teams云有效中相应团队的相同访问权限。  | [50356ee3-b48b-424b-a7a7-35e53c2ce736](../azure/50356ee3-b48b-424b-a7a7-35e53c2ce736.md) |
