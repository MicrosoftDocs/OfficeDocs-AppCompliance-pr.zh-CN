---
title: 循环的应用程序信息 - Skooler 的创意Learning
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
description: 循环的所有可用安全性和符合性信息 - 创意Learning、其数据处理策略、Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/d612b92e-2828-4a94-9e83-92dee316bdb3" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | Skooler |
| 公司的网站 | [https://www.loopseducation.com](https://www.loopseducation.com) |
...
| 应用的核心功能 | 循环是一种通过交互式思维图进行教学和学习的工具。 |
| 公司总部位置 | 瑞典 |
| 应用信息页 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
Skooler 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | 用于允许使用 Microsoft 登录的 UPN。 配置文件预填充的给定名称和姓氏。 | [dc171e47-c074-4bc2-9e7b-3856b71e0630](../azure/dc171e47-c074-4bc2-9e7b-3856b71e0630.md) |
