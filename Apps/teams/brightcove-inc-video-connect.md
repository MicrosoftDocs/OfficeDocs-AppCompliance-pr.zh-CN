...
| 公司网站 | [https://www.brightcove.com/en/](https://www.brightcove.com/en/) |
| 应用的使用条款 | [https://www.brightcove.com/en/terms-and-conditions/](https://www.brightcove.com/en/terms-and-conditions/) |
| 应用的核心功能 | Brightcove 视频连接支持与视频和媒体资产直接协作的Microsoft Teams |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://integrations.support.brightcove.com/teams/installat...](https://integrations.support.brightcove.com/teams/installation.html) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
