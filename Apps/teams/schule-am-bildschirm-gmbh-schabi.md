---
title: Schabi 的应用程序信息（由 Schule am 为一位用户）为一名用户，其应用程序信息是一个
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/03/2022
...
description: Schabi 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/8ddc9e63-e032-4639-afa6-b7c806303212" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003728" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Schule 提供给 Microsoft 的信息是一个表示为一个 Microsoft 的一个组：
...
| 合作伙伴公司名称 | Schule am Bildschirm GmbH |
| 公司网站 | [https://web.schabi.ch](https://web.schabi.ch) |
| 应用的使用条款 | [https://www.schabi.ch/Info/AGB](https://www.schabi.ch/Info/AGB) |
| 应用的核心功能 | 在Schabi-Hausaufgaben中Schabi-Seiten一个Microsoft Teams！ |
| 公司总部位置 | Switzerland（瑞士） |
| 应用信息页面 | [https://web.schabi.ch](https://web.schabi.ch) |
...
此信息由 Schule am 则由一位用户提供，这些信息与此应用程序如何收集和存储组织数据以及组织将拥有对应用收集的数据的控制有关。
...
| 隐私策略 URL | https://www.schabi.ch/Info/Datenschutz |
