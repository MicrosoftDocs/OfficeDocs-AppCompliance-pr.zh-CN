...
description: ArcGIS 地图的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
---
# <a name="arcgis-maps-application-information"></a>ArcGIS 地图应用程序信息

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 7 月 27 日</p>

* <a href="https://teams.microsoft.com/l/app/ba4eda44-cd55-4e15-855c-0debafb0490b" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002859" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Esri 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Esri |
| 公司的网站 | [https://www.esri.com](https://www.esri.com) |
| 应用的使用条款 | [https://www.esri.com/en-us/legal/terms/master-agreement-pro...](https://www.esri.com/en-us/legal/terms/master-agreement-product) |
| 应用的核心功能 | ArcGIS Online 包括一套应用、权威地图和数千个主题上的数据、可视化数据所需的新式映射工具、用于发现和传达数据中有意义的模式的分析以及管理工具，以便轻松管理人员和内容，并使每个人都能够创建和共享地图。 ArcGIS 使组织中的每个人都能够随时随地发现、使用、制作和共享来自任何设备的地图。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://www.esri.com/en-us/about/esri-partner-network/our-p...](https://www.esri.com/en-us/about/esri-partner-network/our-partners/global-alliances/microsoft-esri/overview) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
Esri 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
| 应用是否支持条件访问策略？ | 是 |
| 列出支持的策略类型 | ArcGIS Online 依赖于基于角色访问控制 (RBAC) 模型。 解决方案中的所有用户都需要具有他们有权访问的角色。 |
| 应用是否支持持续访问评估 (CAE)  |  |
| 应用是否在代码中存储任何凭据？ |  |
