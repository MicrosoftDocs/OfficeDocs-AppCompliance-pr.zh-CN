...
| 公司网站 | [https://www.appspace.com](https://www.appspace.com) |
| 应用的使用条款 | [https://www.appspace.com/legal/user-agreement/](https://www.appspace.com/legal/user-agreement/) |
| 应用的核心功能 | Appspace 是一个通信和空间管理平台，可帮助你的企业随时随地组织高效工作。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
| 应用是否遵守 SOC 2 (服务组织) ？ | 是 |
| 你获得哪种 SOC 2 认证？ |   |
| 最新 SOC2 认证日期 |  2020-11-09 |
| 应用是否遵守 SOC 3 (服务组织) ？ | 是 |
| 最新 SOC3 认证日期 |  2020-11-09 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Team.ReadBasic.All | delegated | 获取用户所属的团队。 | [a9a866c4-e5cf-47f2-932c-db14cb89008f](https://docs.microsoft.com/microsoft-365-app-certification/azure/a9a866c4-e5cf-47f2-932c-db14cb89008f) |
>| User.ReadBasic.All | delegated | 代表登录用户读取组织中其他用户的基本个人资料属性。 其中包括显示名称、名字和姓氏、电子邮件地址、开放扩展和照片。 此外，还允许应用读取已登录用户的完整个人资料。 | [a9a866c4-e5cf-47f2-932c-db14cb89008f](https://docs.microsoft.com/microsoft-365-app-certification/azure/a9a866c4-e5cf-47f2-932c-db14cb89008f) |
