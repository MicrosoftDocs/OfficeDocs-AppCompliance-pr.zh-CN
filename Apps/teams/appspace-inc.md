...
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://www.appspace.com](https://www.appspace.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | GCP |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Team.ReadBasic.All | delegated | 获取用户所属的团队。 | [a9a866c4-e5cf-47f2-932c-db14cb89008f](../azure/a9a866c4-e5cf-47f2-932c-db14cb89008f.md) |
>| User.ReadBasic.All | delegated | 代表登录用户读取组织中其他用户的基本个人资料属性。 其中包括显示名称、名字和姓氏、电子邮件地址、开放扩展和照片。 此外，还允许应用读取已登录用户的完整个人资料。 | [a9a866c4-e5cf-47f2-932c-db14cb89008f](../azure/a9a866c4-e5cf-47f2-932c-db14cb89008f.md) |
