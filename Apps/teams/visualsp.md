...
| 合作伙伴公司名称 | VisualSP |
| 公司网站 | |
| 应用的使用条款 | [https://www.visualsp.com/terms-of-service](https://www.visualsp.com/terms-of-service) |
| 应用的核心功能 | 提供对最终用户Microsoft 365内容和你自己的自定义培训的即时访问权限 |
| 公司总部位置 |  |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
| **Information** | **响应** |
|:----------------|:-------------|
| 该应用是否遵守 HIPAA (的健康保险可移植) ？ |  |
| 应用是否遵守运行状况信息信任联盟、COMMON Security Framework (HITRUST CSF) ？ |  |
| 应用是否遵守 SOC 1 (服务组织) ？ |  |
| 最新 SOC1 认证日期 | |
| 应用是否遵守 SOC 2 (服务组织) ？ |  |
| 你获得哪种 SOC 2 认证？ | |
...
| 应用是否遵守 SOC 3 (服务组织) ？ |  |
| 最新 SOC3 认证日期 | |
| 您是否针对应用程序及其支持环境执行 PCI DSS 年度评估？ |  |
| 应用程序国际标准化组织 (ISO 27001) 认证？ |  |
| 应用是否符合国际标准化组织 (ISO 27018) ？ |  |
| 应用是否符合国际标准化组织 (ISO 27017) ？ |  |
| 应用是否符合国际标准化组织 (ISO 27002) ？ |  |
| FedRAMP 应用程序联邦风险和授权管理 (是否符合) 标准？ |  |
| 应用是否遵守 FERPA (家庭教育权和隐私) ？ |  |
| 该应用是否遵守 COPPA (《儿童在线隐私保护) ？ |  |
| 应用是否遵守 SOX Sarbanes-Oxley (《) ？ |  |
| 应用是否符合 NIST 800-171？ |  |
| 该应用已通过云安全联盟 (CSA Star) 认证？ |  |
...
| **Information** | **响应** |
|:----------------|:-------------|
| 应用程序是否与 Microsoft 标识平台 (Azure AD) 单一登录、API 访问等集成？ |  |
...
| 你的应用是否支持 CAE (连续访问)  |  |
| 你的应用是否将任何凭据存储在代码中？ |  |
| 适用于应用的应用和外接程序Microsoft 365 Microsoft 应用程序外部的其他 Microsoft GRAPH。 您的应用程序或外接程序是否使用其他 Microsoft API？ |  |
