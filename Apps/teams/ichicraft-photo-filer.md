...
description: Photo Filer 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "64463743"
---
# <a name="photo-filer"></a>Photo Filer

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 2 月 25 日</p>

* <a href="https://teams.microsoft.com/l/app/28fdbeb3-f306-4d78-a1d8-2c1bef32e6ea" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003881" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Ichicraft 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Ichicraft |
| 公司网站 | [https://photofiler.ichicraft.com](https://photofiler.ichicraft.com) |
| 应用的使用条款 | [https://photofiler.ichicraft.com/terms/](https://photofiler.ichicraft.com/terms/) |
| 应用的核心功能 | 在邮箱中共享和存档照片的最简单Microsoft Teams。 |
| 公司总部位置 | 荷兰 ()  |
| 应用信息页面 | [https://photofiler.ichicraft.com](https://photofiler.ichicraft.com) |
...
Ichicraft 提供了此信息，这些信息与该应用如何收集和存储组织数据以及你的组织将拥有对应用收集的数据的控制有关。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | delegated | 创建包含用户上载的照片小摘要的聊天消息。 | [e54fe734-bab8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |
>| Files.ReadWrite.All | delegated | 读取文件夹中的文件夹结构和上载SharePoint 文档库。 | [e54fe734-bab8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |
>| User.Read | delegated | 从用户配置文件中读取。 | [e54fe734-bab8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |
