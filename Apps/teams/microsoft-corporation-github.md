...
description: 适用于GitHub的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/ca9e26b7-dce5-44a0-b2b7-a70a3d65ce25" target="_blank">Teams存储区中的视图</a>
...
| 公司的网站 | [https://github.com](https://github.com) |
| 应用的使用条款 | [https://github.com/site/terms](https://github.com/site/terms) |
| 应用的核心功能 | GitHub是用于协作和版本控制的代码托管平台。 它允许开发人员从规划和编码到交付软件，共同处理其项目。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://teams.github.com](https://teams.github.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
Microsoft Corporation 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
