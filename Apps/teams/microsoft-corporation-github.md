...
| 公司网站 | [https://github.com](https://github.com) |
| 应用的使用条款 | [https://github.com/site/terms](https://github.com/site/terms) |
| 应用的核心功能 | GitHub是一个代码托管平台，用于协作和版本控制。 它允许开发人员一起处理他们的项目，从规划和编码到交付软件。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://teams.github.com](https://teams.github.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
