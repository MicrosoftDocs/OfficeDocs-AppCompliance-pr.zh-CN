---
title: Hootsuite Inc. 的 Hootsuite Amplify 应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
description: Hootsuite 为放大提供的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/08d9aab9-a8f3-4f65-91e2-a33ef9bad6bb" target="_blank">Teams存储区中的视图</a>
...
| 公司的网站 | [https://www.hootsuite.com](https://www.hootsuite.com) |
| 应用的使用条款 | [https://www.hootsuite.com/legal/eula](https://www.hootsuite.com/legal/eula) |
| 应用的核心功能 | 将内容从Microsoft Teams共享到团队社交频道，由 Hootsuite Amplify 提供支持。 |
| 公司总部位置 | 加拿大 |
| 应用信息页 | [https://www.hootsuite.com/about/contact-us](https://www.hootsuite.com/about/contact-us) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
Hootsuite Inc. 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
