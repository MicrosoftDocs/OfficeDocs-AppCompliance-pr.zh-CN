---
title: Hootsuite by Hootsuite 公司为 Hootsuite 提供的应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
description: Hootsuite 提供的所有适用于为用户提供的安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/08d9aab9-a8f3-4f65-91e2-a33ef9bad6bb" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003153" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Hootsuite Inc. 提供给 Microsoft 的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | Amplify by Hootsuite |
| ID | WA200003153 |
| Office 365客户端 | Microsoft Teams |
| 合作伙伴公司名称 | Hootsuite Inc. |
| 公司网站 | [https://www.hootsuite.com](https://www.hootsuite.com) |
| 应用的使用条款 | [https://www.hootsuite.com/legal/eula](https://www.hootsuite.com/legal/eula) |
| 应用的核心功能 | 由 Hootsuite Microsoft Teams团队社交频道共享内容。 |
| 公司总部位置 | 加拿大 |
| 应用信息页面 | [https://www.hootsuite.com/about/contact-us](https://www.hootsuite.com/about/contact-us) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
此信息由 Hootsuite Inc. 提供，用于了解此应用程序如何收集和存储组织数据，以及您的组织将拥有对应用收集的数据的控制。
