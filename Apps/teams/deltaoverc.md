...
>|   **Graph权限**  | **权限类型** |          **字距调整**          |
>|:------------------------|:--------------------|:------------------------------------|
>| Group.Read.All | 两者 | 读取所有组 |
>| Group.ReadWrite.All | 两者 | 读取和写入所有组 |
>| User.Read | delegated | 登录并读取用户个人资料 |
>| User.Read.All | 应用程序 | 读取所有用户的完整个人资料 |
>| User.ReadWrite | delegated | 对用户个人资料的读写权限 |
>| User.ReadWrite.All | 两者 | 读取和写入所有用户的完整个人资料 |
