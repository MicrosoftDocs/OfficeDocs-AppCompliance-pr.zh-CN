---
title: 由 GLOBAL CONGRESS SRL 提供的 Rafiky 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/20/2021
...
description: 所有可用于 Rafiky 的安全性和合规性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/c4661f80-2c9c-42d4-aec5-5ed6d64adb4d" target="_blank">Teams存储区中的视图</a>
...
GLOBAL CONGRESS SRL 提供给 Microsoft 的信息：
...
| 公司的网站 | [https://rafiky.net/en/](https://rafiky.net/en/) |
| 应用的使用条款 | [https://rafiky.net/en/terms-conditions/](https://rafiky.net/en/terms-conditions/) |
| 应用的核心功能 | Rafiky 是一种极其灵活且易于访问的云平台解决方案，旨在为联机事件执行远程同时解释。 它&#8217;远程解释的独特和创新的愿景：它允许专业翻译随时随地工作。 |
| 公司总部位置 | Italy（意大利） |
| 应用信息页 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
GLOBAL CONGRESS SRL 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
