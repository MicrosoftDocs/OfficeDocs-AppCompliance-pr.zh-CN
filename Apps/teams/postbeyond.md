---
title: PostBeyond by PostBeyond 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: PostBeyond 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/6e588f9e-5271-4583-b373-7991497deaec" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | PostBeyond |
| 公司的网站 | [https://www.postbeyond.com](https://www.postbeyond.com) |
| 应用的使用条款 | [https://www.postbeyond.com/terms-of-use/](https://www.postbeyond.com/terms-of-use/) |
| 应用的核心功能 | 通过 PostBeyond 支持的员工宣传，激活社交媒体倡导者，以提高品牌知名度、参与度和可衡量的结果。 在整个员工社交网络中放大最佳内容，为品牌提供应有的关注。 我们使扩展员工的宣传功能对营销人员非常强大，并且为员工带来令人愉快的轻松。  |
| 公司总部位置 | 加拿大 |
| 应用信息页 | [https://www.postbeyond.com/product/](https://www.postbeyond.com/product/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
PostBeyond 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
