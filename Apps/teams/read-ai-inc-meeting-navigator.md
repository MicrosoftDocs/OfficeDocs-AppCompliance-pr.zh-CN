---
title: Read AI 公司读取会议导航器的应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/15/2022
...
description: 读取会议导航器的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "65357038"
---
# <a name="read-meeting-navigator"></a>读取会议导航器

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 4 月 15 日</p>

* <a href="https://teams.microsoft.com/l/app/18eb20ae-cd59-48c6-8060-fbe171a917e5" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003896" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Read AI， Inc. 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Read AI, Inc. |
| 公司的网站 | [https://read.ai](https://read.ai) |
| 应用的使用条款 | [https://read.ai/tos](https://read.ai/tos) |
| 应用的核心功能 | 读取仪表板可度量会议情绪、参与度和整体性能。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://www.read.ai/product](https://www.read.ai/product) |
...
Read AI， Inc. 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 用户配置文件数据、会议音频数据和会议视频数据  |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 用户配置文件数据，聚合派生自音频和视频数据的用户指标 |
...
| 隐私策略 URL | https://read.ai/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 委托 | 我们允许用户将其日历与我们的服务链接，以启用 Azure 媒体机器人的自动调度 | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| Calls.AccessMedia.All | 应用程序 | 访问会议音频和视频数据以进行应用程序处理 | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| Calls.JoinGroupCall.All | 应用程序 | 我们需要 Azure 媒体机器人加入正在进行的Teams会议的联接权限 | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| User.Read | 委托 | 作为 SSO 过程的一部分，我们通过请求用户配置文件的读取权限来访问所需的用户数据 | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| 电子邮件 | 委托 | 我们需要电子邮件地址作为帐户创建过程的一部分  | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| openid | 委托 | 我们允许用户通过 SSO 登录 | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| 个人资料 | 委托 | 我们需要用户配置文件数据来创建用户帐户 (名字和姓氏，具体)  | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
