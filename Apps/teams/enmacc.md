...
| 合作伙伴公司名称 | enmacc |
| 公司网站 | [https://enmacc.com](https://enmacc.com) |
| 应用的使用条款 | [https://enmacc.com/terms_en.html](https://enmacc.com/terms_en.html) |
| 应用的核心功能 | 接收 Microsoft Teams 中所有的 enmacc 实时能源交易Microsoft Teams。 |
| 公司总部位置 | 德国 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
