...
description: 所有可用于 enmacc 的安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/260128ec-36bf-49df-956f-7102feba3e49" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | enmacc |
| 公司的网站 | [https://enmacc.com](https://enmacc.com) |
| 应用的使用条款 | [https://enmacc.com/terms_en.html](https://enmacc.com/terms_en.html) |
| 应用的核心功能 | 接收Microsoft Teams中的所有实时能源交易活动。 |
| 公司总部位置 | 德国 |
| 应用信息页 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
此信息已通过 enmacc 提供，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
