...
description: 适用于 Achievers 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66912910"
---
# <a name="achievers"></a>成就

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 10 月 28 日</p>

* <a href="https://teams.microsoft.com/l/app/76903584-359f-4e1e-9f6e-741f48322709" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000573" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Achievers 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | 成就 |
| 公司的网站 | [https://www.achievers.com](https://www.achievers.com) |
| 应用的使用条款 | [https://developer.achievers.com/docs/achievers-terms-of-use](https://developer.achievers.com/docs/achievers-terms-of-use) |
| 应用的核心功能 | 在“成就者”平台中为同事创建识别，在 Microsoft 生态系统中减少摩擦。 |
| 公司总部位置 | 加拿大 |
| 应用信息页 | [https://www.achievers.com/connect/teams/](https://www.achievers.com/connect/teams/) |
...
Achievers 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 否 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 可访问 |
| 数据库中存储了哪些数据？ | 租户 ID、用户 ID、用户电子邮件、用户区域设置、机器人 ID、机器人名称、机器人服务 URL |
...
| 隐私策略 URL | https://over.achievers.com/ilr_privacy_policy |
