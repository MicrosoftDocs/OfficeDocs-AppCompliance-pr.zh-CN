...
description: Digiplein 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/9a58f891-dad9-4c01-bf1a-3c418fb6b282" target="_blank">Teams存储区中的视图</a>
...
| 公司的网站 | [https://www.uitgeversgroep.nl](https://www.uitgeversgroep.nl) |
...
| 公司总部位置 | 荷兰 ()  |
| 应用信息页 | [https://www.uitgeversgroep.nl/digiplein](https://www.uitgeversgroep.nl/digiplein) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
此信息由 Educatieve Uitgeversgroep B.V 提供。 关于此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
