...
| 应用的核心功能 | Cerkl 广播将员工受众与组织&#8217;重要通信。 使用基于行为的个性化设置，广播在正确的时间在正确的频道上向合适的员工传递正确的消息。 这就是&#8217;我们真正从竞争中分离出来的地方 - 允许不同通信者跨渠道进行通信，而不需要重复工作。 广播还提供了业界领先的指标，帮助客户了解哪些&#8217;适合其受众。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegated | 收集用户的电子邮件，并用于查看用户当前是否在我们的系统中并且是否由组织添加。 | [74ef25ab-3685-446c-aa43-4e9cc251ed62](https://docs.microsoft.com/microsoft-365-app-certification/azure/74ef25ab-3685-446c-aa43-4e9cc251ed62) |
