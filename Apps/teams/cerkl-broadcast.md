...
description: 所有可用于广播的安全性和合规性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/cfdaef91-3bae-4545-a571-b86b1685857f" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | <2>点子 |
| 公司的网站 | [https://cerkl.com](https://cerkl.com) |
| 应用的使用条款 | [https://cerkl.com/terms](https://cerkl.com/terms) |
| 应用的核心功能 | Cerkl Broadcast 将员工受众与其组织连接&#8217;重要通信。 使用基于行为的个性化设置，广播会在正确的时间在正确的频道上向正确的员工传递正确的消息。 这&#8217;我们真正从竞争中脱颖而出的地方——我们允许精明的沟通者跨渠道沟通，而无需重复努力。 广播还提供行业领先的指标，帮助客户了解&#8217;为受众工作的内容。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://cerkl.com/broadcast/microsoft-teams/](https://cerkl.com/broadcast/microsoft-teams/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | GCP |
...
Cerkl 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | 收集用户的电子邮件，用于查看用户当前是否在我们的系统中，并且是由组织添加的。 | [74ef25ab-3685-446c-aa43-4e9cc251ed62](../azure/74ef25ab-3685-446c-aa43-4e9cc251ed62.md) |
