...
| 公司网站 | [https://evocom.de](https://evocom.de) |
| 应用的使用条款 | [https://evocom.de/termsofuse](https://evocom.de/termsofuse) |
| 应用的核心功能 | Evocom&#180;USP = 简单。 Evocom 是一个直观的解决方案，用于协作工作流、项目和任务管理。 信息工作者设计过程，并让他们立即工作。 部门中的人员使用 Evocom 将协调内部工作的微型流程数字化。 流程专家协调跨部门流程，使用来自部门的微流程，并利用与 LOB 系统（如 CRM、ERP 和其他系统）的现有集成。 |
| 公司总部位置 | 德国 |
| 应用信息页面 | [https://evocom.de/microsoft365](https://evocom.de/microsoft365) |
...
| 隐私策略 URL | https://evocom.de/datenschutz |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegated | 分析子 anzeigen | [3e745135-a761-48a7-ab54-5c0277b2e642](../azure/3e745135-a761-48a7-ab54-5c0277b2e642.md) |
