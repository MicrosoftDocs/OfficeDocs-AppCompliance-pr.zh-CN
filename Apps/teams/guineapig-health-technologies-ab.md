---
title: 由都吉斯巴达健康技术 AB 为巴布亚新几内亚提供的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/20/2022
...
ms.locfileid: "63543940"
---
# <a name="guineapig"></a>GuineaPig

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 10 月 29 日</p>

* <a href="https://teams.microsoft.com/l/app/75b23a20-bc91-4485-b4a4-a156fe37fe9b" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003486" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

由通过为 Microsoft 提供的由通过通过"通过""服务"向 Microsoft 提供的信息：
...
| 公司总部位置 | 瑞典 |
| 应用信息页面 | [https://guineapig.app](https://guineapig.app) |
...
这些数据由且由且由"且"运行状况技术 AB 提供，用于了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegated | 我们使用 User.Read 读取用户名等信息，以在聊天和选项卡等内容中使用它。 https://www.guineapig.app/privacy-policy 请访问 获取详细说明。 | [d6a2090f-1447-456b-bd5f-121e4efd8c89](../azure/d6a2090f-1447-456b-bd5f-121e4efd8c89.md) |
