...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| User.Read | 应用程序 | 在身份验证过程中， &amp; 我们使用电子邮件地址的完整名称。 另外，电子邮件地址用于在用户订阅学习序列时向用户发送学习序列 | 在身份验证过程中， &amp; 我们使用电子邮件地址的完整名称。 另外，电子邮件地址用于在用户订阅学习序列时向用户发送学习序列 | b256b34a-b377-4fc2-b25a-a8f5f0594e86 |
