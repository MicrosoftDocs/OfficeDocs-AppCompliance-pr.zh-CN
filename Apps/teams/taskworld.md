...
description: Taskworld 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/f8be25a9-34d4-499f-9464-d5d3792de6bf" target="_blank">在应用商店Teams视图</a>
...
| 合作伙伴公司名称 | Taskworld |
| 公司网站 | [https://taskworld.com](https://taskworld.com) |
| 应用的使用条款 | [https://taskworld.com/terms-privacy-security/customer-terms...](https://taskworld.com/terms-privacy-security/customer-terms-of-service/) |
| 应用的核心功能 | 在任务中接收 Taskworld Teams更有效地协作！ |
| 公司总部位置 | 新加坡 |
| 应用信息页面 | |
...
此信息由 Taskworld 提供，用于了解此应用程序如何收集和存储组织数据，以及组织将拥有对应用收集的数据的控制。
...
| 隐私策略 URL | https://taskworld.com/terms-privacy-security/privacy/ |
