---
title: Kanban Tool by Shore Labs 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Kanban 工具的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/b3c15d4f-1972-4836-a1eb-7575dd56a17e" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | Shore Labs |
| 公司的网站 | [https://www.shorelabs.com](https://www.shorelabs.com) |
| 应用的使用条款 | [https://kanbantool.com/policy/terms-of-service](https://kanbantool.com/policy/terms-of-service) |
| 应用的核心功能 | 可视化看板上的工作和跟踪时间。 |
| 公司总部位置 | Poland（波兰） |
| 应用信息页 | [https://kanbantool.com](https://kanbantool.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS、SelfHosted、GCP |
...
Shore Labs 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| 电子邮件 | 委托 | 用于通信、标识匹配和通知传递的用户电子邮件地址。 | [4e820d60-9e62-403c-accd-857b987cc13c](../azure/4e820d60-9e62-403c-accd-857b987cc13c.md) |
>| Team.ReadBasic.All | 委托 | 用户是其直接成员的团队的标识符和名称。 它们用于自动将用户分配到看板工具中的更正组。 | [a8ead1a3-85e1-42a3-9ed0-9afb97482b31](../azure/a8ead1a3-85e1-42a3-9ed0-9afb97482b31.md) |
>| User.Read | 委托 | 已登录用户的基本公司信息。 它用于填充新帐户的帐户详细信息，并识别属于组织中的用户，以便提供单Sign-On功能。 | [a8ead1a3-85e1-42a3-9ed0-9afb97482b31](../azure/a8ead1a3-85e1-42a3-9ed0-9afb97482b31.md) |
>| offline_access | 委托 | 允许“使用 Microsoft 登录”功能，并在用户登录后同步已授予应用访问权限的数据。 | [a8ead1a3-85e1-42a3-9ed0-9afb97482b31](../azure/a8ead1a3-85e1-42a3-9ed0-9afb97482b31.md) |
>| openid | 委托 | 打开 ID 令牌，允许用户通过“使用 Microsoft 登录”按钮使用其工作或学校帐户登录到应用。 | [a8ead1a3-85e1-42a3-9ed0-9afb97482b31](../azure/a8ead1a3-85e1-42a3-9ed0-9afb97482b31.md) |
>| 个人资料 | 委托 | 在看板工具中自动填充并保持与Microsoft Teams中的更改同步的用户名。 | [a8ead1a3-85e1-42a3-9ed0-9afb97482b31](../azure/a8ead1a3-85e1-42a3-9ed0-9afb97482b31.md) |
