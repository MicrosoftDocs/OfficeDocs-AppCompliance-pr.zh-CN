---
title: Orca by ORCA SECURITY LTD 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: Orca 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "65874211"
---
# <a name="orca"></a>逆 戟 鲸

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 5 月 27 日</p>

* <a href="https://teams.microsoft.com/l/app/50423b81-408b-4699-a850-9a0514ee42c3" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004132" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

ORCA SECURITY LTD 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | ORCA 安全性 LTD |
| 公司的网站 | [https://orca.security](https://orca.security) |
| 应用的使用条款 | [https://orca.security/terms-of-use](https://orca.security/terms-of-use) |
| 应用的核心功能 | Orca Security for Microsoft Teams 提供云环境安全状态的实时图片。 使用一个视图中组合的这两个工具，用户可以围绕云环境中的安全问题进行高效讨论，Orca 警报详细介绍了特定的云风险，其中包括安全风险发现结果和构成风险的已连接云资源。 |
| 公司总部位置 | Israel（以色列） |
| 应用信息页 | |
...
ORCA SECURITY LTD 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | Teams用户 ID、团队 ID、团队名称 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | Teams用户 ID、团队 ID、团队名称 |
...
| 隐私策略 URL | https://orca.security/privacy-policy/ |
