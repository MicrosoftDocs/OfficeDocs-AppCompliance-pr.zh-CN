...
| 应用的核心功能 | 我们获得奖励的在线培训课程库现在直接在 Microsoft Teams。  通过在任何频道中添加"放大"选项卡，轻松访问 180 多个电子课程和 3000 多个视频课程。 可用主题包括：Microsoft Teams &amp; Office 365Microsoft Excel、Word、Outlook、PowerPoint、Power BI 和业务主题。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://usedapplicensing001.azurewebsites.net/teamsApp/inde...](https://usedapplicensing001.azurewebsites.net/teamsApp/index.html) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
| 应用是否遵守 SOC 1 (服务组织) ？ | 是 |
| 最新 SOC1 认证日期 |  2021-05-13 |
| 应用是否遵守 SOC 2 (服务组织) ？ | 是 |
| 你获得哪种 SOC 2 认证？ |   |
| 最新 SOC2 认证日期 |  2021-05-13 |
| 应用是否遵守 SOC 3 (服务组织) ？ | 是 |
| 最新 SOC3 认证日期 |  2021-05-13 |
