...
description: 大大脑 eLearning 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/12345514-afee-abcd-acde-c5b34109abcd" target="_blank">Teams存储区中的视图</a>
...
Biggerbrains 提供给 Microsoft 的信息：
...
| 公司的网站 | [https://getbiggerbrains.com](https://getbiggerbrains.com) |
| 应用的使用条款 | [https://getbiggerbrains.com/privacy-legal/](https://getbiggerbrains.com/privacy-legal/) |
| 应用的核心功能 | 我们屡获殊荣的在线培训课程库现在直接在Microsoft Teams中提供。  通过在任何频道中添加“更大的大脑”选项卡，轻松访问超过 180 个 eLearning 课程和 3000 多节视频课程。 可用主题包括：Microsoft Teams &amp; Office 365Microsoft Excel、Word、Outlook、PowerPoint、Power BI 和业务主题。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://usedapplicensing001.azurewebsites.net/teamsApp/inde...](https://usedapplicensing001.azurewebsites.net/teamsApp/index.html) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
Biggerbrains 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
| 最新的 SOC1 认证日期 | 2021-05-13 |
| 应用是否符合服务组织控制 (SOC 2) ？ | 可访问 |
| 最新的 SOC2 认证日期 | 2021-05-13 |
| 应用是否符合服务组织控制 (SOC 3) ？ | 可访问 |
| 最新的 SOC3 认证日期 | 2021-05-13 |
