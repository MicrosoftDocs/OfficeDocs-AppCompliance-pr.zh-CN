---
title: Asa by Two App Studio Pte Ltd 的应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/09/2021
...
description: Asa 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/2973405f-6e3b-45a3-a3a4-7c85d8d3be88" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003449" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Two App Studio Pte Ltd. 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Two App Studio Pte Ltd. |
| 公司网站 | [https://asa.team](https://asa.team) |
| 应用的使用条款 | [https://asa.team/terms](https://asa.team/terms) |
| 应用的核心功能 | 远程工作区管理工具 |
| 公司总部位置 | 新加坡 |
| 应用信息页面 | [https://asa.team](https://asa.team) |
...
此信息由 Two App Studio Pte Ltd. 提供，用于了解此应用程序如何收集和存储组织数据，以及您的组织将拥有对应用收集的数据的控制。
...
| 数据库中存储了哪些数据？ | microsoft tenantId 用于用户及其发送自动程序消息的组 |
...
| 隐私策略 URL | https://asa.team/privacypolicy |
