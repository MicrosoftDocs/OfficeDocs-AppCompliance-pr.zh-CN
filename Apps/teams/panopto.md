---
title: Panopto 的 Panopto 应用程序信息
ms.author: elmalova
author: elenamalova
ms.date: 03/07/2022
ms.topic: article
...
description: Panopto 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "63080989"
---
# <a name="panopto"></a>Panopto

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 2 月 22 日</p>

* <a href="https://teams.microsoft.com/l/app/adb3c870-c01c-11eb-a2cc-4dbd838985a1" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003801" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Panopto 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Panopto |
| 公司网站 | [https://www.panopto.com](https://www.panopto.com) |
| 应用的使用条款 | [https://www.panopto.com/terms-of-service/](https://www.panopto.com/terms-of-service/) |
| 应用的核心功能 | 将Teams录制导出到 Panopto 并搜索、共享和查看 Panopto 视频，而无需离开Teams。  添加诸如每个会议可视索引和经人工验证的隐藏式字幕等功能。 无需离开 Teams 即可访问 Panopto 功能：创建映射到 Panopto 文件夹的新频道选项卡;搜索和共享 Panopto 视频;在安排的会议中演示 Panopto 视频;以及准备好新的 Panopto 视频后接收通知。 需要 Panopto 网站？ 请访问 www.panopto.com/plans 开始。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
...
Panopto 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及您的组织将拥有对应用收集的数据的控制有关。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础基础结构是否处理与 Microsoft 客户或他们的设备相关的任何数据？ | 否 |
| 应用或基础基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 会议Teams和频道Teams元数据。 |
...
| 最新 SOC2 认证日期 |  2021-08-19 |
| 应用是否遵守 SOC 3 (服务组织) ？ | 是 |
| 最新 SOC3 认证日期 |  2021-10-13 |
...
| 隐私策略 URL | https://www.panopto.com/privacy/ |
