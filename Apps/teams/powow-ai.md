...
>|   **Graph权限**  | **权限类型** |          **字距调整**          |
>|:------------------------|:--------------------|:------------------------------------|
>| User.Read.All | 应用程序 | 用于搜索连接器 (将 Powow 数据推送到 Microsoft 索引中，以在搜索Microsoft 服务)  |
>| ExternalItem.ReadWrite.All | 应用程序 | 用于搜索连接器 (将 Powow 数据推送到 Microsoft 索引中，以在搜索Microsoft 服务)  |
>| email | delegated | 查看用户的电子邮件地址进行注册和登录 |
