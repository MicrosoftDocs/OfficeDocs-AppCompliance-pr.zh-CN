...
>|   **Graph权限**  | **权限类型** |          **字距调整**          |
>|:------------------------|:--------------------|:------------------------------------|
>| User.Read.All | 应用程序 | 用于搜索连接器 (功能将 Powow 数据推送到 Microsoft 索引中，以在搜索Microsoft 服务)  |
>| ExternalItem.ReadWrite.All | 应用程序 | 用于搜索连接器 (功能将 Powow 数据推送到 Microsoft 索引中，以在搜索Microsoft 服务)  |
>| 电子邮件 | delegated | 查看用户的电子邮件地址进行注册和登录 |
>| offline_access | delegated | 若要访问应用程序内的用户数据， (跟踪日历)  |
>| openid | delegated | 让用户登录 |
>| 个人资料 | delegated | 访问用户的基本个人资料信息进行注册 |
>| User.Read | delegated | 登录并读取用于注册和登录的用户配置文件 |
