...
| 合作伙伴公司名称 | 存储变得简单 |
| 公司网站 | [https://storagemadeeasy.com](https://storagemadeeasy.com) |
| 应用的使用条款 | [https://www.storagemadeeasy.com/terms](https://www.storagemadeeasy.com/terms) |
| 应用的核心功能 | 搜索、浏览、编辑和共享存储在 Azure 文件、Azure Blob 存储和其他存储中的文件。 |
| 公司总部位置 | 英国大英和爱尔兰 ()  |
| 应用信息页面 | [https://docs.storagemadeeasy.com/microsoft-teams](https://docs.storagemadeeasy.com/microsoft-teams) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | SelfHosted、Azure、AWS、GCP、IBMCloud、Users 可能会连接到 Wasabi、Backblaze、Cloudian、Dropbox、Box.com、Salesforce、S3-Compatible、FTP 和 WebDAV 服务 |
...
此信息由"轻松存储此应用如何收集和存储组织数据以及组织将拥有对应用收集的数据的控制的信息。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite | 应用程序 | 当用户通过应用下载、上载或编辑指定文件时读取或写入的文件数据。 | [0752d800-857f-49bd-87eb-e60985516c67](../azure/0752d800-857f-49bd-87eb-e60985516c67.md) |
>| Sites.ReadWrite.All | 应用程序 | 为跨所有文件服务&#8217;提供联合视图的文件和文件夹收集的元数据。 | [0752d800-857f-49bd-87eb-e60985516c67](../azure/0752d800-857f-49bd-87eb-e60985516c67.md) |
