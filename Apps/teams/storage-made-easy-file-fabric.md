...
此信息由用户存储轻松使用，了解如何收集和存储组织数据，以及组织将拥有对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite | 应用程序 | 当用户通过应用下载、上载或编辑指定文件时读取或写入的文件数据。 | [0752d800-857f-49bd-87eb-e60985516c67](https://docs.microsoft.com/microsoft-365-app-certification/azure/0752d800-857f-49bd-87eb-e60985516c67) |
>| Sites.ReadWrite.All | 应用程序 | 为每个用户收集的元数据&#8217;跨所有文件服务提供联合视图的文件和文件夹。 | [0752d800-857f-49bd-87eb-e60985516c67](https://docs.microsoft.com/microsoft-365-app-certification/azure/0752d800-857f-49bd-87eb-e60985516c67) |
