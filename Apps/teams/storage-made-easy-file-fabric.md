...
description: File Fabric 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/bd063a87-1e4d-42cf-baea-8cab71839e35" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | 存储变得简单 |
| 公司的网站 | [https://storagemadeeasy.com](https://storagemadeeasy.com) |
| 应用的使用条款 | [https://www.storagemadeeasy.com/terms](https://www.storagemadeeasy.com/terms) |
| 应用的核心功能 | 搜索、浏览、编辑和共享存储在Azure 文件存储、Azure Blob 存储和其他存储中的文件。 |
| 公司总部位置 | 大不列颠及北爱尔兰联合王国 ()  |
| 应用信息页 | [https://docs.storagemadeeasy.com/microsoft-teams](https://docs.storagemadeeasy.com/microsoft-teams) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | SelfHosted、Azure、AWS、GCP、IBMCloud、用户可以连接到 Wasabi、Backblaze、Cloudian、Dropbox、Box.com、Salesforce、S3 兼容、FTP 和 WebDAV 服务 |
...
存储轻松地提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite | 应用程序 | 当用户通过应用下载、上传或编辑指定文件时读取或写入的文件数据。 | [0752d800-857f-49bd-87eb-e60985516c67](../azure/0752d800-857f-49bd-87eb-e60985516c67.md) |
>| Sites.ReadWrite.All | 应用程序 | 为提供所有文件服务联合视图的所有用户&#8217;文件和文件夹收集的元数据。 | [0752d800-857f-49bd-87eb-e60985516c67](../azure/0752d800-857f-49bd-87eb-e60985516c67.md) |
