---
title: Workday Peakon Employee Voice by Workday 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/26/2022
...
description: Workday Peakon 员工语音的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
---
# <a name="workday-peakon-employee-voice"></a>Workday Peakon 员工语音

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 7 月 20 日</p>

* <a href="https://teams.microsoft.com/l/app/1c37bec0-d522-4cba-9643-ddc79d841729" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003453" target="_blank">在 AppSource 中查看</a>
...
| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | Workday Peakon 员工语音 |
| ID | WA200003453 |
| 支持Office 365客户端 | Microsoft Teams |
| 合作伙伴公司名称 | Workday |
| 公司的网站 | [https://www.workday.com/en-us/homepage.html](https://www.workday.com/en-us/homepage.html) |
| 应用的使用条款 | [https://nw.myworkday.com/workdaypeakonemployeevoiceforteams...](https://nw.myworkday.com/workdaypeakonemployeevoiceforteams/post-license/) |
| 应用的核心功能 | 获取有关新调查的通知，直接通过Microsoft Teams提醒你尚未完成的调查。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://nw.myworkday.com/workdaypeakonemployeevoiceforteams](https://nw.myworkday.com/workdaypeakonemployeevoiceforteams) |
...
Workday 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 可访问 |
| 应用会处理哪些数据？ | 电子邮件和 Azure Active Director ID - 适用于 MS Teams 应用的 Peakon 不直接处理数据。  |
| 应用是否支持 TLS 1.1 或更高版本？ | 可访问 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 可访问 |
| 数据库中存储了哪些数据？ | 公司 ID、应用程序日志 |
...
| 应用是否具有面向外部的隐私通知，描述它如何收集、使用、共享和存储客户数据？ | 可访问 |
| 隐私策略 URL | https://www.workday.com/en-us/privacy.html |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteForUser.All | 应用程序 | 安装应用并在 Azure 数据库中查找用户   | [075a01db-a69f-4975-a713-aa85d004f3b5](../azure/075a01db-a69f-4975-a713-aa85d004f3b5.md) |
