...
description: SMART 提供的 Lumio 的所有安全和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| 公司网站 | [https://smarttech.com](https://smarttech.com) |
| 应用的使用条款 | [https://www.smarttech.com/legal/sls-terms](https://www.smarttech.com/legal/sls-terms) |
| 应用的核心功能 | 使用活动、评估和学生协作转换课程。 |
| 公司总部位置 | 加拿大 |
| 应用信息页面 | [https://www.smarttech.com/smart-learning-suite/](https://www.smarttech.com/smart-learning-suite/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | delegated | 数据用于验证未收集数据的组权限。  | [14cf575a-fae2-48e2-af39-e3448d3a48bb](../azure/14cf575a-fae2-48e2-af39-e3448d3a48bb.md) |
>| Group.Read.All | delegated | 他们属于哪个组，这用于验证他们是确定功能的学生或教师组的一部分。 未收集数据。  | [14cf575a-fae2-48e2-af39-e3448d3a48bb](../azure/14cf575a-fae2-48e2-af39-e3448d3a48bb.md) |
