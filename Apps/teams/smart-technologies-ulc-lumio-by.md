---
title: SMART By SMART Technologies ULC 的 Lumio 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: Lumio by SMART 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/e0ffcbc7-f3f2-46b7-a189-afd01c545782" target="_blank">Teams存储区中的视图</a>
...
| 公司的网站 | [https://smarttech.com](https://smarttech.com) |
| 应用的使用条款 | [https://www.smarttech.com/legal/sls-terms](https://www.smarttech.com/legal/sls-terms) |
| 应用的核心功能 | 通过活动、评估和学生协作转换课程。 |
| 公司总部位置 | 加拿大 |
| 应用信息页 | [https://www.smarttech.com/smart-learning-suite/](https://www.smarttech.com/smart-learning-suite/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
SMART Technologies ULC 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 委托 | 数据用于验证未收集数据的组权限。  | [14cf575a-fae2-48e2-af39-e3448d3a48bb](../azure/14cf575a-fae2-48e2-af39-e3448d3a48bb.md) |
>| Group.Read.All | 委托 | 他们属于哪个组，这用于验证他们是学生或教师组的一部分来确定功能。 未收集任何数据。  | [14cf575a-fae2-48e2-af39-e3448d3a48bb](../azure/14cf575a-fae2-48e2-af39-e3448d3a48bb.md) |
