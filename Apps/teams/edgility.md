...
description: Edgility 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/fe2f94eb-7164-4fcd-a2c7-16db90307caa" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003970" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Edgility 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Edgility |
| 公司的网站 | [https://edgility.com.au](https://edgility.com.au) |
| 应用的使用条款 | [https://www.edgility.com.au/legal/](https://www.edgility.com.au/legal/) |
| 应用的核心功能 | Edgility 是开发集成企业通信工具的领导者。 通过这些短信解决方案，组织可以简化使用已依赖的平台提醒、宣传、提醒和通知业务相关人员的过程。 其中包括 Microsoft 产品，如 Excel、Outlook 和 Teams。 用户可以通过将短信接收到 Microsoft Outlook 和Teams来充分利用此有效的对话工具。 |
| 公司总部位置 | 澳大利亚 |
| 应用信息页 | [https://www.edgility.com.au/microsoft/teams/](https://www.edgility.com.au/microsoft/teams/) |
...
Edgility 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
