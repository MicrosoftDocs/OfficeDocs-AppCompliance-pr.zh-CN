---
title: COR Global Ltd 的 COR 应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/16/2022
...
description: 适用于 COR 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
<p>开发人员上次更新时间：2021 年 9 月 6 日</p>

* <a href="https://teams.microsoft.com/l/app/1ff72075-1e25-4b42-bd88-3fdbc9d6d34e" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004235" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

COR Global Ltd. 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | COR Global Ltd. |
| 公司的网站 | [https://projectcor.com](https://projectcor.com) |
| 应用的使用条款 | [https://projectcor.com/cor-terms-of-service/](https://projectcor.com/cor-terms-of-service/) |
| 应用的核心功能 | 实时可见性。 COR 是面向专业人员和创意团队的管理解决方案，这些团队巧妙地建议如何使用人工智能管理项目、团队和财务。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://cor.zendesk.com/hc/en-us](https://cor.zendesk.com/hc/en-us) |
...
COR Global Ltd 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
| 隐私策略 URL | https://projectcor.com/cor-privacy-and-personal-data/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.Read.All | 应用程序 | 与 One 驱动器集成 | [e73458d3-c732-4460-bfb2-9da9086fc714](../azure/e73458d3-c732-4460-bfb2-9da9086fc714.md) |
