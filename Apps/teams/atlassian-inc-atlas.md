---
title: Atlassian，Inc. 的 Atlassian 应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/15/2022
...
description: Atlas 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/69883cee-eb8c-41c2-9533-7fdb0762e913" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003760" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Atlassian 公司向 Microsoft 提供的信息：
...
| 合作伙伴公司名称 | Atlassian， Inc. |
| 公司的网站 | [https://atlassian.com](https://atlassian.com) |
| 应用的使用条款 | [https://atlassian.com/legal/cloud-terms-of-service](https://atlassian.com/legal/cloud-terms-of-service) |
| 应用的核心功能 | 解锁团队间更健康的沟通 |
| 公司总部位置 | 澳大利亚 |
| 应用信息页 | |
...
Atlassian 公司提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
