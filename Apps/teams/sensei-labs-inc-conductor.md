...
description: Sensei Labs 一线的所有可用安全性和合规性信息、它的数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| 合作伙伴网站的 URL | [https://www.senseilabs.com](https://www.senseilabs.com) |
...
>|:---------------------------------------|:-----------------------------------|:------------------------------------|
>| 在机器人对话期间正确处理人员。 为了将用户映射到Teams中的用户 | Teams标识符、名称、电子邮件地址 | 将Teams映射到平台中的用户 |
...
>Teams团队成员身份。 客户的实例与Teams实例之间的关联。 数据保留时间，只要他们是一个"一线"客户。 在停用客户的 Instance 实例时或请求时删除
