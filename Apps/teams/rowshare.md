...
| 合作伙伴公司名称 | RowShare |
| 公司网站 | [https://www.rowshare.com](https://www.rowshare.com) |
| 应用的使用条款 | [https://my.rowshare.com/termsofuse](https://my.rowshare.com/termsofuse) |
| 应用的核心功能 | 使用协作、安全且可视的电子表格简化管理流程。 |
| 公司总部位置 | 法国 |
| 应用信息页面 | [https://www.rowshare.com/features](https://www.rowshare.com/features) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
