...
| 应用的核心功能 | Fireflies 是一个会议助理，可记录、转录和记录会议记录。
 ...
 | |公司总部|美国| |应用信息页面| | |用于运行应用的托管环境或服务模型是什么？ |Paas | |应用使用哪些托管云提供商？ |GCP |
...
此信息由用户 Fireflies.ai，这些信息与此应用程序如何收集和存储组织数据以及组织将拥有对应用收集的数据的控制有关。
