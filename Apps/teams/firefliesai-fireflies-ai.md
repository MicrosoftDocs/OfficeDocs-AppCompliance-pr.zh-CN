---
title: Fireflies AI 的应用程序信息（按 Fireflies.ai
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/12/2021
...
description: Fireflies AI 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/685d9120-feba-4cb0-934c-efcc69b85fc6" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002618" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

由 microsoft Fireflies.ai 提供的信息：
...
| 合作伙伴公司名称 | Fireflies.ai |
| 公司网站 | [https://fireflies.ai](https://fireflies.ai) |
| 应用的使用条款 | [https://fireflies.ai/terms-of-service.pdf](https://fireflies.ai/terms-of-service.pdf) |
| 应用的核心功能 | Fireflies 是一个会议助理，可记录、转录和记录会议记录。

 | |公司总部|美国| |应用信息页面| [https://app.fireflies.ai/integrations/collaboration/microso...](https://app.fireflies.ai/integrations/collaboration/microsoft-teams) | |用于运行应用的托管环境或服务模型是什么？ |Paas | |应用使用哪些托管云提供商？ |GCP |
...
此信息由应用 Fireflies.ai 如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
| 隐私策略 URL | https://fireflies.ai/privacy_policy.pdf |
