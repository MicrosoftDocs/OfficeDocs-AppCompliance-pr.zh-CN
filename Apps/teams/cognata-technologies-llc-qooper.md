...
| 公司网站 | [https://qooper.io](https://qooper.io) |
| 应用的使用条款 | [https://qooper.io/terms-of-use](https://qooper.io/terms-of-use) |
| 应用的核心功能 | 通过有意义的连接内容实现目标 &amp; 。 通过引导、对等指导、社区学习和网络将你的人员与有意义的连接和内容包围在一起。 Qooper 合作伙伴与各种规模的公司、学院和非营利组织合作，以自动管理计划管理工作、在交互式指导学习平台上联系人员以及显示计划分析。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://qooper.io](https://qooper.io) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
