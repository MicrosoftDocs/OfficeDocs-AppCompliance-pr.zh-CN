---
title: 适用于 Qooper by COGNATA TECHNOLOGIES、LLC 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/25/2021
...
description: Qooper 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/fadca663-cc96-4756-8a3b-271000082238" target="_blank">Teams存储区中的视图</a>
...
COGNATA TECHNOLOGIES、LLC 提供给 Microsoft 的信息：
...
| 公司的网站 | [https://qooper.io](https://qooper.io) |
| 应用的使用条款 | [https://qooper.io/terms-of-use](https://qooper.io/terms-of-use) |
| 应用的核心功能 | 使用有意义的连接 &amp; 内容实现目标。 通过指导、对等辅导、社区学习和网络，为用户提供有意义的连接和内容。 Qooper 与各种规模的公司、大学和非营利组织合作，以自动化指导计划管理工作，在交互式指导学习平台上连接人员并显示程序分析。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://qooper.io](https://qooper.io) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
COGNATA TECHNOLOGIES、LLC 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
