---
title: Pavestep by Pavestep 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/23/2022
...
description: 适用于 Pavestep 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/aaa83b14-3857-43e0-88ca-b726f5df5db3" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004114" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Pavestep 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Pavestep |
| 公司的网站 | [https://www.pavestep.com](https://www.pavestep.com) |
| 应用的使用条款 | [https://www.pavestep.com/user-agreement](https://www.pavestep.com/user-agreement) |
| 应用的核心功能 | Pavestep 是一种直观的性能管理解决方案。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | |
...
Pavestep 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 名字、姓氏、电子邮件、作业角色 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 名字、姓氏、电子邮件、作业角色 |
