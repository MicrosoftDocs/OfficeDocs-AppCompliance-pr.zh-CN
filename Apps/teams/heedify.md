...
>|   **Graph权限**  | **权限类型** |          **字距调整**          |
>|:------------------------|:--------------------|:------------------------------------|
>| Presence.Read.All | delegated | 联系人中心代理需要状态信息以更好地管理呼叫和联系人，尤其是在呼叫转移的情况下  |
>| User.Read.All | delegated | 为了管理联系人，已登录的用户需要能够浏览用户并读取其信息，包括其离职和经理 (（如果接待员)   |
>| Calendars.Read | delegated | 接待员需要在转接电话或通过电话与客户共享信息之前检查用户日历 |
>| Contacts.ReadWrite | delegated | 应用程序需要能够向用户添加联系人 (代理) 读取其联系人  |
>| Contacts.ReadWrite.Shared | delegated | 应用程序需要能够向其他用户添加共享联系人 (代理) 读取其共享联系人  |
