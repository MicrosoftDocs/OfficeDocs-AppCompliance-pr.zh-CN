---
title: Eloops by Eloops 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Eloops 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/431a9917-9c32-480e-a584-6c149e7b7213" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | Eloops |
| 公司的网站 | [https://eloops.com](https://eloops.com) |
| 应用的使用条款 | [https://eloops.com/terms-of-service/](https://eloops.com/terms-of-service/) |
| 应用的核心功能 | 工作但&#8217;感觉不像工作的员工参与平台 |
| 公司总部位置 | Israel（以色列） |
| 应用信息页 | [https://eloops.com/microsoft-teams-integration-help-center/](https://eloops.com/microsoft-teams-integration-help-center/) |
...
Eloops 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | 我们使用用户&#8217;的名字和姓氏在 SSO 流上注册它们 | [431a9917-9c32-480e-a584-6c149e7b7213](../azure/431a9917-9c32-480e-a584-6c149e7b7213.md) |
