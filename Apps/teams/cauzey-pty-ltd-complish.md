---
title: Cauzey Pty Ltd 的复杂应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/16/2021
...
description: 适用于 Complish 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/e840a6b7-6a38-4404-baa5-e404eb0c98b3" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001641" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Cauzey Pty Ltd 提供给 Microsoft 的信息：
...
| 公司的网站 | [https://www.complish.app](https://www.complish.app) |
| 应用的使用条款 | [https://www.complish.app/privacy-and-terms](https://www.complish.app/privacy-and-terms) |
| 应用的核心功能 | 通过使工作可见、与目标相关联和促进重点讨论，使工作变得简单易于养成良好的远程习惯。 |
| 公司总部位置 | 澳大利亚 |
| 应用信息页 | [https://www.complish.app](https://www.complish.app) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
Cauzey Pty Ltd 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
