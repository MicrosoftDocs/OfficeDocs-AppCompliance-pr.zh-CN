...
| 公司网站 | [https://www.complish.app](https://www.complish.app) |
| 应用的使用条款 | [https://www.complish.app/privacy-and-terms](https://www.complish.app/privacy-and-terms) |
| 应用的核心功能 | 通过使工作可见、与目标相连接并推动重点讨论，使培养良好的远程习惯变得容易。 |
| 公司总部位置 | 澳大利亚 |
| 应用信息页面 | [https://www.complish.app](https://www.complish.app) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
