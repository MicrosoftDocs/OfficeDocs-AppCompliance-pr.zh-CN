---
title: 由 Pilotech AS 提供的 InCaseIT 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/20/2021
...
description: InCaseIT 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/4420b597-c1d5-4d40-ba81-2b2a78575c81" target="_blank">Teams存储区中的视图</a>
...
| 公司的网站 | [https://incaseit.com](https://incaseit.com) |
| 应用的使用条款 | [https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/t...](https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/topic/1-4-terms-of-use) |
| 应用的核心功能 | 危机管理系统。 危机和事件的准备和处理系统。 |
| 公司总部位置 | 挪威 |
| 应用信息页 | [https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/t...](https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/topic/introduction-to-incaseit-version-2-0) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
Pilotech AS 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 委托 | 使用的唯一数据是用户显式确认，允许应用程序使用访问令牌调用图形 API。 | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
>| OnlineMeetings.ReadWrite | 委托 | 使用的唯一数据是用户显式确认，允许应用程序使用访问令牌调用图形 API。 | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
>| User.Read | 委托 | 使用的唯一数据是用户显式确认，允许应用程序使用访问令牌调用图形 API。 | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
