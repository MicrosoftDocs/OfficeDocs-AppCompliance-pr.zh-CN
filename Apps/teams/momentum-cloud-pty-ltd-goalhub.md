---
title: 动量云 Pty Ltd 的 Goalhub 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: Goalhub 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/593a90d6-6630-4376-8745-55d7c2c3f0c9" target="_blank">Teams存储区中的视图</a>
...
| 公司的网站 | [https://www.momentumcloud.com.au](https://www.momentumcloud.com.au) |
| 应用的使用条款 | [https://www.goalhub.com/terms](https://www.goalhub.com/terms) |
| 应用的核心功能 | 连接、受支持、实现目标。 |
| 公司总部位置 | 澳大利亚 |
| 应用信息页 | [https://www.goalhub.com/about-1](https://www.goalhub.com/about-1) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | GCP |
...
Momentum Cloud Pty Ltd 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
