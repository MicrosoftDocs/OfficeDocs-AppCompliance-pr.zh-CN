...
>|   **Graph权限**  | **权限类型** |          **字距调整**          |
>|:------------------------|:--------------------|:------------------------------------|
>| AppCatalog.ReadWrite.All | delegated | 将应用程序目录中的应用程序添加到会议 |
>| Calendars.ReadWrite | delegated | 能够订阅会议更新 |
>| Calendars.ReadWrite | 应用程序 | 能够创建会议 |
>| Directory.ReadWrite.All | 应用程序 | 能够创建与会议关联的组 |
>| Files.ReadWrite.All | delegated | 允许用户将文件上载到会议组 |
>| Files.ReadWrite.All | 应用程序 | 允许应用程序将会议数据上载到会议组 |
>| Group.ReadWrite.All | 应用程序 | 允许应用程序创建与会议关联的组 |
>| MailboxSettings.Read | 应用程序 | 允许应用程序读取用户时区 |
>| OnlineMeetings.ReadWrite | delegated | 启用会议类型标记 |
>| TeamsAppInstallation.ReadForUser | delegated | 将应用程序添加到会议 |
>| TeamsAppInstallation.ReadWriteSelfForUser | delegated | 将应用程序添加到会议 |
>| TeamsTab.Create | delegated | 将应用程序添加到会议 |
>| TeamsTab.ReadWrite.All | delegated | 将应用程序添加到会议 |
>| User.Read.All | 应用程序 | 允许应用在没有登录用户的情况下读取用户配置文件 |
