---
title: Foxit Software Incorporated 的 Foxit PDF 编辑器的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Foxit PDF 编辑器的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66249725"
---
# <a name="foxit-pdf-editor"></a>Foxit PDF 编辑器

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 8 月 19 日</p>

* <a href="https://teams.microsoft.com/l/app/959a79dd-69d0-4d05-b9a8-b9f02e28c049" target="_blank">在 Teams 应用商店中查看</a>
...
| 公司的网站 | [https://www.foxit.com](https://www.foxit.com) |
| 应用的使用条款 | [https://www.foxit.com/product/terms-of-service.html](https://www.foxit.com/product/terms-of-service.html) |
| 应用的核心功能 | 借助适用于 Microsoft Teams 的 Foxit PDF 编辑器，可以在不离开 Microsoft Teams 的情况下使用文档执行更多操作：1.Secure 协作共享 PDF，并与频道中的所有人协作，并将文档存储在 Microsoft SharePoint 或一个驱动器中&#65307; 2.高质量的查看 - 借助 Microsoft Teams 中高质量的查看 PDF，&#65307; 3.批注通过文本标记和批注 PDF 工具向文档PDF-Provide反馈; |
| 公司总部位置 | 中国 |
| 应用信息页 | |
...
Foxit Software Incorporated 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | 委托 | 读取用户文档并保存文档。 | [959a79dd-69d0-4d05-b9a8-b9f02e28c049](../azure/959a79dd-69d0-4d05-b9a8-b9f02e28c049.md) |
