---
title: Switchvox 的应用程序信息（由一位用户显示）
ms.author: elmalova
author: elenamalova
ms.date: 01/03/2022
ms.topic: article
...
description: Switchvox 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "62255538"
---
# <a name="switchvox"></a>Switchvox

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 12 月 23 日</p>

* <a href="https://teams.microsoft.com/l/app/eb668aa5-abb2-445c-81b4-3c174db84fe2" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001535" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

由一位 Microsoft 的一位用户提供的信息：
...
| 合作伙伴公司名称 | Sangoma |
| 公司网站 | [https://www.sangoma.com](https://www.sangoma.com) |
| 应用的使用条款 | [https://cdn.sangoma.com/wp-content/uploads/digium_end_user_...](https://cdn.sangoma.com/wp-content/uploads/digium_end_user_license_agreement.pdf) |
| 应用的核心功能 | 从交换机内的任何位置在 Switchvox 电话上无缝Microsoft Teams。 |
| 公司总部位置 | 加拿大 |
| 应用信息页面 | |
...
此信息由一位用户由一位用户提供，这些信息与该应用如何收集和存储组织数据以及你的组织将拥有对应用收集的数据的控制有关。
...
| 数据库中存储了哪些数据？ | 呼叫历史记录 (，包括号码、姓名、联系人电子邮件) 应用程序发起的呼叫的联系人信息 |
...
| 隐私策略 URL | https://cdn.sangoma.com/wp-content/uploads/Privacy-Policy.pdf |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Chat.Read | delegated | 执行聊天成员解析 | [eb668aa5-abb2-445c-81b4-3c174db84fe2](https://docs.microsoft.com/microsoft-365-app-certification/azure/eb668aa5-abb2-445c-81b4-3c174db84fe2) |
>| Group.Read.All | delegated | 执行组的成员解析 | [eb668aa5-abb2-445c-81b4-3c174db84fe2](https://docs.microsoft.com/microsoft-365-app-certification/azure/eb668aa5-abb2-445c-81b4-3c174db84fe2) |
>| User.Read.All | delegated | 执行目录联系人查找 | [eb668aa5-abb2-445c-81b4-3c174db84fe2](https://docs.microsoft.com/microsoft-365-app-certification/azure/eb668aa5-abb2-445c-81b4-3c174db84fe2) |
