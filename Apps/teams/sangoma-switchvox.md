...
| 您是否具有管理 SLA 服务级别协议的策略 (SLA) 修补程序？ | 否 |
...
| 在支持你的应用的网络 (外围) 部署入侵检测和防护 IDPS 和 IDPS 软件吗？ | 否 |
...
>|   **Graph权限**  | **权限类型** |          **字距调整**          |
>|:------------------------|:--------------------|:------------------------------------|
>| User.Read.All | delegated | 执行目录联系人查找 |
>| Group.Read.All | delegated | 执行组的成员解析 |
>| Chat.Read | delegated | 执行聊天成员解析 |
