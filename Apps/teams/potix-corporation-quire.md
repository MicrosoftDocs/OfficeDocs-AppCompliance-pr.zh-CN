---
title: Quire by Potix Corporation 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Quire 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "64879659"
---
# <a name="quire"></a>Quire

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 6 月 9 日</p>

* <a href="https://teams.microsoft.com/l/app/dfad3be2-e62c-49c5-9453-ccd30999f003" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002946" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Potix Corporation 提供给 Microsoft 的信息：
...
| 公司的网站 | [https://www.quire.io](https://www.quire.io) |
| 应用的使用条款 | [https://quire.io/terms](https://quire.io/terms) |
| 应用的核心功能 | 用于在分层列表中分解目标的最佳协作项目管理软件。 |
| 公司总部位置 | 台湾 (省)  |
| 应用信息页 | [https://www.quire.io](https://www.quire.io) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
Potix Corporation 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
