---
title: Quire 的应用程序信息（由 Potix Corporation）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
* <a href="https://teams.microsoft.com/l/app/dfad3be2-e62c-49c5-9453-ccd30999f003" target="_blank">在应用商店Teams视图</a>
...
| 公司网站 | [https://www.quire.io](https://www.quire.io) |
| 应用的使用条款 | [https://quire.io/terms](https://quire.io/terms) |
| 应用的核心功能 | 用于分解分层列表中目标的最佳协作项目管理软件。 |
| 公司总部位置 | 中国 (中国台湾)  |
| 应用信息页面 | [https://www.quire.io](https://www.quire.io) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
这些信息由 Potix Corporation 提供，用于了解此应用如何收集和存储组织数据，以及组织将拥有对应用收集的数据的控制。
