---
title: DailyBot by DailyBot 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/20/2022
...
description: DailyBot 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66915648"
---
# <a name="dailybot"></a>DailyBot

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 4 月 27 日</p>

* <a href="https://teams.microsoft.com/l/app/82bfb2e1-cad3-4e99-8995-5d140f295ef2" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001492" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

DailyBot 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | DailyBot |
| 公司的网站 | [https://www.dailybot.com](https://www.dailybot.com) |
| 应用的使用条款 | [https://www.dailybot.com/legal/terms-and-conditions](https://www.dailybot.com/legal/terms-and-conditions) |
| 应用的核心功能 | DailyBot 通过自动执行站立、每日状态报告、回顾和定期签入来减少会议需求。它跟踪团队动机，并以荣誉和欣赏促进积极的反馈。 DailyBot 包括用于创建快捷方式/命令和自动执行聊天工作流的额外功能。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://www.dailybot.com/integrations/msteams](https://www.dailybot.com/integrations/msteams) |
...
DailyBot 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 用户Email、租户 ID、MS 团队资源 ID 和名称、团队频道 ID |
| 应用是否支持 TLS 1.1 或更高版本？ | 可访问 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 用户Email、租户 ID、MS 团队资源 ID 和名称、团队频道 ID、DailyBot 功能和工作流收集的用户响应内容，例如：签入、调查、窗体或 Kudos。 |
...
| 隐私策略 URL | https://www.dailybot.com/legal/privacy-policy |
...
| **Information** | **响应** |
|:----------------|:-------------|
| 应用程序是否与 Microsoft Identity Platform (Azure AD) 集成以进行单一登录、API 访问等？ | 可访问 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | DailyBot 需要从团队中读取用户的基本信息，这用于在加入进程时提供良好的用户体验，并使成员邀请过程更轻松。 | [82bfb2e1-cad3-4e99-8995-5d140f295ef2](../azure/82bfb2e1-cad3-4e99-8995-5d140f295ef2.md) |
