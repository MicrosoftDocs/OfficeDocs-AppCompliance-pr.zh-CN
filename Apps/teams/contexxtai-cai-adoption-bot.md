...
| 应用的核心功能 | 使用整个采用套件时，包括 &quot;个人指导，应用&quot;分析 (C.AI 分析) 通过 Graph API &amp; 匿名化使用情况数据Exchange Teams。 基于此数据，自动程序算法 (C.AI Adoption Bot) 检测特定学习情况 &amp; 会向用户发送快速提示。 例如，如果用户从未向帖子添加Teams，机器人会假定用户不知道如何操作，并发送自定义的学习材料。 如果没有分析，它将只是&amp; QA 自动程序。 |
| 公司总部位置 | 德国 |
...
| 您的环境是否使用传统的反恶意软件保护或应用程序控件？ | 传统反恶意软件、应用程序控件 |
...
| 启用了 MFA (多重) 身份验证： | 代码存储库、DNS 管理、凭据/密钥存储 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 应用程序 | 用户能否在正确的时间发送提示，而不是在专注时间发送提示，例如 | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| ChannelMessage.Read.All | 应用程序 | Microsoft Teams元数据（如私人或不同频道）或每个频道的对话量来分析Teams | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| Chat.Read.All | 应用程序 | Microsoft Teams聊天元数据，例如消息是否被喜欢或者存在多少个组和一对一聊天来分析聊天Teams | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| Directory.Read.All | 应用程序 | 用户对象 ID，用于以后能够向指定用户发送提示。 | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| Group.Read.All | 应用程序 | Microsoft Teams元数据，如Teams分析元数据使用率的Teams | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| Mail.Read | 应用程序 | Microsoft Exchange元数据（如电子邮件数量和组与 1：1 电子邮件）来分析Exchange (使用情况Teams)  | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| User.Read.All | 应用程序 | Microsoft Teams聊天和对话元数据，如用户被提及以分析Teams | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
