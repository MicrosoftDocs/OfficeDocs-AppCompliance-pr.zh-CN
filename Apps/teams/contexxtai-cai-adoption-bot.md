...
| 应用的核心功能 | 使用整个采用套件时，包括 &quot;个人指导，应用&quot;分析 (C.AI 分析) 通过 图形 API &amp; 匿名化使用情况数据Exchange Teams。 基于此数据，自动程序算法 (C.AI Adoption Bot) 检测特定学习情况 &amp; 会向用户发送快速提示。 例如，如果用户从未向帖子添加Teams，机器人会假定用户不知道如何操作，并发送自定义的学习材料。 如果没有分析，它将只是&amp; QA 自动程序。 |
| 公司总部位置 | 德国 |
| 应用信息页面 | [https://contexxt.ai/cai-adoption-bot/](https://contexxt.ai/cai-adoption-bot/) |
...
| 你的应用将处理哪些数据？ | 来自用户配置文件、Exchange和Teams数据的匿名Teams聚合元数据 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 来自用户配置文件、Exchange和Teams数据的匿名Teams聚合元数据 |
...
| 隐私策略 URL | https://contexxt.ai/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 应用程序 | 阅读日历使用情况数据，了解时间管理最佳做法 | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| CallRecords.Read.All | 应用程序 | 阅读Teams会议管理最佳做法的呼叫使用情况数据 | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| ChannelMessage.Read.All | 应用程序 | 阅读Teams频道使用情况数据Teams邮件管理最佳做法 | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| Chat.Read.All | 应用程序 | 阅读Teams聊天管理最佳做法Teams聊天使用率数据 | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| Directory.Read.All | 两者 | 读取用户配置文件数据以与机器人交互 | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| Group.Read.All | 应用程序 | 阅读Teams管理最佳做法Teams使用率数据 | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| Group.ReadWrite.All | 应用程序 | 可选：将服务用户帐户临时写入规划器最佳做法规划器 | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| Mail.Read | 应用程序 | 读取邮件元数据，了解电子邮件管理最佳做法 | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| Tasks.Read | delegated | 读取 Planner 最佳做法的 Planner 使用率数据 | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| User.Read.All | 应用程序 | 读取用户 metadadata（如组成员身份）Teams最佳做法 | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
