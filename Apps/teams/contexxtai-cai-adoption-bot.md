...
| 应用的核心功能 | 使用整个采用套件时，包括 &quot;个人指导：通过&quot; Graph API &amp; 匿名处理使用情况数据 (C.AI 应用分析) 分析分析引擎，Exchange Teams。 基于此数据，自动程序算法 (C.AI Adoption Bot) 检测 &amp; 特定学习情况时，会向用户发送快速提示。 例如，如果用户从未向帖子添加Teams，机器人会假定用户不知道如何操作并发送自定义的学习材料。 如果没有分析，它将只是&amp; QA 自动程序。 |
| 公司总部位置 | 德国 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 应用程序 | 用户能否在正确的时间发送提示，而不是在专注时间发送提示，例如 | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](https://docs.microsoft.com/microsoft-365-app-certification/azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13) |
>| ChannelMessage.Read.All | 应用程序 | Microsoft Teams频道元数据（如私人或非私人）或每个频道的对话量来分析Teams | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](https://docs.microsoft.com/microsoft-365-app-certification/azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13) |
>| Chat.Read.All | 应用程序 | Microsoft Teams聊天元数据，例如消息是否被喜欢或者存在多少个组和一对一聊天来分析聊天Teams | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](https://docs.microsoft.com/microsoft-365-app-certification/azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13) |
>| Directory.Read.All | 应用程序 | 用户对象 ID，用于以后能够向指定用户发送提示。 | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](https://docs.microsoft.com/microsoft-365-app-certification/azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13) |
>| Group.Read.All | 应用程序 | Microsoft Teams元数据，如Teams分析元数据使用率的Teams | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](https://docs.microsoft.com/microsoft-365-app-certification/azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13) |
>| Mail.Read | 应用程序 | Microsoft Exchange元数据（如电子邮件数量和组与 1：1 电子邮件）来分析Exchange (使用情况Teams)  | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](https://docs.microsoft.com/microsoft-365-app-certification/azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13) |
>| User.Read.All | 应用程序 | Microsoft Teams聊天和对话元数据，例如，如果用户被提及来分析Teams | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](https://docs.microsoft.com/microsoft-365-app-certification/azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13) |
