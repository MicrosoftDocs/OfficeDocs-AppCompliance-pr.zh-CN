---
title: Avishkaram Technologies Pvt Ltd 针对 TagMyFav 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/14/2022
...
description: TagMyFav 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/4adaed2f-7c6a-4128-ba20-4fb097581b1b" target="_blank">在应用商店Teams视图</a>
...
| 合作伙伴公司名称 | Avishkaram Technologies Pvt Ltd |
| 公司网站 | [https://www.avishkaram.com](https://www.avishkaram.com) |
| 应用的使用条款 | [https://www.tagmyfav.com/terms-conditions](https://www.tagmyfav.com/terms-conditions) |
| 应用的核心功能 | TagMyFav for Microsoft 365提供了一个简单的书签解决方案，以便更轻松地进行协作&amp;通信。 保存&amp;共享链接，同时Microsoft Teams对话、在 Outlook 中阅读电子邮件、在 Word 中创建文档或在浏览器中进行研究。 TagMyFav 适用于所有行业，如客户支持、技术支持、法律 &amp; 人士、学生教师、市场营销、人力资源等，以组织和共享对协作或研究有用的链接。 |
| 公司总部位置 | 印度 |
| 应用信息页面 | [https://www.tagmyfav.com](https://www.tagmyfav.com) |
...
Avishkaram Technologies Pvt Ltd 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及您的组织将拥有对应用收集的数据的控制有关。
...
| 数据库中存储了哪些数据？ | Email、Name、TimeZone、Microsoft Teams ID |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Contacts.Read | delegated | 读取用户的联系人 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
>| User.Read | delegated | 读取用户的基本个人资料信息 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
>| 电子邮件 | delegated | 查看用户电子邮件 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
>| offline_access | delegated | 保留对已授予其访问权限的数据的访问权限 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
>| openid | delegated | 登录用户 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
>| profile | delegated | 查看用户配置文件 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
