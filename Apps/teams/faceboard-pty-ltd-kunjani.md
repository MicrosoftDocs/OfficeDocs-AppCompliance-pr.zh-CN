...
* <a href="https://teams.microsoft.com/l/app/6b4ac65a-764d-4021-bf3f-40cb2d137a33" target="_blank">在应用商店Teams视图</a>
...
| 公司网站 | [https://www.kunjani.co](https://www.kunjani.co) |
| 应用的使用条款 | [https://www.kunjani.co/termsandconditions](https://www.kunjani.co/termsandconditions) |
| 应用的核心功能 | 使用由你设计的交互式"为会议设置实时体验"游戏。 |
| 公司总部位置 | 英国大英和爱尔兰 ()  |
| 应用信息页面 | [https://Kunjani.co](https://Kunjani.co) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
此信息由 FACEBOARD (PTY) LTD 提供，用于了解此应用如何收集和存储组织数据以及组织将拥有对应用收集的数据的控制。
