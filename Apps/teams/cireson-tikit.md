...
>|:----------------|:------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|:--------------------|
>| Device.Read | 应用程序 | 用于单一登录的用户图形信息，通过团队机器人通信  | 我们存储用户角色、系列名称、给定名称、电子邮件、AAD ID、Teams ID。 此通知用于应用程序身份验证、安全性、RBAC、团队集成、团队通知和用户关系映射   | [b13c40ee-e073-459e-96b5-3f3cca046a37](https://docs.microsoft.com/microsoft-365-app-certification/azure/b13c40ee-e073-459e-96b5-3f3cca046a37) |
