...
description: Hi Digital一文的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/bce03b83-412b-4dfa-ae76-c9171a5f5ed7" target="_blank">在应用商店Teams视图</a>
...
Digital Digital Digital Srl 提供给 Microsoft 的信息：
...
| 公司网站 | [https://www.habitinspiringplatform.com](https://www.habitinspiringplatform.com) |
| 应用的使用条款 | [https://www.iubenda.com/termini-e-condizioni/98527945](https://www.iubenda.com/termini-e-condizioni/98527945) |
| 应用的核心功能 | hi 是一名数字指导员，他培养人们以充分利用Microsoft Teams。 |
| 公司总部位置 | Italy（意大利） |
| 应用信息页面 | [https://www.habitinspiringplatform.com/coaching-plan](https://www.habitinspiringplatform.com/coaching-plan) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
此信息由数字版权局提供，它有关此应用程序如何收集和存储组织数据，以及你的组织将拥有对应用收集的数据的控制。
