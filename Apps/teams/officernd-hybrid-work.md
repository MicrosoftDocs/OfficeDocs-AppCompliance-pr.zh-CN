...
description: OfficeRnD 混合工作的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/ff19eb3c-6afa-4f33-acfd-df1338289524" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003460" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

OfficeRnD 提供给 Microsoft 的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | OfficeRnD Hybrid Work |
| ID | WA200003460 |
| Office 365客户端 | Microsoft Teams |
| 合作伙伴公司名称 | OfficeRnD |
| 公司网站 | [https://officernd.com](https://officernd.com) |
| 应用的使用条款 | [https://officernd.com/terms](https://officernd.com/terms) |
| 应用的核心功能 | 使员工能够快速查找和预订桌面、会议室和其他空间。 |
| 公司总部位置 | 英国大英和爱尔兰 ()  |
| 应用信息页面 | [https://www.officernd.com/hybrid-workplace-management-softw...](https://www.officernd.com/hybrid-workplace-management-software/) |
...
此信息由 OfficeRnD 提供，用于了解此应用程序如何收集和存储组织数据，以及您的组织将拥有对应用收集的数据的控制。
...
| 隐私策略 URL | https://officernd.com/privacy |
