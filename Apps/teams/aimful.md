...
description: Aimful 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
<p>开发人员上次更新时间：2022 年 1 月 28 日</p>

* <a href="https://teams.microsoft.com/l/app/7da7691c-e47a-479e-9bb2-cda07cffd0e5" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003698" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Aimful 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Aimful |
| 公司网站 | [https://aimful.io](https://aimful.io) |
| 应用的使用条款 | [https://aimful.io/terms-and-conditions/](https://aimful.io/terms-and-conditions/) |
| 应用的核心功能 | Aimful 鼓励团队或公司中的会议文化转型  |
| 公司总部位置 | 美国美国 |
| 应用信息页面 | [https://aimful.io/how-it-works/](https://aimful.io/how-it-works/) |
...
Aimful 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及组织将拥有对应用收集的数据的控制有关。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础基础结构是否处理与 Microsoft 客户或他们的设备相关的任何数据？ | 是 |
| 你的应用将处理哪些数据？ | 日历、用户电子邮件和时区中的事件 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 日历、用户电子邮件和时区中的事件 |
...
| 应用是否符合 SOX Sarbanes-Oxley的 () ？ | 不支持 |
...
| 隐私策略 URL | https://aimful.io/policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | delegated | 访问日历事件 | [93544582-de9c-42a0-baa5-df3d25e9bd48](../azure/93544582-de9c-42a0-baa5-df3d25e9bd48.md) |
>| MailboxSettings.Read | delegated | 访问用户的时区 | [93544582-de9c-42a0-baa5-df3d25e9bd48](../azure/93544582-de9c-42a0-baa5-df3d25e9bd48.md) |
