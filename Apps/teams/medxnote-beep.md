...
description: Beep 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66852680"
---
# <a name="beep"></a>Beep

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 5 月 11 日</p>

* <a href="https://teams.microsoft.com/l/app/6b8b29d8-5beb-4eae-915e-5a56a0e1f5a6" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004364" target="_blank">在 AppSource 中查看</a>
...
| 合作伙伴公司名称 | Medxnote |
| 公司的网站 | [https://medxnote.com](https://medxnote.com) |
| 应用的使用条款 | [https://medxnote.com/terms-conditions/](https://medxnote.com/terms-conditions/) |
| 应用的核心功能 | 加强与 MedxPlanner 在 Microsoft Teams 中的 EPR 任务集成的临床协作。 |
| 公司总部位置 | 爱尔兰 |
| 应用信息页 | |
...
Medxnote 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 租户 ID、用户配置文件、标记 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 租户 ID、用户配置文件、标记 |
...
| 其他人员是否正在审查和批准原始开发人员提交到生产的所有代码更改请求？ | 否 |
...
| 隐私策略 URL | https://medxnote.com/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.ReadWrite.All | 两者 | 我们正在获取用户的组织信息 | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| TeamsActivity.Send | 应用程序 | 此权限用于向用户发送活动。 因此，我们将使用此方法在用户的源中创建编程活动，让他们知道任务已更新。 | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| TeamworkTag.ReadWrite | 应用程序 | 我们使用此权限在 Microsoft Teams 中的团队中获取和创建标记。 因此，我们可以以编程方式提及它们。 | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| User.Read | 委托 | 使用此权限，我们将获取用户的基本信息，如 displayName、mail、userPrincipalName、ID 和照片。 | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| User.Read.All | 应用程序 | 使用此操作，我们将提取总属性。 | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| User.ReadWrite.All | 应用程序 | 使用此功能，我们将获得用户的联接团队。 | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
