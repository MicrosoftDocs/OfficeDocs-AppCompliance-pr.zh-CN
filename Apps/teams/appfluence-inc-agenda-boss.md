---
title: Appfluence Inc 的议程老板应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/16/2021
...
description: 议程老板的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/ae645efa-0e64-47d9-91e4-b693a99f7f87" target="_blank">Teams存储区中的视图</a>
...
| 公司的网站 | [https://agendaboss.com](https://agendaboss.com) |
| 应用的使用条款 | [https://agendaboss.com/eula](https://agendaboss.com/eula) |
| 应用的核心功能 | 将所有任务和日历事件放在一起，并将其聚合到简单的线性列表中。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://agendaboss.com/about](https://agendaboss.com/about) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
