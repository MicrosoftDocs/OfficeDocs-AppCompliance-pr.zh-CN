---
title: Stylebot Inc 的 Stylebot 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/07/2021
...
description: Stylebot 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/db9c0532-d5d9-4e1b-839f-3952c88c8ee2" target="_blank">Teams存储区中的视图</a>
...
| 公司的网站 | [https://www.stylebot.app](https://www.stylebot.app) |
| 应用的使用条款 | [https://www.stylebot.app/apptermsofservice](https://www.stylebot.app/apptermsofservice) |
| 应用的核心功能 | Stylebot 通过将现代语言和样式手册放在触手可及处来改善写作 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://www.stylebot.app/msteamshelp](https://www.stylebot.app/msteamshelp) |
...
Stylebot Inc 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
