---
title: ChurnZero by ChurnZero 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/08/2021
...
description: 适用于 ChurnZero 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/c2e66b59-725d-4c56-8a0e-ee2587031d9f" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | 埃塞洛 |
| 公司的网站 | [https://churnzero.net](https://churnzero.net) |
| 应用的使用条款 | [https://churnzero.net/terms-of-use](https://churnzero.net/terms-of-use) |
| 应用的核心功能 | ChurnZero 是一个实时客户成功平台，可帮助订阅企业应对流失、扩展当前帐户、提高产品采用率和优化客户体验。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
ChurnZero 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | 委托用户与 ChurnZero 用户关联的 Azure 对象 ID，以便在将来的机器人会话中识别并授权该用户。 | [c2e66b59-725d-4c56-8a0e-ee2587031d9f](../azure/c2e66b59-725d-4c56-8a0e-ee2587031d9f.md) |
