...
| 公司网站 | [https://www.derdack.com](https://www.derdack.com) |
| 应用的使用条款 | [https://www.signl4.com/terms_of_use/](https://www.signl4.com/terms_of_use/) |
| 应用的核心功能 | Derdack SIGNL4 是一款移动通知应用，可可靠地通知运营团队有关责任并提高其工作效率。 |
| 公司总部位置 | 德国 |
| 应用信息页面 | [https://www.signl4.com](https://www.signl4.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
