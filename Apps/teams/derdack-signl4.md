---
title: Derdack SIGNL4 的 SIGNL4 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/18/2022
...
description: SIGNL4 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66845014"
---
# <a name="signl4"></a>SIGNL4

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 7 月 15 日</p>

* <a href="https://teams.microsoft.com/l/app/bd19c878-00b7-47cd-9b65-74a2def84427" target="_blank">在 Teams 应用商店中查看</a>
...
| 公司的网站 | [https://www.derdack.com](https://www.derdack.com) |
| 应用的使用条款 | [https://www.signl4.com/terms_of_use/](https://www.signl4.com/terms_of_use/) |
| 应用的核心功能 | Derdack SIGNL4 支持移动警报和操作关键基础结构的任何事件响应。 它支持操作和调用团队。 |
| 公司总部位置 | 德国 |
| 应用信息页 | [https://www.signl4.com](https://www.signl4.com) |
...
Derdack SIGNL4 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | email address |
...
| 隐私策略 URL | https://www.signl4.com/privacy-policy/ |
