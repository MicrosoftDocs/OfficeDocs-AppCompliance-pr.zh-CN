---
title: BrainCore 解决方案中缺少的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/07/2022
...
description: CSA STAR 注册表中的所有可用的安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用目录信息以及安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/fbd349eb-146f-4e94-af76-df4754f40749" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003833" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

BrainCore 解决方案提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | BrainCore Solutions |
| 公司的网站 | [https://braincore.solutions](https://braincore.solutions) |
| 应用的使用条款 | [https://absentify.com/terms-and-conditions](https://absentify.com/terms-and-conditions) |
| 应用的核心功能 | 处理员工休假的最简单方法 - Microsoft Teams |
| 公司总部位置 | Switzerland（瑞士） |
| 应用信息页 | [https://absentify.com](https://absentify.com) |
...
BrainCore 解决方案提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | Microsoft 用户 ID，电子邮件，DisplayName |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | Microsoft 用户 ID，电子邮件，DisplayName |
...
| 隐私策略 URL | https://absentify.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | 应用程序 | 可选。 将通知发送到Microsoft Teams。 | [0f5eabc0-89bf-4cc6-80d1-10094b5919d2](/microsoft-365-app-certification/azure/0f5eabc0-89bf-4cc6-80d1-10094b5919d2) |
>| Calendars.ReadWrite | 委托 | 可选：为缺勤自动创建Outlook日历条目。 | [3dbcb38b-8d2f-4e97-9bd1-975fb770b31c](/microsoft-365-app-certification/azure/3dbcb38b-8d2f-4e97-9bd1-975fb770b31c) |
>| User.Read | 委托 | 用于登录 | [4dce2abf-3f8e-4281-9f7a-d602fc391886](/microsoft-365-app-certification/azure/4dce2abf-3f8e-4281-9f7a-d602fc391886) |
>| User.ReadBasic.All | 委托 | 可选：查看用户的 Microsoft 个人资料图片。 | [4dce2abf-3f8e-4281-9f7a-d602fc391886](/microsoft-365-app-certification/azure/4dce2abf-3f8e-4281-9f7a-d602fc391886) |
