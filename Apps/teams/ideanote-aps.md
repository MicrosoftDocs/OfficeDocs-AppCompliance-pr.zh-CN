---
title: Ideanote ApS 的 Ideanote 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Ideanote 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/b18682e5-87f8-413a-9af4-be50bcee1049" target="_blank">在应用商店Teams视图</a>
...
由 Ideanote ApS 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Ideanote ApS |
| 公司网站 | [https://ideanote.io](https://ideanote.io) |
| 应用的使用条款 | [https://ideanote.io/legal/terms](https://ideanote.io/legal/terms) |
| 应用的核心功能 | 通过目标驱动创新收集、开发和管理想法。 |
| 公司总部位置 | 丹麦 |
| 应用信息页面 | [https://ideanote.io](https://ideanote.io) |
...
此信息由 Ideanote ApS 提供，这些信息与此应用程序如何收集和存储组织数据以及您的组织将拥有对应用收集的数据的控制有关。
...
| 数据库中存储了哪些数据？ | 有关从用户获取的 JWT 令牌的信息。 用户名、用户电子邮件。 |
...
| 隐私策略 URL | https://ideanote.io/legal/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegated | 我们需要有关该用户的信息，以自动登录到其 Ideanote 帐户。 | [d7db1079-6f45-4373-bb2b-ae5d71169b31](../azure/d7db1079-6f45-4373-bb2b-ae5d71169b31.md) |
