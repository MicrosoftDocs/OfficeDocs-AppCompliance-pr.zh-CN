...
description: 适用于 huminos 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/c0b70874-2c95-4be7-a0cb-0d893e25a2a3" target="_blank">Teams存储区中的视图</a>
...
| 公司的网站 | [https://www.myokr.co](https://www.myokr.co) |
| 应用的使用条款 | [https://www.myokr.co/terms](https://www.myokr.co/terms) |
| 应用的核心功能 | 加速性能 |
| 公司总部位置 | 印度 |
| 应用信息页 | [https://www.myokr.co](https://www.myokr.co) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
SOE Technologies 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 委托 | 获取用户日历详细信息以在用户日历中创建 1：1 会议，更新或删除由 myOKR 平台创建的会议，并显示空闲时间段 | [5f5ab403-96ae-46a9-b78e-a06d60cc9e4e](../azure/5f5ab403-96ae-46a9-b78e-a06d60cc9e4e.md) |
>| User.Read | 委托 | 我们使用用户 azure 对象 ID 使用户使用针对电子邮件的身份验证登录到 myOKR 应用 | [5f5ab403-96ae-46a9-b78e-a06d60cc9e4e](../azure/5f5ab403-96ae-46a9-b78e-a06d60cc9e4e.md) |
>| User.Read.All | 应用程序 | 将用户信息与 myOKR 平台同步，并根据各种用户削减（例如位置、部门 &amp; 经理）向管理员显示 myOKR 应用程序分析 | [5f5ab403-96ae-46a9-b78e-a06d60cc9e4e](../azure/5f5ab403-96ae-46a9-b78e-a06d60cc9e4e.md) |
>| offline_access | 委托 | 用户的 Azure Active Directory ID | [5f5ab403-96ae-46a9-b78e-a06d60cc9e4e](../azure/5f5ab403-96ae-46a9-b78e-a06d60cc9e4e.md) |
>| openid | 委托 | 我们使用用户 azure 对象 ID 使用户使用 Microsoft 身份验证登录到 myOKR 应用 | [5f5ab403-96ae-46a9-b78e-a06d60cc9e4e](../azure/5f5ab403-96ae-46a9-b78e-a06d60cc9e4e.md) |
