...
| 公司网站 | [https://www.yuccahr.com](https://www.yuccahr.com) |
| 应用的使用条款 | [https://www.yuccahr.com/terms-of-use](https://www.yuccahr.com/terms-of-use) |
| 应用的核心功能 | 连接，集成新员工，建立参与度。 直接位于Microsoft Teams。 |
| 公司总部位置 | 德国 |
| 应用信息页面 | |
...
| 数据库中存储了哪些数据？ | UserID、TenantID、Microsoft Teams TeamID、Microsoft Teams ChannelID、管理员的用户电子邮件地址 |
...
>|   **Graph权限**  | **权限类型** |          **字距调整**          |
>|:------------------------|:--------------------|:------------------------------------|
>| Calendars.ReadWrite | 应用程序 | 为匹配方安排日历事件 |
>| Channel.ReadBasic.All | 应用程序 | 在 Web 应用程序中显示频道名称 |
>| ChannelMember.Read.All | 应用程序 | 在频道或其他频道中匹配人员 |
>| Group.Read.All | 应用程序 | 在 Web 应用程序中显示团队名称 |
>| MailboxSettings.Read | 应用程序 | 若要获取用户所需的语言，在发送邮件时 |
>| User.Read.All | 应用程序 | 需要电子邮件来生成自适应卡片以允许用户直接聊天 |
