---
title: TiLly 由 Tilly Group Limited 提供的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/15/2022
...
description: 适用于 tiLly 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66113006"
---
# <a name="tilly"></a>蒂莉

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 12 月 6 日</p>

* <a href="https://teams.microsoft.com/l/app/9f9d64e3-e479-4b7b-9c5e-c4e049a732aa" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003825" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Tilly Group Limited 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Tilly Group Limited |
| 公司的网站 | [https://tillygroup.co.uk](https://tillygroup.co.uk) |
| 应用的使用条款 | [https://www.tillygroup.co.uk/wp-content/uploads/2021/11/Til...](https://www.tillygroup.co.uk/wp-content/uploads/2021/11/Tilly-Group-Limited-tiLly-Terms-of-Use.pdf) |
| 应用的核心功能 | 通过自己的 Microsoft Teams BOT 来参与、授权和支持学习者提升技能！ |
| 公司总部位置 | 大不列颠及北爱尔兰联合王国 ()  |
| 应用信息页 | [https://www.tillygroup.co.uk/wp-content/uploads/2021/11/BOT...](https://www.tillygroup.co.uk/wp-content/uploads/2021/11/BOT-Infographic-1.pdf) |
...
Tilly Group Limited 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 租户 ID、业务名称、联系人详细信息。 对于用户、用户名、匿名用户 ID、提问和提供的答案，包括任何图像和附件 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 租户 ID、业务名称、联系人详细信息。 对于用户、用户名、匿名用户 ID、提问和提供的答案，包括任何图像和附件 |
...
| 隐私策略 URL | https://www.tillygroup.co.uk/wp-content/uploads/2021/11/Tilly-Group-Limited-tiLly-Privacy-Statement.pdf |
...
| 应用是否支持条件访问策略？ | 是 |
| 列出支持的策略类型 | 应用程序与 Azure AD 联合，因此可以使用所有条件访问策略 |
| 应用是否支持持续访问评估 (CAE)  | 是 |
| 应用是否在代码中存储任何凭据？ | 否 |
