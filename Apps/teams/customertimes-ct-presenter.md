...
description: CT 演示者的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66817602"
---
# <a name="ct-presenter"></a>CT 演示者

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 6 月 30 日</p>

* <a href="https://teams.microsoft.com/l/app/f33e9d75-e765-49f9-b7b2-d4bfa89066a0" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004401" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Customertimes 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Customertimes |
| 公司的网站 | [https://customertimes.com](https://customertimes.com) |
| 应用的使用条款 | [https://rd.ctclm.com/eula](https://rd.ctclm.com/eula) |
| 应用的核心功能 | 远程演示文稿 |
| 公司总部位置 | 法国 |
| 应用信息页 | [https://help.customertimes.com/articles/](https://help.customertimes.com/articles/) |
...
Customertimes 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
