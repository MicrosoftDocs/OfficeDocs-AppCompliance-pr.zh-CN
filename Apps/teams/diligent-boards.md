...
description: 有关"管理中心"的所有Boards信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "63549410"
---
# <a name="diligent-boards"></a>勤奋的 Boards
...
| 应用的核心功能 | Access&#8217;内部最一流的Microsoft Teams。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
