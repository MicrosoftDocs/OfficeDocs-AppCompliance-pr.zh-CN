...
description: 有关管理中心的所有Boards信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
---
# <a name="diligent-boards"></a>学习Boards

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 11 月 9 日</p>

* <a href="https://teams.microsoft.com/l/app/df797265-8679-421c-a75c-3540540daf42" target="_blank">在应用商店Teams视图</a>
...
| 合作伙伴公司名称 | 认真 |
| 公司网站 | [https://www.diligent.com](https://www.diligent.com) |
| 应用的使用条款 | [https://diligent.com/terms-of-use](https://diligent.com/terms-of-use) |
| 应用的核心功能 | Access&#8217;是 Microsoft Teams 一流的管理软件。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
...
此信息由"学习"提供，关于此应用如何收集和存储组织数据，以及你的组织将拥有对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础基础结构是否处理与 Microsoft 客户或他们的设备相关的任何数据？ | 否 |
| 应用或基础基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 租户Microsoft Teams ID 和Teams用户 ID |
...
| 应用是否遵守 SOC 1 (服务组织) ？ | 是 |
| 最新 SOC1 认证日期 |  2021-04-08 |
| 应用是否遵守 SOC 2 (服务组织) ？ | 是 |
| 你获得哪种 SOC 2 认证？ |  type2 |
| 最新 SOC2 认证日期 |  2021-04-08 |
| 应用是否遵守 SOC 3 (服务组织) ？ | 否 |
| 最新 SOC3 认证日期 | |
...
| 隐私策略 URL | https://diligent.com/privacy-policy |
