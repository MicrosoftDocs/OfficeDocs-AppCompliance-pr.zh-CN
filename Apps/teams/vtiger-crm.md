---
title: Vtiger CRM by Vtiger 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Vtiger CRM 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/08cb9b41-2ceb-4fe1-b85b-6eb6128aa138" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | Vtiger |
| 公司的网站 | [https://www.vtiger.com](https://www.vtiger.com) |
| 应用的使用条款 | [https://www.vtiger.com/policy-legal-center/terms-of-service/](https://www.vtiger.com/policy-legal-center/terms-of-service/) |
| 应用的核心功能 | 连接 Vtiger CRM 查看和共享团队内的交易、案例、任务或联系人。 |
| 公司总部位置 | 印度 |
| 应用信息页 | [https://help.vtiger.com/article/149601890-MS-Teams-and-Vtig...](https://help.vtiger.com/article/149601890-MS-Teams-and-Vtiger-CRM-Integration) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
Vtiger 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 应用程序 | 获取电子邮件地址以验证 AuthToken。 | [7a483472-4f1b-4c75-bff3-7a48dae227dc](../azure/7a483472-4f1b-4c75-bff3-7a48dae227dc.md) |
