...
description: 有关用户统一呼叫记录的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| 应用的核心功能 | 统一云呼叫录制 &amp; 语音 AI，实现合规性、销售 &amp; 服务性能 |
| 公司总部位置 | 澳大利亚 |
| 应用信息页面 | |
