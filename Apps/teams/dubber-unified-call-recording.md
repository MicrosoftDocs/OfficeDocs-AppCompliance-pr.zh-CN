...
description: 用于部署统一呼叫记录的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "62147511"
---
# <a name="dubber-unified-call-recording"></a>Dubber 统一的通话记录
