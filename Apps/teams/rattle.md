---
title: Rattle by Rattle 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/02/2022
...
description: Rattle 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "65628267"
---
# <a name="rattle"></a>摇铃

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 5 月 2 日</p>

* <a href="https://teams.microsoft.com/l/app/bacd48e3-a2e1-48db-992f-609eb58ac326" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004030" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Rattle 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | 摇铃 |
| 公司的网站 | [https://www.gorattle.com](https://www.gorattle.com) |
| 应用的使用条款 | [https://www.gorattle.com/terms-of-service](https://www.gorattle.com/terms-of-service) |
| 应用的核心功能 | Rattle 是一种无代码自动化工具，用于从 MS Teams 管理Salesforce |
| 公司总部位置 | 美国美国 |
| 应用信息页 | |
...
Rattle 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
| 启用了多重身份验证 (MFA) ： | 凭据、CodeRepositories |
...
| 隐私策略 URL | https://www.gorattle.com/privacy-policy |
