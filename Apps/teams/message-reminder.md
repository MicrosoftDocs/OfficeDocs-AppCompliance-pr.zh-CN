...
| 公司网站 | [https://systemz.io](https://systemz.io) |
| 应用的使用条款 | [https://systemz.io/files/EULA-Message-Reminder-EN.pdf](https://systemz.io/files/EULA-Message-Reminder-EN.pdf) |
| 应用的核心功能 | 将提醒设置为任何聊天或线程中的任意消息！ |
| 公司总部位置 | 联盟 ()  |
| 应用信息页面 | [https://systemz.io/product/message-reminder](https://systemz.io/product/message-reminder) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
