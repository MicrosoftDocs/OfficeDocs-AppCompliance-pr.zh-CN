---
title: Highspot by Highspot 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/14/2021
...
description: Highspot 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/55b7c78e-4768-47e0-97be-e6b953e6a0d0" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002894" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Highspot 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Highspot |
| 公司的网站 | [https://www.highspot.com](https://www.highspot.com) |
| 应用的使用条款 | [https://www.highspot.com/terms/](https://www.highspot.com/terms/) |
| 应用的核心功能 | Highspot 是代表喜爱的销售支持平台。 我们使公司能够提升推动战略增长的客户对话。 我们的直观平台结合了智能内容管理、培训、上下文指导、客户参与和可操作分析。 市场推广团队使用 Highspot 提供统一的购买体验，从而增加收入、客户满意度和保留期。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://www.highspot.com/overview/](https://www.highspot.com/overview/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
Highspot 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
