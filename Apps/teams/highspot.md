...
| 合作伙伴公司名称 | Highspot |
| 公司网站 | [https://www.highspot.com](https://www.highspot.com) |
| 应用的使用条款 | [https://www.highspot.com/terms/](https://www.highspot.com/terms/) |
| 应用的核心功能 | 高分是代表喜欢的销售支持平台。 我们使公司能够提升推动战略增长的客户对话。 我们的直观平台结合了智能内容管理、培训、上下文指导、客户参与度以及可操作分析。 进入市场团队使用 Highspot 提供统一的购买体验，从而增加收入、客户满意度和保留率。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://www.highspot.com/overview/](https://www.highspot.com/overview/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
