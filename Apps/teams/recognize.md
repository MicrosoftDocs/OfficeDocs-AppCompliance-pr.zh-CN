...
description: CSA STAR 注册表中所有可用于识别的安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及安全/合规性信息。
...
ms.locfileid: "65359553"
---
# <a name="recognize"></a>认识

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 5 月 11 日</p>

* <a href="https://teams.microsoft.com/l/app/bbcb7b0c-c687-4be0-91e3-362afebbbcd0" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001519" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Recognize 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | 认识 |
| 公司的网站 | [https://recognizeapp.com](https://recognizeapp.com) |
| 应用的使用条款 | [https://recognizeapp.com/terms](https://recognizeapp.com/terms) |
| 应用的核心功能 | 具有对等识别、提名、奖励、 &amp; 奖励证书的员工参与平台。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://recognizeapp.com](https://recognizeapp.com) |
...
Recognize 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
| 隐私策略 URL | https://recognizeapp.com/privacy |
