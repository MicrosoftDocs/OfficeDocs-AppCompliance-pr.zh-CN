...
description: CSA STAR 注册表中Org@Work的所有可用安全性和符合性信息、其数据处理策略、Microsoft Cloud App Security应用目录信息以及安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/b9f5d3b0-424e-473d-bcbe-dd01f17f9a41" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | Lundano |
| 公司的网站 | [https://www.lundano.com/en/](https://www.lundano.com/en/) |
| 应用的使用条款 | [https://cp.lundano.com/Terms_en.html](https://cp.lundano.com/Terms_en.html) |
| 应用的核心功能 | 使用协作规划管理工作组织和办公室占用情况 |
| 公司总部位置 | 法国 |
| 应用信息页 | [https://www.lundano.com/orgatwork/index.html#](https://www.lundano.com/orgatwork/index.html#) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
Lundano 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | 我们将存储数据。 我们只是使用数据将用户登录到Org@work | [aa1c54a1-f482-424d-9389-dbd131233483](../azure/aa1c54a1-f482-424d-9389-dbd131233483.md) |
>| 电子邮件 | 委托 | 我们将存储数据。 我们只是使用数据将用户登录到Org@work | [aa1c54a1-f482-424d-9389-dbd131233483](../azure/aa1c54a1-f482-424d-9389-dbd131233483.md) |
>| offline_access | 委托 | 我们将存储数据。 我们只是使用数据将用户登录到Org@work | [aa1c54a1-f482-424d-9389-dbd131233483](../azure/aa1c54a1-f482-424d-9389-dbd131233483.md) |
>| openid | 委托 | 我们将存储数据。 我们只是使用数据将用户登录到Org@work | [aa1c54a1-f482-424d-9389-dbd131233483](../azure/aa1c54a1-f482-424d-9389-dbd131233483.md) |
>| 个人资料 | 委托 | 我们将存储数据。 我们只是使用数据将用户登录到Org@work | [aa1c54a1-f482-424d-9389-dbd131233483](../azure/aa1c54a1-f482-424d-9389-dbd131233483.md) |
