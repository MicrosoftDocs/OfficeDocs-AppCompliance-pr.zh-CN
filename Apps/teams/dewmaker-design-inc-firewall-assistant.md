---
title: DewMaker Design， Inc. 针对防火墙助理的应用程序信息
ms.author: elmalova
author: elenamalova
ms.date: 02/08/2022
ms.topic: article
...
description: 防火墙助理的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "62477520"
---
# <a name="firewall-assistant"></a>防火墙助理

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 2 月 7 日</p>

* <a href="https://teams.microsoft.com/l/app/40b745ad-16a8-4eda-bf1c-5b48b0dc947d" target="_blank">在应用商店Teams视图</a>
...
DewMaker Design， Inc. 提供给 Microsoft 的信息：
...
| 公司网站 | [https://dewmaker.com](https://dewmaker.com) |
| 应用的使用条款 | [https://teamwell.services/terms.html](https://teamwell.services/terms.html) |
| 应用的核心功能 | Azure 的自助服务管理SQL Server Azure 防火墙规则Microsoft Teams。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
...
此信息由 DewMaker Design， Inc. 提供，用于了解此应用如何收集和存储组织数据，以及组织将拥有对应用收集的数据的控制。
...
| 数据库中存储了哪些数据？ | MS 登录 (和 Azure) 终结点数据的电子邮件地址 |
...
| 应用是否遵守 SOX Sarbanes-Oxley (法案) ？ | 是 |
