---
title: GamaLearn 针对 SwiftAssess 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/20/2021
...
* <a href="https://teams.microsoft.com/l/app/0cd07157-f297-4c2c-a23b-64577bceea6c" target="_blank">在应用商店Teams视图</a>
...
| 合作伙伴公司名称 | GamaLearn |
| 公司网站 | [https://gamalearn.com](https://gamalearn.com) |
| 应用的使用条款 | [https://swiftassess.com/terms-and-conditions](https://swiftassess.com/terms-and-conditions) |
| 应用的核心功能 | 满足所有评估需求的一站式商店，范围从尝试和真实的方法和功能开始，可指导你完成组织中所有级别的评估转换策略的创作、交付和跟踪。 SwiftAssess 提供了多个关键解决方案、功能和工作流，可简化和自动执行不同机构中的实际评估流程。 这包括安全性、辅助功能、分析、项目银行等的行业标准 |
| 公司总部位置 | 阿拉伯联合酋长国 ()  |
| 应用信息页面 | [https://swiftassess.com/about/partners/microsoft#Teams](https://swiftassess.com/about/partners/microsoft#Teams) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
GamaLearn 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及组织将拥有对应用收集的数据的控制有关。
