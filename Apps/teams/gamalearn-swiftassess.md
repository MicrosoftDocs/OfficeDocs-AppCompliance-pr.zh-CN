---
title: GamaLearn 提供的 SwiftAssess 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/20/2021
...
description: SwiftAssess 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/0cd07157-f297-4c2c-a23b-64577bceea6c" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001973" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

GamaLearn 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | GamaLearn |
| 公司的网站 | [https://gamalearn.com](https://gamalearn.com) |
| 应用的使用条款 | [https://swiftassess.com/terms-and-conditions](https://swiftassess.com/terms-and-conditions) |
| 应用的核心功能 | 满足所有评估需求的一站式商店，包括尝试和真实的方法和功能，指导你在组织中各个级别完成创作、交付和跟踪评估转换策略。 SwiftAssess 提供了多个关键解决方案、功能和工作流，可简化和自动化不同机构中的实际评估流程。 这涵盖了安全性、辅助功能、分析、项目银行等的行业标准 |
| 公司总部位置 | 阿拉伯联合酋长国 ()  |
| 应用信息页 | [https://swiftassess.com/about/partners/microsoft#Teams](https://swiftassess.com/about/partners/microsoft#Teams) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
GamaLearn 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
