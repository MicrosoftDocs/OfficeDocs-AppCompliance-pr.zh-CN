---
title: 来自 Dontknow Internet S.L 的 delibera 应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: 适用于 delibera 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66656043"
---
# <a name="delibera"></a>delibera

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 6 月 29 日</p>

* <a href="https://teams.microsoft.com/l/app/0c914e60-f699-11ea-b068-b9aff13273d5" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003380" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Dontknow Internet S.L 提供的信息。 到 Microsoft：
...
| 合作伙伴公司名称 | Dontknow Internet S.L. |
| 公司的网站 | [https://www.delibera.com](https://www.delibera.com) |
| 应用的使用条款 | [https://www.delibera.com/terms](https://www.delibera.com/terms) |
| 应用的核心功能 | Delibera 提高了组织中关键对话的质量，帮助领导者了解、决定和执行得更好 |
| 公司总部位置 | 西班牙 |
| 应用信息页 | [https://www.delibera.com](https://www.delibera.com) |
...
此信息已由 Dontknow Internet S.L 提供。 关于此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
| 隐私策略 URL | https://www.delibera.com/privacy |
