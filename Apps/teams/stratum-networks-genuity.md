---
title: Genuity by Stratum Networks 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2022
...
description: Genuity 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/1d37e38f-7513-4239-8251-208a749bba7e" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004008" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

层网络提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Stratum Networks |
| 公司的网站 | [https://secure.gogenuity.com](https://secure.gogenuity.com) |
| 应用的使用条款 | [https://gogenuity.com/terms](https://gogenuity.com/terms) |
| 应用的核心功能 | 在Microsoft Teams中管理 Genuity 支持人员 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | |
...
此信息已由 Stratum Networks 提供，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
