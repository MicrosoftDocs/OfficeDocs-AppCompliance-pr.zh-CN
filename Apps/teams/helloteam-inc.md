---
title: HelloTeam Inc. 的 HelloTeam 应用程序信息
ms.author: elmalova
author: elenamalova
ms.date: 11/10/2021
ms.topic: article
...
description: HelloTeam 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/58426e2f-12cd-4b86-bae3-37feb09bf146" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003448" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

HelloTeam Inc. 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | HelloTeam Inc. |
| 公司网站 | [https://www.helloteam.com](https://www.helloteam.com) |
| 应用的使用条款 | [https://www.helloteam.com/index.php/terms-and-conditions/](https://www.helloteam.com/index.php/terms-and-conditions/) |
| 应用的核心功能 | 适用于新式员工的一人一人成功平台 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
...
HelloTeam Inc. 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及您的组织将拥有对应用收集的数据的控制有关。
...
| 是否定期执行数据安全和隐私 (例如，数据保护影响评估或隐私) ，以确定与应用个人数据处理相关的风险？ | 否 |
