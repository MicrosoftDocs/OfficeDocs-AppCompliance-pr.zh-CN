...
| 应用的核心功能 | WorkJam 是数字工作场所解决方案行业领导选择安排其一线员工&#8212;作为你的一线生产力平台或在你的一线员工解决方案中。 WorkJam 以 37 多种语言提供，并部署在 38 多个国家/地区，它通过市场领先的任务管理、轮班管理、调查和微型学习工具提供员工业务流程总计。  |
| 公司总部位置 | 加拿大 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | 应用程序 | 向最终用户发送通知。 | [0b87cb84-073e-4cf6-a1ef-45d864ef2918](https://docs.microsoft.com/microsoft-365-app-certification/azure/0b87cb84-073e-4cf6-a1ef-45d864ef2918) |
>| User.Read | delegated | 用于识别和身份验证 | [0b87cb84-073e-4cf6-a1ef-45d864ef2918](https://docs.microsoft.com/microsoft-365-app-certification/azure/0b87cb84-073e-4cf6-a1ef-45d864ef2918) |
