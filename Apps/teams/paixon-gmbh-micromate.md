---
title: Paixon GmbH 的 Micromate 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Micromate 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/4112cc9a-d683-4ffd-b0bc-2013af7c7497" target="_blank">在应用商店Teams视图</a>
...
| 公司网站 | [https://paixon.ch](https://paixon.ch) |
| 应用的使用条款 | [https://micromate.ai/de/nutzungsbedingungen/](https://micromate.ai/de/nutzungsbedingungen/) |
| 应用的核心功能 | Micromate vermittelt durchierte Lerneinheitenkt im Chat nachhaltig Wissen. 窗体 von 自适应卡片中的 Micromate setzt da一 auf Microlearning durch die Ausspielung von Quizzes。 一个&#246;nliche Ansprache des Lernenden， ein Tutorial zur Funktionsweise der App und die Integration spannender Gamification Elemente moti一ren den Lernenden zur nachhaltigen Nutzung. |
| 公司总部位置 | Switzerland（瑞士） |
| 应用信息页面 | [https://micromate.ai/de/produkt/](https://micromate.ai/de/produkt/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Cloudscale |
...
Paixon GmbH 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及您的组织将拥有对应用收集的数据的控制有关。
