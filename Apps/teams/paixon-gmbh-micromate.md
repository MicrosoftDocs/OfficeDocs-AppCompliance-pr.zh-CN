---
title: 由 Paixon GmbH 提供的 Micromate 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: 适用于 Micromate 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/4112cc9a-d683-4ffd-b0bc-2013af7c7497" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002981" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Paixon GmbH 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Paixon GmbH |
| 公司的网站 | [https://paixon.ch](https://paixon.ch) |
| 应用的使用条款 | [https://micromate.ai/de/nutzungsbedingungen/](https://micromate.ai/de/nutzungsbedingungen/) |
| 应用的核心功能 | Micromate vermittelt durch personalisierte Lerneinheiten direkt im Chat nachhaltig Wissen. Micromate setzt dabei auf Microlearning durch die Ausspielung von Quizzes in Form von Adaptive Card. Die pers&#246;nliche Ansprache des Lernenden， ein Tutorial zur Funktionsweise der App und die Integration spannender Gamification Elemente motivieren den Lernenden zur nachhaltigen Nutzung. |
| 公司总部位置 | Switzerland（瑞士） |
| 应用信息页 | [https://micromate.ai/de/produkt/](https://micromate.ai/de/produkt/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | 云缩放 |
...
Paixon GmbH 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
