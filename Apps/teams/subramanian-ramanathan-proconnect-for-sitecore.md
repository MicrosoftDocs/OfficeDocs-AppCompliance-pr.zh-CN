---
title: 由 Subramanian Ramanathan 提供的适用于 Sitecore 的 Proconnect 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/24/2022
...
description: 适用于 Sitecore 的 Proconnect 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/a87fd06b-7e73-4374-ba75-4545b2470706" target="_blank">在 Teams 应用商店中查看</a>
...
| 公司的网站 | [https://subbu.ca](https://subbu.ca) |
...
| 应用的核心功能 | 使用有关工作流 &amp; 发布更新的即时警报增强内容创作体验。 此连接器还包括针对警报的适当操作，从而使内容作者能够更快地完成其工作。 此连接器可提高通信透明度，并包含有关网站/页面性能的见解。 |
| 公司总部位置 | 加拿大 |
| 应用信息页 | |
...
Subramanian Ramanathan 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
