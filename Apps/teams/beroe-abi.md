...
description: Abi 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/55560ea0-ae82-48b2-b71e-a45356f56bb1" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003862" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Beroe 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Beroe |
| 公司的网站 | [https://www.beroeinc.com](https://www.beroeinc.com) |
| 应用的使用条款 | [https://www.beroeinc.com/terms/](https://www.beroeinc.com/terms/) |
| 应用的核心功能 | Abi &#8211; AI 支持的数字采购助理 |
| 公司总部位置 | 印度 |
| 应用信息页 | [https://www.beroeinc.com/beroe-live-ai](https://www.beroeinc.com/beroe-live-ai) |
...
Beroe 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 名字，姓氏 &amp; 工作电子邮件 ID |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 名字，姓氏，工作电子邮件 ID &amp; 对话 ID |
...
| 隐私策略 URL | https://www.beroeinc.com/privacy-policy/ |
