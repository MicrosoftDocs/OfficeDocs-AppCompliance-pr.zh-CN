...
| 合作伙伴公司名称 | Evernote |
| 公司网站 | [https://evernote.com](https://evernote.com) |
| 应用的使用条款 | [https://evernote.com/legal/terms-of-service](https://evernote.com/legal/terms-of-service) |
| 应用的核心功能 | 设置收件箱。 将重要电子邮件保存到 Evernote  |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://evernote.com/about-us](https://evernote.com/about-us) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | GCP |
