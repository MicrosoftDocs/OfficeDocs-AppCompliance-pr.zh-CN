---
title: Evernote by Evernote 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/24/2021
...
description: Evernote 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/4e1f8576-93d5-4c24-abb5-f02782e00a4e" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | Evernote |
| 公司的网站 | [https://evernote.com](https://evernote.com) |
| 应用的使用条款 | [https://evernote.com/legal/terms-of-service](https://evernote.com/legal/terms-of-service) |
| 应用的核心功能 | 驯服收件箱。 将重要电子邮件保存到 Evernote  |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://evernote.com/about-us](https://evernote.com/about-us) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | GCP |
...
Evernote 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
