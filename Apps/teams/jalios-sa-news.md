---
title: 新闻应用程序信息 - Jalios by Jalios SA
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: 新闻 - Jalios 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/a8662bd0-31c6-4254-b48f-0f54d0b92fcb" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003889" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Jalios SA 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Jalios SA |
| 公司的网站 | [https://www.jalios.com](https://www.jalios.com) |
| 应用的使用条款 | [https://jalios.com/msteams-app/termsofuse](https://jalios.com/msteams-app/termsofuse) |
| 应用的核心功能 | 动态和可自定义的数字公司报纸  |
| 公司总部位置 | 法国 |
| 应用信息页 | |
...
Jalios SA 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 可访问 |
| 应用会处理哪些数据？ | 用户配置文件数据、用户电子邮件数据 |
...
| 隐私策略 URL | https://jalios.com/msteams-app/privacy |
...
| 如果你的应用不使用上述库之一，它使用什么身份验证库或库？ | Microsoft Teams JavaScript 客户端 SDK |
| 应用是否支持条件访问策略？ | 否 |
| 应用是否支持持续访问评估 (CAE)  | 否 |
| 应用是否在代码中存储任何凭据？ | 可访问 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 委托 | 读取自定义架构扩展属性  | [5159b699-a8c3-4170-ae49-c22ccb76cdde](../azure/5159b699-a8c3-4170-ae49-c22ccb76cdde.md) |
>| User.Read | 委托 | 读取用户数据以将他登录到 Jalios Workplace | [5159b699-a8c3-4170-ae49-c22ccb76cdde](../azure/5159b699-a8c3-4170-ae49-c22ccb76cdde.md) |
>| offline_access | 委托 | SSO：维护对数据的访问权限 | [5159b699-a8c3-4170-ae49-c22ccb76cdde](../azure/5159b699-a8c3-4170-ae49-c22ccb76cdde.md) |
>| openid | 委托 | 让用户登录 | [5159b699-a8c3-4170-ae49-c22ccb76cdde](../azure/5159b699-a8c3-4170-ae49-c22ccb76cdde.md) |
