---
title: timeghost 的应用程序信息 - 按 timeghost.io 进行时间跟踪
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/23/2022
...
* <a href="https://teams.microsoft.com/l/app/e3956558-7399-4ec1-848a-c61a2aa95bc1" target="_blank">在 Teams 应用商店中查看</a>
...
timeghost.io 提供给 Microsoft 的信息：
...
| 公司总部位置 | 德国 |
| 应用信息页 | [https://timeghost.io](https://timeghost.io) |
...
timeghost.io 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 用户配置文件数据、用户邮件数据、用户日历数据 |
...
| 启用了多重身份验证 (MFA) ： | DNSManagement、CodeRepositories、Credential |
...
| 隐私策略 URL | https://timeghost.io/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 委托 | 为了将 Microsoft 365 应用集成到 timeghost，并在 timeghost 源中显示特定Outlook 日历事件。 | [f6f894ce-5b44-4c9b-aff4-253d2fbe8a99](../azure/f6f894ce-5b44-4c9b-aff4-253d2fbe8a99.md) |
>| People.Read | 委托 | 若要将 Microsoft 365 应用集成到 timeghost 并显示，请显示链接到其 Microsoft 365 配置文件的用户头像。 | [f6f894ce-5b44-4c9b-aff4-253d2fbe8a99](../azure/f6f894ce-5b44-4c9b-aff4-253d2fbe8a99.md) |
>| User.Read | 委托 | 为了将 Microsoft 365 应用集成到 timeghost，并显示其公司中的其他用户也使用 timeghost。 | [f6f894ce-5b44-4c9b-aff4-253d2fbe8a99](../azure/f6f894ce-5b44-4c9b-aff4-253d2fbe8a99.md) |
>| User.ReadBasic.All | 委托 | 若要将 Microsoft 365 应用集成到 timeghost 并显示，请显示链接到其 Microsoft 365 配置文件的用户头像。 | [f6f894ce-5b44-4c9b-aff4-253d2fbe8a99](../azure/f6f894ce-5b44-4c9b-aff4-253d2fbe8a99.md) |
>| openid | 委托 | 内部用户 ID  | [f6f894ce-5b44-4c9b-aff4-253d2fbe8a99](../azure/f6f894ce-5b44-4c9b-aff4-253d2fbe8a99.md) |
>| 个人资料 | 委托 | 若要将 Microsoft 365 应用集成到 timeghost 并显示，请显示链接到其 Microsoft 365 配置文件的用户头像。 | [f6f894ce-5b44-4c9b-aff4-253d2fbe8a99](../azure/f6f894ce-5b44-4c9b-aff4-253d2fbe8a99.md) |
