---
title: PT Privy Identitas Digital 的 PrivyNow 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/14/2022
...
description: PrivyNow 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66546999"
---
# <a name="privynow"></a>PrivyNow

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 3 月 2 日</p>

* <a href="https://teams.microsoft.com/l/app/00e595af-26e4-46b9-97d1-46e0831b1f02" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004229" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

PT Privy Identitas Digital 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | PT Privy Identitas Digital |
| 公司的网站 | [https://privynow.com/about-us/](https://privynow.com/about-us/) |
| 应用的使用条款 | [https://privynow.com/terms-of-use/](https://privynow.com/terms-of-use/) |
| 应用的核心功能 | 签署各种文档是日常生活的重要组成部分，延迟更改一切。 快速完成与 PrivyNow 的交易。 在 1 分钟内上传和共享文档。   若要使用此应用，用户必须具有活动的 PrivyNow 帐户，请通过 PrivyNow.com 注册或联系我们的支持团队以获取更多详细信息。 |
| 公司总部位置 | 印度尼西亚 |
| 应用信息页 | [https://privynow.com/guide/](https://privynow.com/guide/) |
...
PT Privy Identitas Digital 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
| 数据库中存储了哪些数据？ | 全名、电子邮件 |
| 如果基础结构处理或存储 Microsoft 客户数据，则此数据在地理上存储在哪里？ | 印度尼西亚 |
| 是否已建立数据出租和处置流程？ | 是 |
| 帐户终止后数据保留多长时间？ | 不保留 |
| 是否已建立数据访问管理过程？ | 是 |
...
| 隐私策略 URL | https://privynow.com/terms-of-use/ |
