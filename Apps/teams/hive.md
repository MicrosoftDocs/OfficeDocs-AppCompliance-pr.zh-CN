...
* <a href="https://teams.microsoft.com/l/app/4a863b83-e52f-412d-ba6a-3b9608090c7d" target="_blank">在应用商店Teams视图</a>
...
| 合作伙伴公司名称 | Hive |
| 公司网站 | [https://www.hive.com](https://www.hive.com) |
| 应用的使用条款 | [https://hive.com/terms](https://hive.com/terms) |
| 应用的核心功能 | 配置单元使团队可以更有效地协作 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://www.hive.com](https://www.hive.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
此信息由 Hive 提供，用于了解此应用如何收集和存储组织数据，以及组织将拥有对应用收集的数据的控制。
