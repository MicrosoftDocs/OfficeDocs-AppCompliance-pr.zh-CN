...
description: Hive 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "64879729"
---
# <a name="hive"></a>Hive

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 9 月 17 日</p>

* <a href="https://teams.microsoft.com/l/app/4a863b83-e52f-412d-ba6a-3b9608090c7d" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000093" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Hive 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Hive |
| 公司的网站 | [https://www.hive.com](https://www.hive.com) |
| 应用的使用条款 | [https://hive.com/terms](https://hive.com/terms) |
| 应用的核心功能 | Hive 使团队能够更有效地协作 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://www.hive.com](https://www.hive.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
Hive 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
