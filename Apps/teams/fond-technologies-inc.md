...
ms.locfileid: "63538150"
---
# <a name="fond"></a>Fond

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 12 月 17 日</p>

* <a href="https://teams.microsoft.com/l/app/d25d7cc9-0a7e-41e2-ad98-f446141a8ffa" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003631" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

由 Technologie Technologies， Inc. 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Fond Technologies, Inc. |
| 公司网站 | [https://fond.co](https://fond.co) |
| 应用的使用条款 | [https://www.fond.co/tos/](https://www.fond.co/tos/) |
| 应用的核心功能 | 用百度来庆祝同事的成就 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://fond.co/products/features/fond-teams-integration/](https://fond.co/products/features/fond-teams-integration/) |
...
此信息由一些设备技术公司提供，用于了解此应用如何收集和存储组织数据，以及组织将拥有对应用收集的数据的控制。
...
| 数据库中存储了哪些数据？ | 客户租户 ID、团队名称、频道名称、Webhook URL |
...
| 隐私策略 URL | https://www.fond.co/privacy/ |
