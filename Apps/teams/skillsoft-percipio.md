...
description: 有关 Skillsoft Percipio 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/858597e0-33db-4cc0-bd1e-466b6ceb977a" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003256" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

由 Skillsoft 提供给 Microsoft 的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | Skillsoft Percipio |
| ID | WA200003256 |
| Office 365支持的客户端 | Microsoft Teams |
| 合作伙伴公司名称 | Skillsoft |
| 公司网站 | [https://www.skillsoft.com](https://www.skillsoft.com) |
| 应用的使用条款 | [https://www.skillsoft.com/terms-of-use](https://www.skillsoft.com/terms-of-use) |
| 应用的核心功能 | 利用 Skillsoft Percipio，可以访问整套 Percipio 培训内容和功能。 |
| 公司总部位置 | 爱尔兰 |
| 应用信息页面 | |
...
此信息由 Skillsoft 提供，用于了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
