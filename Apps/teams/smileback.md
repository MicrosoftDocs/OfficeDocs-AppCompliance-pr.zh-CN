...
| 合作伙伴公司名称 | SmileBack |
| 公司网站 | [https://smileback.com](https://smileback.com) |
| 应用的使用条款 | [https://smileback.com/terms](https://smileback.com/terms) |
| 应用的核心功能 | Back 是一个客户满意度平台，专为托管服务提供商、技术支持和 IT 支持团队设计。 我们的 CSAT + NPS&#174;可帮助 IT 专业人员收集、报告客户反馈并采取行动。 CSAT (客户满意度调查) 帮助你了解当前的客户满意度，从而让你能够即时直接衡量每个客户交互情况 (支持票证) 。 NPS&#174; (推广者分数) 可让你深入了解总体客户关系。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
