...
description: SmileBack 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/273e3385-93c3-4054-8c03-328b8c3fd9af" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | SmileBack |
| 公司的网站 | [https://smileback.com](https://smileback.com) |
| 应用的使用条款 | [https://smileback.com/terms](https://smileback.com/terms) |
| 应用的核心功能 | SmileBack 是专为托管服务提供商、技术支持人员和 IT 支持团队设计的客户满意度平台。 我们的 CSAT + NPS&#174;工具可帮助 IT 专业人员收集、报告和处理客户反馈。 CSAT (客户满意度调查) 帮助你了解当前的客户满意度，使你能够即时、直接地衡量每一个客户交互 (支持票证) 。 NPS&#174; (Net Promoter Score) 提供对整体客户关系的见解。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS，Heroku |
...
SmileBack 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
