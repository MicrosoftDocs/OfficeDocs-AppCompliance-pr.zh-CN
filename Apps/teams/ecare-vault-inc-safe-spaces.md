...
>|:----------------|:------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|:--------------------|
>| EduRoster.Read | delegated | 名称和出生日期用于预填充输入字段 | 无 - 存储的所有数据都是用户 (预填充到字段中的数据，然后是用户提交)  | [6919164d-b678-4c3d-a268-e6fbecc1e68d](https://docs.microsoft.com/microsoft-365-app-certification/azure/6919164d-b678-4c3d-a268-e6fbecc1e68d) |
...
>| GroupMember.Read.All | delegated | 用于生成电子保管库团队名单的团队成员的 AAD ID | 存储 AAD 用户 ID 以与每个成员的电子邮件保管库用户帐户关联 | [6919164d-b678-4c3d-a268-e6fbecc1e68d](https://docs.microsoft.com/microsoft-365-app-certification/azure/6919164d-b678-4c3d-a268-e6fbecc1e68d) |
>| User.Read | delegated | 电子邮件地址和 AAD ID 用于注册用户 &amp; 并将其与电子数据保管库用户帐户关联 | 用户帐户的电子邮件地址和 AAD ID，以及通过 Bot Framework 向用户发送通知 | [6919164d-b678-4c3d-a268-e6fbecc1e68d](https://docs.microsoft.com/microsoft-365-app-certification/azure/6919164d-b678-4c3d-a268-e6fbecc1e68d) |
>| User.Read.All | delegated | 姓名和、AAD ID 和电子邮件地址，仅适用于安装了空格保险箱频道的成员 | 针对 eCare Vault 用户帐户存储的名称、AAD ID 和电子邮件地址 | [6919164d-b678-4c3d-a268-e6fbecc1e68d](https://docs.microsoft.com/microsoft-365-app-certification/azure/6919164d-b678-4c3d-a268-e6fbecc1e68d) |
...
>| openid | delegated | 电子邮件地址和 AAD ID 用于注册用户 &amp; 并将其与电子数据保管库用户帐户关联 | 用户帐户的电子邮件地址和 AAD ID，以及通过 Bot Framework 向用户发送通知 | [6919164d-b678-4c3d-a268-e6fbecc1e68d](https://docs.microsoft.com/microsoft-365-app-certification/azure/6919164d-b678-4c3d-a268-e6fbecc1e68d) |
...
>|:-----------------------------------------------------|:------------------------------|:----------------------------------------|
>| eCare Vault | 租户/公司信息、用户登录域名、用户登录信息Microsoft Teams &amp; 团队频道标识符。 | 保险箱空间是电子数据保管库平台的配套应用程序。 OII 要求将用户从 Microsoft Teams链接到公司的电子保管库用户。 |
