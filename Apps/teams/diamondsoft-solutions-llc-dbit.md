...
| 公司网站 | [https://www.diamondsoftsolutions.com](https://www.diamondsoftsolutions.com) |
| 应用的使用条款 | [https://www.dbit.io/termsofuse.html](https://www.dbit.io/termsofuse.html) |
| 应用的核心功能 | 具有较少麻烦的 DBit 密码管理解决方案。 DBit 是一种适用于小型和大型团队的密码管理工具。 使用 DBit，你可以安全地在团队成员之间共享密码。 生成的共享密码和密码将在设置的分钟数后自动过期。 你的密码在我们的服务器的内存中进行加密，从不存储到磁盘存储中。 密码过期后，将从服务器内存中删除它们。 此应用程序由 Diamondsoft Solutions， LLC 开发 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
