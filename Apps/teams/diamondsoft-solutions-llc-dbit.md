---
title: DBit by Diamondsoft Solutions、LLC 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/29/2021
...
description: DBit 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/b28bb657-8edd-47ae-a912-c5fc11b3e89e" target="_blank">Teams存储区中的视图</a>
...
| 公司的网站 | [https://www.diamondsoftsolutions.com](https://www.diamondsoftsolutions.com) |
| 应用的使用条款 | [https://www.dbit.io/termsofuse.html](https://www.dbit.io/termsofuse.html) |
| 应用的核心功能 | 麻烦较少的 DBit 密码管理解决方案。 DBit 是适用于小型到大型团队的密码管理工具。 使用 DBit，可以在团队成员之间安全地共享密码。 生成的共享密码和密码将在设置的分钟数后自动过期。 密码在我们的服务器上的内存中加密，并且永远不会存储到磁盘存储。 密码过期后，将从服务器的内存中删除密码。 此应用由 Diamondsoft Solutions、LLC 开发 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | |
...
Diamondsoft Solutions、LLC 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
