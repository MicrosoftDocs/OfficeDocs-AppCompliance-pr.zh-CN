...
| 公司网站 | [https://cyberday.ai](https://cyberday.ai) |
| 应用的使用条款 | [https://cyberday.ai/terms-of-use](https://cyberday.ai/terms-of-use) |
| 应用的核心功能 | 网络日是一种信息安全管理系统，可指导客户遵守他们选择的安全框架。 |
| 公司总部位置 | 芬兰 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegated | 使用电子邮件标识此用户是的应用管理员的用户 + 显示 | [1c7d277c-ff8a-4ea4-bc14-7d06314f8941](https://docs.microsoft.com/microsoft-365-app-certification/azure/1c7d277c-ff8a-4ea4-bc14-7d06314f8941) |
>| openid | delegated | 使用用户 ID 标识用户 | [1c7d277c-ff8a-4ea4-bc14-7d06314f8941](https://docs.microsoft.com/microsoft-365-app-certification/azure/1c7d277c-ff8a-4ea4-bc14-7d06314f8941) |
