---
title: Cyberday by Digiturvamalli 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Cyberday 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/a8e43ae4-a97b-4d1a-b364-b27794da19a4" target="_blank">Teams存储区中的视图</a>
...
| 公司的网站 | [https://cyberday.ai](https://cyberday.ai) |
| 应用的使用条款 | [https://cyberday.ai/terms-of-use](https://cyberday.ai/terms-of-use) |
| 应用的核心功能 | Cyberday 是一种信息安全管理系统，可引导客户遵守他们选择的安全框架。 |
| 公司总部位置 | 芬兰 |
| 应用信息页 | [https://cyberday.ai](https://cyberday.ai) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
Digiturvamalli 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | 使用电子邮件标识此用户是谁的应用管理员的用户 + 显示 | [1c7d277c-ff8a-4ea4-bc14-7d06314f8941](../azure/1c7d277c-ff8a-4ea4-bc14-7d06314f8941.md) |
>| openid | 委托 | 使用用户 ID 标识用户 | [1c7d277c-ff8a-4ea4-bc14-7d06314f8941](../azure/1c7d277c-ff8a-4ea4-bc14-7d06314f8941.md) |
