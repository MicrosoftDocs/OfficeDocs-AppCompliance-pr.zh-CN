---
title: Gtmhub by Gtmhub 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Gtmhub 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66564534"
---
# <a name="gtmhub"></a>Gtmhub

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 6 月 28 日</p>

* <a href="https://teams.microsoft.com/l/app/5fdd80e2-4d58-4c5c-ac85-356c1b2a0bba" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001164" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Gtmhub 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Gtmhub |
| 公司的网站 | [https://www.gtmhub.com](https://www.gtmhub.com) |
| 应用的使用条款 | [https://gtmhub.com/terms-of-service](https://gtmhub.com/terms-of-service) |
| 应用的核心功能 | 允许你在不离开 MS Teams 的情况下查看、共享和更新 OKR。 查看 OKR、在频道中共享 OKR 以及更新关键结果的速度从未如此快。 更新体验与在 Gtmhub 中一样无缝。 从 Gtmhub 选项卡可以访问中心，其中显示所有 OKR 和任务。  |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://help.gtmhub.com/en/articles/3558083-how-to-view-and...](https://help.gtmhub.com/en/articles/3558083-how-to-view-and-update-okrs-from-ms-teams) |
...
Gtmhub 提供了有关此应用如何收集和存储组织数据以及组织对应用收集的数据的控制的信息。
...
| 隐私策略 URL | https://help.gtmhub.com/en/articles/633973-privacy-policy |
