---
title: Gtmhub 的应用程序信息（由 Gtmhub 提供）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
* <a href="https://teams.microsoft.com/l/app/5fdd80e2-4d58-4c5c-ac85-356c1b2a0bba" target="_blank">在应用商店Teams视图</a>
...
| 合作伙伴公司名称 | Gtmhub |
| 公司网站 | [https://www.gtmhub.com](https://www.gtmhub.com) |
| 应用的使用条款 | [https://gtmhub.com/terms-of-service](https://gtmhub.com/terms-of-service) |
| 应用的核心功能 | 允许查看、共享和更新 OKR，而无需离开 MS Teams。 查看 OKR、在频道中共享它们和更新关键结果从未如此快速。 更新体验与 Gtmhub 中的体验一样无缝。 从 Gtmhub 选项卡中，可以访问 Hub，其中显示了所有 OKR 和任务。  |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://help.gtmhub.com/en/articles/3558083-how-to-view-and...](https://help.gtmhub.com/en/articles/3558083-how-to-view-and-update-okrs-from-ms-teams) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
Gtmhub 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及组织将拥有对应用收集的数据的控制有关。
