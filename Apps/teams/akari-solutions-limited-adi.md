...
| 应用的核心功能 | ADI 可帮助你满足所有辅助功能需求，并增强变更管理计划。 你可以要求 ADI 提供有关如何在 Microsoft Teams 内使用辅助功能的答案、建议和信息，你可以了解隐藏的和情境式残障以及适合哪些工具和提示。 ADI 将用基于文本的对话答案、字节大小的视频和来自各种源的概念链接的混合方式回答你。 |
| 公司总部位置 | 英国大英和爱尔兰 ()  |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
