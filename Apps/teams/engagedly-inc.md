...
description: 用于参与的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "62147203"
---
# <a name="engagedly"></a>Engagedly

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 8 月 21 日</p>

* <a href="https://teams.microsoft.com/l/app/d794bf4c-ef30-4d92-9e2e-6944e9f1512e" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003446" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Engagedly Inc 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Engagedly Inc |
| 公司网站 | [https://engagedly.com](https://engagedly.com) |
| 应用的使用条款 | [https://engagedly.com/terms/](https://engagedly.com/terms/) |
| 应用的核心功能 | 参与是一项人才管理解决方案，它提供持续绩效管理以及极具吸引力的绩效考核，推动员工参与游戏系统，并提供一系列分析和员工规划工具。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
...
此信息由 Engagedly Inc 提供，用于了解此应用如何收集和存储组织数据，以及组织将拥有对应用收集的数据的控制。
...
| 隐私策略 URL | https://engagedly.com/privacy/ |
