...
description: 用于一个功能区 VLE 的所有可用安全性和合规性信息、其数据处理策略、MICROSOFT CLOUD APP SECURITY应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| 应用的核心功能 | 橄榄色 VLE 可帮助国家/组织和教育提供商创建和管理课程、大众化计划和教育者。 教育提供商 管理员可以构建自己的在线课程、测试、作业、计划，并将其分配给学生。 Microsoft Teams API 集成Graph，以便管理员还可以在视频教室内创建视频教室Teams邀请学生加入视频教室。 学习者可以看到并学习其课程、计划和管理项目组合证据。 管理员还可以发布新闻源。 |
| 公司总部位置 | 爱尔兰 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
