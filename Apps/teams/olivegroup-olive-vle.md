---
title: OliveGroup 的 OLIVE VLE 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/12/2021
...
description: OLIVE VLE 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/ccb8561b-4f4a-496f-898f-b27e681c3a62" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | OliveGroup |
| 公司的网站 | [https://www.olivegroup.io](https://www.olivegroup.io) |
| 应用的使用条款 | [https://vle.olivegroup.io/termsofuse](https://vle.olivegroup.io/termsofuse) |
| 应用的核心功能 | Olive VLE 可帮助教程和教育提供商创建和管理课程、学徒计划和学习者。 教育提供商管理员可以构建自己的在线课程、测试、作业、计划，并将其分配给学习者。 Microsoft Teams使用图形 API集成，以便管理员还可以在Teams中创建视频教室，并邀请学员进入视频教室。 学习者可以查看并学习他们的课程、课程和管理项目组合证据。 管理员还可以发布新闻源。 |
| 公司总部位置 | 爱尔兰 |
| 应用信息页 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
OliveGroup 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
