---
title: 一个通过一个（由一个来）的一组用于一组用户的应用程序信息
ms.author: elmalova
author: elenamalova
ms.date: 07/12/2021
ms.topic: article
...
description: 用于一个功能区 VLE 的所有可用安全性和合规性信息、它的数据处理策略、MICROSOFT CLOUD APP SECURITY应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/ccb8561b-4f4a-496f-898f-b27e681c3a62" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003331" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

由 OliveGroup 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | OliveGroup |
| 公司网站 | [https://www.olivegroup.io](https://www.olivegroup.io) |
| 应用的使用条款 | [https://vle.olivegroup.io/termsofuse](https://vle.olivegroup.io/termsofuse) |
| 应用的核心功能 | 橄榄色 VLE 可帮助国家/组织和教育提供商创建和管理课程、大众化计划和教育者。 教育提供商 管理员可以构建自己的在线课程、测试、作业、计划，并将其分配给学生。 Microsoft Teams使用 Graph API 集成，以便管理员还可以在 Teams 内创建视频教室，并邀请观看者加入视频教室。 学习者可以看到并学习其课程、计划和管理项目组合证据。 管理员还可以发布新闻源。 |
| 公司总部位置 | 爱尔兰 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
此信息由一些用户提供，这些信息与此应用程序如何收集和存储组织数据以及组织对应用收集的数据的控制有关。
