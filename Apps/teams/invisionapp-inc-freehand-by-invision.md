---
title: InVisionApp，Inc. 的 InVision Freehand 应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/06/2021
...
description: InVision 为 Freehand 提供的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/67cf2c5a-db0e-4256-a423-14010cbeafdd" target="_blank">Teams存储区中的视图</a>
...
InVisionApp， Inc. 提供给 Microsoft 的信息：
...
| 公司的网站 | [https://www.invisionapp.com](https://www.invisionapp.com) |
| 应用的使用条款 | [https://www.invisionapp.com/legal/terms-of-service](https://www.invisionapp.com/legal/terms-of-service) |
| 应用的核心功能 | 使用联机白板实时协作。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://www.invisionapp.com/freehand](https://www.invisionapp.com/freehand) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
InVisionApp， Inc. 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
| 最新的 SOC2 认证日期 | 2020-05-13 |
| 应用是否符合服务组织控制 (SOC 3) ？ | 是 |
| 最新的 SOC3 认证日期 | 2020-06-12 |
