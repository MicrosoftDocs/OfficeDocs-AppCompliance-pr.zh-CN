...
description: 1Page 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
<p>开发人员上次更新时间：2021 年 12 月 31 日</p>

* <a href="https://teams.microsoft.com/l/app/2b876f4d-2e6b-4ee7-9b09-8893808c1380" target="_blank">在应用商店Teams视图</a>
...
| 合作伙伴公司名称 | OAYAW， Inc. |
| 公司网站 | [https://www.get1page.com](https://www.get1page.com) |
| 应用的使用条款 | [https://www.get1page.com/en/terms-of-use](https://www.get1page.com/en/terms-of-use) |
| 应用的核心功能 | 使用 1Page &amp; 摘要对话入门者（每次会议前几分钟）对会议进行超级图表 |
| 公司总部位置 | 美国美国 |
| 应用信息页面 | [https://www.get1page.com](https://www.get1page.com) |
...
此信息由 OAYAW， Inc. 提供，用于了解此应用程序如何收集和存储组织数据，以及组织将拥有对应用收集的数据的控制。
...
| 数据库中存储了哪些数据？ | 电子邮件地址、姓名、日历事件 |
| 如果基础结构处理或存储 Microsoft 客户数据，那么此数据在地理位置上存储在哪里？ | 法国 |
| 你是否已制定数据租用和处置流程？ | 是 |
...
| 隐私策略 URL | https://www.get1page.com/en/privacy-policy |
...
| 你的应用是否支持条件访问策略？ | 是 |
| 列出支持的策略类型 | 根据用户已连接的应用程序和购买的应用内项目，用户将能够查看或看不到特定卡片。 |
| 你的应用是否支持 CAE (连续访问)  | 是 |
| 你的应用是否将任何凭据存储在代码中？ | 否 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | delegated | 借助日历信息，我们可以为会议中的个人提供相关数据。 | [d7e20ef1-fc4b-42e0-a74f-a3c9a806aa73](../azure/d7e20ef1-fc4b-42e0-a74f-a3c9a806aa73.md) |
