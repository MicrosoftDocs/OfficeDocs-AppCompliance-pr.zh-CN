...
>|:-----------------------------------------------------|:------------------------------|:----------------------------------------|
>| 我们将数据传输到我们的应用程序服务 (Talentcentral： https://talentcentral.eu.shl.com/admin) | EUII：Microsoft teams 用户名和团队用户 ID | 来自 Teams 应用的用户名将在我们的另一个应用程序中使用，该应用程序触发包含用户名的电子邮件。 和用户 ID，我们保留为标识符，并映射它&#8217;用户 ID。 |
