...
description: SHL 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/0c52adc0-18a0-45ca-b6ee-154cf1ef87e2" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | SHL |
| 公司的网站 | [https://shl.com](https://shl.com) |
| 应用的使用条款 | [https://www.shl.com/en/terms-of-service/](https://www.shl.com/en/terms-of-service/) |
| 应用的核心功能 | SHL 是人力资源技术和心理识别科学的全球领导者，它能够深入了解人们，帮助公司制定强大的劳动力解决方案来推动业务成果。 SHL 带来了强大而透明的 AI 技术、数据科学和客观性，帮助公司吸引、开发和增加在数字时代取得成功所需的劳动力。 |
| 公司总部位置 | 大不列颠及北爱尔兰联合王国 ()  |
| 应用信息页 | [https://www.shl.com/en/about/](https://www.shl.com/en/about/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
SHL 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read.Shared | 委托 | 可用的共享 Calander 槽 | [afd2c390-8b78-40fa-913b-7fc5911e884a](../azure/afd2c390-8b78-40fa-913b-7fc5911e884a.md) |
