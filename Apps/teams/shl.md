...
| 合作伙伴公司名称 | SHL |
| 公司网站 | [https://shl.com](https://shl.com) |
| 应用的使用条款 | [https://www.shl.com/en/terms-of-service/](https://www.shl.com/en/terms-of-service/) |
| 应用的核心功能 | SHL 是人力资源技术和现代科学的全球领导者，它可带来深入的人员见解，帮助公司制定功能强大的员工解决方案，从而推动业务成果。 SHL 提供了强大且透明的 AI 技术、数据科学以及面向对象，可帮助公司吸引、开发和增加他们在数字时代取得成功所需的员工。 |
| 公司总部位置 | 英国大英和爱尔兰 ()  |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
SHL 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及组织将拥有对应用收集的数据的控制有关。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read.Shared | delegated | 可用的共享日历槽位 | [afd2c390-8b78-40fa-913b-7fc5911e884a](https://docs.microsoft.com/microsoft-365-app-certification/azure/afd2c390-8b78-40fa-913b-7fc5911e884a) |
