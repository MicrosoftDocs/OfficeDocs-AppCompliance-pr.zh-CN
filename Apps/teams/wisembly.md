...
description: Wisembly 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/b63d5c73-8c76-4d8b-b0dc-ca35c6e37a90" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | Wisembly |
| 公司的网站 | [https://wisembly.com](https://wisembly.com) |
| 应用的使用条款 | [https://wisembly.com/en/condition-of-sale.html](https://wisembly.com/en/condition-of-sale.html) |
| 应用的核心功能 | 创建简单且引人入胜的虚拟和混合活动研讨会、会议、研讨会...从头到尾，明智地指导你完成活动项目，无论需要什么：可自定义主页、注册、组织研讨会和全体会议、视频工具、交互式功能等。 |
| 公司总部位置 | 法国 |
| 应用信息页 | [https://wisembly.com](https://wisembly.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
Wisembly 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
