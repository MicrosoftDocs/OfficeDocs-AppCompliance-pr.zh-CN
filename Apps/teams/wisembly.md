...
| 合作伙伴公司名称 | Wisembly |
| 公司网站 | [https://wisembly.com](https://wisembly.com) |
| 应用的使用条款 | [https://wisembly.com/en/condition-of-sale.html](https://wisembly.com/en/condition-of-sale.html) |
| 应用的核心功能 | 创建简单且极具吸引力的虚拟和混合活动研讨会、会议、研讨会...从开始到完成，从头到头，从头到下，你都会指导你完成事件项目：可自定义的主页、注册、研讨会和主持会话的组织、视频工具、交互功能等。 |
| 公司总部位置 | 法国 |
| 应用信息页面 | [https://wisembly.com](https://wisembly.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
