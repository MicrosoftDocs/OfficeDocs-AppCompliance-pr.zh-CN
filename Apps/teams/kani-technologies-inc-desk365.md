...
| 应用的核心功能 | Desk365 是现代化支持人员，Microsoft 365工作场所。 借助 Desk365 Teams应用，你可以轻松与支持团队的其他代理协作。 你可以回复票证、添加注释、检查状态、更改票证属性，所有这些都无需离开Microsoft Teams。 Desk365 最多 4 个代理是免费的。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
