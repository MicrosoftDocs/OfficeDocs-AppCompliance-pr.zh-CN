...
description: Desk365 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/7656ec6e-c63b-4571-8ab8-95d1c451d1e6" target="_blank">Teams存储区中的视图</a>
...
| 公司的网站 | [https://www.desk365.io](https://www.desk365.io) |
| 应用的使用条款 | [https://www.desk365.io/terms-of-service/](https://www.desk365.io/terms-of-service/) |
| 应用的核心功能 | Desk365 是Microsoft 365工作场所的新式支持。 使用 Desk365 Teams应用，可以轻松地与支持团队中的其他代理协作。 你可以回复票证、添加笔记、检查状态、更改票证属性，所有这些都无需离开Microsoft Teams。 Desk365 最多适用于 4 个代理。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://www.desk365.io/agent-bot/](https://www.desk365.io/agent-bot/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
Kani Technologies Inc 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
