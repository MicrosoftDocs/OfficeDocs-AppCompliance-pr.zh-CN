---
title: 由丹麦研究员进行的 IntraActive 重播的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/02/2022
...
description: IntraActive 重播的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
---
# <a name="replay-by-intraactive"></a>IntraActive 重播
...
>| 个人资料 | 委托 | 单一登录是必需的 | [9e997761-d28c-4542-8897-94e7b5dc2484](../azure/9e997761-d28c-4542-8897-94e7b5dc2484.md) |
