...
| 合作伙伴公司名称 | Sine.co |
| 公司网站 | [https://www.sine.co](https://www.sine.co) |
| 应用的使用条款 | [https://www.sine.co/terms/](https://www.sine.co/terms/) |
| 应用的核心功能 | 增强访问者和工作人员安全、安全性和合规性的工作场所软件。 |
| 公司总部位置 | 澳大利亚 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
此信息由应用 Sine.co 如何收集和存储组织数据，以及组织将拥有对应用收集的数据的控制的信息。
