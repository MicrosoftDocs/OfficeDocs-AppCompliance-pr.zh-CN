...
description: Sine 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/b0d37fb7-080f-4288-992b-36790712c016" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | Sine.co |
| 公司的网站 | [https://www.sine.co](https://www.sine.co) |
| 应用的使用条款 | [https://www.sine.co/terms/](https://www.sine.co/terms/) |
| 应用的核心功能 | Sine 工作区软件，可增强访客和辅助角色的安全性、安全性、合规性。 |
| 公司总部位置 | 澳大利亚 |
| 应用信息页 | [https://www.sine.co](https://www.sine.co) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
Sine.co 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
