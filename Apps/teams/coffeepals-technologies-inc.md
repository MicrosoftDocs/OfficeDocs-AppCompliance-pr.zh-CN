---
title: CoffeePals Technologies Inc. 的 CoffeePals 应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
CoffeePals Technologies Inc. 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | CoffeePals Technologies Inc. |
| 公司网站 | [https://coffeepals.co](https://coffeepals.co) |
| 应用的使用条款 | [https://coffeepals.co/terms-of-service](https://coffeepals.co/terms-of-service) |
| 应用的核心功能 | CoffeePals 随机配对人员以会面和聊天形成个人连接。 它将包含允许员工更好地进行联系的其他功能。 |
| 公司总部位置 | 加拿大 |
| 应用信息页面 | [https://coffeepals.co/product](https://coffeepals.co/product) |
| 用于运行应用的托管环境或服务模型是什么？ | Paas |
| 应用使用哪些托管云提供商？ | Aws、MongoDB、Heroku |
...
此信息由 CoffeePals Technologies Inc. 提供，用于了解此应用程序如何收集和存储组织数据，以及您的组织将拥有对应用收集的数据的控制。
...
| 数据库中存储了哪些数据？ | 用户配置文件数据、用户使用情况数据、用户电子邮件地址、用户匹配历史记录、用户 设置、组织 设置、组织名称、团队名称、组织头像、匹配报告数据、用户配置文件照片、用户团队成员身份、用户反馈 |
...
| 隐私策略 URL | https://coffeepals.co/privacy |
