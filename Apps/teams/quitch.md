...
description: Quitch 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/f2125454-678c-4f97-90cc-dfe4742f4711" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003683" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Quitch 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Quitch |
| 公司网站 | [https://quitch.com](https://quitch.com) |
| 应用的使用条款 | [https://quitch.com/user-terms-of-service/](https://quitch.com/user-terms-of-service/) |
| 应用的核心功能 | 你的会议交互式测验Microsoft Teams测验 |
| 公司总部位置 | 澳大利亚 |
| 应用信息页面 | [https://quitch.com/microsoft-teams/](https://quitch.com/microsoft-teams/) |
...
Quitch 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及组织将拥有对应用收集的数据的控制有关。
...
| 隐私策略 URL | https://quitch.com/privacy-policy/ |
