---
title: Team Tracker Ltd 针对 Team Tracker 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/10/2021
...
* <a href="https://teams.microsoft.com/l/app/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d" target="_blank">在应用商店Teams视图</a>
...
Team Tracker Ltd 提供给 Microsoft 的信息：
...
| 应用的核心功能 | Team Tracker 是用户第一个预订热服务台的应用，并查看其工作 |
| 公司总部位置 | 英国大英和爱尔兰 ()  |
| 应用信息页面 | |
...
Team Tracker Ltd 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及您的组织将拥有对应用收集的数据的控制有关。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | delegated | 在用户设置其未来几周的活动后，团队跟踪程序将基于用户的选择更新用户日历及其可用性。  | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](../azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d.md) |
>| MailboxSettings.Read | delegated | 用于获取用于创建日历事件的时区 | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](../azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d.md) |
>| User.Read | delegated | 针对用户的个人资料验证用户信息 | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](../azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d.md) |
>| 电子邮件 | delegated | 用于验证用户电子邮件 | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](../azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d.md) |
>| openid | delegated | 允许用户使用其帐户Office 365登录 | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](../azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d.md) |
>| profile | delegated | 针对用户的个人资料验证用户的基本信息 | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](../azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d.md) |
