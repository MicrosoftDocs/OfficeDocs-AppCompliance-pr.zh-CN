---
title: iManage 的应用程序信息（通过 iManage）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/28/2021
...
* <a href="https://teams.microsoft.com/l/app/c941fa60-c3a3-4bc6-b846-a63406009c15" target="_blank">在应用商店Teams视图</a>
...
| 合作伙伴公司名称 | iManage |
| 公司网站 | [https://imanage.com](https://imanage.com) |
...
| 应用的核心功能 | 在 iManage 中保存并管理内容时自由协作。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://imanage.com/products/work/](https://imanage.com/products/work/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
| 应用是否遵守 SOC 2 (服务组织) ？ | 是 |
| 你获得哪种 SOC 2 认证？ |   |
| 最新 SOC2 认证日期 |  2021-04-16 |
| 应用是否遵守 SOC 3 (服务组织) ？ | 是 |
| 最新 SOC3 认证日期 |  2021-04-16 |
