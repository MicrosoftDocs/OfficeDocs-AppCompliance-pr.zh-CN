...
| "Teams应用程序信息"页的 URL | [https://imanage.com/products/work/](https://imanage.com/products/work/) |
...
>监视和存档所有数据导出。  受 iManage 控制的数据不会离开我们的系统，除非用户明确操作。
...
此信息由 iManage 提供有关此应用如何处理身份验证、授权、应用程序注册最佳做法和其他标识条件的信息。
