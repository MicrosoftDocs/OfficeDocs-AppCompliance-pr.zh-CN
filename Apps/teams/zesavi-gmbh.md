---
title: 由 Zesavi GmbH 为 Zesavi 提供的应用程序信息
ms.author: elmalova
author: elenamalova
ms.date: 01/03/2022
ms.topic: article
...
description: 用于 Zesavi 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| 应用的核心功能 | Zesavi 使公司中的每个人都可以直接在 Internet 浏览器中创建、编辑 &amp; 共享简短视频文档。 |
| 公司总部位置 | 德国 |
| 应用信息页面 | |
