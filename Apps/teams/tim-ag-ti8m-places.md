---
title: tim AG 提供的 ti8m&amp; 位置的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/04/2021
...
description: 适用于 ti8m 位置的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/9e384ce2-2db2-412e-8da7-08c5cf4c418e" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | ti&amp;m AG |
| 公司的网站 | [https://www.ti8m.com/places](https://www.ti8m.com/places) |
...
| 应用的核心功能 | Places 是用于在混合工作场所设置中预订工作场所的应用。 我们在地图或基于日历的视图中提供预订。 应用在Microsoft Teams中完全集成，并使用基于 Microsoft Services 的所有身份验证。 |
| 公司总部位置 | Switzerland（瑞士） |
| 应用信息页 | [https://www.ti8m.ch/places](https://www.ti8m.ch/places) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
tim&amp; AG 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite.Shared | 委托 | 取消工作区和用户日历上的事件  | [43134ae0-301f-4762-b7a9-aa9f2ff77b38](../azure/43134ae0-301f-4762-b7a9-aa9f2ff77b38.md) |
>| Directory.ReadWrite.All | 委托 | 安装和创建管理AAD组 - 安全组  | [43134ae0-301f-4762-b7a9-aa9f2ff77b38](../azure/43134ae0-301f-4762-b7a9-aa9f2ff77b38.md) |
>| Place.ReadWrite.All | 委托 | 工作区和地图名称列表  | [43134ae0-301f-4762-b7a9-aa9f2ff77b38](../azure/43134ae0-301f-4762-b7a9-aa9f2ff77b38.md) |
>| User.Read | 委托 | 用户名、电子邮件和显示名，在应用程序中显示 Userdata 所必需 | [43134ae0-301f-4762-b7a9-aa9f2ff77b38](../azure/43134ae0-301f-4762-b7a9-aa9f2ff77b38.md) |
