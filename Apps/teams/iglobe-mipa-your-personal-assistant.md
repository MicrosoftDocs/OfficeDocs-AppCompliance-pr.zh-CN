...
>| Tasks.ReadWrite | delegated | 应用程序数据库中不存储任何数据。 | 读取并更新日历完整，读取和更新Outlook更新到 Do Entreies | [e854ea05-68ab-4204-如果为 db4a784fb4d8](https://docs.microsoft.com/microsoft-365-app-certification/azure/e854ea05-68ab-4204-babe-db4a784fb4d8) |
>| User.Read | delegated | 应用程序数据库中不存储任何数据。 | 读取并更新日历完整，读取和更新Outlook更新到 Do Entreies | [e854ea05-68ab-4204-如果为 db4a784fb4d8](https://docs.microsoft.com/microsoft-365-app-certification/azure/e854ea05-68ab-4204-babe-db4a784fb4d8) |
