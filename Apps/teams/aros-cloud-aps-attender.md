...
description: Attender 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
---
# <a name="attender"></a>与会者

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 2 月 18 日</p>

* <a href="https://teams.microsoft.com/l/app/30b8d518-2535-4919-ab8b-d0fab193380f" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003856" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Aros 云 ApS 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Aros Cloud ApS |
| 公司网站 | [https://www.attender.uk](https://www.attender.uk) |
| 应用的使用条款 | [https://www.attender.uk/wp-content/uploads/2022/02/Terms-of...](https://www.attender.uk/wp-content/uploads/2022/02/Terms-of-use.pdf) |
| 应用的核心功能 | 学校快速注册，减少学生学习时间并节省教学时间。 |
| 公司总部位置 | 丹麦 |
| 应用信息页面 | [https://www.attender.uk](https://www.attender.uk) |
...
此信息由 Aros 云 ApS 提供，用于了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础基础结构是否处理与 Microsoft 客户或他们的设备相关的任何数据？ | 是 |
| 你的应用将处理哪些数据？ | 用户 UPN 名称、用户显示名称、学生出席数据、学生个人资料图片、教师和学生出席数据 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 用户 UPN 名称、用户显示名称、学生出席数据、学生个人资料图片、教师和学生出席数据 |
| 如果基础结构处理或存储 Microsoft 客户数据，那么此数据在地理位置上存储在哪里？ | 丹麦 |
| 你是否已制定数据租用和处置流程？ | 不支持 |
...
| 隐私策略 URL | https://www.attender.uk/wp-content/uploads/2022/02/Privacy-Statement.pdf |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Read.All | delegated | 确定用户角色 | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
>| GroupMember.Read.All | delegated | 确定用户角色 | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
>| User.Read | delegated | 登录 | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
>| 电子邮件 | delegated | 获取用户登录名。 | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
>| openid | delegated | 单一登录 | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
>| 个人资料 | delegated | 用户信息 | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
