---
title: GuideSpark 通过 GuideSpark 通信云的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/14/2021
...
description: GuideSpark Communicate Cloud 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/34b870ca-2417-4660-b835-ebb18ee7ccf9" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | GuideSpark |
| 公司的网站 | [https://guidespark.com](https://guidespark.com) |
| 应用的使用条款 | [https://www.guidespark.com/terms/](https://www.guidespark.com/terms/) |
| 应用的核心功能 | 通过面向受众并通过 GuideSpark 通信云跟踪参与数据来推动组织更改。 展开你的传递渠道，并联系你的人员，以促进有效的内部沟通。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://www.guidespark.com/change-communications-software/](https://www.guidespark.com/change-communications-software/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
GuideSpark 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
