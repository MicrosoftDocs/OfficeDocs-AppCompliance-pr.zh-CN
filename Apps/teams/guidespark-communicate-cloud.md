...
description: GuideSpark 通信云的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| 合作伙伴公司名称 | GuideSpark |
| 公司网站 | [https://guidespark.com](https://guidespark.com) |
| 应用的使用条款 | [https://www.guidespark.com/terms/](https://www.guidespark.com/terms/) |
| 应用的核心功能 | 通过面向受众推动组织变革，并通过 GuideSpark 通信云跟踪参与度数据。 扩展传递渠道并联系用户，便于进行有效的内部通信。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://www.guidespark.com/change-communications-software/](https://www.guidespark.com/change-communications-software/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
