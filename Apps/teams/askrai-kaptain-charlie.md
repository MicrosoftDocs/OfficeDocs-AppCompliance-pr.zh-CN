...
description: 所有可用的 Security and compliance information for Windows、 its data handling policies、 its Microsoft Cloud App Security app catalog information， and security/compliance information in the CSA STAR registry.
...
此信息由应用 askR.ai 如何收集和存储组织数据，以及组织将拥有对应用收集的数据的控制的信息。
...
| 应用是否遵守健康信息信任联盟、COMMON Security Framework (HITRUST CSF) ？ | 否 |
| 应用是否遵守 SOC 1 (服务组织) ？ | 否 |
| 最新 SOC1 认证日期 |   |
| 应用是否遵守 SOC 2 (服务组织) ？ | 否 |
| 你获得哪种 SOC 2 认证？ | |
