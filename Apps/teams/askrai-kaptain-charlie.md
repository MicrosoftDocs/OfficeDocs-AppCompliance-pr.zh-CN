---
title: Kaptain Charlie 的应用程序信息 askR.ai
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/29/2021
...
description: Kaptain Charlie 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/1f36eaf6-30a3-4488-a73f-4754b91e865d" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | askR.ai |
| 公司的网站 | [https://en.askr.ai](https://en.askr.ai) |
| 应用的使用条款 | [https://en.askr.ai/terms-of-use-askr-ai](https://en.askr.ai/terms-of-use-askr-ai) |
| 应用的核心功能 | 与数据聊天！ askR.ai 你的个人数据助手你有数据，但你不喜欢技术过程来访问它们？ 使用数据助手回答你的问题，并协助你探索！ Microsoft Teams上的第一个数据助手 askR.ai 是什么？ - AI 支持的个人数据助手 - 提供即时 KPI 和数据 viz - 了解特定的业务词汇 - 向你发送警报 - 建议进行其他分析 |
| 公司总部位置 | 法国 |
| 应用信息页 | [https://en.askr.ai](https://en.askr.ai) |
...
askR.ai 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
| 如果你的应用不使用上述库之一，它使用什么身份验证库或库？ | OAuth 库 |
| 应用是否支持条件访问策略？ | 否 |
