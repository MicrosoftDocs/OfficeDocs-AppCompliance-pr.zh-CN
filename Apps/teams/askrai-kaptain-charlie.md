...
description: 所有可用的 Security and compliance information for Handling、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/1f36eaf6-30a3-4488-a73f-4754b91e865d" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001583" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

由 microsoft askR.ai 提供的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | Kaptain Charlie |
| ID | WA200001583 |
| Office 365客户端 | Microsoft Teams |
| 合作伙伴公司名称 | askR.ai |
| 公司网站 | [https://en.askr.ai](https://en.askr.ai) |
| 应用的使用条款 | [https://en.askr.ai/terms-of-use-askr-ai](https://en.askr.ai/terms-of-use-askr-ai) |
| 应用的核心功能 | 与你的数据聊天！ askR.ai 是个人数据助理 您具有数据，但您不喜欢访问数据的技术过程？ 使用数据助理回答你的问题并帮助你进行探索！ what does askR.ai， the first data-assistant on Microsoft Teams？ - AI 支持的个人数据助理 - 提供即时 KPI 和数据 viz - 了解特定业务词汇 - 向您发送警报 - 建议进行其他分析 |
| 公司总部位置 | 法国 |
| 应用信息页面 | [https://en.askr.ai](https://en.askr.ai) |
...
此信息已由用户 askR.ai，这些信息与此应用程序如何收集和存储组织数据以及组织将拥有对应用收集的数据的控制有关。
...
| 隐私策略 URL | https://en.askr.ai/terms-of-use-askr-ai |
...
| 你的应用是否使用最新版本的 MSAL (Microsoft 身份验证库) Microsoft Identity Web 进行身份验证？ | 不支持 |
