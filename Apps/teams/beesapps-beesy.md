...
>|   **Graph权限**  | **权限类型** |          **字距调整**          |
>|:------------------------|:--------------------|:------------------------------------|
>| Mail.Read | delegated | 用户 un mail dans beesy depuis microsoft outlook Web 组件 |
>| User.Read | delegated | lier le 分析 microsoft office365 a son compte beesy.me |
>| Chat.Read | delegated | cr&#233;er une 操作 dans beesy.me depuis un message d'une conversation dans microsoft teams |
