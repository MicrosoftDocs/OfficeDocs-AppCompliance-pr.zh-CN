...
>|:----------------|:------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|:--------------------|
>| User.Read | delegated | 我们仅存储 UPN ID，以通过 AAD 令牌请求检查系统中是否存在帐户来比较给定的 ID。 | 允许用户登录，并授予应用对 UPN 的访问权限，以启用无提示登录 | [d27f56ed-ddc7-4cf8-86ac-721b76c7d287](https://docs.microsoft.com/microsoft-365-app-certification/azure/d27f56ed-ddc7-4cf8-86ac-721b76c7d287) |
...
>|:---------------------------------------|:-----------------------------------|:------------------------------------|
>| 我们访问此数据以在机器人中提供上下文，以将操作直接记录给聊天 (聊天机器人是虚拟助理) 。 | 不会直接从名单中存储任何数据，我们将团队成员与已经集成在一起的人 beesy.me 服务数据，只是匹配。 |  |
