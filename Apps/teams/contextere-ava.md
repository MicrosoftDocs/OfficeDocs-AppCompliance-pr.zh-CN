---
title: Contextere AVA by Contextere 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/25/2021
...
description: Contextere AVA 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/be5caee0-f2bc-11ea-b597-ef970e2f5141" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | Contextere |
| 公司的网站 | [https://contextere.com](https://contextere.com) |
| 应用的使用条款 | [https://contextere.com/wp-primary/wp-content/uploads/Contex...](https://contextere.com/wp-primary/wp-content/uploads/Contextere-End-User-License-Agreement-Microsoft-Challenge.pdf) |
| 应用的核心功能 | Contextere Advanced 虚拟助理 (AVA) 为工业工人提供在职见解。 |
| 公司总部位置 | 加拿大 |
| 应用信息页 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
Contextere 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
