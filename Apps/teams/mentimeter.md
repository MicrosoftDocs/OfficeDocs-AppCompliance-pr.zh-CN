...
| 合作伙伴公司名称 | Mentimeter |
| 公司网站 | [https://www.mentimeter.com](https://www.mentimeter.com) |
| 应用的使用条款 | [https://www.mentimeter.com/terms](https://www.mentimeter.com/terms) |
| 应用的核心功能 | 通过投票、测验、Word 云、QA&amp; 等吸引参与者，以捕获实时输入。
 |
| 公司总部位置 | 瑞典 |
| 应用信息页面 | [https://www.mentimeter.com/features](https://www.mentimeter.com/features) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
