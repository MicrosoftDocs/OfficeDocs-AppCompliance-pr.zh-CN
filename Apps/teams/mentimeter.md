---
title: Mentimeter by Mentimeter 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/25/2021
...
description: Mentimeter 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/6aa4a751-8a6a-429e-b924-1360ed272414" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | Mentimeter |
| 公司的网站 | [https://www.mentimeter.com](https://www.mentimeter.com) |
| 应用的使用条款 | [https://www.mentimeter.com/terms](https://www.mentimeter.com/terms) |
| 应用的核心功能 | 让参与者参与投票、测验、Word 云、QA&amp; 等，以捕获实时输入。  |
| 公司总部位置 | 瑞典 |
| 应用信息页 | [https://www.mentimeter.com/features](https://www.mentimeter.com/features) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
Mentimeter 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
