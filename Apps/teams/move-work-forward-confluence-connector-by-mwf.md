...
>|   **Graph权限**  | **权限类型** |          **字距调整**          |
>|:------------------------|:--------------------|:------------------------------------|
>| Channel.ReadBasic.All | delegated | 获取用于将通知发送到通道的配置页面的通道列表。 |
>| Teams.ReadBasic.All | delegated | 获取配置页面的团队列表，以将通知发送到团队的频道。 |
>| 电子邮件 | delegated | 增强 Microsoft 和 Atlassian 之间的帐户映射 |
>| TeamsAppInstallation.ReadForTeam | delegated | 查找安装了 Confluence 连接器的团队 |
>| User.Read | delegated | 读取基本用户信息 |
