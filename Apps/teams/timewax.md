---
title: Timewax by Timewax 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/21/2022
...
description: Timewax 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/0d3bddff-8ca4-4f41-ae48-5aad1ef26e0d" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004428" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Timewax 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Timewax |
| 公司的网站 | [https://www.timewax.com](https://www.timewax.com) |
| 应用的使用条款 | [https://www.timewax.com/tc/](https://www.timewax.com/tc/) |
| 应用的核心功能 | 从 Timewax 平台直接进入 Teams 获取通知。 |
| 公司总部位置 | 荷兰 ()  |
| 应用信息页 | [https://www.docs.timewax.com/en/knowledgebase/microsoft-tea...](https://www.docs.timewax.com/en/knowledgebase/microsoft-teams/) |
...
Timewax 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
| 隐私策略 URL | https://www.timewax.com/privacynotice/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 委托 | 需要它来提取用户的日历事件，以确定它们是否已由我们的 Outlook 集成同步，以便我们可以在选项卡中显示它们。 | [c6557591-6b74-430d-b25e-87ab28766f32](../azure/c6557591-6b74-430d-b25e-87ab28766f32.md) |
>| User.Read | 委托 | 需要它来个性化团队集成。 | [c6557591-6b74-430d-b25e-87ab28766f32](../azure/c6557591-6b74-430d-b25e-87ab28766f32.md) |
