...
description: 所有可用的安全与合规性信息 gauge.it、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/9e9e5036-942e-42b4-8b7a-855a59d1c1a1" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003874" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

云覆盖 IT 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | 云覆盖 IT |
| 公司网站 | [https://www.cloudcoverit.co.uk](https://www.cloudcoverit.co.uk) |
| 应用的使用条款 | [https://www.cloudcoverit.co.uk/terms](https://www.cloudcoverit.co.uk/terms) |
| 应用的核心功能 | 创建模板清单并共享给组、团队，甚至是你自己。 |
| 公司总部位置 | 英国大英和爱尔兰 ()  |
| 应用信息页面 | |
...
此信息由 Cloud Cover IT 提供有关此应用如何收集和存储组织数据以及组织将拥有对应用收集的数据的控制的信息。
...
| 隐私策略 URL | https://www.cloudcoverit.co.uk/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegated | 访问 Active Directory ID | [898cccfe-ed44-4140-ad2f-c5dd98a12820](../azure/898cccfe-ed44-4140-ad2f-c5dd98a12820.md) |
