---
title: 由开发系统执行 MetaMeeting 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/25/2022
...
description: MetaMeeting 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/5c85c141-757a-403a-9dec-3fce9dd738e5" target="_blank">在应用商店Teams视图</a>
