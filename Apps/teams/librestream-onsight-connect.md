---
title: Librestream 提供的 Onsight 连接应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: Onsight 连接的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/c01f5608-4ade-4749-aafa-9e5449a5bcb4" target="_blank">Teams存储区中的视图</a>
...
| 公司的网站 | [https://librestream.com](https://librestream.com) |
| 应用的使用条款 | [https://librestream.com/support-archives/software-eula/](https://librestream.com/support-archives/software-eula/) |
| 应用的核心功能 | 增强数字化转型策略，使员工和客户能够立即访问快速检查和解决问题所需的内容、人员、智能数据和指导。 Onsight 增强现实平台在全球部署，提高了制造业、航空、能源、重型设备和现场服务等行业的运营效率。 |
| 公司总部位置 | 加拿大 |
| 应用信息页 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
Librestream 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
