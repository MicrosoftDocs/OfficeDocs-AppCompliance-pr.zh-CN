---
title: Librestream 连接 Onsight 应用程序的信息
ms.author: elmalova
author: elenamalova
ms.date: 04/29/2021
ms.topic: article
...
description: Onsight 应用程序的所有可用安全性和合规性连接、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息和 CSA STAR 注册表中的安全/合规性信息。
...
| 使用条款 URL | [https://librestream.com/support-archives/software-eula/](https://librestream.com/support-archives/software-eula/) |
