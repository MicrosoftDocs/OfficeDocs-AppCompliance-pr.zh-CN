...
description: 培训助手的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/40049dbc-3781-491d-ad2e-d59009538e45" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003547" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

自动程序平台提供给 Microsoft 的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | Training Assistant |
| ID | WA200003547 |
| Office 365支持的客户端 | Microsoft Teams |
| 合作伙伴公司名称 | The Bot Platform |
| 公司网站 | [https://thebotplatform.com](https://thebotplatform.com) |
| 应用的使用条款 | [https://thebotplatform.com/wp-content/uploads/2021/11/TBP-T...](https://thebotplatform.com/wp-content/uploads/2021/11/TBP-Training-Assistant-Customer-Terms-of-Use.pdf) |
| 应用的核心功能 | 此数字助理将你接受一系列培训模块，这些模块涵盖设置和使用Teams。 每个模块都包含特定的教程视频和培训内容，以确保员工完全了解 Microsoft Teams 功能的范围以及如何使用它们。 |
| 公司总部位置 | 英国大英和爱尔兰 ()  |
| 应用信息页面 | |
...
自动程序平台提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及组织将拥有对应用收集的数据的控制有关。
...
| 隐私策略 URL | https://thebotplatform.com/wp-content/uploads/2021/11/TBP-Training-Assistant-Privacy-Statement.pdf |
