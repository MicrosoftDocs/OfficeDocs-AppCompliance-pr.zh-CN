...
ms.locfileid: "61350308"
---
# <a name="training-assistant"></a>培训助手
...
| 应用的核心功能 | 此数字助理将介绍一系列培训模块，这些模块涵盖设置和使用 Teams。 每个模块都包含特定的教程视频和培训内容，以确保员工完全了解 Microsoft Teams 功能的范围以及如何使用它们。 |
| 公司总部位置 | 英国大英和爱尔兰 ()  |
| 应用信息页面 | |
