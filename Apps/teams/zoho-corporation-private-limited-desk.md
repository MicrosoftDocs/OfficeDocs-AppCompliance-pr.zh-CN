...
* <a href="https://teams.microsoft.com/l/app/091ec948-c0ee-4d56-aa9e-51c3d8316a9c" target="_blank">在应用商店Teams视图</a>
...
>1) 用户界面中提供删除实体的选项，则具有删除选项的 Zoho desk 中的管理员和代理可以执行此操作。2) 我们还有导出选项，管理员可以使用这些选项导出和达到其目的。  3) 我们根据客户请求在后端维护审核，可以提供此信息。
...
<iframe height='1020' title='Microsoft Cloud App Security信息' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/28308' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/28308" target="_blank">在新建选项卡中查看</a>
