...
description: 8x8 的所有可用安全性和符合性信息、其数据处理策略、Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/bab6487a-dbe6-426f-b329-b7ef0d0fd5ba" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002665" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

8x8 公司提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | 8x8, Inc |
| 公司的网站 | [https://www.8x8.com](https://www.8x8.com) |
| 应用的使用条款 | [https://www.8x8.com/terms-and-conditions](https://www.8x8.com/terms-and-conditions) |
| 应用的核心功能 | 8x8 语音是基于云的直接路由服务，用于进行/接收 PSTN 调用。 具有企业级电话 + 联系中心功能的本机体验。 47 个国家/地区的无限制呼叫计划 + 43 个国家/地区的 PSTN 更换服务、分析、短信、彩信和传真。 在本地或国际上获取经济通话套餐，并将 PSTN 呼叫扩展到 Microsoft 尚未提供计划&#8217;的国家，以充分利用Microsoft 365。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://www.8x8.com/products/integrations/8x8-voice-for-mic...](https://www.8x8.com/products/integrations/8x8-voice-for-microsoft-teams) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS、OracleCloud |
...
8x8 公司提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
