---
title: Indeqa 的应用程序信息（由 Indeqa B.V 提供）
ms.author: elmalova
author: elenamalova
ms.date: 09/24/2021
ms.topic: article
...
description: Indeqa 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| 合作伙伴公司名称 | Indeqa B.V. |
| 公司网站 | [https://www.easy2meet.eu](https://www.easy2meet.eu) |
...
此信息由 Indeqa B.V 提供。 关于此应用如何收集和存储组织数据，以及你的组织将拥有对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | delegated | 我们需要用户信息来管理 Easy2Meet 中的用户和会议 | [286a2e24-18ad-432d-8698-694bcd77ecfc](https://docs.microsoft.com/microsoft-365-app-certification/azure/286a2e24-18ad-432d-8698-694bcd77ecfc) |
>| 电子邮件 | delegated | 查看当前用户的电子邮件地址。 我们需要电子邮件地址来发送会议邀请 | [286a2e24-18ad-432d-8698-694bcd77ecfc](https://docs.microsoft.com/microsoft-365-app-certification/azure/286a2e24-18ad-432d-8698-694bcd77ecfc) |
>| openid | delegated | 我们在此处不收集数据。 我们使用此密码登录用户 | [286a2e24-18ad-432d-8698-694bcd77ecfc](https://docs.microsoft.com/microsoft-365-app-certification/azure/286a2e24-18ad-432d-8698-694bcd77ecfc) |
>| 个人资料 | delegated | 我们需要用户信息来管理 Easy2Meet 中的用户和会议 | [286a2e24-18ad-432d-8698-694bcd77ecfc](https://docs.microsoft.com/microsoft-365-app-certification/azure/286a2e24-18ad-432d-8698-694bcd77ecfc) |
