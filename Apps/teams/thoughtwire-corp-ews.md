...
description: ThoughtWire EWS 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Create | 应用程序 | 允许应用程序为医院单位创建组/团队。 | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| Group.ReadWrite.All | 应用程序 | 应用程序必须确定需要创建/重新创建哪些组，以及管理成员身份。 | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| GroupMember.ReadWrite.All | 应用程序 | 必需，这样应用程序才能管理组成员身份。 即，随着班次的变化，在团队中添加/删除医生。 | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| TeamMember.ReadWrite.All | 应用程序 | 必需，这样应用程序才能管理组成员身份。 即，随着班次的变化，在团队中添加/删除医生。 | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| TeamsAppInstallation.ReadWriteForTeam | 应用程序 | 允许应用程序自动将 ThoughtWire 自动程序安装到其创建/管理的团队中。 | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| User.Read | 应用程序 | 允许应用程序在管理成员身份和/或检索用户名以在应用程序中标识用户时，根据需要检索用户的 A分钟内/ 用户名。 | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
