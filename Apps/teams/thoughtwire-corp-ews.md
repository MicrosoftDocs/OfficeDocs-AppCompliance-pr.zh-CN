...
| 公司网站 | [https://thoughtwire.com](https://thoughtwire.com) |
| 应用的使用条款 | [https://www.thoughtwire.com/end-user-license-agreement/](https://www.thoughtwire.com/end-user-license-agreement/) |
| 应用的核心功能 | ThoughtWire 应用支持 EarlyWarning-一种高级检测和干预工具，已证明将代码蓝色事件减少 61%。 早期警告解决方案旨在根据患者重要因素检测患者症，将不良健康事件通知给患者，并允许他们采取措施。 响应团队工作人员可以访问患者上下文，并且了解响应团队的状态和可用性，从而简化响应和患者医疗工作流。 |
| 公司总部位置 | 加拿大 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
| 应用是否遵守 SOC 2 (服务组织) ？ | 是 |
| 你获得哪种 SOC 2 认证？ |   |
| 最新 SOC2 认证日期 |  2021-03-31 |
| 应用是否遵守 SOC 3 (服务组织) ？ | 是 |
| 最新 SOC3 认证日期 |  2021-03-31 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Create | 应用程序 | 允许应用程序为医院单位创建组/团队。 | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](https://docs.microsoft.com/microsoft-365-app-certification/azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c) |
>| Group.ReadWrite.All | 应用程序 | 应用程序必须确定需要创建/重新创建哪些组，以及管理成员身份。 | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](https://docs.microsoft.com/microsoft-365-app-certification/azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c) |
>| GroupMember.ReadWrite.All | 应用程序 | 必需，这样应用程序才能管理组成员身份。 即，随着班次的变化，在团队中添加/删除医生。 | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](https://docs.microsoft.com/microsoft-365-app-certification/azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c) |
>| TeamMember.ReadWrite.All | 应用程序 | 必需，这样应用程序才能管理组成员身份。 即，随着班次的变化，在团队中添加/删除医生。 | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](https://docs.microsoft.com/microsoft-365-app-certification/azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c) |
>| TeamsAppInstallation.ReadWriteForTeam | 应用程序 | 允许应用程序自动将 ThoughtWire 自动程序安装到其创建/管理的团队中。 | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](https://docs.microsoft.com/microsoft-365-app-certification/azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c) |
>| User.Read | 应用程序 | 允许应用程序在管理成员身份和/或检索用户名以在应用程序中标识用户时，根据需要检索用户的 A分钟内/ 用户名。 | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](https://docs.microsoft.com/microsoft-365-app-certification/azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c) |
