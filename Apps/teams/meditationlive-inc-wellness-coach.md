---
title: Meditation.live 公司提供的健康教练应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: 健康教练的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/9913e2ed-5c17-4d66-b9e7-439290238f29" target="_blank">Teams存储区中的视图</a>
...
Meditation.live 公司向 Microsoft 提供的信息：
...
| 公司的网站 | [https://welllnesscoach.live](https://welllnesscoach.live) |
| 应用的使用条款 | [https://www.wellnesscoach.live/terms-of-service](https://www.wellnesscoach.live/terms-of-service) |
| 应用的核心功能 | 快速的心理和身体实践，让你整天移动和激励。  |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://wellnesscoach.live/teams-app](https://wellnesscoach.live/teams-app) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
Meditation.live 公司提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
