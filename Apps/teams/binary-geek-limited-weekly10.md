---
title: 由二进制极客有限公司提供的 Weekly10 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
description: Weekly10 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/c80cee99-d17f-4b2d-a2a4-57652ffd2a4b" target="_blank">Teams存储区中的视图</a>
...
| 公司的网站 | [https://www.weekly10.com](https://www.weekly10.com) |
| 应用的使用条款 | [https://www.weekly10.com/terms/customer](https://www.weekly10.com/terms/customer) |
| 应用的核心功能 | 通过每周签入来增加反馈、管理性能和衡量员工参与度。 |
| 公司总部位置 | 大不列颠及北爱尔兰联合王国 ()  |
| 应用信息页 | [https://www.weekly10.com/integrations/microsoft-teams/](https://www.weekly10.com/integrations/microsoft-teams/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
Binary Geek Limited 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 应用程序 | 将用户从Azure AD同步到 Weekly10 (可选)  | [2cc7f3cd-05e3-4ebb-b9f9-d92f1bcda7fb](../azure/2cc7f3cd-05e3-4ebb-b9f9-d92f1bcda7fb.md) |
>| Calendars.ReadWrite | 应用程序 | 检查员工可用性和自动预订会议 (可选) 。 | [494610b2-b490-4f54-8384-312d6f9b4869](../azure/494610b2-b490-4f54-8384-312d6f9b4869.md) |
>| User.Read | 委托 | 针对Azure AD的 SSO 目的验证用户。 | [6fd1421e-89e8-4a8b-bd01-9397656a50d5](../azure/6fd1421e-89e8-4a8b-bd01-9397656a50d5.md) |
