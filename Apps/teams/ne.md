...
description: 适用于 NE 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/bd4bd4f6-ec6c-42b3-b296-bf39b8b758b3" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | NE |
| 公司的网站 | [https://www.ne.se](https://www.ne.se) |
| 应用的使用条款 | [https://www.ne.se/info/hj%c3%a4lp/allm%c3%a4nna-avtalsvillk...](https://www.ne.se/info/hj%c3%a4lp/allm%c3%a4nna-avtalsvillkor/fleranv%c3%a4ndare/) |
| 应用的核心功能 | 一个团队应用，允许 NE 客户从团队内部访问其内容服务。 它还添加了团队消息扩展，允许用户通过在聊天中键入@ne来搜索 NE 百科全书。 |
| 公司总部位置 | 瑞典 |
| 应用信息页 | [https://www.ne.se/info/om-oss/](https://www.ne.se/info/om-oss/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
NE 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
