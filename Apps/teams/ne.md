...
* <a href="https://teams.microsoft.com/l/app/bd4bd4f6-ec6c-42b3-b296-bf39b8b758b3" target="_blank">在应用商店Teams视图</a>
...
| 合作伙伴公司名称 | NE |
| 公司网站 | [https://www.ne.se](https://www.ne.se) |
...
| 应用的核心功能 | 允许 NE 客户从团队内访问其内容服务的团队应用。 它还添加了团队消息扩展，允许用户在聊天中键入@ne搜索 NE 区。 |
| 公司总部位置 | 瑞典 |
| 应用信息页面 | [https://www.ne.se/info/om-oss/](https://www.ne.se/info/om-oss/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
NE 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及组织将拥有对应用收集的数据的控制有关。
