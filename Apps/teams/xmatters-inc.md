...
| 公司网站 | [https://www.xmatters.com](https://www.xmatters.com) |
| 应用的使用条款 | [https://www.xmatters.com/policy/terms-conditions](https://www.xmatters.com/policy/terms-conditions) |
| 应用的核心功能 | 通过跨工具链自动通信来防止、管理和解决 IT 问题 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://help.xmatters.com/integrations/socialchat/microsoft...](https://help.xmatters.com/integrations/socialchat/microsoftteams.htm) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | GCP |
