---
title: TeamsChamp by TeamsChamp 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/22/2021
...
description: TeamsChamp 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/4fea4594-3f83-4e33-9929-9af6b78a7340" target="_blank">Teams存储区中的视图</a>
...
| 应用的使用条款 | [https://www.teamschamp.com/terms/](https://www.teamschamp.com/terms/) |
| 应用的核心功能 | TeamsChamp 通过对员工的数字能力进行游戏化来促进组织信息系统的使用和采用 (，) 这些系统进行了投资。  重新激励Microsoft 365采用与新鲜空气的呼吸和文化，促进其数字化转型。 |
| 公司总部位置 | 西班牙 |
| 应用信息页 | [https://www.teamschamp.com](https://www.teamschamp.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | 登录并读取用户配置文件 | [79d7af39-4f57-4e95-adaf-ec8ff756d0df](../azure/79d7af39-4f57-4e95-adaf-ec8ff756d0df.md) |
>| User.ReadBasic.All | 委托 | 读取所有用户的基本配置文件 | [79d7af39-4f57-4e95-adaf-ec8ff756d0df](../azure/79d7af39-4f57-4e95-adaf-ec8ff756d0df.md) |
>| 个人资料 | 委托 | 查看用户的基本个人资料 | [79d7af39-4f57-4e95-adaf-ec8ff756d0df](../azure/79d7af39-4f57-4e95-adaf-ec8ff756d0df.md) |
