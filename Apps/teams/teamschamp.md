...
| 应用的核心功能 | Teams使用和采用可促进组织信息系统的使用和采用 (通过员工的数字能力) 对信息系统进行了投资。  重新推动Microsoft 365采用，同时提供促进数字化转型的新鲜力和文化。 |
| 公司总部位置 | 西班牙 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegated | 登录并读取用户配置文件 | [79d7af39-4f57-4e95-adaf-ec8ff756d0df](https://docs.microsoft.com/microsoft-365-app-certification/azure/79d7af39-4f57-4e95-adaf-ec8ff756d0df) |
>| User.ReadBasic.All | delegated | 读取所有用户的基本个人资料 | [79d7af39-4f57-4e95-adaf-ec8ff756d0df](https://docs.microsoft.com/microsoft-365-app-certification/azure/79d7af39-4f57-4e95-adaf-ec8ff756d0df) |
>| 个人资料 | delegated | 查看用户的基本个人资料 | [79d7af39-4f57-4e95-adaf-ec8ff756d0df](https://docs.microsoft.com/microsoft-365-app-certification/azure/79d7af39-4f57-4e95-adaf-ec8ff756d0df) |
