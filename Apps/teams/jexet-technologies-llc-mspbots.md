---
title: Jexet Technologies LLC 的 MSPBots 应用程序信息
ms.author: elmalova
author: elenamalova
ms.date: 11/23/2021
ms.topic: article
...
description: MSPBots 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/10fcc57c-8d49-4f94-a516-a75de60bc969" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001128" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Jexet Technologies LLC 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Jexet Technologies LLC |
| 公司网站 | [https://mspbots.ai](https://mspbots.ai) |
| 应用的使用条款 | [https://mspbots.ai/termsofuse/](https://mspbots.ai/termsofuse/) |
| 应用的核心功能 | 商业智能平台、IT 托管服务提供商业务使用可自定义机器人的重复任务的自动化。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
...
此信息由 Jexet 技术 LLC 提供，用于了解此应用程序如何收集和存储组织数据，以及您的组织将拥有对应用收集的数据的控制。
...
| 隐私策略 URL | https://mspbots.ai/home/data-security/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | 应用程序 | 向频道发送消息 | [a2af9d71-95f1-4236-be2c-c105ab9b7ee9](https://docs.microsoft.com/microsoft-365-app-certification/azure/a2af9d71-95f1-4236-be2c-c105ab9b7ee9) |
>| ChatMessage.Send | 应用程序 | 发送消息聊天 | [a2af9d71-95f1-4236-be2c-c105ab9b7ee9](https://docs.microsoft.com/microsoft-365-app-certification/azure/a2af9d71-95f1-4236-be2c-c105ab9b7ee9) |
>| 个人资料 | 应用程序 | 获取使用应用用户信息 | [a2af9d71-95f1-4236-be2c-c105ab9b7ee9](https://docs.microsoft.com/microsoft-365-app-certification/azure/a2af9d71-95f1-4236-be2c-c105ab9b7ee9) |
