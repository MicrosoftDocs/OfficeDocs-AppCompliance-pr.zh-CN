...
* <a href="https://teams.microsoft.com/l/app/672c12b8-883e-4138-8318-224420bdafe8" target="_blank">在应用商店Teams视图</a>
...
| 应用程序Teams页的 URL | [https://www.chitchattr.com/reminderz/](https://www.chitchattr.com/reminderz/) |
...
>|:---------------------------------------|:-----------------------------------|:------------------------------------|
>| 检索用户的名称，以在提醒中显示发送消息的用户的姓名。  | 用户的显示名称 | 存储名称用于标识授权查询 (当用户申请许可证时，我们需要确定当前获得许可)   |
