...
| 合作伙伴公司名称 | 365Apps |
| 合作伙伴网站的 URL | [https://365projects.app](https://365projects.app) |
| "Teams应用程序信息"页的 URL | [https://365projects.app](https://365projects.app) |
...
>应用不会存储除应用管理员 Guid 之外的用户数据， (用户在租户管理中心内使用)  
