---
title: HubEngage by HubEngage 的应用程序信息， Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/17/2022
...
description: HubEngage 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66549369"
---
# <a name="hubengage"></a>HubEngage

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 1 月 12 日</p>

* <a href="https://teams.microsoft.com/l/app/d96b4f99-e4b8-4af8-ba3d-36675f9a5353" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003668" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

HubEngage 公司向 Microsoft 提供的信息：
...
| 合作伙伴公司名称 | HubEngage， Inc. |
| 公司的网站 | [https://www.hubengage.com](https://www.hubengage.com) |
| 应用的使用条款 | [https://www.hubengage.com/privacy-policy/](https://www.hubengage.com/privacy-policy/) |
| 应用的核心功能 | HubEngage Teams 应用允许你从 Teams 中访问组织的通信和其他相关信息。 你还可以提交自己的帖子，并喜欢并评论其他帖子。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | |
...
HubEngage 公司提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
| 隐私策略 URL | https://www.hubengage.com/platform-privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 两者 | 了解用户 | [63e17eec-6b5f-476b-a26b-54fde8bd2c83](../azure/63e17eec-6b5f-476b-a26b-54fde8bd2c83.md) |
