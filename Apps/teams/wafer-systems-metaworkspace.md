---
title: MetaWorkspace by Wafer Systems 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/07/2022
...
description: MetaWorkspace 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/431b1597-8da3-45ca-9b36-ff245ea7c442" target="_blank">Teams存储区中的视图</a>
