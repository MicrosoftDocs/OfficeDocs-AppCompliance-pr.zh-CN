---
title: BrowserStack By BrowserStack Inc 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: BrowserStack 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/180f19aa-1b79-4b4a-b716-068b81cfb145" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004404" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

BrowserStack Inc 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | BrowserStack Inc |
| 公司的网站 | [https://www.browserstack.com](https://www.browserstack.com) |
| 应用的使用条款 | [https://www.browserstack.com/terms](https://www.browserstack.com/terms) |
| 应用的核心功能 | 将 BrowserStack 见解直接引入 Microsoft Teams！ |
| 公司总部位置 | 印度 |
| 应用信息页 | [https://www.browserstack.com/docs/automate/selenium/microso...](https://www.browserstack.com/docs/automate/selenium/microsoft-teams) |
...
BrowserStack Inc 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
| 隐私策略 URL | https://www.browserstack.com/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | 登录并读取用户配置文件以进行身份验证 | [180f19aa-1b79-4b4a-b716-068b81cfb145](../azure/180f19aa-1b79-4b4a-b716-068b81cfb145.md) |
