...
>|:---------------------------------------|:-----------------------------------|:------------------------------------|
>| 因此，我们可以在邮件和通知中使用它们处理显示名称 | 用户显示名称 | 我们存储会话引用以发送主动邮件 |
...
>大多数系统的 FloQast 系统通过与其他系统（如 Netsuite 或 Oracle 等 ERP 系统）集成提供其主要价值。 然后，我们的客户可以完全控制其数据，并且可以选择他们执行或不希望与 FloQast 共享哪些操作。
