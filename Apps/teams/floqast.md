...
| 合作伙伴公司名称 | FloQast |
| 公司网站 | [https://floqast.com](https://floqast.com) |
| 应用的使用条款 | [https://floqast.com/terms-of-use/](https://floqast.com/terms-of-use/) |
| 应用的核心功能 | FloQast 提供了一个接近的管理解决方案以及工作流自动化，旨在帮助会计执行当月结束的关闭。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://floqast.com](https://floqast.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
