...
* <a href="https://teams.microsoft.com/l/app/326749cd-77f8-4579-8944-6837ebeb175d" target="_blank">在应用商店Teams视图</a>
...
| Teams信息页的 URL | [https://floqast.com](https://floqast.com) |
...
此信息由 FloQast 提供，用于说明此应用如何收集和存储组织数据，以及组织将拥有对应用收集的数据的控制。
...
>|:---------------------------------------|:-----------------------------------|:------------------------------------|
>| 因此，我们可以在邮件和通知中使用它们的 显示名称 | 用户显示名称 | 我们存储会话引用以发送主动邮件 |
...
>FloQast 存储总帐数据、会计信息和其他公司信息。 使用 FloQast&#8217;无限期存储数据的策略。 为了符合所有 SEC 数据保留要求，FloQast 为客户提供了在订阅结束后删除数据的选项。 在删除请求的一个月内，FloQast 将硬删除当前正在运行的生产系统中的所有信息。

#### <a name="organizational-controls-for-data-stored-by-partner"></a>合作伙伴存储的数据的组织控制

描述组织的管理员如何控制他们在合作伙伴系统中的信息？例如删除、保留、审核、存档、最终用户策略等。

>大多数情况下，FloQast 系统通过与其他系统（如 Netsuite 或 Oracle 等 ERP 系统）集成提供其主要价值。 然后，我们的客户可以完全控制其数据，并且可以选择他们执行或不希望与 FloQast 共享哪些操作。
...
此信息由 FloQast 提供有关此应用如何处理身份验证、授权、应用程序注册最佳做法和其他标识条件的信息。
