---
title: FloQast by FloQast 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
description: 适用于 FloQast 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/326749cd-77f8-4579-8944-6837ebeb175d" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | FloQast |
| 公司的网站 | [https://floqast.com](https://floqast.com) |
| 应用的使用条款 | [https://floqast.com/terms-of-use/](https://floqast.com/terms-of-use/) |
| 应用的核心功能 | FloQast 提供了一个紧密的管理解决方案以及工作流自动化，旨在帮助会计师执行月末结束操作。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://floqast.com](https://floqast.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
FloQast 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
