---
title: Solutions2Share GmbH 文件管理器的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/24/2022
...
description: 文件管理器的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "64463728"
---
# <a name="file-manager"></a>文件管理器

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 12 月 30 日</p>

* <a href="https://teams.microsoft.com/l/app/4946e155-584a-412d-aac1-48975e073587" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003770" target="_blank">在 AppSource 中查看</a>
...
| 应用的核心功能 | 通过部署中所有团队Microsoft Teams |
| 公司总部位置 | 德国 |
| 应用信息页面 | [https://www.solutions2share.com/file-manager/](https://www.solutions2share.com/file-manager/) |
