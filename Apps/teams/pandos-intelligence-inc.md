---
title: Pandos Intelligence Inc 的 Pandos 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/10/2022
...
description: Pandos 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/0e777926-2ab4-4e40-9fe5-80dc68e5044f" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003534" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Pandos Intelligence Inc 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Pandos Intelligence Inc |
| 公司的网站 | [https://pandos.io](https://pandos.io) |
| 应用的使用条款 | [https://app.pandos.io/terms-of-use](https://app.pandos.io/terms-of-use) |
| 应用的核心功能 | Pandos 是一站式学习开发平台，面向团队和人员经理、项目主管、培训师和教育讲师。 它支持基本功能，例如基于标准的团队组建 (包括可用性、个性、技能或任何自定义条件) 、团队任务管理和对等评估。 平台会自动生成成员软技能的配置文件，由对等方验证。  |
| 公司总部位置 | 加拿大 |
| 应用信息页 | [https://pandos.io](https://pandos.io) |
...
Pandos Intelligence Inc 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
