---
title: Project见解Project见解的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/22/2022
...
description: Project Insight 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "64879259"
---
# <a name="project-insight"></a>Project 见解

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 3 月 21 日</p>

* <a href="https://teams.microsoft.com/l/app/57a8236b-4ed2-453e-b785-02a887e16a5b" target="_blank">Teams存储区中的视图</a>
...
Project Insight 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Project 见解 |
| 公司的网站 | [https://projectinsight.com](https://projectinsight.com) |
| 应用的使用条款 | [https://projectinsight.com/legal/license-agreement](https://projectinsight.com/legal/license-agreement) |
| 应用的核心功能 | Project见解可让团队直接从Teams管理其工作、项目、时间和费用。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://projectinsight.com/features/microsoft-teams-integra...](https://projectinsight.com/features/microsoft-teams-integration) |
...
Project见解提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 基本用户配置文件信息 |
...
| 最新的 SOC1 认证日期 | 2022-01-18 |
| 应用是否符合服务组织控制 (SOC 2) ？ | 是 |
| 你实现了哪个 SOC 2 认证？ | type2 |
| 最新的 SOC2 认证日期 | 2022-01-18 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteForUser.All | 委托 | 允许为Microsoft Teams租户中的用户安装应用 | [2201df78-1d70-41da-ba2b-c19b00da1215](../azure/2201df78-1d70-41da-ba2b-c19b00da1215.md) |
>| User.Read.All | 委托 | 在系统与Microsoft Teams租户之间匹配用户 | [2201df78-1d70-41da-ba2b-c19b00da1215](../azure/2201df78-1d70-41da-ba2b-c19b00da1215.md) |
>| offline_access | 委托 | 用于请求刷新令牌 | [2201df78-1d70-41da-ba2b-c19b00da1215](../azure/2201df78-1d70-41da-ba2b-c19b00da1215.md) |
