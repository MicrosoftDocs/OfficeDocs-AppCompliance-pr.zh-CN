...
| 应用的核心功能 | 该应用提供全面的员工服务台功能 -包括创建和更新票证) ) 回答例程问题 c) 自动执行预配或载入等常见任务  |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegated | 登录并读取用户个人资料 | [eb628055-f790-4ef0-9fce-ac95b4c61466](../azure/eb628055-f790-4ef0-9fce-ac95b4c61466.md) |
