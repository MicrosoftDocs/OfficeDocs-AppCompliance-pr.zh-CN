---
title: 可操作科学 Rezolve.ai 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/03/2021
...
description: CSA STAR 注册表中 Rezolve.ai 的所有可用安全性和符合性信息、其数据处理策略、Microsoft Cloud App Security应用目录信息以及安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/762a660d-9fa5-461b-be81-310c102ba820" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | 可操作科学 |
| 公司的网站 | [https://www.rezolve.ai](https://www.rezolve.ai) |
| 应用的使用条款 | [https://www.rezolve.ai/generalTerms](https://www.rezolve.ai/generalTerms) |
| 应用的核心功能 | 应用提供全面的员工服务台功能 - 包括) 创建和更新票证的功能 b) 回答例程问题 c) 自动执行常见任务，如预配或加入  |
| 公司总部位置 | 美国美国 |
| 应用信息页 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
Actionable Science 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
| 最新的 SOC1 认证日期 | 2019-12-31 |
| 应用是否符合服务组织控制 (SOC 2) ？ | 是 |
| 最新的 SOC2 认证日期 | 2019-12-31 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | 登录并读取用户个人资料 | [eb628055-f790-4ef0-9fce-ac95b4c61466](../azure/eb628055-f790-4ef0-9fce-ac95b4c61466.md) |
