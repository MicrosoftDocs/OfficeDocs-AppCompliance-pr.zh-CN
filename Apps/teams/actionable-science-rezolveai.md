...
| 合作伙伴公司名称 | 可操作科学 |
| 公司网站 | [https://www.rezolve.ai](https://www.rezolve.ai) |
| 应用的使用条款 | [https://www.rezolve.ai/generalTerms](https://www.rezolve.ai/generalTerms) |
| 应用的核心功能 | 该应用提供全面的员工服务台功能 -包括创建和更新票证) 功能 b) 回答例程问题 c) 自动执行常规任务，如预配或载入  |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
| 应用是否遵守 SOC 1 (服务组织) ？ | 是 |
| 最新 SOC1 认证日期 |  2019-12-31 |
| 应用是否遵守 SOC 2 (服务组织) ？ | 是 |
| 你获得哪种 SOC 2 认证？ |   |
| 最新 SOC2 认证日期 |  2019-12-31 |
| 应用是否遵守 SOC 3 (服务组织) ？ | 否 |
| 最新 SOC3 认证日期 | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegated | 登录并读取用户个人资料 | [eb628055-f790-4ef0-9fce-ac95b4c61466](https://docs.microsoft.com/microsoft-365-app-certification/azure/eb628055-f790-4ef0-9fce-ac95b4c61466) |
