---
title: Workpath GmbH 的 Workpath 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/07/2022
...
description: Workpath 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/8562f79a-0ba8-4555-a967-6e34bdfecca9" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003898" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Workpath GmbH 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Workpath GmbH |
| 公司的网站 | [https://www.workpath.com/en/home](https://www.workpath.com/en/home) |
| 应用的使用条款 | [https://www.workpath.com/en/workpath-ms](https://www.workpath.com/en/workpath-ms) |
| 应用的核心功能 | 使用 Workpath OKR 随时了解你的战略目标。 |
| 公司总部位置 | 德国 |
| 应用信息页 | [https://workpath.zendesk.com/hc/en-us/articles/455508104360...](https://workpath.zendesk.com/hc/en-us/articles/4555081043602-Using-the-MS-Teams-integration) |
...
Workpath GmbH 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
| 隐私策略 URL | https://www.workpath.com/en/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | 读取已登录用户的租户 | [dc8facfc-c606-44b4-a0ad-04f81446845c](../azure/dc8facfc-c606-44b4-a0ad-04f81446845c.md) |
