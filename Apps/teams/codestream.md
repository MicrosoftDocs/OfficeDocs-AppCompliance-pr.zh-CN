---
title: CodeStream by CodeStream 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/06/2022
...
description: CodeStream 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66652173"
---
# <a name="codestream"></a>CodeStream

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 7 月 5 日</p>

* <a href="https://teams.microsoft.com/l/app/7cf49ab7-8b65-4407-b494-f02b525eef2b" target="_blank">在 Teams 应用商店中查看</a>
...
| 合作伙伴公司名称 | CodeStream |
| 公司的网站 | [https://www.codestream.com](https://www.codestream.com) |
| 应用的使用条款 | [https://www.codestream.com/terms](https://www.codestream.com/terms) |
| 应用的核心功能 | CodeStream 使你能够在 IDE 中查看 &amp; 讨论代码。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | |
...
CodeStream 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
| 隐私策略 URL | https://www.codestream.com/privacy |
