...
description: 所有可用于 50 的安全性和合规性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/383cc171-22d5-4df5-87d0-6c656ddcff32" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | Fifty |
| 公司的网站 | [https://app.fifty.do](https://app.fifty.do) |
| 应用的使用条款 | [https://app.fifty.do/CGUV.pdf](https://app.fifty.do/CGUV.pdf) |
| 应用的核心功能 | 五十通过提供个性化的挑战来帮助你从知识转向行动。 这些挑战将有助于巩固或提高你的一些核心技能。 |
| 公司总部位置 | 法国 |
| 应用信息页 | [https://www.fifty.do](https://www.fifty.do) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
50 个应用提供了有关此应用如何收集和存储组织数据以及组织对应用收集的数据的控制的信息。
