...
| 合作伙伴公司名称 | Fifty |
| 公司网站 | [https://app.fifty.do](https://app.fifty.do) |
| 应用的使用条款 | [https://app.fifty.do/CGUV.pdf](https://app.fifty.do/CGUV.pdf) |
| 应用的核心功能 | 第五十项通过提供个性化的挑战帮助你从知识转移到操作。 这些问题将有助于整合或提高你的一些核心技能。 |
| 公司总部位置 | 法国 |
| 应用信息页面 | [https://www.fifty.do](https://www.fifty.do) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
