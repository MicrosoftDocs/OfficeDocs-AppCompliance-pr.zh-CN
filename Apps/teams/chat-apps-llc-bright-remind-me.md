---
title: Chat Apps， LLC 中用于提醒我的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/17/2021
...
* <a href="https://teams.microsoft.com/l/app/a66ea116-3ae1-495b-9f5f-b4b59f19945b" target="_blank">在应用商店Teams视图</a>
...
| 合作伙伴公司名称 | 聊天应用，LLC |
| 公司网站 | [https://brightbits.app](https://brightbits.app) |
| 应用的使用条款 | [https://brightbits.app/terms/](https://brightbits.app/terms/) |
| 应用的核心功能 | 在方便你进行响应时获取重要消息的提醒。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://brightbits.app/bright-remind-me/](https://brightbits.app/bright-remind-me/) |
...
此信息由聊天应用 LLC 提供，它有关此应用程序如何收集和存储组织数据，以及您的组织将拥有对应用收集的数据的控制。
