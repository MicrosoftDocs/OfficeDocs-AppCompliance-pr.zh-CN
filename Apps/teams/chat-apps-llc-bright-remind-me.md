---
title: 通过聊天应用、LLC 为 Bright 提醒我的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/17/2021
...
description: Bright 提醒我的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/a66ea116-3ae1-495b-9f5f-b4b59f19945b" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003002" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

聊天应用，LLC 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | 聊天应用，LLC |
| 公司的网站 | [https://brightbits.app](https://brightbits.app) |
| 应用的使用条款 | [https://brightbits.app/terms/](https://brightbits.app/terms/) |
| 应用的核心功能 | 当响应方便时，获取重要消息的提醒。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://brightbits.app/bright-remind-me/](https://brightbits.app/bright-remind-me/) |
...
聊天应用、LLC 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
