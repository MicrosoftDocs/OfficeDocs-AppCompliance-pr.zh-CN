...
description: KURO 门户的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "65692354"
---
# <a name="kuro-portal"></a>KURO 门户

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 5 月 3 日</p>

* <a href="https://teams.microsoft.com/l/app/c4af7af6-4fa4-4777-bab7-713cda6d0f74" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004019" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Si-Net提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Si-Net |
| 公司的网站 | [https://www.si-net.it](https://www.si-net.it) |
| 应用的使用条款 | [https://www.si-net.it/termini-di-utilizzo-kuro/](https://www.si-net.it/termini-di-utilizzo-kuro/) |
| 应用的核心功能 | 适用于Teams的 KURO 门户应用有望成为一个轻型 CRM，用户可以一目了然地获得所有必要的客户信息，用作电话簿，直接从团队与自己的电话运营商呼叫，直接向联系人发送电子邮件，直接聊天，并与 Kuro 门户来宾客户创建会议， 以简单快速的方式搜索客户信息，直接访问所选客户&#8217;文档集合和共享文档管理  |
| 公司总部位置 | Italy（意大利） |
| 应用信息页 | |
...
Si-Net提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
| 隐私策略 URL | https://www.si-net.it/termini-di-utilizzo-kuro/ |
