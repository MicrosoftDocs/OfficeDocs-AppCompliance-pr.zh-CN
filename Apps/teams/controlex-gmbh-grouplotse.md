...
| 公司网站 | [https://grouplotse.com](https://grouplotse.com) |
| 应用的使用条款 | [https://grouplotse.com/en/user-terms-of-service/](https://grouplotse.com/en/user-terms-of-service/) |
| 应用的核心功能 | 快速阐明责任。 包括 AI、IoT 和云服务的接口！ |
| 公司总部位置 | 德国 |
| 应用信息页面 | [https://grouplotse.com/en/product/](https://grouplotse.com/en/product/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
