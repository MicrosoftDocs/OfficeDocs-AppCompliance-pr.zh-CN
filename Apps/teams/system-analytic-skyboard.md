...
description: SkyBoard 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/9322b063-9069-45fc-aaad-e3a0f9a2462a" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004162" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

系统分析提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | 系统分析 |
| 公司的网站 | [https://www.systemanalytic.com](https://www.systemanalytic.com) |
| 应用的使用条款 | [https://www.systemanalytic.com/eula.html](https://www.systemanalytic.com/eula.html) |
| 应用的核心功能 | 完整的数字咨询委员会。 |
...
系统分析提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
| 隐私策略 URL | https://vmlyr-digitalsolutions.com/privacy.html |
