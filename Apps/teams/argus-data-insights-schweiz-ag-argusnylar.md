...
| 公司网站 | [https://www.argusdatainsights.ch/en/](https://www.argusdatainsights.ch/en/) |
| 应用的使用条款 | [https://portal.nylar.org/terms-of-use](https://portal.nylar.org/terms-of-use) |
| 应用的核心功能 | 对于你的帐户来说，一个 USEFUL 扩展是一个功能扩展。 |
| 公司总部位置 | Switzerland（瑞士） |
| 应用信息页面 | [https://portal.nylar.org/help](https://portal.nylar.org/help) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
