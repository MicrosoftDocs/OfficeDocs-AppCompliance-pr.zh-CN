...
>|   **Graph权限**  | **权限类型** |          **字距调整**          |
>|:------------------------|:--------------------|:------------------------------------|
>| email | delegated | 我们需要此权限，以便用户可以收到交易电子邮件 |
>| offline_access | delegated | 需要提交作业提交 |
>| openid | delegated | 标识用户时需要 |
>| 个人资料 | delegated | 读取用户的名字和姓氏所必需 |
>| User.Read | delegated | 读取用户的名字和姓氏所必需 |
>| EduAssignments.ReadWrite | delegated | 创建工作分配提交所必需 |
