---
title: BitFractal by BitFractal 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/03/2022
...
description: BitFractal 的所有可用安全性和符合性信息、其数据处理策略、Microsoft Cloud App Security 应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/2908a48e-21b7-48e4-89fc-7f4a433952fa" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004172" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

BitFractal 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | BitFractal |
| 公司的网站 | [https://www.bitfractal.com](https://www.bitfractal.com) |
| 应用的使用条款 | [https://www.bitfractal.com/termsofuse](https://www.bitfractal.com/termsofuse) |
| 应用的核心功能 | BitFractal 通过将 AI 认知服务从 Azure 连接到 Teams 的用户友好界面，然后利用机器人、选项卡、消息扩展等 Teams 功能，以简单高效的方式将 AI 引入业务用户，以自动化日常流程。 |
| 公司总部位置 | 美利坚合众国 |
| 应用信息页 | [https://www.bitfractal.com](https://www.bitfractal.com) |
...
BitFractal 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | User Profile Data (DisplayName、Email、ObjectId、TenantId)  |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | User Profile Data (DisplayName、Email、ObjectId、TenantId)  |
| 如果基础结构处理或存储 Microsoft 客户数据，则此数据在地理上存储在哪里？ | 美利坚合众国 |
| 是否已建立数据出租和处置流程？ | 是 |
| 帐户终止后数据保留多长时间？ |  |
| 是否已建立数据访问管理过程？ | 是 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | 获取应用与用户交互的基本用户配置文件信息 | [6a1d567b-1106-46a0-83bc-ffe9ada78b9b](../azure/6a1d567b-1106-46a0-83bc-ffe9ada78b9b.md) |
>| User.Read | 委托 | 获取应用与用户交互的基本用户配置文件信息 | [8f261936-59e1-44b3-8234-a746c5e4eab7](../azure/8f261936-59e1-44b3-8234-a746c5e4eab7.md) |
>| User.Read | 委托 | 获取应用与用户交互的基本用户配置文件信息 | [fb5ad138-bf16-44c0-bdc2-2a9c0e6f246f](../azure/fb5ad138-bf16-44c0-bdc2-2a9c0e6f246f.md) |
