---
title: 支持 Alice by Bao Le Duc 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: Standup Alice 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/724b774e-aa53-4d2d-885b-6008c114cb37" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | Bao Le Duc |
| 公司的网站 | [https://www.standupalice.com](https://www.standupalice.com) |
| 应用的使用条款 | [https://www.standupalice.com/terms](https://www.standupalice.com/terms) |
| 应用的核心功能 | 帮助你有效地为 Scrum 团队运行每日站立会议 |
| 公司总部位置 | 德国 |
| 应用信息页 | [https://www.standupalice.com](https://www.standupalice.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | GCP |
...
此信息由 Bao Le Duc 提供，介绍此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
