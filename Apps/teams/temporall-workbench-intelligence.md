...
| 公司总部位置 | 英国大英和爱尔兰 ()  |
| 应用信息页面 | [https://www.temporall.com/teams_intelligence/](https://www.temporall.com/teams_intelligence/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | GCP |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.Read.All | delegated | 获取已安装的 Teams 应用的列表，以能够获取已知外部 ID 的本地应用 ID。 | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| Channel.ReadBasic.All | 应用程序 | 频道 ID &amp; 名称。 理由：允许加入/离开频道以同步邮件活动。  | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| ChannelMessage.Read.All | 应用程序 | 邮件活动 &amp; 类型以及发件人 &amp; 目标。 从这些路由接收的数据：/teams/${teamId}/channels/${channelId}/messages /teams/${teamId}/channels/${channelId}/messages/${messageId}。 理由：能够计算邮件 &amp; 活动的指标报告。 这构成了我们的网络分析模块的核心，能够绘制用户团队之间的活动 &amp; 图表。 | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| Directory.Read.All | 应用程序 | ClientId、用户列表、组织列表和子频道。 理由：需要将同步 &amp; 用户读取到临时工作台 | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| Group.ReadWrite.All | 应用程序 | 组 ID &amp; 名称。 理由：将应用安装到每个组/频道 | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| TeamMember.Read.All | 应用程序 | 团队的用户成员身份。 理由：允许将用户与临时Teams同步到临时工作台 | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| TeamsAppInstallation.ReadWriteForTeam.All | 应用程序 | 读取为团队安装的应用列表。 理由：检查我们的应用是否已安装，否则将安装它，以能够通过图形 api 获取消息活动 | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| TeamsAppInstallation.ReadWriteForUser.All | 应用程序 | 读取已安装的应用列表。 检查我们的应用是否已安装，否则将安装它以通过调查表与用户交互 | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| User.Read | delegated | 基本用户 &amp; 公司信息。 理由：用于按用户对邮件活动进行分类，允许机器人参与主动邮件。 | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
