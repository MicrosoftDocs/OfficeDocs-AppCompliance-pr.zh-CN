---
title: 按 Think AI Thinky365-Dynamics的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: Thinky365-Dynamics 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/0c272470-130c-46b8-9268-7b305b4cad1d" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004295" target="_blank">在 AppSource 中查看</a>
...
| 应用的核心功能 | 以全新的创新方式与客户互动，同时改善整体客户体验 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | |
