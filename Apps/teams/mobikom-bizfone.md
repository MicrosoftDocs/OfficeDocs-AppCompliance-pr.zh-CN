---
title: MobiKOM 提供的 Bizfone 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
description: Bizfone 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/5be25d59-35cd-4318-83b0-2a5d5668ddcd" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | MobiKOM |
| 公司的网站 | [https://mobikom.dk](https://mobikom.dk) |
| 应用的使用条款 | [https://mobikom.dk/salgs-og-leveringsbetingelser/](https://mobikom.dk/salgs-og-leveringsbetingelser/) |
| 应用的核心功能 | H&#229;ndter dine telefonopkald i Teams， og f&#229; overblik over dine kolleger. |
| 公司总部位置 | 丹麦 |
| 应用信息页 | [https://mobikom.dk/faq/](https://mobikom.dk/faq/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
MobiKOM 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 委托 | 日历用于用户能够向同事显示其缓存，并使用会议来设置其电话 | [1dd6ac57-e6f0-4995-a57f-b6d074c16e11](../azure/1dd6ac57-e6f0-4995-a57f-b6d074c16e11.md) |
>| Contacts.Read | 委托 | 如果用户想要在应用中显示联系人，以便更轻松地拨号联系人，则可以存储这些联系人 | [1dd6ac57-e6f0-4995-a57f-b6d074c16e11](../azure/1dd6ac57-e6f0-4995-a57f-b6d074c16e11.md) |
>| User.Read | 委托 | 此应用程序中的用户读取用于标识目的。 | [1dd6ac57-e6f0-4995-a57f-b6d074c16e11](../azure/1dd6ac57-e6f0-4995-a57f-b6d074c16e11.md) |
>| User.Read | 委托 | 我们不存储数据。 应用程序仅用于身份验证目的 | [fc8f7563-e8ea-4b6d-9622-82775a21a35a](../azure/fc8f7563-e8ea-4b6d-9622-82775a21a35a.md) |
