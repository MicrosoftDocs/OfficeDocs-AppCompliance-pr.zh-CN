...
| 应用的核心功能 | Planyway 是 Trello 用于管理计划、跟踪项目和规划资源的团队日历、日程表和时间跟踪工具。 通过 Planyway，可以在一个地方直观地组织和简化所有团队工作：计划和确定即将执行的任务的优先级、在日历或日程表上分配和安排任务、跟踪项目之间的团队工作负载、管理团队可用性、跟踪在任务和项目上花费的时间、同步你的工作和个人日程安排。 |
| 公司总部位置 | 联盟 ()  |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
