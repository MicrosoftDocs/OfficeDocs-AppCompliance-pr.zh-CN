...
description: 针对定制会谈的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66655915"
---
# <a name="tailored-talks"></a>定制的会谈

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 5 月 23 日</p>

* <a href="https://teams.microsoft.com/l/app/a1f5ad93-accd-463f-a8d5-904c77015815" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004309" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Pogo Studio 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Pogo Studio |
| 公司的网站 | [https://pogodigitalhealth.com](https://pogodigitalhealth.com) |
| 应用的使用条款 | [https://teams.tailored-talks.com/pdf/TermsOfUse.pdf](https://teams.tailored-talks.com/pdf/TermsOfUse.pdf) |
| 应用的核心功能 | 定制的讲座使临床医生能够与患者共享个性化演示文稿。 |
...
Pogo Studio 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
| 隐私策略 URL | https://teams.tailored-talks.com/pdf/PrivacyPolicy.pdf |
...
| 是否定期执行数据安全和隐私评审 (例如，数据保护影响评估或隐私风险评估) ，以确定与处理应用的个人数据相关的风险？ | 不支持 |
...
| 应用是否支持条件访问策略？ | 是 |
| 列出支持的策略类型 | 策略可以针对特定用户和组，让管理员对访问权限进行精细控制。 |
| 应用是否支持持续访问评估 (CAE)  | 否 |
| 应用是否在代码中存储任何凭据？ | 不支持 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 应用程序 | 标识用户 | [61f93bfb-a23c-4043-9187-fbd3326e614b](../azure/61f93bfb-a23c-4043-9187-fbd3326e614b.md) |
>| openid | 应用程序 | 标识用户 | [61f93bfb-a23c-4043-9187-fbd3326e614b](../azure/61f93bfb-a23c-4043-9187-fbd3326e614b.md) |
>| 个人资料 | 应用程序 | 标识用户 | [61f93bfb-a23c-4043-9187-fbd3326e614b](../azure/61f93bfb-a23c-4043-9187-fbd3326e614b.md) |
