---
title: HighSide， Inc 用于 HighSide 协作的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: HighSide 协作的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
---
# <a name="highside-collaboration"></a>HighSide 协作

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 1 月 31 日</p>

* <a href="https://teams.microsoft.com/l/app/d4460828-ddde-4619-b40b-39412667f7a3" target="_blank">在应用商店Teams视图</a>
...
| 公司网站 | [https://highside.io](https://highside.io) |
| 应用的使用条款 | [https://highside.io/terms-of-service](https://highside.io/terms-of-service) |
| 应用的核心功能 | E2E 加密的邮件文件&amp;Microsoft Teams。 |
| 公司总部位置 | 美国美国 |
| 应用信息页面 | [https://highside.io/secureteams](https://highside.io/secureteams) |
