---
title: CyRecord by CyTrack 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/23/2022
...
description: CyRecord 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/4073224c-6e1d-4e72-a754-510d91279b3b" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004280" target="_blank">在 AppSource 中查看</a>
...
| 应用的核心功能 | CyRecord 面向需要高级功能来录制外部 Microsoft Teams 电话的业务用户。   通话录音提供了关于电话的无可争议的事实，导致更快速的争议解决。 通过倾听和培训改善客户服务，并符合法规要求。 |
| 公司总部位置 | 澳大利亚 |
| 应用信息页 | [https://web.cytrack.com/microsoft-teams/call-recording-for-...](https://web.cytrack.com/microsoft-teams/call-recording-for-microsoft-teams/) |
