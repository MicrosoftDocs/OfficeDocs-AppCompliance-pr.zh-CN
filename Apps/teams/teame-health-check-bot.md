...
description: TeaMe 运行状况检查自动程序的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| 公司网站 | [https://www.cdc-jp.com](https://www.cdc-jp.com) |
| 应用的使用条款 | [https://www.cdc-jp.com/health_check_terms](https://www.cdc-jp.com/health_check_terms) |
| 应用的核心功能 | &#8220;TeaMe 运行状况检查应用&#8221;是一项适用于企业的应用程序服务。  此应用程序是一种为员工&#8221; 和 &#8220;组织运行状况检查&#8221; 提供 &#8220;增长满意度标记的工具&#8221;可获取来自员工的一组调查表的解答，并共享员工的结果统计数据。 |
| 公司总部位置 | 日本 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
