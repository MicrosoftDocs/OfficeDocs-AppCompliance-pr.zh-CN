---
title: SmartDraw Software、LLC 的 SmartDraw 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/29/2021
...
description: SmartDraw 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/b1879f1f-dba8-49d6-81a1-21ec15e4f94b" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003505" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

SmartDraw Software，LLC 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | SmartDraw 软件， LLC |
| 公司的网站 | [https://www.smartdraw.com](https://www.smartdraw.com) |
| 应用的使用条款 | [https://www.smartdraw.com/support/terms-of-service.pdf](https://www.smartdraw.com/support/terms-of-service.pdf) |
| 应用的核心功能 | 易于 &amp; 强大的工具，用于制作流程图、UML、ERD、技术图等。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://www.smartdraw.com/features](https://www.smartdraw.com/features) |
...
SmartDraw Software、LLC 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | sso 身份验证元数据，oauth 令牌  |
