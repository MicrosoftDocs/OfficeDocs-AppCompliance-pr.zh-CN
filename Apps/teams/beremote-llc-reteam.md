---
title: ReTeam by BeRemote LLC 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/28/2021
...
description: ReTeam 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/92c90c0c-9a22-42ae-be52-c078eae02dea" target="_blank">Teams存储区中的视图</a>
...
| 公司的网站 | [https://www.beremote.com](https://www.beremote.com) |
| 应用的使用条款 | [https://www.beremote.com/terms-of-use](https://www.beremote.com/terms-of-use) |
| 应用的核心功能 | ReTeam 为专业团队、教练和导师提供参与和社会凝聚力的工具 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
BeRemote LLC 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
