---
title: EdMill by My-Serious-Game 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/19/2021
...
description: EdMill 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/484aa99e-4b6b-4182-8c89-3ae4f85f0cd6" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002622" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

My-Serious-Game 提供给 Microsoft 的信息：
...
| Teams应用程序信息页的 URL | [https://www.edmill.com](https://www.edmill.com) |
| 隐私策略的 URL | [https://app.edmill.com/privacy-policy](https://app.edmill.com/privacy-policy) |
| 使用条款的 URL | [https://app.edmill.com/static/cgv.pdf](https://app.edmill.com/static/cgv.pdf) |
...
My-Serious-Game 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
<iframe height='1020' title='Microsoft Cloud App Security信息' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/36913' frameborder='no'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/36913" target="_blank">在新选项卡中查看</a>
...
My-Serious-Game 提供了有关此应用如何处理身份验证、授权、应用程序注册最佳做法和其他标识条件的信息。
