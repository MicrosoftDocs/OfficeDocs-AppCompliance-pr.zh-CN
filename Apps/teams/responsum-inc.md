---
title: Responsum Inc. 的 Responsum 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/07/2022
...
description: Responsum 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/652dd9a4-1b9f-49a7-ac6f-dbfbc993f825" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003743" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Responsum Inc. 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Responsum Inc. |
| 公司网站 | [https://www.responsum.ai](https://www.responsum.ai) |
| 应用的使用条款 | [https://www.responsum.ai/terms-of-service](https://www.responsum.ai/terms-of-service) |
| 应用的核心功能 | AI 销售助手可更新整个销售工具的信息，并学习团队的知识。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
...
此信息由 Responsum Inc. 提供，有关此应用程序如何收集和存储组织数据以及您的组织将拥有对应用收集的数据的控制。
...
| **Information** | **响应** |
|:----------------|:-------------|
| 应用程序是否与 Microsoft 标识平台 (Azure AD) 单一登录、API 访问等？ | 否 |
