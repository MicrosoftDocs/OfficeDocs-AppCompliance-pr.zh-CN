...
| "Teams应用程序信息"页的 URL | [https://stealthmail.com/product/teams](https://stealthmail.com/product/teams) |
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| ChannelMessage.Read.All | delegated | 应用程序使用所创建的安全电子邮件上的引用将邮件发送到频道 | 无 | 1ed0a549-c730-44c7-a984-a8c658fe9807 |
>| ChannelMessage.Send | delegated | 应用程序使用所创建的安全电子邮件上的引用将邮件发送到频道 | 无 | 1ed0a549-c730-44c7-a984-a8c658fe9807 |
>| Chat.ReadWrite | delegated | 应用程序发送消息以使用所创建的安全电子邮件上的引用进行聊天 | 无 | 1ed0a549-c730-44c7-a984-a8c658fe9807 |
>| GroupMember.Read.All | delegated | 应用程序获取频道成员，让他们使用安全电子邮件 | 无 | 1ed0a549-c730-44c7-a984-a8c658fe9807 |
>| User.Read.All | delegated | 应用程序获取聊天成员，以使他们使用安全电子邮件 | 无 | 1ed0a549-c730-44c7-a984-a8c658fe9807 |
>| User.ReadBasic.All | delegated | 应用程序获取聊天成员，以使他们使用安全电子邮件 | 无 | 1ed0a549-c730-44c7-a984-a8c658fe9807 |
>| email | delegated | 对用户进行身份验证 | 数据库中不存储任何内容 | 1ed0a549-c730-44c7-a984-a8c658fe9807 |
