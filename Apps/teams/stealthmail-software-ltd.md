...
这些信息由一家由用户软件公司提供，用于了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:----------------|:------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|:--------------------|
>| ChannelMessage.Read.All | delegated | 应用程序使用所创建的安全电子邮件上的引用将邮件发送到频道 | 无 | [1ed0a549-c730-44c7-a984-a8c658fe9807](../azure/1ed0a549-c730-44c7-a984-a8c658fe9807.md) |
>| ChannelMessage.Send | delegated | 应用程序使用所创建的安全电子邮件上的引用将邮件发送到频道 | 无 | [1ed0a549-c730-44c7-a984-a8c658fe9807](../azure/1ed0a549-c730-44c7-a984-a8c658fe9807.md) |
>| Chat.ReadWrite | delegated | 应用程序发送消息以使用所创建的安全电子邮件上的引用进行聊天 | 无 | [1ed0a549-c730-44c7-a984-a8c658fe9807](../azure/1ed0a549-c730-44c7-a984-a8c658fe9807.md) |
>| GroupMember.Read.All | delegated | 应用程序获取频道成员，让他们使用安全电子邮件 | 无 | [1ed0a549-c730-44c7-a984-a8c658fe9807](../azure/1ed0a549-c730-44c7-a984-a8c658fe9807.md) |
>| User.Read.All | delegated | 应用程序获取聊天成员，以使他们使用安全电子邮件 | 无 | [1ed0a549-c730-44c7-a984-a8c658fe9807](../azure/1ed0a549-c730-44c7-a984-a8c658fe9807.md) |
>| User.ReadBasic.All | delegated | 应用程序获取聊天成员，以使他们使用安全电子邮件 | 无 | [1ed0a549-c730-44c7-a984-a8c658fe9807](../azure/1ed0a549-c730-44c7-a984-a8c658fe9807.md) |
>| 电子邮件 | delegated | 对用户进行身份验证 | 数据库中不存储任何内容 | [1ed0a549-c730-44c7-a984-a8c658fe9807](../azure/1ed0a549-c730-44c7-a984-a8c658fe9807.md) |
