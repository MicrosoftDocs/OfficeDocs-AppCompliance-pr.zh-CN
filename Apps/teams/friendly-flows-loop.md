...
description: 适用于Loop的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/5dcf4bd7-eccd-4f6d-b5f0-a4e04aab4ff9" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | 友好流 |
| 公司的网站 | [https://friendlyflows.com](https://friendlyflows.com) |
| 应用的使用条款 | [https://friendlyflows.com/terms-of-use/](https://friendlyflows.com/terms-of-use/) |
| 应用的核心功能 | 在正确的时间将人们聚集在一起处理项目。 |
| 公司总部位置 | 荷兰 ()  |
| 应用信息页 | [https://friendlyflows.com/loop/](https://friendlyflows.com/loop/) |
...
友好流提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 可访问 |
| 应用会处理哪些数据？ | 用户配置文件、用户输入 |
...
| 如果你的应用不使用上述库之一，它使用什么身份验证库或库？ | None |
| 应用是否支持条件访问策略？ | 否 |
| 应用是否支持持续访问评估 (CAE)  | 否 |
| 应用是否在代码中存储任何凭据？ | 否 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | 身份验证 | [95a2eca4-fb4b-4488-8ba8-6bacf3812c76](../azure/95a2eca4-fb4b-4488-8ba8-6bacf3812c76.md) |
>| 电子邮件 | 委托 | 注册 | [95a2eca4-fb4b-4488-8ba8-6bacf3812c76](../azure/95a2eca4-fb4b-4488-8ba8-6bacf3812c76.md) |
>| 个人资料 | 委托 | 身份验证 | [95a2eca4-fb4b-4488-8ba8-6bacf3812c76](../azure/95a2eca4-fb4b-4488-8ba8-6bacf3812c76.md) |
