...
| 合作伙伴公司名称 | MailClark |
| 公司网站 | [https://mailclark.ai/microsoft-teams-integration](https://mailclark.ai/microsoft-teams-integration) |
| 应用的使用条款 | [https://mailclark.ai/tos](https://mailclark.ai/tos) |
| 应用的核心功能 | 管理 &amp; 对电子邮件、Facebook 和 Twitter 邮件Microsoft Teams。 |
| 公司总部位置 |  |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
