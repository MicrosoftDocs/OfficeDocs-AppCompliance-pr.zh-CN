---
title: JustLogin by JustLogin 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: JustLogin 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/cfbb8888-3227-45fc-a4b7-423af170defa" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004314" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

JustLogin 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | JustLogin |
| 公司的网站 | [https://justlogin.com](https://justlogin.com) |
| 应用的使用条款 | [https://justlogin.com/terms/](https://justlogin.com/terms/) |
| 应用的核心功能 | JustLogin - 你的员工友好的 HR Software。 |
| 公司总部位置 | 新加坡 |
| 应用信息页 | |
...
JustLogin 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
| 隐私策略 URL | https://justlogin.com/privacy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| 电子邮件 | 委托 | 需要电子邮件才能通过 SSO 登录到 JustLogin | [af5883db-bda9-4d1a-b1ce-022bea20f021](../azure/af5883db-bda9-4d1a-b1ce-022bea20f021.md) |
