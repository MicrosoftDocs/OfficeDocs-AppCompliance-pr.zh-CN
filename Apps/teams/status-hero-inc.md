...
description: 状态英雄的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66549368"
---
# <a name="status-hero"></a>状态英雄

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 5 月 3 日</p>

* <a href="https://teams.microsoft.com/l/app/7917afd4-9825-4c1d-b683-ce1fcb77d5b4" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004205" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Status Hero 公司向 Microsoft 提供的信息：
...
| 合作伙伴公司名称 | Status Hero， Inc. |
| 公司的网站 | [https://statushero.com](https://statushero.com) |
| 应用的使用条款 | [https://statushero.com/terms](https://statushero.com/terms) |
| 应用的核心功能 | 状态英雄将团队工具中的异步签入和数据转换为简洁、有见地的报告。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://statushero.com/integrations/microsoft-teams](https://statushero.com/integrations/microsoft-teams) |
...
Status Hero 公司提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
| 隐私策略 URL | https://statushero.com/privacy |
