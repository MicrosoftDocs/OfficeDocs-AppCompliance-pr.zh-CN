---
title: Infographfx 技术演示文稿 AI 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/28/2021
...
description: 演示文稿 AI 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/1f510555-b518-4084-84e0-18c7bebc807c" target="_blank">Teams存储区中的视图</a>
...
| 公司的网站 | [https://presentations.ai](https://presentations.ai) |
| 应用的使用条款 | [https://presentations.ai/terms_teams.html](https://presentations.ai/terms_teams.html) |
| 应用的核心功能 | Presentations.AI 是一种智能工具，具有最佳设计做法，可创建出色的演示文稿。 |
| 公司总部位置 | 印度 |
| 应用信息页 | |
...
Infographfx 技术提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
