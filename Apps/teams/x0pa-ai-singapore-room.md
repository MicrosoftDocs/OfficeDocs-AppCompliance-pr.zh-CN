---
title: X0PA AI 新加坡版 X0PA ROOM 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/31/2021
...
description: X0PA ROOM 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/d84ed1b7-cd38-42e7-8a07-56f7ae72e93a" target="_blank">Teams存储区中的视图</a>
...
| 公司的网站 | [https://x0paroom.com](https://x0paroom.com) |
| 应用的使用条款 | [https://x0pa.com/terms-of-use](https://x0pa.com/terms-of-use) |
| 应用的核心功能 | 使用 X0PA ROOM 的智能按需视频面试功能和分析 |
| 公司总部位置 | 新加坡 |
| 应用信息页 | [https://x0paroom.com](https://x0paroom.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
X0PA AI 新加坡版提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
