---
title: X0PA AI 新加坡 X0PA 会议室的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/31/2021
...
* <a href="https://teams.microsoft.com/l/app/d84ed1b7-cd38-42e7-8a07-56f7ae72e93a" target="_blank">在应用商店Teams视图</a>
...
| 公司网站 | [https://x0paroom.com](https://x0paroom.com) |
| 应用的使用条款 | [https://x0pa.com/terms-of-use](https://x0pa.com/terms-of-use) |
| 应用的核心功能 | Smart On Demand Video Interviewing Capabilities and Analytics with X0PA ROOM |
| 公司总部位置 | 新加坡 |
| 应用信息页面 | [https://x0paroom.com](https://x0paroom.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
X0PA AI 新加坡提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及组织将拥有对应用收集的数据的控制有关。
