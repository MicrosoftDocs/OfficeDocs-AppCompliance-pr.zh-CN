---
title: Weekdone Ltd 针对 Weekdone 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/28/2021
...
description: Weekdone 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/fa662fca-9224-49e3-9566-f66d2a6949af" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003399" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Weekdone Ltd 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Weekdone Ltd |
| 公司网站 | [https://weekdone.com](https://weekdone.com) |
| 应用的使用条款 | [https://weekdone.com/terms-of-service](https://weekdone.com/terms-of-service) |
| 应用的核心功能 | 查看和更新每周签入和 OKR，并获取有关更新的通知 |
| 公司总部位置 | 爱沙尼亚 |
| 应用信息页面 | [https://weekdone.com/integrations/microsoft-teams](https://weekdone.com/integrations/microsoft-teams) |
...
Weekdone Ltd 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及您的组织将拥有对应用收集的数据的控制有关。
...
| 数据库中存储了哪些数据？ | 设备的 IP 地址。 客户的名称和电子邮件地址。 |
...
| 隐私策略 URL | https://weekdone.com/privacy |
