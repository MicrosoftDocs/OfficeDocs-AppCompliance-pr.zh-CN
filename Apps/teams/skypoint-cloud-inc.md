...
* <a href="https://teams.microsoft.com/l/app/9637dd07-ec2d-48f7-83cd-bccad3be9fd4" target="_blank">在应用商店Teams视图</a>
...
| 公司网站 | [https://skypointcloud.com](https://skypointcloud.com) |
| 应用的使用条款 | [https://skypointcloud.com/terms/](https://skypointcloud.com/terms/) |
| 应用的核心功能 | SkyPoint 可帮助品牌了解他们的客户、做出战略决策，并持续采取正确的行动，以更好地服务于他们的消费者并继续发展其业务。 We're a customer data platform that provides intelligent capabilities across data management and一致性， privacy compliance， analytics and insights， and activation.  |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://skypointcloud.com/platform/](https://skypointcloud.com/platform/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
此信息由 SkyPoint Cloud Inc. 提供，用于了解此应用程序如何收集和存储组织数据，以及组织对应用收集的数据的控制。
