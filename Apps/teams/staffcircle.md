...
| 公司网站 | [https://www.staffcircle.com](https://www.staffcircle.com) |
| 应用的使用条款 | [https://www.staffcircle.com/terms](https://www.staffcircle.com/terms) |
| 应用的核心功能 | 适用于远程工作者的内部通信、文化、参与和性能管理平台。 |
| 公司总部位置 | 英国大英和爱尔兰 ()  |
| 应用信息页面 | [https://www.staffcircle.com/integrations/microsoft-teams-in...](https://www.staffcircle.com/integrations/microsoft-teams-integration/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
