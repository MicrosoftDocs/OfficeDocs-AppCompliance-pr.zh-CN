...
description: Kazoo 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/afd11b2b-88b8-4f07-8902-a6e445b6e753" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | Kazoo |
| 公司的网站 | [https://www.kazoohr.com](https://www.kazoohr.com) |
| 应用的使用条款 | [https://www.kazoohr.com/terms-of-use](https://www.kazoohr.com/terms-of-use) |
| 应用的核心功能 | 员工参与度和性能管理工具，通过对等识别和奖励以及持续性能管理来提高企业文化和员工满意度。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
Kazoo 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
