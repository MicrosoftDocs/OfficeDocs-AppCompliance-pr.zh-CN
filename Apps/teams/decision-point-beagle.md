...
description: Beagle 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/a0f836a9-178e-4407-9c26-4579dcd17bd1" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | 决策点 |
| 公司的网站 | [https://decisionpoint.ai](https://decisionpoint.ai) |
...
| 应用的核心功能 | Beagle 是基于聊天的 BI 工具，与 MS Teams 等平台集成。 Beagle 降低了采用的障碍，并通过协作应用将数据传递给用户，从而无需培训) 的个人 (。  Beagle 以见解卡的形式向用户显示相关数据，并允许他们使用筛选器深入了解相关数据，并有助于更快地进行决策。  |
| 公司总部位置 | 印度 |
| 应用信息页 | [https://beagleanalytics.ai](https://beagleanalytics.ai) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
决策点提供了此信息，说明此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
