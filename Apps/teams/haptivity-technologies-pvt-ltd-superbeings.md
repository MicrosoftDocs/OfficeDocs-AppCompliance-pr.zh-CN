---
title: 适用于 SuperBeings by Haptivity Technologies Pvt Ltd 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/20/2021
...
description: SuperBeings 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "64880209"
---
# <a name="superbeings"></a>SuperBeings

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 9 月 3 日</p>

* <a href="https://teams.microsoft.com/l/app/1e7931be-a76f-4b12-b1b3-8914c7860aec" target="_blank">Teams存储区中的视图</a>
...
Haptivity Technologies Pvt Ltd 提供给 Microsoft 的信息：
...
| 公司的网站 | [https://www.superbeings.ai](https://www.superbeings.ai) |
| 应用的使用条款 | [https://www.superbeings.ai/terms-of-use](https://www.superbeings.ai/terms-of-use) |
| 应用的核心功能 | 为你的领导者提供工具/学习/见解，以持续增压其团队。 |
| 公司总部位置 | 印度 |
| 应用信息页 | [https://www.superbeings.ai](https://www.superbeings.ai) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
Haptivity Technologies Pvt Ltd 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
