...
* <a href="https://teams.microsoft.com/l/app/1e7931be-a76f-4b12-b1b3-8914c7860aec" target="_blank">在应用商店Teams视图</a>
...
由 Haptivity Technologies Pvt Ltd 提供给 Microsoft 的信息：
...
| Teams信息页的 URL | [https://www.superbeings.ai](https://www.superbeings.ai) |
...
此信息由 Haptivity Technologies Pvt Ltd 提供，用于了解此应用程序如何收集和存储组织数据，以及您的组织将拥有对应用收集的数据的控制。
...
>|:---------------------------------------|:-----------------------------------|:------------------------------------|
>| 注册使用我们的服务的组织与我们共享员工电子邮件。 我们尝试从自动程序获取电子邮件，以便同步用户的正确信息，并更好地为用户提供服务。 | 电子邮件 | 我们使用电子邮件 ID 同步不同服务的数据。 这同样适用于我们的自动Teams程序。 |
...
>我们的所有合作伙伴都符合 GDPR。 因此，我们可以要求 SuperBeings 使用或交互的所有系统进行删除/存档和数据保留。
...
此信息由 Haptivity Technologies Pvt Ltd 提供有关此应用程序如何处理身份验证、授权、应用程序注册最佳做法和其他标识条件的信息。
