...
>|:----------------|:------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|:--------------------|
>| User.Read | delegated | 使用 userPrincipalName 标识用户的邮件是否来自有效AAD邮件 | 登录并读取用户个人资料 | [a938ae1e-a791-4751-9e6a-178c991fa0fa](https://docs.microsoft.com/microsoft-365-app-certification/azure/a938ae1e-a791-4751-9e6a-178c991fa0fa) |
...
>|:---------------------------------------|:-----------------------------------|:------------------------------------|
>| 用于标识用户的邮件是否来自有效AAD邮件 | 用户的电子邮件 | 存储用户的邮件列表，用于标识用户是否来自AAD邮件 |
