...
* <a href="https://teams.microsoft.com/l/app/0b48e71e-8f46-46d8-a545-608295f000ac" target="_blank">在应用商店Teams视图</a>
...
| 合作伙伴公司名称 | MiHCM |
| 公司网站 | [https://mihcm.com](https://mihcm.com) |
| 应用的使用条款 | [https://mia.work/terms-of-use](https://mia.work/terms-of-use) |
| 应用的核心功能 | Mia Workplace 虚拟助理使你的组织能够为所有用户提供一个Microsoft Teams助手。 此工作区Microsoft Teams可帮助你的组织提高工作效率、提高员工参与度、执行大量 HR 请求、与工作相关的服务请求、健身健康等 &amp; 。 Mia 为员工参与度、无缝的员工体验提供丰富的 HR 服务/交互。 |
| 公司总部位置 | 斯里兰卡 |
| 应用信息页面 | |
...
MiHCM 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及您的组织将拥有对应用收集的数据的控制有关。
...
| 隐私策略 URL | https://mia.work/privacy-policy |
...
>|   **Graph权限**  | **权限类型** |          **字距调整**          |
>|:------------------------|:--------------------|:------------------------------------|
>| User.Read | delegated | 唯一标识用户 |
>| Group.Read.All | delegated | 读取用户的 Microsoft Planner 任务 |
>| MailboxSettings.Read | 应用程序 | 读取用户的时区 |
>| Calendars.Read | 应用程序 | 读取用户的计划日历事件 |
