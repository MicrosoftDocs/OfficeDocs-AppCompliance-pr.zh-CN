...
| 应用的核心功能 | Totara for Microsoft Teams 使 Totara 云订阅者能够访问学习并与其他用户Microsoft Teams。 此应用允许用户访问分配的学习、探索学习内容以及创建、与播放列表和资源交互并共享，所有这些都Microsoft Teams。 |
| 公司总部位置 | 新西兰 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegated | 通过电子邮件地址将团队用户连接到本地系统用户 | [5022e09d-d2f9-499f-8925-554c324ad23a](https://docs.microsoft.com/microsoft-365-app-certification/azure/5022e09d-d2f9-499f-8925-554c324ad23a) |
