...
| 公司网站 | [https://www.totaralearning.com](https://www.totaralearning.com) |
...
| 应用的核心功能 | Totara for Microsoft Teams 使 Totara 云订阅者能够访问学习并与组织内部Microsoft Teams。 此应用允许用户访问分配的学习、探索学习内容以及创建、与播放列表和资源交互并共享，所有这些都位于Microsoft Teams。 |
| 公司总部位置 | 新西兰 |
| 应用信息页面 | [https://www.totaralearning.com/products/totara-talent-exper...](https://www.totaralearning.com/products/totara-talent-experience-platform) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
此信息由 Totara Learning有关此应用程序如何收集和存储组织数据以及您的组织将拥有对应用收集的数据的控制的信息。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegated | 通过电子邮件地址将团队用户连接到本地系统用户 | [5022e09d-d2f9-499f-8925-554c324ad23a](../azure/5022e09d-d2f9-499f-8925-554c324ad23a.md) |
