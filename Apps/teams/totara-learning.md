---
title: Totara by Totara Learning 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/09/2021
...
description: Totara 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/5022e09d-d2f9-499f-8925-554c324ad23a" target="_blank">Teams存储区中的视图</a>
...
Totara Learning向 Microsoft 提供的信息：
...
| 公司的网站 | [https://www.totaralearning.com](https://www.totaralearning.com) |
| 应用的使用条款 | [https://www.totaralearning.com/en/solutions/totara-cloud/te...](https://www.totaralearning.com/en/solutions/totara-cloud/terms-of-service) |
| 应用的核心功能 | Totara app for Microsoft Teams 使 Totara Cloud 订阅者能够访问学习和与Microsoft Teams中的其他人协作。 此应用允许用户访问分配的学习、浏览学习内容以及创建、与播放列表和资源进行交互和共享-全部在Microsoft Teams中。 |
| 公司总部位置 | 新西兰 |
| 应用信息页 | [https://www.totaralearning.com/products/totara-talent-exper...](https://www.totaralearning.com/products/totara-talent-experience-platform) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
Totara Learning提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | 通过电子邮件地址将 Teams 用户连接到本地系统用户 | [5022e09d-d2f9-499f-8925-554c324ad23a](../azure/5022e09d-d2f9-499f-8925-554c324ad23a.md) |
