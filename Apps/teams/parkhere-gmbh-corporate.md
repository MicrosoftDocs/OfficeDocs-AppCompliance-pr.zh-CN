...
| 公司网站 | [https://park-here.eu](https://park-here.eu) |
| 应用的使用条款 | [https://park-here.eu/ms-teams-terms-of-use/](https://park-here.eu/ms-teams-terms-of-use/) |
| 应用的核心功能 | Finden und Reservieren Sie einen verf&#252;gbaren Parkplatz an Ihrer Arbeitsstein |
| 公司总部位置 | 德国 |
| 应用信息页面 | [https://park-here.eu/komplettloesung/](https://park-here.eu/komplettloesung/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
