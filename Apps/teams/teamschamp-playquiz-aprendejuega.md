---
title: PlayQuiz 的应用程序信息 - Aprende &amp; Juega by TeamsChamp
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/13/2022
...
description: PlayQuiz - Aprende &amp; Juega 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66076333"
---
# <a name="playquiz---aprende-amp-juega"></a>PlayQuiz - 四月 &amp; 僅

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 6 月 10 日</p>

* <a href="https://teams.microsoft.com/l/app/d36eac22-ff28-4392-9ba7-6e32151b9894" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | TeamsChamp |
| 公司的网站 | [https://www.encamina.com](https://www.encamina.com) |
| 应用的使用条款 | [https://www.teamsquiz.com/en/terms/](https://www.teamsquiz.com/en/terms/) |
| 应用的核心功能 | PlayQuiz 是一个 Gamification 应用程序，用户可以每天从Microsoft 365生态系统解答 3 个问题，&#8220;获得&#8221;数字知识点。 用户将能够观看公司排行榜，以发现谁是公司最好的 M365 冠军。 通过在公司中包括游戏化，用户可以深入了解使用Microsoft 365工具的最佳做法。 此外，管理员将能够将其自定义问题添加到系统，以便生成专注于特定主题的活动。 |
| 公司总部位置 | 西班牙 |
| 应用信息页 | [https://www.teamsquiz.com](https://www.teamsquiz.com) |
...
TeamsChamp 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 否 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | direcci&#243;n de correoelectr&#243;nico， nombre y apellido |
| 如果基础结构处理或存储 Microsoft 客户数据，则此数据在地理上存储在哪里？ | 西班牙 |
| 是否已建立数据出租和处置流程？ | 否 |
| 帐户终止后数据保留多长时间？ | 不保留 |
| 是否已建立数据访问管理过程？ | 是 |
...
| 隐私策略 URL | https://www.theplayquiz.com/procesamiento-de-datos/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | Acceder a los datos del usuarios (email， nombre y apellido)  | [f3277edf-4f66-4e94-853b-cc1f1e2914f8](../azure/f3277edf-4f66-4e94-853b-cc1f1e2914f8.md) |
>| User.ReadBasic.All | 委托 | Acceder a los datos de los compa&#241;eros del usuario principal (email， nombre y apellido)  | [f3277edf-4f66-4e94-853b-cc1f1e2914f8](../azure/f3277edf-4f66-4e94-853b-cc1f1e2914f8.md) |
>| openid | 委托 | Recibir identificador del usuario | [f3277edf-4f66-4e94-853b-cc1f1e2914f8](../azure/f3277edf-4f66-4e94-853b-cc1f1e2914f8.md) |
>| 个人资料 | 委托 | obtener la foto a la hora de compartirlo en teams (nombre de imagen y nombre de usuario)  | [f3277edf-4f66-4e94-853b-cc1f1e2914f8](../azure/f3277edf-4f66-4e94-853b-cc1f1e2914f8.md) |
