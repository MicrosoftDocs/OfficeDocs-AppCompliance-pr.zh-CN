...
| 应用的核心功能 | 推荐你的好友在公司中打开工作，并使用此工具跟踪Microsoft Teams。 |
| 公司总部位置 | 菲律宾 ()  |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 两者 | 应用用户的 (名字和姓氏（即员工) ）主要供 HR 用户用来轻松识别引用引荐应用程序跟踪并奖励付款的员工。 它还将用于在发送系统生成的电子邮件通知时正确地址员工。 | [7414b436-87d1-4904-9d52-ff47885b89f1](https://docs.microsoft.com/microsoft-365-app-certification/azure/7414b436-87d1-4904-9d52-ff47885b89f1) |
