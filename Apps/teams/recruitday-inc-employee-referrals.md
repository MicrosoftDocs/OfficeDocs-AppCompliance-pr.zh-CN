...
| 公司网站 | [https://www.recruitday.com](https://www.recruitday.com) |
| 应用的使用条款 | [https://www.recruitday.com/terms-of-use](https://www.recruitday.com/terms-of-use) |
| 应用的核心功能 | 推荐你的好友在公司中打开工作，然后使用你的Microsoft Teams。 |
| 公司总部位置 | 菲律宾 ()  |
| 应用信息页面 | [https://employer.recruitday.com/solutions/employee-referral...](https://employer.recruitday.com/solutions/employee-referrals/microsoft-teams) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 两者 | 应用用户的名字 (姓氏（即员工) ）主要供 HR 用户用来轻松识别引用引荐应用程序跟踪和奖励付款的员工。 它还将用于在发送系统生成的电子邮件通知时正确地址员工。 | [7414b436-87d1-4904-9d52-ff47885b89f1](../azure/7414b436-87d1-4904-9d52-ff47885b89f1.md) |
