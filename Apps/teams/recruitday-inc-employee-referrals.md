---
title: Recruitday Inc. 员工引荐的应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/18/2021
...
description: 适用于员工引荐的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/c179cdf6-f93d-4aa3-9e2d-e934e5a81846" target="_blank">Teams存储区中的视图</a>
...
Recruitday Inc. 提供给 Microsoft 的信息：
...
| 公司的网站 | [https://www.recruitday.com](https://www.recruitday.com) |
| 应用的使用条款 | [https://www.recruitday.com/terms-of-use](https://www.recruitday.com/terms-of-use) |
| 应用的核心功能 | 请参阅好友，在公司中打开工作，并使用Microsoft Teams跟踪奖励。 |
| 公司总部位置 | 菲律宾 ()  |
| 应用信息页 | [https://employer.recruitday.com/solutions/employee-referral...](https://employer.recruitday.com/solutions/employee-referrals/microsoft-teams) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
Recruitday Inc. 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 两者 | 应用用户的名字和姓氏 (，即员工) 主要由人力资源用户用来轻松识别推荐应用程序跟踪和奖励付款的应聘员工。 它还可用于在发送系统生成的电子邮件通知时正确处理员工。 | [7414b436-87d1-4904-9d52-ff47885b89f1](../azure/7414b436-87d1-4904-9d52-ff47885b89f1.md) |
