...
description: Collection Pot 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/dee26c7b-3bce-4fe3-af55-1999276e1a72" target="_blank">Teams存储区中的视图</a>
...
Gifted to You Limited to Microsoft 提供的信息：
...
| 公司的网站 | [https://www.collectionpot.com](https://www.collectionpot.com) |
| 应用的使用条款 | [https://www.collectionpot.com/terms-of-service/](https://www.collectionpot.com/terms-of-service/) |
| 应用的核心功能 | 个性化的 &amp; 有趣方式，为任何场合、生活活动或慈善活动募捐 |
...
此信息已由 Gifted To You Limited 提供，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
