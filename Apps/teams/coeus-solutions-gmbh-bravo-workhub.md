---
title: COeus 解决方案 GmbH 针对 BRAVO Workhub 的应用程序信息
ms.author: elmalova
author: elenamalova
ms.date: 02/07/2022
ms.topic: article
...
description: BRAVO Workhub 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "62449868"
---
# <a name="bravo-workhub"></a>BRAVO Workhub

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 12 月 3 日</p>

* <a href="https://teams.microsoft.com/l/app/53ab3c45-3531-47a8-b524-fe8b5fd539ef" target="_blank">在应用商店Teams视图</a>
...
Coeus 解决方案 GmbH 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Coeus 解决方案 GmbH |
| 公司网站 | [https://getbravo.io](https://getbravo.io) |
| 应用的使用条款 | [https://getbravo.io/terms-and-conditions](https://getbravo.io/terms-and-conditions) |
| 应用的核心功能 | 通过与 BRAVO 的集成轻松Microsoft Teams对等奖励。 |
| 公司总部位置 | 德国 |
| 应用信息页面 | |
...
Coeus 解决方案 GmbH 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及您的组织将拥有对应用收集的数据的控制有关。
...
| 数据库中存储了哪些数据？ | 我们将Microsoft Teams用户 ID 和团队 ID 存储在数据库中。 |
...
| 隐私策略 URL | https://getbravo.io/privacy-policy |
