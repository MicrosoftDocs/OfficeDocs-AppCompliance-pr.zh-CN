---
title: Lexion by Lexion 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/20/2021
...
description: Lexion 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/e2b7f512-12eb-4ba7-8705-b512fb3c05ee" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003176" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Lexion 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Lexion |
| 公司的网站 | [https://lexion.ai](https://lexion.ai) |
| 应用的使用条款 | [https://lexion.ai/terms](https://lexion.ai/terms) |
| 应用的核心功能 | Microsoft Teams机器人用于 Lexion AI 驱动的合同生命周期管理。  |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://lexion.ai](https://lexion.ai) |
...
Lexion 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
