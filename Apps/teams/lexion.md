...
description: 用于词汇表的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/e2b7f512-12eb-4ba7-8705-b512fb3c05ee" target="_blank">在应用商店Teams视图</a>
...
| 合作伙伴公司名称 | Lexion |
| 公司网站 | [https://lexion.ai](https://lexion.ai) |
| 应用的使用条款 | [https://lexion.ai/terms](https://lexion.ai/terms) |
| 应用的核心功能 | Microsoft Teams Ai 支持合同生命周期管理的词典自动程序。
 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://lexion.ai](https://lexion.ai) |
...
词汇表提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及组织将拥有对应用收集的数据的控制有关。
