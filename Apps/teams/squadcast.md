---
title: Squadcast 的 Squadcast 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/19/2022
...
description: Squadcast 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/7792759a-43e8-4dc8-9f55-e7b0382c4a67" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004390" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Squadcast 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Squadcast |
| 公司的网站 | [https://www.squadcast.com](https://www.squadcast.com) |
| 应用的使用条款 | [https://www.squadcast.com/terms](https://www.squadcast.com/terms) |
| 应用的核心功能 | 直接从 MS Teams 进行有效的事件管理。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://support.squadcast.com/docs/msteams](https://support.squadcast.com/docs/msteams) |
...
Squadcast 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 用户配置文件数据 - 仅用户名，Email |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 团队 ID、团队名称、频道 ID、频道名称、租户 ID |
...
| 隐私策略 URL | https://www.squadcast.com/privacy |
