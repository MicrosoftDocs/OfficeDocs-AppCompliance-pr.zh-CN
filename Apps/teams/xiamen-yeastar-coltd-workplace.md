---
title: 厦门叶星有限公司的 Yeastar Workplace 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Yeastar Workplace 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/8a2a6bf3-b7ad-403a-bdf4-68855ed22024" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004339" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

厦门叶星有限公司向 Microsoft 提供的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | Yeastar Workplace |
| ID | WA200004339 |
| 支持Office 365客户端 | Microsoft Teams |
| 合作伙伴公司名称 | 厦门叶星有限公司 |
| 公司的网站 | [https://www.yeastar.com](https://www.yeastar.com) |
| 应用的使用条款 | [https://www.yeastar.com/yeastar-workplace-terms-of-service/](https://www.yeastar.com/yeastar-workplace-terms-of-service/) |
| 应用的核心功能 | 在 Microsoft Teams 中轻松查找和预订会议室。 |
| 公司总部位置 | 中国 |
| 应用信息页 | [https://www.yeastar.com/yeastar-workplace/meeting-room-book...](https://www.yeastar.com/yeastar-workplace/meeting-room-booking) |
| 用于运行应用的托管环境或服务模型是什么？ | Iaas |
| 应用使用哪些托管云提供商？ | AlibabaCloud、GCP、Aws |
...
此信息由厦门 Yeastar 有限公司提供，介绍此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
| 数据库中存储了哪些数据？ | 用户登录和会议预订 |
| 如果基础结构处理或存储 Microsoft 客户数据，则此数据在地理上存储在哪里？ | 美国美国、德国 |
| 是否已建立数据出租和处置流程？ | 是 |
| 帐户终止后数据保留多长时间？ |  |
| 是否已建立数据访问管理过程？ | 是 |
...
| 隐私策略 URL | https://www.yeastar.com/yeastar-workplace-privacy-policy/ |
