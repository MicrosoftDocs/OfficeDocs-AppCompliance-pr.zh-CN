---
title: 按 DSMN8 按 DSMN8 表示的员工小公司的应用程序信息
ms.author: elmalova
author: elenamalova
ms.date: 01/19/2022
ms.topic: article
...
description: 用于按 DSMN8 的 Employee 一致性的所有安全和合规性信息、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/3cf056e3-1c08-4cda-b6d6-962f7c7a1f7c" target="_blank">在应用商店Teams视图</a>
...
| 合作伙伴公司名称 | DSMN8 |
| 公司网站 | [https://dsmn8.com](https://dsmn8.com) |
| 应用的使用条款 | [https://dsmn8.com/terms-and-conditions](https://dsmn8.com/terms-and-conditions) |
| 应用的核心功能 |  DSMN8 是一个基于应用的平台，通过向员工自己的社交媒体频道共享经公司批准的公司内容，使员工成为公司影响者。  |
| 公司总部位置 | 英国大英和爱尔兰 ()  |
| 应用信息页面 | |
...
此信息由 DSMN8 提供，用于说明此应用程序如何收集和存储组织数据，以及您的组织将拥有对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 两者 | 在登录过程中读取职务、名字、姓氏和电子邮件数据以在应用中创建配置文件 | [3cf056e3-1c08-4cda-b6d6-962f7c7a1f7c](https://docs.microsoft.com/microsoft-365-app-certification/azure/3cf056e3-1c08-4cda-b6d6-962f7c7a1f7c) |
