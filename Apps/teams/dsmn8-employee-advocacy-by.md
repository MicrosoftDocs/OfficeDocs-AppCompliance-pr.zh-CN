---
title: DSMN8 由 DSMN8 保护员工的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/19/2022
...
description: DSMN8 为员工宣传提供的所有可用安全性和合规性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "64878279"
---
# <a name="employee-advocacy-by-dsmn8"></a>由 DSMN8 发起员工宣传

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 11 月 26 日</p>

* <a href="https://teams.microsoft.com/l/app/3cf056e3-1c08-4cda-b6d6-962f7c7a1f7c" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003677" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

DSMN8 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | DSMN8 |
| 公司的网站 | [https://dsmn8.com](https://dsmn8.com) |
| 应用的使用条款 | [https://dsmn8.com/terms-and-conditions](https://dsmn8.com/terms-and-conditions) |
| 应用的核心功能 |  DSMN8 是基于应用的平台，通过将公司批准的公司内容共享到自己的社交媒体渠道，使员工能够成为公司影响者。  |
...
DSMN8 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 职务、名字、姓氏、电子邮件地址 |
| 应用是否支持 TLS 1.1 或更高版本？ | 可访问 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 职务、名字、姓氏、电子邮件地址 |
...
| 隐私策略 URL | https://dsmn8.com/terms-and-conditions |
...
| 如果你的应用不使用上述库之一，它使用什么身份验证库或库？ | https://docs.microsoft.com/en-us/azure/active-directory/develop/v2-oauth2-auth-code-flow |
| 应用是否支持条件访问策略？ | 否 |
| 应用是否支持持续访问评估 (CAE)  | 否 |
| 应用是否在代码中存储任何凭据？ | 否 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 两者 | 若要在登录过程中读取职务、名字、姓氏和电子邮件数据，以在我们的应用中创建配置文件 | [3cf056e3-1c08-4cda-b6d6-962f7c7a1f7c](../azure/3cf056e3-1c08-4cda-b6d6-962f7c7a1f7c.md) |
