...
description: GoLinks 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/c1abaf93-e823-4e9a-a810-34a47e77ef71" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003853" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

GoLinks 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | GoLinks |
| 公司网站 | [https://www.golinks.io](https://www.golinks.io) |
| 应用的使用条款 | [https://www.golinks.io/terms.php](https://www.golinks.io/terms.php) |
| 应用的核心功能 | GoLinks（称为 go 链接、golinks、go/links 或 go-links）是直观、易记的简短链接，由团队共享。 它将长而难看的 URL 转换为可读的 Go 链接，可以直接在浏览器、电子邮件、聊天和对话中使用。 通过 GoLinks，公司可以有效和高效地大规模访问和共享工作信息和资源。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://www.golinks.io/golinks.php](https://www.golinks.io/golinks.php) |
...
此信息由 GoLinks 提供，用于了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
| 数据库中存储了哪些数据？ | 我们仅存储 Microsoft 的租户 ID。 |
...
| 隐私策略 URL | https://www.golinks.io/privacy.php |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Read.Group | 应用程序 | 我们需要访问公共频道中的消息，以检查邮件是否包含转到/链接。 | [c1abaf93-e823-4e9a-a810-34a47e77ef71](../azure/c1abaf93-e823-4e9a-a810-34a47e77ef71.md) |
