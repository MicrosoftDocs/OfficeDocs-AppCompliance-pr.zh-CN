---
title: DataFetch 的应用程序信息，由 DataFetch，Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/18/2022
...
description: DataFetch 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
<p>开发人员上次更新时间：2022 年 2 月 14 日</p>

* <a href="https://teams.microsoft.com/l/app/d6756140-a823-11ea-94d9-ddbe638eaf6b" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003961" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

DataFetch，Inc 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | DataFetch， Inc |
| 公司的网站 | [https://datafetch.io](https://datafetch.io) |
| 应用的使用条款 | [https://datafetch.io/terms](https://datafetch.io/terms) |
| 应用的核心功能 | 搜索连接的数据源 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | |
...
DataFetch、 Inc 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 否 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | id、name、tenantId、tenantName |
...
| 隐私策略 URL | https://datafetch.io/privacy-policy |
...
| 应用是否支持条件访问策略？ | 是 |
| 列出支持的策略类型 | 订阅数据源而不是拥有数据源的用户无法删除数据源。 |
| 应用是否支持持续访问评估 (CAE)  | 否 |
| 应用是否在代码中存储任何凭据？ | 否 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteForUser | 委托 | 管理用户安装的 Teams 应用 | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
>| TeamsAppInstallation.ReadWriteSelfForUser | 委托 | 允许Teams应用为用户自行管理 | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
>| User.Read | 委托 | 登录并读取用户个人资料 | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
>| 电子邮件 | 委托 | 查看用户的电子邮件地址 | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
>| offline_access | 委托 | 保留对已授予其访问权限的数据的访问权限 | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
>| openid | 委托 | 对用户标识进行签名 | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
>| 个人资料 | 委托 | 查看用户的基本个人资料 | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
