...
description: 所有 Available security and compliance information forRifriftsnett、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "62200586"
---
# <a name="bedriftsnett"></a>Bed

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 10 月 8 日</p>

* <a href="https://teams.microsoft.com/l/app/af9a1113-600a-4084-9e68-5f20fe25f4d8" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003490" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Unifon AS 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Unifon AS |
| 公司网站 | [https://www.unifon.no](https://www.unifon.no) |
| 应用的使用条款 | [https://www.unifon.no/avtalevilkar/](https://www.unifon.no/avtalevilkar/) |
| 应用的核心功能 | UnifonRifriftsnett 现在直接在 Microsoft Teams |
| 公司总部位置 | 挪威 |
| 应用信息页面 | |
...
此信息由 Unifon AS 提供有关此应用程序如何收集和存储组织数据以及您的组织将拥有对应用收集的数据的控制的信息。
...
| 隐私策略 URL | https://www.unifon.no/personvern/ |
