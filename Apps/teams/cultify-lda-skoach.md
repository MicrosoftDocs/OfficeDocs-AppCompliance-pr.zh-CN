---
title: 由Ifyify，Lda 为 Skoach 提供的应用程序信息
ms.author: elmalova
author: elenamalova
ms.date: 11/09/2021
ms.topic: article
...
description: Skoach 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "60953959"
---
# <a name="skoach"></a>Skoach

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 11 月 9 日</p>

* <a href="https://teams.microsoft.com/l/app/401ece51-d146-4cfb-b426-d7c8b70b056b" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003455" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

由Ifyify，Lda 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Ify、Lda |
| 公司网站 | [https://skoach.com](https://skoach.com) |
| 应用的使用条款 | [https://www.skoach.com/terms-of-service](https://www.skoach.com/terms-of-service) |
| 应用的核心功能 | Skoach 是一个工作虚拟指导，用于使团队保持一致、保持一致和高效，以便根据反复的测试结果，使用户采取新行为。 Skoach 不仅增加了团队的通信流，导致属于和保持一致，还有助于用户自行应对混合工作带来的挑战，提高保留 &amp; 工作效率。 |
| 公司总部位置 | 葡萄牙 |
| 应用信息页面 | |
...
此信息由Ifyify，Lda 提供有关此应用程序如何收集和存储组织数据以及你的组织将拥有对应用收集的数据的控制的信息。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础基础结构是否处理与 Microsoft 客户或他们的设备相关的任何数据？ | 否 |
| 应用或基础基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 客户名称和电子邮件（如果提供）。 |
...
| 隐私策略 URL | https://www.skoach.com/privacy-policy |
