...
description: Avaamo IT 助手的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "63538280"
---
# <a name="avaamo-it-assistant"></a>Avaamo IT 助手

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 8 月 25 日</p>

* <a href="https://teams.microsoft.com/l/app/ed016582-bd1f-4994-ba97-49daab163b19" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003362" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Avaamo 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Avaamo |
| 公司网站 | [https://avaamo.ai](https://avaamo.ai) |
| 应用的使用条款 | [https://avaamo.ai/tos/](https://avaamo.ai/tos/) |
| 应用的核心功能 | 可立即解析支持查询的智能Microsoft Office 365助理。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://www.avaamo.ai/who-is-avaamo/](https://www.avaamo.ai/who-is-avaamo/) |
...
Avaamo 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及您的组织将拥有对应用收集的数据的控制有关。
...
| 隐私策略 URL | https://www.avaamo.ai/privacy/ |
