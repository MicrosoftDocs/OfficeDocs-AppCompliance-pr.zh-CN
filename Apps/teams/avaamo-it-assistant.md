...
description: Avaamo IT 助手的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| 应用的核心功能 | 可立即解析支持查询Microsoft Office 365智能对话助理。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
