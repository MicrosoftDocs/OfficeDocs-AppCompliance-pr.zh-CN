...
description: 隔离的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/287fab70-2e10-4bc3-9049-8991d7796d81" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004410" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

由隔离到 Microsoft 提供的信息：
...
| 合作伙伴公司名称 | isolved |
| 公司的网站 | [https://www.isolvedhcm.com](https://www.isolvedhcm.com) |
| 应用的使用条款 | [https://www.isolvedhcm.com/legal/agreements/employee-terms-...](https://www.isolvedhcm.com/legal/agreements/employee-terms-and-conditions-for-use) |
| 应用的核心功能 | 使你的员工能够在 Microsoft Teams 内部快速获取人力资源问题的解答 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://www.isolvedhcm.com/platform/enhancements/conversati...](https://www.isolvedhcm.com/platform/enhancements/conversational-virtual-assistant) |
...
此信息已由隔离提供，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | Microsoft Azure 租户 ID、Microsoft Azure 用户 ID  |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | Microsoft Azure 租户 ID、Microsoft Azure 用户 ID  |
...
| 最新的 SOC1 认证日期 | 2021-08-31 |
| 应用是否符合服务组织控制 (SOC 2) ？ | 是 |
| 你实现了哪个 SOC 2 认证？ | type1 |
| 最新的 SOC2 认证日期 | 2022-01-31 |
