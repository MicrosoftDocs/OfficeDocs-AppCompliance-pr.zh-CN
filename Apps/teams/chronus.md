---
title: Chronus by Chronus 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: Chronus 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/bb32d4e5-ae29-4c59-ba7e-a11611ca9710" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | Chronus |
| 公司的网站 | [https://chronus.com](https://chronus.com) |
| 应用的使用条款 | [https://chronus.com/service-terms-conditions](https://chronus.com/service-terms-conditions) |
| 应用的核心功能 | Chronus 软件为世界上一些&#8217;最大的组织提供数千个成功的指导计划。 我们使启动、管理和衡量指导影响变得容易。  |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://chronus.com/services](https://chronus.com/services) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
Chronus 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
