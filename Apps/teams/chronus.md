...
| 合作伙伴公司名称 | Chronus |
| 公司网站 | [https://chronus.com](https://chronus.com) |
| 应用的使用条款 | [https://chronus.com/service-terms-conditions](https://chronus.com/service-terms-conditions) |
| 应用的核心功能 | Chronus 软件为世界上一些最大规模的组织&#8217;数千个成功计划。 我们使启动、管理和衡量管理影响变得简单。  |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://chronus.com/services](https://chronus.com/services) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
