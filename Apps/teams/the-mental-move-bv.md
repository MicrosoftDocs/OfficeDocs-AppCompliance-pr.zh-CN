...
description: 心理移动的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "65645638"
---
# <a name="the-mental-move"></a>The Mental Move

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 2 月 16 日</p>

* <a href="https://teams.microsoft.com/l/app/c5c971cc-3589-4338-a3be-1326db95cb24" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004016" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

精神移动 B.V 提供的信息。 到 Microsoft：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | The Mental Move |
| ID | WA200004016 |
| 支持Office 365客户端 | Microsoft Teams |
| 合作伙伴公司名称 | The Mental Move B.V. |
| 公司的网站 | [https://www.thementalmove.nl](https://www.thementalmove.nl) |
| 应用的使用条款 | [https://www.thementalmove.nl/gebruikersvoorwaarden/](https://www.thementalmove.nl/gebruikersvoorwaarden/) |
| 应用的核心功能 | Snel aan de slag met jouw mentale conditie binnen Teams！ |
| 公司总部位置 | 荷兰 ()  |
| 应用信息页 | [https://www.thementalmove.nl/ons-aanbod/online-preventiepla...](https://www.thementalmove.nl/ons-aanbod/online-preventieplatform/) |
...
此信息已由心理移动 B.V 提供。 关于此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
| 隐私策略 URL | https://www.thementalmove.nl/privacy-statement/ |
