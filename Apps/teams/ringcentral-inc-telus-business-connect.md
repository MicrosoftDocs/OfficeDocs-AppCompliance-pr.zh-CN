---
title: 由 RingCentral 公司提供的 TELUS Business Connect 应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: TELUS Business Connect 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/d5001eed-f63e-4a7d-9b49-bf8272c934cd" target="_blank">在 Teams 应用商店中查看</a>
...
| 公司的网站 | [https://www.telus.com](https://www.telus.com) |
| 应用的使用条款 | [https://www.telus.com/en/bc/business/support/article/busine...](https://www.telus.com/en/bc/business/support/article/business-connect-terms) |
| 应用的核心功能 | 使用快速机器人命令和消息传送功能启动和加入 Telus 视频或音频呼叫。 |
| 公司总部位置 | 美国美国 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | 获取用户配置文件数据 | [0dd4bfdf-dc86-4f05-9991-a14bc0144ebf](../azure/0dd4bfdf-dc86-4f05-9991-a14bc0144ebf.md) |
>| User.Read.All | 委托 | 获取用户配置文件数据 | [0dd4bfdf-dc86-4f05-9991-a14bc0144ebf](../azure/0dd4bfdf-dc86-4f05-9991-a14bc0144ebf.md) |
