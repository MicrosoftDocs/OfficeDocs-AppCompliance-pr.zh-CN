---
title: 由 RingCentral 公司连接的 TELUS Business 应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: TELUS Business 连接的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/d5001eed-f63e-4a7d-9b49-bf8272c934cd" target="_blank">Teams存储区中的视图</a>
...
| 应用的使用条款 | [https://telus.com/BusinessConnect/ServiceTerms](https://telus.com/BusinessConnect/ServiceTerms) |
| 应用的核心功能 | 在对话中启动视频会议和通话。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://appsource.microsoft.com/en-us/product/office/WA2000...](https://appsource.microsoft.com/en-us/product/office/WA200002300) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 委托 |  允许应用程序通过其日历发送会议邀请事件 | [e601bd6e-0476-4d66-bd57-a9d13c207f0b](../azure/e601bd6e-0476-4d66-bd57-a9d13c207f0b.md) |
>| User.Read | 委托 |  允许应用读取用户&#8217;的基本配置文件 (电子邮件、名称) ，以便在末尾执行联系人匹配。 并允许用户登录并将其 O365 帐户与 RingCentral 帐户链接 | [e601bd6e-0476-4d66-bd57-a9d13c207f0b](../azure/e601bd6e-0476-4d66-bd57-a9d13c207f0b.md) |
>| User.Read.All | 委托 | 允许应用程序使用电话号码读取用户的完整配置文件，以便通过我们的服务进行电话呼叫。 | [e601bd6e-0476-4d66-bd57-a9d13c207f0b](../azure/e601bd6e-0476-4d66-bd57-a9d13c207f0b.md) |
>| offline_access | 委托 |  允许应用程序获取和更新 oauth 令牌 | [e601bd6e-0476-4d66-bd57-a9d13c207f0b](../azure/e601bd6e-0476-4d66-bd57-a9d13c207f0b.md) |
