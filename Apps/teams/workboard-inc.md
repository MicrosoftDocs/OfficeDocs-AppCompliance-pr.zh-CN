---
title: Workboard Inc. 的 Workboard 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/21/2021
...
Workboard Inc. 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Workboard Inc. |
| 公司网站 | [https://www.workboard.com](https://www.workboard.com) |
| 应用的使用条款 | [https://www.workboard.com/license/terms_of_use_v1.php](https://www.workboard.com/license/terms_of_use_v1.php) |
| 应用的核心功能 | 通过组织调整战略优先级，本地化确定 (确定结果) 跨职能团队和个人。 绘制、计算和共享关键结果和成功指标的进度。  |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://www.workboard.com/microsoft/](https://www.workboard.com/microsoft/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
此信息由 Workboard Inc. 提供，有关此应用程序如何收集和存储组织数据以及您的组织将拥有对应用收集的数据的控制。
...
| 应用是否遵守 SOC 1 (服务组织) ？ | 是 |
| 最新 SOC1 认证日期 |  2020-07-31 |
| 应用是否遵守 SOC 2 (服务组织) ？ | 是 |
| 你获得哪种 SOC 2 认证？ |   |
| 最新 SOC2 认证日期 |  2020-10-30 |
| 应用是否遵守 SOC 3 (服务组织) ？ | 否 |
| 最新 SOC3 认证日期 | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegated | 电子邮件地址和用户的 ID。  它用于将用户映射到 WorkBoard 的用户 ID | [User.Read](../azure/User.Read.md) |
