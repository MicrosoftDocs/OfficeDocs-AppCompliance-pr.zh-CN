...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegated | 电子邮件地址和用户的 ID。  它用于将用户映射到 WorkBoard 的用户 ID | [User.Read](https://docs.microsoft.com/microsoft-365-app-certification/azure/User.Read) |
