...
| 公司的网站 | [https://www.workboard.com](https://www.workboard.com) |
| 应用的使用条款 | [https://www.workboard.com/license/terms_of_use_v1.php](https://www.workboard.com/license/terms_of_use_v1.php) |
| 应用的核心功能 | 通过组织协调战略重点，将目标和关键结果本地化 (OKR) 到跨职能团队和个人。 对关键结果和成功指标进行图表、计算和共享进度。  |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://www.workboard.com/microsoft/](https://www.workboard.com/microsoft/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
Workboard Inc. 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
| 最新的 SOC1 认证日期 | 2020-07-31 |
| 应用是否符合服务组织控制 (SOC 2) ？ | 是 |
| 最新的 SOC2 认证日期 | 2020-10-30 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | 电子邮件地址和用户 ID。  它用于将用户映射到 WorkBoard 的用户 ID | [](../azure/.md) |
