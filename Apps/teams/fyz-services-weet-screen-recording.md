---
title: 按 FYZ SERVICES 进行的 Weet 屏幕录制的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/24/2021
...
description: Weet 屏幕录制的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/f0c0f156-329e-4083-a1a7-89649407a31b" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | FYZ 服务 |
| 公司的网站 | [https://weet.co](https://weet.co) |
| 应用的使用条款 | [https://weet.co/terms-of-service/](https://weet.co/terms-of-service/) |
| 应用的核心功能 | Weet，第一个协作屏幕 &amp; 视频录制器简单、免费和无限制的屏幕录制 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://weet.co/weet-teams-integration/](https://weet.co/weet-teams-integration/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | GCP、AWS |
...
FYZ SERVICES 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteSelfForUser.All | 委托 | 允许检测是否已安装 Weet 应用 | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| User.Read | 委托 | 我们不收集任何数据，但我们仅使用电子邮件来帮助用户使用自动完成功能 | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| User.ReadBasic.All | 委托 | 我们不收集任何数据，但我们仅使用电子邮件来帮助用户使用自动完成功能 | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| offline_access | 委托 | 我们不收集任何数据，但我们仅使用电子邮件来帮助用户使用自动完成功能 | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| openid | 委托 | 我们不收集任何数据，但我们仅使用电子邮件来帮助用户使用自动完成功能 | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| 个人资料 | 委托 | 我们不收集任何数据，但我们仅使用电子邮件来帮助用户使用自动完成功能 | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
