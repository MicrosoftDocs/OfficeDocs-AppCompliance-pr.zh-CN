---
title: LumApps 的 LumApps 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/03/2021
...
description: LumApps 的所有可用安全性和符合性信息、其数据处理策略、Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/ba2c569f-de70-4442-9609-d9818e7152ca" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | LumApps |
| 公司的网站 | [https://www.lumapps.com](https://www.lumapps.com) |
...
| 应用的核心功能 | 通过多种方式集成将 LumApps 链接到Microsoft Teams |
| 公司总部位置 | 法国 |
| 应用信息页 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
LumApps 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read.All | 委托 | 配置文件信息 | [170d42a4-4ec0-4f51-bef0-693c589fccfc](../azure/170d42a4-4ec0-4f51-bef0-693c589fccfc.md) |
>| openid | 委托 | 授权登录名 | [170d42a4-4ec0-4f51-bef0-693c589fccfc](../azure/170d42a4-4ec0-4f51-bef0-693c589fccfc.md) |
>| 个人资料 | 委托 | 有关登录的信息 | [170d42a4-4ec0-4f51-bef0-693c589fccfc](../azure/170d42a4-4ec0-4f51-bef0-693c589fccfc.md) |
