---
title: Cisco 为 Jabber 提供的应用程序信息
ms.author: elmalova
author: elenamalova
ms.date: 02/23/2022
ms.topic: article
...
description: Jabber 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/ed754df9-2e28-48ef-9f0f-e0909ce4f320" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001496" target="_blank">在 AppSource 中查看</a>
...
| 应用的核心功能 | 使用 Jabber 应用直接从 MS Teams进行 Cisco 语音和视频呼叫。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
