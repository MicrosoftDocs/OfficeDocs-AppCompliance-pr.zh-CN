---
title: UserVoice by UserVoice 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: UserVoice 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/1a2efc96-5f06-4b76-ad90-00ce6c1ac74d" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001944" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

UserVoice 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | UserVoice |
| 公司的网站 | [https://www.uservoice.com](https://www.uservoice.com) |
| 应用的使用条款 | [https://www.uservoice.com/tos](https://www.uservoice.com/tos) |
| 应用的核心功能 | 在Microsoft Teams中获取有关产品反馈计划的实时更新。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://help.uservoice.com/hc/en-us/articles/360052330913-M...](https://help.uservoice.com/hc/en-us/articles/360052330913-Microsoft-Teams-Integration) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | GCP |
...
UserVoice 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
| 应用是否符合 Health Information Trust Alliance、Common Security Framework (HITRUST CSF) ？ | 可访问 |
| 应用是否符合服务组织控制 (SOC 1) ？ | 是 |
| 最新的 SOC1 认证日期 | 2020-12-31 |
