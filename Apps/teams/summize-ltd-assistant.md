...
description: 用于 Summize Assistant 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
---
# <a name="summize-assistant"></a>求和助手

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 11 月 17 日</p>

* <a href="https://teams.microsoft.com/l/app/24d7e745-c1ed-4f60-a843-ba1629ef3ed4" target="_blank">在应用商店Teams视图</a>
...
由 Summize (Ltd) 向 Microsoft 提供的信息：
...
| 合作伙伴公司名称 | Summize (Ltd)  |
| 公司网站 | [https://www.summize.com](https://www.summize.com) |
| 应用的使用条款 | [https://www.summize.com/terms-and-conditions](https://www.summize.com/terms-and-conditions) |
| 应用的核心功能 | 求和使合同审阅和创建变得简单。 "求和"正在改变企业了解合同并与之交互的方式。 使用智能的对话软件，我们可以优化合同流程并解锁合同见解。  将助手应用程序汇总在Teams帮助用户将合同上载到 PDF (docx 格式) 进行审阅。  用户还可使用在"求和"应用中创建的模板创建合同。   |
| 公司总部位置 | 英国大英和爱尔兰 ()  |
| 应用信息页面 | |
...
此信息由 Summize (Ltd) 提供有关此应用程序如何收集和存储组织数据以及您的组织将拥有对应用收集的数据的控制的信息。
...
| 你是否在支持应用的网络 (外围部署了入侵检测和) IDPS 和 IDPS 软件？ | 否 |
...
| 应用是否遵守 SOX Sarbanes-Oxley的 (管理) ？ | 否 |
...
| 隐私策略 URL | https://app.summize.com/assets/documents/SummizePrivacyPolicy.pdf |
