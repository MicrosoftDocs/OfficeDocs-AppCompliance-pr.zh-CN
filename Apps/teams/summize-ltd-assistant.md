...
| 应用的核心功能 | 求和使合同审阅和创建变得简单。 "求和"正在改变企业了解合同并与之交互的方式。 使用智能的对话软件，我们可以优化合同流程并解锁合同见解。  将助手应用汇总在Teams帮助用户将合同上传为 PDF (docx 格式) 进行审阅。  用户还可使用在"求和"应用中创建的模板创建合同。   |
| 公司总部位置 | 英国大英和爱尔兰 ()  |
| 应用信息页面 | |
