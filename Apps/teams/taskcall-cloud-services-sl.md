---
title: TaskCall 云服务、S.L 的 TaskCall 应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: TaskCall 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/eea91208-6850-4a61-8508-64b6c45d23a1" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003914" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

TaskCall 云服务、S.L 提供的信息。 到 Microsoft：
...
| 合作伙伴公司名称 | TaskCall Cloud Services, S.L. |
| 公司的网站 | [https://taskcallapp.com](https://taskcallapp.com) |
| 应用的使用条款 | [https://www.taskcallapp.com/terms-of-service](https://www.taskcallapp.com/terms-of-service) |
| 应用的核心功能 | TaskCall 的Microsoft Teams双向集成允许从Microsoft Teams内部处理事件，从而简化了通信和IT-Ops协作。 |
| 公司总部位置 | 西班牙 |
| 应用信息页 | [https://docs.taskcallapp.com/integrations/v1/microsoft-team...](https://docs.taskcallapp.com/integrations/v1/microsoft-teams-integration-guide) |
...
此信息由 TaskCall 云服务、S.L 提供。 关于此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
