---
title: TaskCall 应用程序信息 TaskCall 云服务 S.L。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: TaskCall 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/eea91208-6850-4a61-8508-64b6c45d23a1" target="_blank">在应用商店Teams视图</a>
...
由 TaskCall 云服务 S.L 提供的信息。 到 Microsoft：
...
| 合作伙伴公司名称 | TaskCall 云服务，S.L。 |
| 公司网站 | [https://taskcallapp.com](https://taskcallapp.com) |
| 应用的使用条款 | [https://www.taskcallapp.com/terms-of-service](https://www.taskcallapp.com/terms-of-service) |
| 应用的核心功能 | TaskCall 的Microsoft Teams集成通过允许从内部处理事件IT-Ops通信Microsoft Teams。 |
| 公司总部位置 | 西班牙 |
| 应用信息页面 | [https://docs.taskcallapp.com/integrations/v1/microsoft-team...](https://docs.taskcallapp.com/integrations/v1/microsoft-teams-integration-guide) |
...
此信息由 TaskCall 云服务 S.L 提供。 关于此应用如何收集和存储组织数据，以及你的组织将拥有对应用收集的数据的控制。
