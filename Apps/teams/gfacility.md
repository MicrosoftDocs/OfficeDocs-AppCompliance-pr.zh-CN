...
description: Gfac且所有可用的安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "61076173"
---
# <a name="gfacility"></a>Gfac一

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 9 月 29 日</p>

* <a href="https://teams.microsoft.com/l/app/0f553268-ba1c-4bb0-953c-def3e00aac7d" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003474" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Gfac一起提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Gfac一 |
| 公司网站 | [https://gfacility.com](https://gfacility.com) |
| 应用的使用条款 | [https://gfacility.com/terms-of-use](https://gfacility.com/terms-of-use) |
| 应用的核心功能 | 使用 Gfac一起跟踪会议Microsoft Teams |
| 公司总部位置 | 比利时 |
| 应用信息页面 | |
...
此信息由 Gfac一提供，用于了解此应用如何收集和存储组织数据，以及组织将拥有对应用收集的数据的控制。
...
| 隐私策略 URL | https://gfacility.com/privacy-policy |
