...
| 公司网站 | [https://gensys.nl](https://gensys.nl) |
| 应用的使用条款 | [https://gensys.nl/terms-of-use/](https://gensys.nl/terms-of-use/) |
| 应用的核心功能 | Gensys 应用，用于将 Gensys Anywhere 与 Microsoft Teams |
| 公司总部位置 | 荷兰 ()  |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
