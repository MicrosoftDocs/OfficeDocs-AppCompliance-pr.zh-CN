---
title: Gensys 解决方案 BV 的 Gensys 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Gensys 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/bc1e8e2d-bb5c-47d7-a9e6-f0be9eb83c5a" target="_blank">Teams存储区中的视图</a>
...
| 公司的网站 | [https://gensys.nl](https://gensys.nl) |
| 应用的使用条款 | [https://gensys.nl/terms-of-use/](https://gensys.nl/terms-of-use/) |
| 应用的核心功能 | Gensys 应用，用于将 Gensys Anywhere 与 Microsoft Teams 集成 |
| 公司总部位置 | 荷兰 ()  |
| 应用信息页 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
Gensys Solutions BV 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
