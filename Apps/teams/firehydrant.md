...
description: FireHydrant 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "64878669"
---
# <a name="firehydrant"></a>FireHydrant

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 2 月 10 日</p>

* <a href="https://teams.microsoft.com/l/app/c18f3920-4098-4907-bc92-43c8559b5e18" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003794" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

FireHydrant 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | FireHydrant |
| 公司的网站 | [https://firehydrant.io](https://firehydrant.io) |
| 应用的使用条款 | [https://app.firehydrant.io/legal/ssa](https://app.firehydrant.io/legal/ssa) |
| 应用的核心功能 | 使用 FireHydrant.io 管理事件。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | |
...
FireHydrant 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 用户标识 (名称、电子邮件) 、来自团队频道的事件数据 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 可访问 |
| 数据库中存储了哪些数据？ | 团队 ID、租户 ID、消息、用户名 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.Create | 委托 | FireHydrant 代表我们的用户创建频道来管理事件 | [00485db5-81b3-4299-833a-8d6c366d0ac0](../azure/00485db5-81b3-4299-833a-8d6c366d0ac0.md) |
