---
title: RFPIO 机器人的应用程序信息（按 RFPIO）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/03/2021
...
description: RFPIO 机器人的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/77c23de0-bcf9-4f27-91c9-135a82ee2543" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | RFPIO |
| 公司的网站 | [https://www.rfpio.com](https://www.rfpio.com) |
| 应用的使用条款 | [https://www.rfpio.com/terms-of-service/](https://www.rfpio.com/terms-of-service/) |
| 应用的核心功能 | RFPIO 是领先的 RFP 响应管理解决方案，也是业界首款启用 AI 的 RFP 软件，受一些全球最聪明的公司信任，可管理对 RFP、RPI、安全问卷和 DDQ 的响应。  |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://www.rfpio.com/product/](https://www.rfpio.com/product/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
RFPIO 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
