---
title: Wired2Perform by Wired2Perform 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/03/2021
...
description: Wired2Perform 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/b08f369e-4927-4c66-b997-e1086df7970d" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002935" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Wired2Perform 提供给 Microsoft 的信息：
...
| 公司的网站 | [https://wired2perform.com](https://wired2perform.com) |
| 应用的使用条款 | [https://wired2perform.com/terms-conditions](https://wired2perform.com/terms-conditions) |
| 应用的核心功能 | Wired2Perform&#174;是一家专门驱动的公司，它结合了行为科学和高级分析，将人员与最佳机会同步，并帮助人才领导者成长、优化和访问更适应的员工队伍。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://wired2perform.com](https://wired2perform.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
Wired2Perform 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
