...
* <a href="https://teams.microsoft.com/l/app/b08f369e-4927-4c66-b997-e1086df7970d" target="_blank">在应用商店Teams视图</a>
...
| 公司网站 | [https://wired2perform.com](https://wired2perform.com) |
| 应用的使用条款 | [https://wired2perform.com/terms-conditions](https://wired2perform.com/terms-conditions) |
| 应用的核心功能 | Wired2Perform&#174;是一家由目的驱动的公司，它将行为科学与高级分析相结合，以将人员与最佳可用机会同步，并帮助人才领导扩大、优化和访问更具适应能力的员工。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://wired2perform.com](https://wired2perform.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
Wired2Perform 提供了此信息，这些信息有关此应用如何收集和存储组织数据，以及组织将拥有对应用收集的数据的控制。
