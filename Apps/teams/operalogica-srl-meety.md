---
title: 适用于 Meety by operaLogica srl 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/20/2022
...
description: 适用于 Meety 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/9a68d494-f5ae-4e0c-ad18-478bf6fcd101" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004258" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

operaLogica srl 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | operaLogica srl |
| 公司的网站 | [https://meety.business](https://meety.business) |
| 应用的使用条款 | [https://meety.business/termsofuse](https://meety.business/termsofuse) |
| 应用的核心功能 | 收集和组织会议，并增强会议目标、任务和会议历史记录的会议体验 |
| 公司总部位置 | Italy（意大利） |
| 应用信息页 | |
...
operaLogica srl 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 电子邮件，名称，姓氏，插入会议 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 电子邮件，名称，姓氏，插入会议 |
...
| 隐私策略 URL | https://meety.business/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 委托 | 将会议添加到线程的可能性 | [9a68d494-f5ae-4e0c-ad18-478bf6fcd101](../azure/9a68d494-f5ae-4e0c-ad18-478bf6fcd101.md) |
>| Chat.Read | 委托 | 阅读有关会议的信息 | [9a68d494-f5ae-4e0c-ad18-478bf6fcd101](../azure/9a68d494-f5ae-4e0c-ad18-478bf6fcd101.md) |
>| Chat.ReadBasic | 委托 | 阅读有关会议的信息 | [9a68d494-f5ae-4e0c-ad18-478bf6fcd101](../azure/9a68d494-f5ae-4e0c-ad18-478bf6fcd101.md) |
>| OnlineMeetingArtifact.Read.All | 委托 | 阅读有关会议项目的信息，以增加用户的体验 | [9a68d494-f5ae-4e0c-ad18-478bf6fcd101](../azure/9a68d494-f5ae-4e0c-ad18-478bf6fcd101.md) |
>| OnlineMeetings.Read | 委托 | 读取会议 ID 以添加更多数据 | [9a68d494-f5ae-4e0c-ad18-478bf6fcd101](../azure/9a68d494-f5ae-4e0c-ad18-478bf6fcd101.md) |
>| User.Read | 委托 | 获取有关使用应用的用户的信息 | [9a68d494-f5ae-4e0c-ad18-478bf6fcd101](../azure/9a68d494-f5ae-4e0c-ad18-478bf6fcd101.md) |
