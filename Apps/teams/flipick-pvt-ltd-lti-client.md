...
| 公司网站 | [https://flipick.com](https://flipick.com) |
| 应用的使用条款 | [https://flipick.com/terms-of-use/](https://flipick.com/terms-of-use/) |
| 应用的核心功能 | 该应用通过 L (Learning TI (工具互操作性) 服务器为 SSO) 单一登录) 启动 (课程) 。 它是 LTI 工具使用者，支持基本 LTI (BLTI) 。 |
| 公司总部位置 | 印度 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
