...
| 应用的核心功能 | 通过聊天中的投票收集来自团队成员的反馈。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://brightbits.app/bright-poll/](https://brightbits.app/bright-poll/) |
...
BrightBits 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及组织将拥有对应用收集的数据的控制有关。
