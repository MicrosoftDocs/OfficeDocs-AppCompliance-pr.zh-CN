...
| 应用的核心功能 | 排列器是任何会议智能集成计划程序。 无论是个人还是远程、1：1 或群组，排列器都简单快速。 排列器与 Microsoft 日历集成，以轻松快速地阻止忙碌时间，帮助可视化日程安排，并确保会议放入日历中。 此外，Teams集成使你可以轻松地与团队成员共享邀请、在 Teams 内启动新会议，以及从"会议"选项卡中跟踪Teams会议。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
