...
| 公司网站 | [https://arrangr.com](https://arrangr.com) |
| 应用的使用条款 | [https://arrangr.com/terms_of_use](https://arrangr.com/terms_of_use) |
| 应用的核心功能 | 排列器是任何会议智能集成计划程序。 无论是个人还是远程、1：1 或群组，排列器都简单快速。 排列器与 Microsoft 日历集成，以轻松快速地阻止忙碌时间，帮助可视化日程安排，并确保会议放入日历中。 此外，Teams集成使你可以轻松地与团队成员共享邀请、在 Teams 内启动新会议，以及从"排列器"选项卡中跟踪Teams会议。 |
| 公司总部位置 | 美国美国 |
| 应用信息页面 | [https://arrangr.com/welcome](https://arrangr.com/welcome) |
...
| 你的应用将处理哪些数据？ | 用户名、电子邮件地址、日历名称、日历事件的详细信息、团队成员的姓名和电子邮件。 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 用户名和电子邮件、日历名称、日历会议链接、团队名称。 |
...
| 隐私策略 URL | https://arrangr.com/privacy_policy |
