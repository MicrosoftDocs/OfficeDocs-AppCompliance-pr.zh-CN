---
title: WorkplaceBuddy by WorkplaceBuddy 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: WorkplaceBuddy 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/6fef6052-d84d-4071-b679-8b542512a621" target="_blank">Teams存储区中的视图</a>
...
| 公司的网站 | [https://www.workplacebuddy.com](https://www.workplacebuddy.com) |
| 应用的使用条款 | [https://www.workplacebuddy.com/terms-of-use.pdf](https://www.workplacebuddy.com/terms-of-use.pdf) |
| 应用的核心功能 | WorkplaceBuddy 可帮助你提高工作效率 |
| 公司总部位置 | 荷兰 ()  |
| 应用信息页 | [https://www.workplacebuddy.com](https://www.workplacebuddy.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
WorkplaceBuddy 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 委托 | 我们同步此数据，使 WorkplaceBuddy 选项卡在Teams工作，并使用聊天机器人面向特定用户 | [39073da9-c47c-4da8-b57a-3786461db8f4](../azure/39073da9-c47c-4da8-b57a-3786461db8f4.md) |
>| Group.Read.All | 委托 | 我们同步此数据，使 WorkplaceBuddy 选项卡在Teams工作，并使用聊天机器人面向特定用户 | [39073da9-c47c-4da8-b57a-3786461db8f4](../azure/39073da9-c47c-4da8-b57a-3786461db8f4.md) |
>| User.Read | 委托 | 我们同步此数据以允许用户登录 | [39073da9-c47c-4da8-b57a-3786461db8f4](../azure/39073da9-c47c-4da8-b57a-3786461db8f4.md) |
>| User.ReadBasic.All | 委托 | 我们同步此数据以允许用户登录 | [39073da9-c47c-4da8-b57a-3786461db8f4](../azure/39073da9-c47c-4da8-b57a-3786461db8f4.md) |
