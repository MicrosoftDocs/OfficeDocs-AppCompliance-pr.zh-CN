---
title: 由丹麦研究员提供的 IntraActive 播放应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/02/2022
...
description: IntraActive 播放的所有可用安全性和符合性信息、其数据处理策略、Microsoft Cloud App Security 应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "65938676"
---
# <a name="play-by-intraactive"></a>由 IntraActive 播放

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 5 月 10 日</p>

* <a href="https://teams.microsoft.com/l/app/a2bb73b4-d27a-4fe0-8656-94ec4c27ba95" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004169" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

丹麦研究员向 Microsoft 提供的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | 由 IntraActive 播放 |
| ID | WA200004169 |
| 支持 Office 365 客户端 | Microsoft Teams |
| 合作伙伴公司名称 | 研究员丹麦 |
| 公司的网站 | [https://intraactive.net](https://intraactive.net) |
| 应用的使用条款 | [https://intraactive.net/terms-of-use-play](https://intraactive.net/terms-of-use-play) |
| 应用的核心功能 | 管理数字标牌 |
| 公司总部位置 | 丹麦 |
| 应用信息页 | |
...
本信息由丹麦研究员提供，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
| 隐私策略 URL | https://intraactive.net/privacy-policy-play |
...
| 应用是否支持条件访问策略？ | 是 |
| 列出支持的策略类型 | 所有策略都受支持，因为我们的身份验证方案原生于 Microsoft Teams |
| 应用是否支持持续访问评估 (CAE)  | 是 |
| 应用是否在代码中存储任何凭据？ | 否 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | 标识使用应用程序的用户 | [9e997761-d28c-4542-8897-94e7b5dc2484](../azure/9e997761-d28c-4542-8897-94e7b5dc2484.md) |
>| User.ReadBasic.All | 委托 | 在组织中查找用户，以便用户可以将其他用户添加为其资源的所有者 | [9e997761-d28c-4542-8897-94e7b5dc2484](../azure/9e997761-d28c-4542-8897-94e7b5dc2484.md) |
>| 电子邮件 | 委托 | 单一登录是必需的 | [9e997761-d28c-4542-8897-94e7b5dc2484](../azure/9e997761-d28c-4542-8897-94e7b5dc2484.md) |
>| offline_access | 委托 | 单一登录是必需的 | [9e997761-d28c-4542-8897-94e7b5dc2484](../azure/9e997761-d28c-4542-8897-94e7b5dc2484.md) |
>| openid | 委托 | 单一登录是必需的 | [9e997761-d28c-4542-8897-94e7b5dc2484](../azure/9e997761-d28c-4542-8897-94e7b5dc2484.md) |
>| profile | 委托 | 单一登录是必需的 | [9e997761-d28c-4542-8897-94e7b5dc2484](../azure/9e997761-d28c-4542-8897-94e7b5dc2484.md) |
