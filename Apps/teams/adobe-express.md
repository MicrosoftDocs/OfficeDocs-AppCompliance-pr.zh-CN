---
title: Adobe Express by Adobe 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/07/2022
...
description: Adobe Express 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/85d6a7d0-94aa-11ea-a1d7-2f19374441f9" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003946" target="_blank">在 AppSource 中查看</a>
...
| 合作伙伴公司名称 | Adobe |
| 公司的网站 | [https://www.adobe.com/express/](https://www.adobe.com/express/) |
| 应用的使用条款 | [https://www.adobe.com/legal/terms.html](https://www.adobe.com/legal/terms.html) |
| 应用的核心功能 | Adobe Spark 允许你在数分钟内创建令人惊叹的视觉故事、有影响力的社交图形、网页和短视频。 现在在 Microsoft Teams 中轻松共享它们 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://www.adobe.com/express](https://www.adobe.com/express) |
...
| 隐私策略 URL | https://www.adobe.com/privacy/policy.html |
