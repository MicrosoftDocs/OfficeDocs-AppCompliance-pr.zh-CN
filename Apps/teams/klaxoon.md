...
description: 所有可用的适用于用户的安全与合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| 合作伙伴公司名称 | Klaxoon |
| 公司网站 | [https://klaxoon.com](https://klaxoon.com) |
| 应用的使用条款 | [https://static.klaxoon.com/website/pdf/eula.pdf](https://static.klaxoon.com/website/pdf/eula.pdf) |
| 应用的核心功能 | 使用采用旨在提高团队合作效率的一整套协作工具， (白板、调查、测验、实时轮询等) 功能。 作为 Web 应用、移动应用或 Apple/Android) ，可通过 Web (应用、移动应用或直接从 Microsoft Teams (通过 Tab 集成)  |
| 公司总部位置 | 法国 |
| 应用信息页面 | [https://klaxoon.com](https://klaxoon.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
