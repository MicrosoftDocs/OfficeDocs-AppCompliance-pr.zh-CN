---
title: Klaxoon by Klaxoon 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/21/2022
...
description: Klaxoon 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66548101"
---
# <a name="klaxoon"></a>Klaxoon

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 6 月 21 日</p>

* <a href="https://teams.microsoft.com/l/app/6adc8d55-eb37-4537-a66d-743b3cd4511b" target="_blank">在 Teams 应用商店中查看</a>
...
| 合作伙伴公司名称 | Klaxoon |
| 公司的网站 | [https://klaxoon.com](https://klaxoon.com) |
| 应用的使用条款 | [https://static.klaxoon.com/website/pdf/eula.pdf](https://static.klaxoon.com/website/pdf/eula.pdf) |
| 应用的核心功能 | Klaxoon 提供对一套完整的协作工具的访问权限， (白板、调查、测验、实时轮询等，) 旨在提高团队合作效率。 Klaxoon 套件可作为 Web 应用、移动应用 (Apple/Android) 访问，也可以通过 Tab 集成直接从 Microsoft Teams (访问)  |
| 公司总部位置 | 法国 |
| 应用信息页 | [https://klaxoon.com](https://klaxoon.com) |
| 用于运行应用的托管环境或服务模型是什么？ | 混合 |
| 应用使用哪些托管云提供商？ | Azure、Aws、Other |
...
Klaxoon 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | email， firstname， lastname， avatar |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | email， firstname， lastname， avatar |
| 如果基础结构处理或存储 Microsoft 客户数据，则此数据在地理上存储在哪里？ | 美国、法国、德国美国 |
| 是否已建立数据出租和处置流程？ | 是 |
...
| 隐私策略 URL | https://static.klaxoon.com/website/pdf/privacy-policy.pdf |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | 用户标识和帐户创建 | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
>| 电子邮件 | 委托 | 用户标识和帐户创建 | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
>| offline_access | 委托 | 用户标识和帐户创建 | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
>| openid | 委托 | 用户标识和帐户创建 | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
>| 个人资料 | 委托 | 用户标识和帐户创建 | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
