...
>|:---------------------------------------|:-----------------------------------|:------------------------------------|
>| 我们使用名单来个性化用户响应。 例如：Hello {{givenName}}，感谢您的问题！ | 名字、姓氏、头像、电子邮件和密码 (委派的 SSO 还是未) 。 | 用户帐户管理 |
...
>数据在帐户激活期间保留。 数据删除和/或检索采用平面格式 (pdf、xlsx、csv、图像) 或采用 (.) 格式的图像随时可以通过应用程序本身使用。 它是手动的，由所有者（访问它的凭据的唯一持有者）负责。 停用帐户后，将关闭用户访问。
