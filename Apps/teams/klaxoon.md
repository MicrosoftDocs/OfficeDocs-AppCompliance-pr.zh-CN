...
* <a href="https://teams.microsoft.com/l/app/6adc8d55-eb37-4537-a66d-743b3cd4511b" target="_blank">Teams存储区中的视图</a>
...
| 应用的核心功能 | Klaxoon 提供对一套完整的协作工具的访问权限， (白板、调查、测验、实时轮询等，) 旨在提高团队合作效率。 Klaxoon 套件可作为 Web 应用、移动应用 (Apple/Android) 访问，也可以通过 Tab 集成直接从Microsoft Teams (访问)  |
| 公司总部位置 | 法国 |
| 应用信息页 | [https://klaxoon.com](https://klaxoon.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS、Azure、claranet |
