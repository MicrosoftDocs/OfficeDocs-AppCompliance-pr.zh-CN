---
title: Perflo by Perflo 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/20/2022
...
description: Perflo 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/374c7844-f88a-43f3-b6d5-5cf58b5b293e" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004251" target="_blank">在 AppSource 中查看</a>
...
| 合作伙伴公司名称 | Perflo |
| 公司的网站 | [https://www.perflo.co](https://www.perflo.co) |
| 应用的使用条款 | [https://www.perflo.co/terms](https://www.perflo.co/terms) |
| 应用的核心功能 | 最终的团队诊断解决方案，使团队能够持续改进。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://www.perflo.co](https://www.perflo.co) |
...
Perflo 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | MS Teams ID，配置文件图片 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | MS Teams ID，配置文件图片 |
