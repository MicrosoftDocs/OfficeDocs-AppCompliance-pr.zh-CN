...
description: Perflo 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/abce776c-943c-4f4b-9f8b-53aa73af701e" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003721" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Perflo 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Perflo |
| 公司网站 | [https://www.perflo.co](https://www.perflo.co) |
| 应用的使用条款 | [https://www.perflo.co/terms](https://www.perflo.co/terms) |
| 应用的核心功能 | 向团队发送微型调查并生成经理报告。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://www.perflo.co](https://www.perflo.co) |
...
Perflo 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及您的组织将拥有对应用收集的数据的控制有关。
...
| 数据库中存储了哪些数据？ | 频道、Teams、用户配置文件名称、个人资料图片、MS Teams ID |
...
| 隐私策略 URL | https://www.perflo.co/privacy |
