---
title: 通过创建 IT 葡萄牙创建 Diggspace 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Diggspace 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66655909"
---
# <a name="diggspace"></a>Diggspace

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 6 月 17 日</p>

* <a href="https://teams.microsoft.com/l/app/661a0fd1-38d6-4a93-8450-1dd493d9974d" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004347" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

创建 IT 葡萄牙版提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | 创建 IT 葡萄牙 |
| 公司的网站 | [https://www.create.pt](https://www.create.pt) |
| 应用的使用条款 | [https://www.diggspace.com/en/terms-of-use](https://www.diggspace.com/en/terms-of-use) |
| 应用的核心功能 | Diggspace 是一个随时可用且可自定义的平台，可用于生成 Intranet |
| 公司总部位置 | 葡萄牙 |
| 应用信息页 | [https://www.diggspace.com](https://www.diggspace.com) |
...
Create IT Portugal 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
| 是否已将入侵检测和预防 (IDPS) 软件部署在支持应用的网络边界外围？ | 不支持 |
...
| 应用是否执行自动决策，包括可能具有法律效果或类似影响的分析？ | 是 |
| 个人是否有一个选项来反对处理？ | 是 |
...
| 如果你的应用不使用上述库之一，它使用什么身份验证库或库？ | ADAL |
| 应用是否支持条件访问策略？ | 是 |
| 列出支持的策略类型 | MFA |
| 应用是否支持持续访问评估 (CAE)  | 是 |
| 应用是否在代码中存储任何凭据？ | 否 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.AccessAsUser.All | 委托 | 身份验证 | [a6604cc9-a6f7-4009-96ba-9f837e528977](../azure/a6604cc9-a6f7-4009-96ba-9f837e528977.md) |
>| Mail.ReadBasic | 委托 | 显示 Outlook 电子邮件计数 | [a6604cc9-a6f7-4009-96ba-9f837e528977](../azure/a6604cc9-a6f7-4009-96ba-9f837e528977.md) |
>| Tasks.Read | 委托 | 显示用户任务 | [a6604cc9-a6f7-4009-96ba-9f837e528977](../azure/a6604cc9-a6f7-4009-96ba-9f837e528977.md) |
>| User.Read | 委托 | 身份验证和配置文件信息 | [a6604cc9-a6f7-4009-96ba-9f837e528977](../azure/a6604cc9-a6f7-4009-96ba-9f837e528977.md) |
>| User.Read.All | 应用程序 | 同步配置文件数据 | [a6604cc9-a6f7-4009-96ba-9f837e528977](../azure/a6604cc9-a6f7-4009-96ba-9f837e528977.md) |
>| 电子邮件 | 委托 | 身份验证 | [a6604cc9-a6f7-4009-96ba-9f837e528977](../azure/a6604cc9-a6f7-4009-96ba-9f837e528977.md) |
>| offline_access | 委托 | 身份验证 | [a6604cc9-a6f7-4009-96ba-9f837e528977](../azure/a6604cc9-a6f7-4009-96ba-9f837e528977.md) |
>| 个人资料 | 委托 | 身份验证 | [a6604cc9-a6f7-4009-96ba-9f837e528977](../azure/a6604cc9-a6f7-4009-96ba-9f837e528977.md) |
