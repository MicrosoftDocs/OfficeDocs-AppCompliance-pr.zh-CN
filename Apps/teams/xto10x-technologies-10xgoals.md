...
| 公司总部位置 | 印度 |
| 应用信息页面 | [https://www.xto10x.com/10xgoals/](https://www.xto10x.com/10xgoals/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 应用程序 | 获取用户电子邮件和 azure id，以便应用可以主动为组织所有用户安装应用。  | [950aa4fb-0583-4b13-9b5f-bbc92b9cc376](../azure/950aa4fb-0583-4b13-9b5f-bbc92b9cc376.md) |
>| TeamsAppInstallation.ReadWriteSelfForUser.All | 应用程序 | 必须这样做，以便应用可以提取已安装的 teamsAppDefinition 供管理员使用，然后为组织所有用户主动安装自身。  | [950aa4fb-0583-4b13-9b5f-bbc92b9cc376](../azure/950aa4fb-0583-4b13-9b5f-bbc92b9cc376.md) |
