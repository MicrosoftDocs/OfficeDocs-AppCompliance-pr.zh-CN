---
title: xto10x Technologies 的 10xGoals 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: 10xGoals 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/950aa4fb-0583-4b13-9b5f-bbc92b9cc376" target="_blank">Teams存储区中的视图</a>
...
xto10x Technologies 提供给 Microsoft 的信息：
...
| 公司的网站 | [https://www.xto10x.com/10xgoals/](https://www.xto10x.com/10xgoals/) |
| 应用的使用条款 | [https://www.xto10x.com/security/terms-of-use/](https://www.xto10x.com/security/terms-of-use/) |
| 应用的核心功能 | 10xGoals 是一种工具，可通过全团队的焦点、对齐、协作和可见性将策略推入执行。 通过 10xGoals &lt;&gt; Microsoft Teams集成，可以管理此处的整个执行。 首先，用户可以接受/拒绝/评论分配给他们的目标，以更好地管理其时间。 若要使用此应用，用户必须具有活动的 10xGoals 订阅。 |
| 公司总部位置 | 印度 |
| 应用信息页 | [https://www.xto10x.com/10xgoals/](https://www.xto10x.com/10xgoals/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
xto10x Technologies 提供了有关此应用如何收集和存储组织数据以及组织对应用收集的数据的控制的信息。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 应用程序 | 提取用户电子邮件和 azure ID，以便应用可以主动为组织的所有用户安装应用。  | [950aa4fb-0583-4b13-9b5f-bbc92b9cc376](../azure/950aa4fb-0583-4b13-9b5f-bbc92b9cc376.md) |
>| TeamsAppInstallation.ReadWriteSelfForUser.All | 应用程序 | 这是必需的，以便应用可以提取已安装的 teamsAppDefinition 供管理员使用，然后主动为组织的所有用户安装自身。  | [950aa4fb-0583-4b13-9b5f-bbc92b9cc376](../azure/950aa4fb-0583-4b13-9b5f-bbc92b9cc376.md) |
