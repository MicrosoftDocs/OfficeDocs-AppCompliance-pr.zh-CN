...
| 公司网站 | [https://www.xto10x.com/10xgoals/](https://www.xto10x.com/10xgoals/) |
| 应用的使用条款 | [https://www.xto10x.com/security/terms-of-use/](https://www.xto10x.com/security/terms-of-use/) |
| 应用的核心功能 | 10xGoals 是一种通过团队范围的焦点、对齐、协作和可见性推动策略执行的工具。 使用 10xGoals &lt;&gt; Microsoft Teams集成，用户可以在此处管理整个执行。 首先，用户可以接受/拒绝/评论分配给他们的目标，以更好地管理时间。 若要使用此应用，用户必须拥有活动的 10xGoals 订阅。 |
| 公司总部位置 | 印度 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 应用程序 | 获取用户电子邮件和 azure id，以便应用可以主动为组织所有用户安装应用。  | [950aa4fb-0583-4b13-9b5f-bbc92b9cc376](https://docs.microsoft.com/microsoft-365-app-certification/azure/950aa4fb-0583-4b13-9b5f-bbc92b9cc376) |
>| TeamsAppInstallation.ReadWriteSelfForUser.All | 应用程序 | 必须这样做，以便应用可以提取已安装的 teamsAppDefinition 供管理员使用，然后为组织所有用户主动安装自身。  | [950aa4fb-0583-4b13-9b5f-bbc92b9cc376](https://docs.microsoft.com/microsoft-365-app-certification/azure/950aa4fb-0583-4b13-9b5f-bbc92b9cc376) |
