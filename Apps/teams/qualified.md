...
description: CSA STAR 注册表中所有可用的安全性和符合性信息，包括“合格”、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/d9850897-f8bf-407c-878b-b0cdcbba93ff" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | 认证 |
| 公司的网站 | [https://www.qualified.com](https://www.qualified.com) |
| 应用的使用条款 | [https://www.qualified.com/legal/terms-of-service](https://www.qualified.com/legal/terms-of-service) |
| 应用的核心功能 | 当热门前景到达您的网站时，合格的立即通知销售代表 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://www.qualified.com/university-guide/microsoft-teams-...](https://www.qualified.com/university-guide/microsoft-teams-integration) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Heroku |
...
Qualified 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 应用程序 | 允许我们选择要通知的通道 | [2c951ed5-c5c6-493f-9b02-4b42e3ba536c](../azure/2c951ed5-c5c6-493f-9b02-4b42e3ba536c.md) |
>| Team.ReadBasic.All | 应用程序 | 允许我们查找来自所有团队的所有频道，以便我们选择要通知的频道 | [2c951ed5-c5c6-493f-9b02-4b42e3ba536c](../azure/2c951ed5-c5c6-493f-9b02-4b42e3ba536c.md) |
