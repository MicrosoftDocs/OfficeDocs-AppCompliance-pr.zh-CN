---
title: Zoho Sign by Zoho Corporation Private Limited 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/17/2022
...
description: Zoho Sign 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* [Teams存储区中的视图](https://teams.microsoft.com/l/app/7a22873b-81e6-48ed-aee3-6f0e7dd5a104)
* [在 AppSource 中查看](https://appsource.microsoft.com/product/office/WA104382011)
...
| 应用的核心功能 | Zoho Sign 是一种安全且基于云的数字签名应用，可用于在法律和电子方面对业务文书工作进行签名、发送和管理。 可以毫不费力地创建电子签名工作流，以实时收集签名、对签名者进行身份验证、触发提醒以及跟踪签名和审批状态。 Zoho Sign 还允许你直接从 Web 浏览器和移动应用从 Microsoft 应用管理所有文书工作。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://www.zoho.com/sign/help/teams-extension.html](https://www.zoho.com/sign/help/teams-extension.html) |
...
| 如果基础结构处理或存储 Microsoft 客户数据，则此数据在地理上存储在哪里？ | 印度、日本、澳大利亚、中国、荷兰 (美国) 、爱尔兰、美国 |
| 是否已建立数据出租和处置流程？ | 是 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | 登录并读取用户个人资料 | [a67ee0a9-b008-4e90-986d-1eb8d55a81d6](../azure/a67ee0a9-b008-4e90-986d-1eb8d55a81d6.md) |
