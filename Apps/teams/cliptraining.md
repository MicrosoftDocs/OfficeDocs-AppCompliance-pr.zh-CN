---
title: 按 ClipTraining 进行剪辑训练的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/08/2021
...
description: 适用于 ClipTraining 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/6cb4b701-2a4f-4080-8a8a-d99f93905e15" target="_blank">Teams存储区中的视图</a>
...
| 公司的网站 | [https://www.cliptraining.com](https://www.cliptraining.com) |
| 应用的使用条款 | [https://www.cliptraining.com/eula/](https://www.cliptraining.com/eula/) |
| 应用的核心功能 | 适用于新式学习的内容流式处理服务，包括 5000 多节Microsoft 365课程。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://www.cliptraining.com](https://www.cliptraining.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
ClipTraining 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| 电子邮件 | 委托 | 用户登录和通信的电子邮件地址、名字、姓氏。  | [af089bb5-48be-413d-ad34-53c32799da7d](../azure/af089bb5-48be-413d-ad34-53c32799da7d.md) |
>| offline_access | 委托 | 用户登录和通信的电子邮件地址、名字、姓氏。  | [af089bb5-48be-413d-ad34-53c32799da7d](../azure/af089bb5-48be-413d-ad34-53c32799da7d.md) |
>| openid | 委托 | 用户登录和通信的电子邮件地址、名字、姓氏。  | [af089bb5-48be-413d-ad34-53c32799da7d](../azure/af089bb5-48be-413d-ad34-53c32799da7d.md) |
>| 个人资料 | 委托 | 用户登录和通信的电子邮件地址、名字、姓氏。  | [af089bb5-48be-413d-ad34-53c32799da7d](../azure/af089bb5-48be-413d-ad34-53c32799da7d.md) |
