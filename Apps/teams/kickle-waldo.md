...
description: Waldo 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/1d041f16-ab49-4627-bfda-6b60ad2cab6a" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | Kickle |
| 公司的网站 | [https://hellowaldo.app](https://hellowaldo.app) |
| 应用的使用条款 | [https://hellowaldo.app/terms-and-conditions](https://hellowaldo.app/terms-and-conditions) |
| 应用的核心功能 | 桌面预订，停车预订。 弹性办公室和家庭作业变得简单！ |
| 公司总部位置 | 法国 |
| 应用信息页 | [https://hellowaldo.app/takeatour/](https://hellowaldo.app/takeatour/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
Kickle 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Chat.ReadBasic | 委托 | 根据聊天历史记录，Waldo 会标识你的同事。 此列表随后用于在日历视图中显示状态。 | [c71a6f53-cf0c-426d-a826-cedae8b073f7](../azure/c71a6f53-cf0c-426d-a826-cedae8b073f7.md) |
>| User.Read | 委托 | Microsoft Graph Toolkit的组件人员使用此权限 | [c71a6f53-cf0c-426d-a826-cedae8b073f7](../azure/c71a6f53-cf0c-426d-a826-cedae8b073f7.md) |
>| User.ReadBasic.All | 委托 | Microsoft Graph Toolkit的组件人员使用此权限 | [c71a6f53-cf0c-426d-a826-cedae8b073f7](../azure/c71a6f53-cf0c-426d-a826-cedae8b073f7.md) |
>| offline_access | 委托 | 应用用于代表用户执行后台任务 (续订令牌进行身份验证)  | [c71a6f53-cf0c-426d-a826-cedae8b073f7](../azure/c71a6f53-cf0c-426d-a826-cedae8b073f7.md) |
>| openid | 委托 | 身份验证必需 | [c71a6f53-cf0c-426d-a826-cedae8b073f7](../azure/c71a6f53-cf0c-426d-a826-cedae8b073f7.md) |
