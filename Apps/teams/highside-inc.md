...
| 应用程序Teams页的 URL | [https://highside.io/secureteams](https://highside.io/secureteams) |
...
>|:-----------------------------------------------------|:------------------------------|:----------------------------------------|
>| AWS | Microsoft Teams租户 ID | 因此我们知道哪些团队请求来自哪些用户以及哪些用户属于哪个用户 |
