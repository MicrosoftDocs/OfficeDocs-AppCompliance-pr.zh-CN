---
title: Motionlab by Motionlab 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/20/2022
...
description: Motionlab 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/8ad5fc1b-251b-4d14-aceb-2624bcab0e85" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004250" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Motionlab 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Motionlab |
| 公司的网站 | [https://www.motionlab.io](https://www.motionlab.io) |
| 应用的使用条款 | [https://www.motionlab.io/term-of-use](https://www.motionlab.io/term-of-use) |
| 应用的核心功能 | 直接在 Microsoft Teams 中轻松创建个性化视频。 |
| 公司总部位置 | 捷克语 |
| 应用信息页 | |
...
Motionlab 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 创建个性化视频所需的信息。 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 创建个性化视频所需的信息。 |
