...
| 应用的核心功能 | NextSet 组通讯簿提供人员列表显示、员工搜索等功能。 管理员通过导入员工和组织信息来生成组通讯簿。 此外，用户还可以注册个人通讯簿 (电话号码、分机号码等)  |
| 公司总部位置 | 日本 |
| 应用信息页面 | [https://www.nextset.co.jp/address.html](https://www.nextset.co.jp/address.html) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
