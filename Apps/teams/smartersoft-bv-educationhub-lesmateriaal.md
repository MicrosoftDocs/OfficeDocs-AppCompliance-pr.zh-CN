---
title: Smartersoft B.V 提供的 EducationHUB Lesmateriaal 应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: EducationHUB Lesmateriaal 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/f5558ae7-a166-41bd-997b-f8cc1eddebac" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004326" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Smartersoft B.V 提供的信息。 到 Microsoft：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | EducationHUB Lesmateriaal |
| ID | WA200004326 |
| 支持Office 365客户端 | Microsoft Teams |
| 合作伙伴公司名称 | Smartersoft B.V. |
| 公司的网站 | [https://smartersoft.nl](https://smartersoft.nl) |
| 应用的使用条款 | [https://content.educationhub.nl/terms](https://content.educationhub.nl/terms) |
| 应用的核心功能 | 允许学校提供直接访问学校提供的数字内容，而不是强迫学生到另一个网站。 |
| 公司总部位置 | 荷兰 ()  |
| 应用信息页 | [https://content.educationhub.nl](https://content.educationhub.nl) |
...
Smartersoft B.V 提供了此信息。 关于此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 添加到应用程序的用户 ID、组成员身份、个人内容 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 用户 ID、组 ID、用户提供的指向数字学校内容的链接 |
...
| 应用是否支持条件访问策略？ | 是 |
| 列出支持的策略类型 | 总之，Microsoft 平台负责为我们提供用户令牌。 管理员决定如何验证/强制使用 MFA |
| 应用是否支持持续访问评估 (CAE)  | 是 |
| 应用是否在代码中存储任何凭据？ | 否 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Read.All | 委托 | 在组扩展属性中保存的访问信息 | [d3c78487-7def-49e1-9d17-40e94d66ac5b](../azure/d3c78487-7def-49e1-9d17-40e94d66ac5b.md) |
>| Team.ReadBasic.All | 委托 | 有关用户团队的信息 | [d3c78487-7def-49e1-9d17-40e94d66ac5b](../azure/d3c78487-7def-49e1-9d17-40e94d66ac5b.md) |
>| User.Read | 委托 | 登录 | [d3c78487-7def-49e1-9d17-40e94d66ac5b](../azure/d3c78487-7def-49e1-9d17-40e94d66ac5b.md) |
