---
title: Quadra Visitorz 的应用程序信息（按 Quadrasystems.net）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/13/2022
...
description: Quadra Visitorz 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/86458973-657f-4072-8e6a-f1baf684c62f" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004199" target="_blank">在 AppSource 中查看</a>
...
| 应用的核心功能 | Visitorz 是一种直观、易于使用且可缩放的访问者管理解决方案。 |
| 公司总部位置 | 印度 |
| 应用信息页 | |
