...
description: 有关迁移程序的所有可用Project信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| "Teams应用程序信息"页的 URL | [https://help.fluentpro.com/147404-project-migrator](https://help.fluentpro.com/147404-project-migrator) |
...
>| User.Read | delegated | 名字、姓氏、公司名称、电话公司电子邮件。 此数据用于注册和身份验证过程。 | 名字、姓氏、公司名称、电话、公司电子邮件、UPN。 | [c36d31a2-8de1-4eb5-9e7d-01da45244c04](https://docs.microsoft.com/microsoft-365-app-certification/azure/c36d31a2-8de1-4eb5-9e7d-01da45244c04) |
