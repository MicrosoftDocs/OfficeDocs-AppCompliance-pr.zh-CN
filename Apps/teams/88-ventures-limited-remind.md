...
| 应用的核心功能 | 提醒您自己或团队成员重要会议、事项甚至生日。 设置个人提醒、群聊提醒或频道提醒。 你甚至可以设置定期提醒 (每周一上午 9 点召开团队) ！ |
| 公司总部位置 | 香港特别行政区 |
| 应用信息页面 | |
...
>|   **Graph权限**  | **权限类型** |          **字距调整**          |
>|:------------------------|:--------------------|:------------------------------------|
>| Directory.Read.All | delegated | 在管理员搜索用户以将其分配给许可证时使用。 此功能的用法完全是可选的，在正常应用使用期间不需要。 |
