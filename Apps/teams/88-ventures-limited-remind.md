...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Directory.Read.All | delegated | 数据库中未存储任何信息 | 允许管理员浏览已设置公共提醒的用户的组织用户目录 | 88546d4f-9973-4716-98e4-cd181c04bc2d |
...
>|:--------------------------------|:---------------------|:--------------------------|
>|  (1) 当用户在邮件上设置提醒时，机器人会尝试获取最初发送消息的人的姓名，以在用户的提醒列表中显示该信息 (2) 当用户为另一个频道或聊天成员设置提醒时，机器人会尝试获取标识 (用户或聊天机器人) 以及被提及用户的名称，以在用户的提醒列表中显示该信息 |  (1) 当用户在邮件上设置提醒时，机器人会尝试获取最初发送消息的人的姓名，以在用户的提醒列表中显示该信息 (2) 当用户为另一个频道或聊天成员设置提醒时，机器人会尝试获取标识 (用户或聊天机器人) 以及被提及用户的名称，以在用户的提醒列表中显示该信息 |  |
...
>静态加密：双因素 (2FA) ，用于限制对 IT 基础结构和客户数据（系统之间的受保护 IP 范围）的访问
