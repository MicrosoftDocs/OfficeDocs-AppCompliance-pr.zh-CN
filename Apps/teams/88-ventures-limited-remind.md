...
>|:---------------------------------------|:-----------------------------------|:------------------------------------|
>|  (1) 当用户在邮件上设置提醒时，机器人会尝试获取最初发送消息的人的姓名，以在用户的提醒列表中显示该信息 (2) 当用户为另一个频道或聊天成员设置提醒时，机器人会尝试获取标识 (用户或聊天机器人) 以及被提及用户的名称以在用户的提醒列表中显示该信息 |  (1) 当用户在邮件上设置提醒时，机器人会尝试获取最初发送消息的人的姓名，以在用户的提醒列表中显示该信息 (2) 当用户为另一个频道或聊天成员设置提醒时，机器人会尝试获取标识 (用户或聊天机器人) 以及被提及用户的名称以在用户的提醒列表中显示该信息 |  |
