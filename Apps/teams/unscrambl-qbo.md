---
title: 适用于 qbo by Unscrambl 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/29/2021
...
description: 适用于 qbo 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/834c6939-152c-450b-a305-c65b4dd5d1c7" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | Unscrambl |
| 公司的网站 | [https://unscrambl.com](https://unscrambl.com) |
| 应用的使用条款 | [https://unscrambl.com/service-agreement](https://unscrambl.com/service-agreement) |
| 应用的核心功能 | qbo 由 Unscrambl qbo 见解提供支持，使用一流的 NLP 进行分析对话。 用户键入问题，qbo 会在快照中显示最相关的见解和可视化效果。 用户可以主动与同事协作，在演示就绪板中做出决策并捕获结果。 qbo 使组织中的每个人都能够做出数据驱动的决策。 qbo 直接连接到一系列云或本地源，可以通过Microsoft Teams或浏览器进行访问。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://qbo.ai](https://qbo.ai) |
...
Unscrambl 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 名称和电子邮件地址用于帐户创建 |
