...
| 合作伙伴公司名称 | Humu Inc. |
| 公司网站 | [https://www.humu.com](https://www.humu.com) |
| 应用的使用条款 | [https://www.humu.com/humu-for-microsoft-teams-license](https://www.humu.com/humu-for-microsoft-teams-license) |
| 应用的核心功能 | Humu 是一个操作管理平台，使组织每周都可以轻松改进一次。 Humu 将业务策略转换为组织中每个人与个人相关的操作。 我们的主要焦点是大规模推动组织改进，从而创建更加高效、协作、创新且更具包容性的员工。 Humu 通过简化更改来更好地工作。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
