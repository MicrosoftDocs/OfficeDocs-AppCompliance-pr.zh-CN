...
description: Humu 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/7fbbb34f-a0fa-471b-9c2a-abc15daad3cb" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | Humu Inc. |
| 公司的网站 | [https://www.humu.com](https://www.humu.com) |
| 应用的使用条款 | [https://www.humu.com/humu-for-microsoft-teams-license](https://www.humu.com/humu-for-microsoft-teams-license) |
| 应用的核心功能 | Humu 是一个操作管理平台，使组织每周都能轻松改进。 Humu 将业务策略转换为组织中每个人的个人相关操作。 我们的主要重点是大规模推动组织改进，从而创造更高效、协作、创新和包容性的劳动力。 Humu 通过简化更改使工作变得更好。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | GCP |
...
Humu Inc. 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
