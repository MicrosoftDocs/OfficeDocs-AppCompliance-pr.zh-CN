---
title: 由有形 IT 墨西哥提供的 ACV 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/16/2022
...
description: ACV 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/0a3b1cc0-1cda-4373-90b9-7740e604c5e3" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004237" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

有形 IT 墨西哥向 Microsoft 提供的信息：
...
| 合作伙伴公司名称 | 有形 IT 墨西哥 |
| 公司的网站 | [https://www.tangibleit.com](https://www.tangibleit.com) |
| 应用的使用条款 | [https://www.acv.app/terms](https://www.acv.app/terms) |
| 应用的核心功能 | 管理出勤控制，通过仪表板提供执行可见性，并通过使用白板促进教学体验。 全部位于镜像学校的解决方案中。 |
| 公司总部位置 | 墨西哥 |
| 应用信息页 | [https://www.acv.app](https://www.acv.app) |
...
有形 IT Mexico 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 用户配置文件数据、用于身份验证的用户电子邮件数据。 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 用户名，用户电子邮件，用户角色，学校电话，学校地址，学校名称，科目，课程，课程。 |
...
| 隐私策略 URL | https://www.acv.app/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | 两者 | 若要发布白板协作 (我们的功能) 链接到频道。 | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| Group.ReadWrite.All | 两者 | 若要发布白板协作 (我们的功能) 链接到频道。 | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| User.Read | 两者 | 执行身份验证过程，并在属于组的学生配置文件上获取数据。 | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| 电子邮件 | 两者 | 执行身份验证过程，并在属于组的学生配置文件上获取数据。 | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| openid | 两者 | 执行身份验证过程，并在属于组的学生配置文件上获取数据。 | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| 个人资料 | 两者 | 执行身份验证过程，并在属于组的学生配置文件上获取数据。 | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
