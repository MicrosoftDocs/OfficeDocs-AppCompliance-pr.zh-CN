---
title: 按 Think AI Thinky365-Autotask的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Thinky365-Autotask 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/2291b3d5-ea1d-4605-9a94-ac4523b85c06" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004355" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Think AI 提供给 Microsoft 的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | Thinky365-Autotask |
| ID | WA200004355 |
| 支持Office 365客户端 | Microsoft Teams |
| 合作伙伴公司名称 | Think AI |
| 公司的网站 | [https://www.thinky365.com](https://www.thinky365.com) |
| 应用的使用条款 | [https://thinky365.com/terms-of-use/](https://thinky365.com/terms-of-use/) |
| 应用的核心功能 | Thinky365 Chatbot for Autotask 是 24&#215;7 虚拟代理。 使用此聊天机器人，你将能够以新的创新方式提升服务团队的工作效率，同时改善客户的整体用户体验。  |
| 公司总部位置 | 美国美国 |
| 应用信息页 | |
...
Think AI 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 不支持 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | Microsoft Graph、CRM 和 Azure 等服务的终结点 |
