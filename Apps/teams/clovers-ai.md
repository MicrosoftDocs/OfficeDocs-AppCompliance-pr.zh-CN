---
title: 适用于 Clovers by Clovers AI 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/22/2022
...
description: 适用于 Clovers 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/1356036b-5fa7-42ce-8079-5741f2acfc5f" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003795" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Clovers AI 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Clovers AI |
| 公司的网站 | [https://clovers.ai](https://clovers.ai) |
| 应用的使用条款 | [https://clovers.ai/terms-of-use/](https://clovers.ai/terms-of-use/) |
| 应用的核心功能 | Clovers - 帮助团队更高效地雇佣面试指南 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | |
...
Clovers AI 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
