---
title: Clovers AI 的 Clovers 应用程序信息
ms.author: elmalova
author: elenamalova
ms.date: 02/22/2022
ms.topic: article
...
description: Clovers 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/1356036b-5fa7-42ce-8079-5741f2acfc5f" target="_blank">在应用商店Teams视图</a>
...
| 合作伙伴公司名称 | Clovers AI |
| 公司网站 | [https://clovers.ai](https://clovers.ai) |
| 应用的使用条款 | [https://clovers.ai/terms-of-use/](https://clovers.ai/terms-of-use/) |
| 应用的核心功能 | Clovers - 帮助团队更高效地雇用的面试指南 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
...
Clovers AI 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及组织对应用收集的数据的控制有关。
