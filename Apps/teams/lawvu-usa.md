---
title: LawVu USA by LawVu 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/04/2022
...
description: 适用于 LawVu USA 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/410462ec-76c7-45ac-9f57-61e6f82a6792" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003911" target="_blank">在 AppSource 中查看</a>
...
| 是否已与共享 Microsoft 客户数据的任何第三方服务达成数据共享协议？ |  |
