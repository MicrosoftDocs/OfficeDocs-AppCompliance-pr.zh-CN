---
title: Captivate IO Ltd 针对 Captivate Hub 的应用程序信息
ms.author: elmalova
author: elenamalova
ms.date: 12/14/2021
ms.topic: article
...
description: Captivate Hub 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "61537898"
---
# <a name="the-captivate-hub"></a>Captivate 中心

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 7 月 16 日</p>

* <a href="https://teams.microsoft.com/l/app/0ea8ef28-454a-4796-84dc-06c775639565" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003575" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Captivate IO Ltd 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Captivate IO Ltd |
| 公司网站 | [https://captivat.io](https://captivat.io) |
| 应用的使用条款 | [https://captivat.io/tos](https://captivat.io/tos) |
| 应用的核心功能 | Captivate Hub 是一个无代码可扩展系统，设计用于支持跨多个渠道的人工/计算机对话。 它支持多供应商数字助理和大量实时聊天解决方案。 |
| 公司总部位置 | 英国大英和爱尔兰 ()  |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ | Iaas |
| 应用使用哪些托管云提供商？ | IBMCloud |
...
此信息由 Captivate IO Ltd 提供，用于了解此应用如何收集和存储组织数据，以及您的组织将拥有对应用收集的数据的控制。
...
| 数据库中存储了哪些数据？ | 租户 ID、Teams组、频道组和将 连接到应用程序的团队组中包含的用户 |
...
| 隐私策略 URL | https://www.captivat.io/privacy-policy/ |
...
| 你的应用是否支持 CAE (连续访问)  | 否 |
| 你的应用是否将任何凭据存储在代码中？ | 是 |
| 适用于应用的应用和外接程序Microsoft 365 Microsoft 应用和外接程序可能使用 Microsoft Graph。 您的应用程序或外接程序是否使用其他 Microsoft API？ | 否 |
