---
title: Squadify 控股 Pty Ltd 的 Squadify 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/05/2022
...
description: 适用于 Squadify 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/110107b9-4326-43d8-bf43-bf10fcdce8ad" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004349" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Squadify Holdings Pty Ltd 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Squadify 控股 Pty Ltd |
| 公司的网站 | [https://www.squadify.net](https://www.squadify.net) |
| 应用的使用条款 | [https://www.squadify.net/mst-terms-of-use](https://www.squadify.net/mst-terms-of-use) |
| 应用的核心功能 | 适用于 Microsoft Teams 的 Squadify 可让你收集团队反馈、对话并生成可操作的见解。 使用适用于 Microsoft Teams 的 Squadify，可以使用 1 次单击设置创建 Squad，并将其与 Microsoft Teams 中的团队进行匹配。 还可以启动 Squadifys、跟踪其进度，并生成有关团队性能的见解，以便开始创建正确的对话。 |
| 公司总部位置 | 澳大利亚 |
| 应用信息页 | [https://www.squadify.net/our-product](https://www.squadify.net/our-product) |
...
Squadify Holdings Pty Ltd 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 用户全名和Email地址 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 用户全名和Email地址 |
| 如果基础结构处理或存储 Microsoft 客户数据，则此数据在地理上存储在哪里？ | 澳大利亚 |
| 是否已建立数据出租和处置流程？ | 是 |
...
| 隐私策略 URL | https://www.squadify.net/privacy-policy |
