---
title: SimplyDo by SimplyDo 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/20/2022
...
description: SimplyDo 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/dbf692fe-35c1-4511-9178-9131e6511712" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004248" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

SimplyDo 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | SimplyDo |
| 公司的网站 | [https://www.simplydo.co.uk](https://www.simplydo.co.uk) |
| 应用的使用条款 | [https://www.simplydo.co.uk/terms-of-use](https://www.simplydo.co.uk/terms-of-use) |
| 应用的核心功能 | SimplyDo 使组织能够从员工群中获取想法和见解，从而持续改进和创新。 |
| 公司总部位置 | 大不列颠及北爱尔兰联合王国 ()  |
| 应用信息页 | [https://www.simplydo.co.uk/product](https://www.simplydo.co.uk/product) |
...
SimplyDo 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 用户配置文件数据 (名称、部门、职务、电子邮件) 。 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 用户配置文件数据 (名称、部门、职务、电子邮件)  |
...
| 隐私策略 URL | https://www.simplydo.co.uk/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | 访问单一登录的配置文件数据 | [dbf692fe-35c1-4511-9178-9131e6511712](../azure/dbf692fe-35c1-4511-9178-9131e6511712.md) |
>| 电子邮件 | 委托 | 支持 OpenID Connect 功能/登录 | [dbf692fe-35c1-4511-9178-9131e6511712](../azure/dbf692fe-35c1-4511-9178-9131e6511712.md) |
>| offline_access | 委托 | 支持 OpenID Connect 功能/登录 | [dbf692fe-35c1-4511-9178-9131e6511712](../azure/dbf692fe-35c1-4511-9178-9131e6511712.md) |
>| openid | 委托 | 支持 OpenID Connect 功能/登录 | [dbf692fe-35c1-4511-9178-9131e6511712](../azure/dbf692fe-35c1-4511-9178-9131e6511712.md) |
