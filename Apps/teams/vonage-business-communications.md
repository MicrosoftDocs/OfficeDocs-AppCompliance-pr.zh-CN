---
title: Vonage Business Communications 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/05/2021
...
description: Vonage Business Communications 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/47c6b242-a067-426c-9a02-0f680a42c488" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | Vonage |
| 公司的网站 | [https://www.vonage.com](https://www.vonage.com) |
| 应用的使用条款 | [https://www.vonage.com/legal/unified-communications/tos/glo...](https://www.vonage.com/legal/unified-communications/tos/global-vbc-tos/) |
| 应用的核心功能 | Vonage Business Communications for Teams 支持使用 Vonage 直接路由调用、短信和 MMS。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://www.vonage.com/unified-communications/](https://www.vonage.com/unified-communications/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
Vonage 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | 应用程序 | 没有使用此权限存储数据 | [1d8a304e-ea67-4aa2-9345-2793419cf83f](../azure/1d8a304e-ea67-4aa2-9345-2793419cf83f.md) |
>| User.Read | 委托 | 获取 Azure 用户 ID 和租户 ID，以便稍后可以向此用户发送通知。 | [1d8a304e-ea67-4aa2-9345-2793419cf83f](../azure/1d8a304e-ea67-4aa2-9345-2793419cf83f.md) |
