...
| 应用的核心功能 | Vonage Business Communications for Teams支持使用 Vonage 直接路由的呼叫、短信和彩信。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://www.vonage.com/unified-communications/](https://www.vonage.com/unified-communications/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | 应用程序 | 没有存储具有此权限的数据 | [1d8a304e-ea67-4aa2-9345-2793419cf83f](../azure/1d8a304e-ea67-4aa2-9345-2793419cf83f.md) |
>| User.Read | delegated | 获取 Azure 用户 ID 和租户 ID，以便我们稍后可以向此用户发送通知。 | [1d8a304e-ea67-4aa2-9345-2793419cf83f](../azure/1d8a304e-ea67-4aa2-9345-2793419cf83f.md) |
