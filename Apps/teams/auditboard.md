...
description: AuditBoard 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/c37d6bf9-d665-4119-b4e4-c641ee74fe09" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003600" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

AuditBoard 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | AuditBoard |
| 公司网站 | [https://www.auditboard.com](https://www.auditboard.com) |
| 应用的使用条款 | [https://www.auditboard.com/terms-of-use/](https://www.auditboard.com/terms-of-use/) |
| 应用的核心功能 | 使 AuditBoard 订阅者能够接收Microsoft Teams。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
...
AuditBoard 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及组织将拥有对应用收集的数据的控制有关。
...
| 隐私策略 URL | https://www.auditboard.com/privacy-policy/ |
