---
title: CLIPr by CLIPr Co 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/21/2022
...
description: CLIPr 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/2d6b2a6d-a20d-4206-a11c-e01d34d0d3a0" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003612" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

CLIPr Co 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | CLIPr Co |
| 公司的网站 | [https://www.clipr.ai](https://www.clipr.ai) |
| 应用的使用条款 | [https://www.clipr.ai/terms-of-use](https://www.clipr.ai/terms-of-use) |
| 应用的核心功能 | CLIPr 使用 AI/机器学习使视频内容可搜索且可操作。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | |
...
CLIPr Co 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 我们收集用户的姓名和电子邮件地址。 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 用户名、电子邮件地址和附加到其租户 ID 的公司名称。  |
...
| 隐私策略 URL | https://www.clipr.ai/privacy-policy |
