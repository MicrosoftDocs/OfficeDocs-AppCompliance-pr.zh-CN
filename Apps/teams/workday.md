...
| 合作伙伴公司名称 | Workday |
| 公司网站 | [https://www.workday.com/en-us/homepage.html](https://www.workday.com/en-us/homepage.html) |
| 应用的使用条款 | [https://nw.myworkday.com/microsoftteams/post-license/](https://nw.myworkday.com/microsoftteams/post-license/) |
| 应用的核心功能 | 将 Workday 添加到您的Teams轻松轻松地执行 HR 和财务任务！  有关应用安全和数据隐私的更完整信息，Workday 客户应参阅 Workday 上的自然工作区创新服务说明和自然工作区用户组Community。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://nw.myworkday.com/microsoftteams/](https://nw.myworkday.com/microsoftteams/) |
...
| 数据库中存储了哪些数据？ | Microsoft 租户 ID、用户AAD对象 ID、对话 ID |
