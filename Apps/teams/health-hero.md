...
description: Health Hero 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/1394c825-0026-4f33-bcc9-abaa9ae5d83b" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | 运行状况主图 |
| 公司的网站 | [https://gohealthhero.com](https://gohealthhero.com) |
| 应用的使用条款 | [https://www.gohealthhero.com/terms](https://www.gohealthhero.com/terms) |
| 应用的核心功能 | Health Hero 允许用户捕获正常活动并接收活动点。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
Health Hero 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
| 应用是否符合服务组织控制 (SOC 1) ？ | 可访问 |
| 最新的 SOC1 认证日期 | 2021-01-01 |
| 应用是否符合服务组织控制 (SOC 2) ？ | 是 |
| 最新的 SOC2 认证日期 | 2021-01-01 |
| 应用是否符合服务组织控制 (SOC 3) ？ | 是 |
| 最新的 SOC3 认证日期 | 2021-01-01 |
