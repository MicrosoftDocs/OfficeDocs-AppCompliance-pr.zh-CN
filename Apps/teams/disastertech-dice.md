---
title: DisasterTech DICE by DisasterTech 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: DisasterTech DICE 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "65811221"
---
# <a name="disastertech-dice"></a>DisasterTech DICE

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 5 月 31 日</p>

* <a href="https://teams.microsoft.com/l/app/7df3e67b-ed62-48e9-a950-c95bd7ebce80" target="_blank">Teams存储区中的视图</a>
...
| 公司的网站 | [https://www.disastertech.com](https://www.disastertech.com) |
| 应用的使用条款 | [https://dice.disastertech.com/tos.html](https://dice.disastertech.com/tos.html) |
| 应用的核心功能 | 灾难技术数据科学集成协作环境 (DICE) 使用用户定义的自助式分析和数据科学工具提供基于 Web 的数据可视化和数据探索软件。 DICE 提供对最全面的灾难风险数据清单的访问权限，以便在灾难发生之前、期间和之后进行实时浏览。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | |
...
DisasterTech 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | Microsoft Teams单一登录 | [7df3e67b-ed62-48e9-a950-c95bd7ebce80](../azure/7df3e67b-ed62-48e9-a950-c95bd7ebce80.md) |
>| 电子邮件 | 委托 | Microsoft Teams单一登录 | [7df3e67b-ed62-48e9-a950-c95bd7ebce80](../azure/7df3e67b-ed62-48e9-a950-c95bd7ebce80.md) |
>| offline_access | 委托 | Microsoft Teams单一登录 | [7df3e67b-ed62-48e9-a950-c95bd7ebce80](../azure/7df3e67b-ed62-48e9-a950-c95bd7ebce80.md) |
>| openid | 委托 | Microsoft Teams单一登录 | [7df3e67b-ed62-48e9-a950-c95bd7ebce80](../azure/7df3e67b-ed62-48e9-a950-c95bd7ebce80.md) |
>| 个人资料 | 委托 | Microsoft Teams单一登录 | [7df3e67b-ed62-48e9-a950-c95bd7ebce80](../azure/7df3e67b-ed62-48e9-a950-c95bd7ebce80.md) |
