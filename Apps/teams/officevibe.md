...
>| TeamsAppInstallation.ReadWriteForUser | delegated | 电子邮件、姓名、图片：在 Officevibe 中创建用户。 链接到所有用户的组：大致了解组织。 租户 ID &amp; 租户名称：在 Officevibe 中设置组织 | 电子邮件、姓名、图片：在 Officevibe 中创建用户。 链接到所有用户的组：大致了解组织。 租户 ID &amp; 租户名称：在 Officevibe 中设置组织 | 3e500164-df82-4d1e-9db8-0901e07d374d  |
>| User.Read | delegated | 电子邮件、姓名、图片：在 Officevibe 中创建用户。 链接到所有用户的组：大致了解组织。 租户 ID &amp; 租户名称：在 Officevibe 中设置组织 | 电子邮件、姓名、图片：在 Officevibe 中创建用户。 链接到所有用户的组：大致了解组织。 租户 ID &amp; 租户名称：在 Officevibe 中设置组织 | 3e500164-df82-4d1e-9db8-0901e07d374d  |
