...
description: Keepass 应用程序的所有可用安全性和合规性Pro、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
>| Files.ReadWrite.All | delegated | 在文件中读取/写入 KDBX SharePoint |
>| openid | delegated | Teams SSO |
>| 个人资料 | delegated | Teams SSO |
