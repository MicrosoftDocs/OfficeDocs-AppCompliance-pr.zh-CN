...
description: Wurqi 的所有可用安全性和符合性信息、其数据处理策略、Microsoft Cloud App Security 应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "65938684"
---
# <a name="wurqi"></a>Wurqi

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 2 月 11 日</p>

* <a href="https://teams.microsoft.com/l/app/5173558d-bfb0-40dd-b75c-3cfac117ce72" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004161" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Wurqi 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Wurqi |
| 公司的网站 | [https://wurqi.com](https://wurqi.com) |
| 应用的使用条款 | [https://wurqi.com/terms/](https://wurqi.com/terms/) |
| 应用的核心功能 | Wurqi 是一个工作管理平台，可集成所有工作、项目和通信。 Teams 应用为用户提供仅限视图的页面，该页面将显示有关他们正在处理的项目的所有信息，使团队中的所有用户能够查看事情的进展情况。  |
...
Wurqi 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
| 启用了多重身份验证 (MFA) ： | DNSManagement、CodeRepositories |
...
| 隐私策略 URL | https://wurqi.com/privacy-policy/ |
