---
title: Ask Vizir by Vizir.co 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/25/2022
...
description: Ask Vizir 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "65069688"
---
# <a name="ask-vizir"></a>询问 Vizir

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 4 月 22 日</p>

* <a href="https://teams.microsoft.com/l/app/7b0641d9-8e1f-4415-99da-c80f8c175c69" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003119" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Vizir.co 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Vizir.co |
| 公司的网站 | [https://www.vizir.co](https://www.vizir.co) |
| 应用的使用条款 | [https://vizir.co/mentions-legales](https://vizir.co/mentions-legales) |
| 应用的核心功能 | 询问 Vizir 机器人可帮助法国的团队用户使用Microsoft Office 365产品。 与 Microsoft France 合作制造 |
| 公司总部位置 | 法国 |
| 应用信息页 | [https://www.vizir.co](https://www.vizir.co) |
| 用于运行应用的托管环境或服务模型是什么？ | Paas |
| 应用使用哪些托管云提供商？ | OVH、Aws |
...
Vizir.co 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 用户电子邮件、名称、姓氏 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 用户电子邮件、名称、姓氏 |
...
| 隐私策略 URL | https://www.vizir.co/politique-confidentialite/ |
