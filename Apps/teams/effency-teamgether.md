---
title: TeamGether 的应用程序信息（按 EFFENCY）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/12/2021
...
description: TeamGether 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/5a0547cc-ea63-4425-acc8-08b89a8fc1a1" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | EFFENCY |
| 公司的网站 | [https://www.effency.fr](https://www.effency.fr) |
| 应用的使用条款 | [https://www.effency.fr/conditions-generales/](https://www.effency.fr/conditions-generales/) |
| 应用的核心功能 | TeamGether 是由 EFFENCY 开发的集体效率中的领先数字教练应用程序 |
| 公司总部位置 | 法国 |
| 应用信息页 | [https://www.effency.fr/teams/](https://www.effency.fr/teams/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
此信息由 EFFENCY 提供，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
