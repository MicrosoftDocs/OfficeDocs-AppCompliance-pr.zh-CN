...
| 合作伙伴公司名称 | EFFENCY |
| 公司网站 | [https://www.effency.fr](https://www.effency.fr) |
| 应用的使用条款 | [https://www.effency.fr/conditions-generales/](https://www.effency.fr/conditions-generales/) |
| 应用的核心功能 | TeamGether 是 EFFENCY 开发的效率方面领先的数字指导应用程序 |
| 公司总部位置 | 法国 |
| 应用信息页面 | [https://www.effency.fr/teams/](https://www.effency.fr/teams/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
