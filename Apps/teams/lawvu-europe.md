---
title: LawVu Europe by LawVu 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/04/2022
...
description: LawVu Europe 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/ce6fa59d-9c48-492c-b0e2-434abe99c355" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003931" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

LawVu 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | LawVu |
| 公司的网站 | [https://lawvu.com](https://lawvu.com) |
...
| 应用的核心功能 | 业务用户可以直接从Teams提出法律请求。  集成捕获所有相关字段，包括原始邮件中的内容和任何附件，并在 LawVu 中创建此事，使其&#8217;法律团队&#8217;记录系统的一部分。 |
| 公司总部位置 | 新西兰 |
| 应用信息页 | [https://help.lawvu.com/en/articles/5953276-microsoft-teams-...](https://help.lawvu.com/en/articles/5953276-microsoft-teams-integration-coming-soon) |
...
LawVu 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | MS Teams中的附件文件。 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | MS 团队中的附件文件被拉入数据存储。 |
...
| 最新的 SOC1 认证日期 | 2021-02-28 |
| 应用是否符合服务组织控制 (SOC 2) ？ | 是 |
| 你实现了哪个 SOC 2 认证？ | type2 |
| 最新的 SOC2 认证日期 | 2021-02-11 |
...
| 隐私策略 URL | https://lawvu.com/trust-center/privacy/gdpr |
