---
title: Semos Cloud Soultions 提供的 JobPts 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: JobPts 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/601a47bc-f201-4398-a0cb-593ea081f265" target="_blank">Teams存储区中的视图</a>
...
Semos Cloud Soultions 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Semos Cloud Soultions |
| 公司的网站 | [https://semoscloud.com](https://semoscloud.com) |
| 应用的使用条款 | [https://semoscloud.com/terms-of-use/](https://semoscloud.com/terms-of-use/) |
| 应用的核心功能 | 在不离开 MsTeams 的情况下轻松识别同事，以做好工作 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://semoscloud.com/product/jobpts](https://semoscloud.com/product/jobpts) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
Semos Cloud Soultions 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | 读取公司基本信息 | [1ac9e5c6-4850-4864-96c5-b91e4512334e](../azure/1ac9e5c6-4850-4864-96c5-b91e4512334e.md) |
>| 电子邮件 | 委托 | 这用于将 AzureAD 用户与 JobPts 工具中的用户映射 | [1ac9e5c6-4850-4864-96c5-b91e4512334e](../azure/1ac9e5c6-4850-4864-96c5-b91e4512334e.md) |
>| offline_access | 委托 | 维护对数据的访问 | [1ac9e5c6-4850-4864-96c5-b91e4512334e](../azure/1ac9e5c6-4850-4864-96c5-b91e4512334e.md) |
>| openid | 委托 | 使用户能够使用其工作帐户登录 | [1ac9e5c6-4850-4864-96c5-b91e4512334e](../azure/1ac9e5c6-4850-4864-96c5-b91e4512334e.md) |
>| 个人资料 | 委托 | 若要使 JobPts 能够查看用户的基本信息 (用户名)  | [1ac9e5c6-4850-4864-96c5-b91e4512334e](../azure/1ac9e5c6-4850-4864-96c5-b91e4512334e.md) |
