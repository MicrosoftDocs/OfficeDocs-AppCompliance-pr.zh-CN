---
title: Pajat Solutions Oy 的 Poimapper 应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/01/2022
...
description: 适用于 Poimapper 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66655882"
---
# <a name="poimapper"></a>Poimapper

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 6 月 30 日</p>

* <a href="https://teams.microsoft.com/l/app/f2dac71d-b558-496b-be58-b28980e2cfd9" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004353" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Pajat Solutions Oy 提供的信息。 到 Microsoft：
...
| 合作伙伴公司名称 | Pajat Solutions Oy。 |
| 公司的网站 | [https://poimapper.com](https://poimapper.com) |
| 应用的使用条款 | [https://portal.poimapper.com/termofservice.jsp](https://portal.poimapper.com/termofservice.jsp) |
| 应用的核心功能 | Poimapper 会更改组织收集和分析字段数据的方式。 |
| 公司总部位置 | 芬兰 |
| 应用信息页 | |
...
此信息已由 Pajat Solutions Oy 提供。 关于此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
| 隐私策略 URL | https://portal.poimapper.com/privacy.jsp |
