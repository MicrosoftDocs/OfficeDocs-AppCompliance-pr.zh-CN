---
title: Skyline Consulatnts 提供的 EN-UA 字典的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: EN-UA 字典的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66564565"
---
# <a name="en-ua-dictionary"></a>EN-UA 字典

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 5 月 24 日</p>

* <a href="https://teams.microsoft.com/l/app/1a24a3a3-1fda-4f70-abee-40bba8c638e8" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004310" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Skyline Consulatnts 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Skyline Consulatnts |
| 公司的网站 | [https://skylineconsultants.com](https://skylineconsultants.com) |
| 应用的使用条款 | [https://skylineconsultants.com/terms-and-conditions/](https://skylineconsultants.com/terms-and-conditions/) |
| 应用的核心功能 | Skyline 顾问的English-Ukrainian字典应用程序已完全组织，供用户在 Microsoft Teams 中工作时搜索未知字词。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | |
...
Skyline Consulatnts 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
| 数据库中存储了哪些数据？ | 我们的数据库保留信息：用户在应用中停止的位置，并在用户下次进入应用程序时还原该位置。 图形用户 ID |
...
| 如果你的应用不使用上述库之一，它使用什么身份验证库或库？ | Microsoft.Graph;Microsoft.TeamsFx; |
| 应用是否支持条件访问策略？ | 否 |
| 应用是否支持持续访问评估 (CAE)  | 否 |
| 应用是否在代码中存储任何凭据？ | 否 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | 访问用户配置文件 | [2da850e4-5b9d-455c-ae32-bec270de4b60](../azure/2da850e4-5b9d-455c-ae32-bec270de4b60.md) |
