---
title: Bonfyre by Bonfyre 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/07/2022
...
description: Bonfyre 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/829fa155-8058-4b1e-b43a-86efb74da5d4" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004185" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Bonfyre 公司向 Microsoft 提供的信息：
...
| 合作伙伴公司名称 | Bonfyre， Inc |
| 公司的网站 | [https://bonfyreapp.com](https://bonfyreapp.com) |
| 应用的使用条款 | [https://bonfyreapp.com/terms-of-use-teams](https://bonfyreapp.com/terms-of-use-teams) |
| 应用的核心功能 | 将 Bonfyre 参与功能的功能引入员工每天使用的工作渠道。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://bonfyreapp.com/blog/bonfyre-now-integrates-with-mic...](https://bonfyreapp.com/blog/bonfyre-now-integrates-with-microsoft-teams) |
...
Bonfyre 公司提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 用户提交的内容和用户配置文件数据。 |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 用户名、电子邮件地址和个人资料图片。  此信息可能会在客户加入期间预先共享，但我们与用户配置文件同步以使信息保持最新。 |
...
| 隐私策略 URL | https://bonfyreapp.com/privacy-policy-teams |
