...
description: Marvel 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/2e7fb70e-f75d-4e85-997e-90ce89000f43" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | 奇迹 |
| 公司的网站 | [https://marvelapp.com](https://marvelapp.com) |
| 应用的使用条款 | [https://marvelapp.com/terms/](https://marvelapp.com/terms/) |
| 应用的核心功能 | Marvel - Wireframe、Design and Prototyping for everyone |
| 公司总部位置 | 大不列颠及北爱尔兰联合王国 ()  |
| 应用信息页 | [https://marvelapp.com](https://marvelapp.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | GCP |
...
Marvel 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
