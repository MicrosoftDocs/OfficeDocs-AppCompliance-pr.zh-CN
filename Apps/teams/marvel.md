...
| 合作伙伴公司名称 | 奇迹 |
| 公司网站 | [https://marvelapp.com](https://marvelapp.com) |
| 应用的使用条款 | [https://marvelapp.com/terms/](https://marvelapp.com/terms/) |
| 应用的核心功能 | 规划 - 适用于所有人的线框、设计和原型制作 |
| 公司总部位置 | 英国大英和爱尔兰 ()  |
| 应用信息页面 | [https://marvelapp.com](https://marvelapp.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | GCP |
