...
description: Adobe Acrobat 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/10aea93d-20cf-44c2-b4a5-284c5ef2e6a5" target="_blank">Teams存储区中的视图</a>
...
| 公司的网站 | [https://www.adobe.com](https://www.adobe.com) |
| 应用的使用条款 | [https://www.adobe.com/legal/terms.html](https://www.adobe.com/legal/terms.html) |
| 应用的核心功能 | 借助 Adobe Acrobat for Microsoft Teams，PDF 文件格式的创建者可为你提供一种方法，让你与频道中的每个人协作，并在单个 PDF &#8211;中收集反馈，而无需离开Teams环境。 当其他人对文档采取行动时，接收活动通知。 审阅者可以在&#8217;的反馈中相互查看和评论，因此，&#8217;将花费更少的时间来管理冲突 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://helpx.adobe.com/document-cloud/help/microsoft-teams...](https://helpx.adobe.com/document-cloud/help/microsoft-teams.html) |
...
Adobe Systems Inc. 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | UserInfo、OAuth 资源、用户资源、  |
...
| 如果你的应用不使用上述库之一，它使用什么身份验证库或库？ | 不使用任何身份验证库，我们直接使用 OAuth 2.0 协议 |
| 应用是否支持条件访问策略？ | 否 |
| 应用是否支持持续访问评估 (CAE)  | 否 |
| 应用是否在代码中存储任何凭据？ | 否 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | 委托 | 若要能够列出和导航用户最近的、OneDrive和Teams频道的文件和文件夹。 我们允许用户访问这些文件，使用它们对它们执行操作，并将文件保存回其存储。 | [ecff17cf-5629-49ba-a629-7f575496aeac](../azure/ecff17cf-5629-49ba-a629-7f575496aeac.md) |
>| Team.ReadBasic.All | 委托 | 读取团队的名称和说明 | [ecff17cf-5629-49ba-a629-7f575496aeac](../azure/ecff17cf-5629-49ba-a629-7f575496aeac.md) |
>| User.Read | 委托 | 登录并读取用户个人资料 | [ecff17cf-5629-49ba-a629-7f575496aeac](../azure/ecff17cf-5629-49ba-a629-7f575496aeac.md) |
>| 电子邮件 | 委托 | 查看用户的电子邮件地址 | [ecff17cf-5629-49ba-a629-7f575496aeac](../azure/ecff17cf-5629-49ba-a629-7f575496aeac.md) |
>| offline_access | 委托 | 维护对已授予它加入的数据的访问权限 | [ecff17cf-5629-49ba-a629-7f575496aeac](../azure/ecff17cf-5629-49ba-a629-7f575496aeac.md) |
>| openid | 委托 | 让用户登录 | [ecff17cf-5629-49ba-a629-7f575496aeac](../azure/ecff17cf-5629-49ba-a629-7f575496aeac.md) |
>| 个人资料 | 委托 | 查看用户基本配置文件 | [ecff17cf-5629-49ba-a629-7f575496aeac](../azure/ecff17cf-5629-49ba-a629-7f575496aeac.md) |
