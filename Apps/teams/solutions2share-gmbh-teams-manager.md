---
title: Teams Manager by Solutions2Share GmbH 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/27/2021
...
description: Teams管理器的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
<p>开发人员上次更新时间：2021 年 9 月 24 日</p>

* <a href="https://teams.microsoft.com/l/app/87000000-3db9-bb44-5015-0b4a327a6597" target="_blank">Teams存储区中的视图</a>
...
| 公司的网站 | [https://teams-manager.com](https://teams-manager.com) |
| 应用的使用条款 | [https://www.teams-manager.com/terms-of-use/](https://www.teams-manager.com/terms-of-use/) |
| 应用的核心功能 | 基于具有审批工作流的复杂可自定义模板创建新Teams。 Teams管理器可帮助公司控制其Microsoft Teams，并使用治理功能阻止不受控制的增长，同时仍使用户能够创建新的Teams。 |
| 公司总部位置 | 德国 |
| 应用信息页 | [https://teams-manager.com](https://teams-manager.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
Solutions2Share GmbH 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.ReadWrite.All | 两者 | 我们将存储 TenantID 和 TeamId 以映射模板。  | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |
>| Notes.ReadWrite.All | 应用程序 | None | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |
>| User.Read | 委托 | None | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |
>| User.Read.All | 两者 | 我们会保存在审批者/管理员部分中输入的用户的 ID。 | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |
>| User.ReadBasic.All | 委托 | None | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |
