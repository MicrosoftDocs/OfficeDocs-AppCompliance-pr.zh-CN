---
title: Zoho Corporation Private Limited 的 ServiceDesk Plus Cloud 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/10/2022
...
description: ServiceDesk Plus Cloud 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/04fdcea1-3511-499c-966d-099d59aef45f" target="_blank">Teams存储区中的视图</a>
...
| 公司的网站 | [https://www.manageengine.com/products/service-desk](https://www.manageengine.com/products/service-desk) |
| 应用的使用条款 | [https://ondemand.manageengine.com/terms.html](https://ondemand.manageengine.com/terms.html) |
| 应用的核心功能 | ServiceDesk Plus 是一种 SaaS IT 技术支持台管理软件。 借助大量 IT 服务管理功能，它可帮助 IT 管理员在组织内有效地组织技术支持人员操作。 默认情况下，ServiceDesk Plus (云) 适用于Azure AD。 若要开始，请使用Azure AD实例中的帐户注册 ServiceDesk Plus (Cloud) 。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://help.sdpondemand.com/servicedeskplus_cloud_for_teams](https://help.sdpondemand.com/servicedeskplus_cloud_for_teams) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | 登录并读取用户个人资料 | [127e5be9-da2c-4335-a284-da367379428a](/microsoft-365-app-certification/azure/39cb9f28-b9d0-4bf7-a4f4-d9e38508a0db) |
>| offline_access | 委托 | 保留对已授予其访问权限的数据的访问权限 | [127e5be9-da2c-4335-a284-da367379428a](/microsoft-365-app-certification/azure/39cb9f28-b9d0-4bf7-a4f4-d9e38508a0db) |
