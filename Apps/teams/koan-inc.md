---
title: Koan by Koan 的应用程序信息， Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/18/2021
...
description: 适用于 Koan 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/dae2b2c3-b014-4188-a887-c87c3ca4a227" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | Koan, Inc. |
| 公司的网站 | [https://www.koan.co](https://www.koan.co) |
| 应用的使用条款 | [https://www.koan.co/terms-of-service](https://www.koan.co/terms-of-service) |
| 应用的核心功能 | 将目标管理和状态跟踪直接引入Microsoft Teams以查看进度并使团队保持一致。 Koan&#8217;的集成使员工能够专注于最重要的工作，而无需离开Microsoft Teams。 轻松养成积极的团队习惯，即分享状态、识别胜利和及早识别关注点，为身边的其他人提高标准。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://www.koan.co/how-it-works](https://www.koan.co/how-it-works) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
Koan， Inc. 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 委托 | 使用通道 ID 和通道名称。 我们使用这些数据，以便用户可以选择要在何处传递反射通知。 | [5b599e19-a609-432b-9074-c9d4457e8766](../azure/5b599e19-a609-432b-9074-c9d4457e8766.md) |
>| Team.ReadBasic.All | 两者 | 收集和使用团队 ID 和团队名称。 我们使用这些数据，以便用户可以选择要在何处传递反射通知。 | [5b599e19-a609-432b-9074-c9d4457e8766](../azure/5b599e19-a609-432b-9074-c9d4457e8766.md) |
>| User.Read | 委托 | 使用用户名、用户 ID、用户电子邮件地址。 我们使用这些数据在 Microsoft Teams 和 Koan 之间链接用户帐户。 它仅适用于提及。 | [5b599e19-a609-432b-9074-c9d4457e8766](../azure/5b599e19-a609-432b-9074-c9d4457e8766.md) |
