---
title: 适用于完美 Wiki 的应用程序信息（由 OOO RD17 提供）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
description: 适用于 Perfect Wiki 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/40906836-4323-4bbe-875e-3cbb134c40a2" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | OOO RD17 |
| 公司的网站 | [https://perfectwikiforteams.com](https://perfectwikiforteams.com) |
...
| 应用的核心功能 | 功能 Rich Wiki for Microsoft Teams |
| 公司总部位置 | 俄罗斯联邦 ()  |
| 应用信息页 | [https://perfectwikiforteams.com](https://perfectwikiforteams.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
OOO RD17 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 委托 | ChannelId 和 channelName，我们获取信息以在应用中显示用户 | [b9604964-9c3a-483e-abf2-1b5cba495081](../azure/b9604964-9c3a-483e-abf2-1b5cba495081.md) |
>| Team.ReadBasic.All | 委托 | 我们获取用户的 teamId 并获取团队名称 | [b9604964-9c3a-483e-abf2-1b5cba495081](../azure/b9604964-9c3a-483e-abf2-1b5cba495081.md) |
>| User.Read | 委托 | userId，用于了解登录的用户 | [b9604964-9c3a-483e-abf2-1b5cba495081](../azure/b9604964-9c3a-483e-abf2-1b5cba495081.md) |
