...
description: UKG Pro的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/f2120944-5201-4c71-8314-770f7806fff0" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | UKG, Inc. |
| 公司的网站 | [https://ukg.com](https://ukg.com) |
| 应用的使用条款 | [https://ukg.com](https://ukg.com) |
| 应用的核心功能 | 轻松访问员工信息、查看薪酬详细信息，并按需完成其他人力资源操作。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://ukg.com](https://ukg.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
UKG， Inc. 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
