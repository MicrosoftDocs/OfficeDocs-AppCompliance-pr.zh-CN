---
title: FinTech Studio 的 FinTech Studio 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/13/2022
...
description: FinTech Studio 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "64974367"
---
# <a name="fintech-studios"></a>FinTech Studios

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 3 月 1 日</p>

* <a href="https://teams.microsoft.com/l/app/65e85032-940c-4d03-ad03-029fe9fff997" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003969" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

FinTech Studio 提供给 Microsoft 的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | FinTech Studios |
| ID | WA200003969 |
| 支持Office 365客户端 | Microsoft Teams |
| 合作伙伴公司名称 | FinTech Studios |
| 公司的网站 | [https://www.fintechstudios.com](https://www.fintechstudios.com) |
| 应用的使用条款 | [https://www.fintechstudios.com/eula](https://www.fintechstudios.com/eula) |
| 应用的核心功能 | AI 驱动的商业智能 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://www.fintechstudios.com/products](https://www.fintechstudios.com/products) |
...
FinTech Studio 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 用户配置文件数据、团队名称/id、频道名称/ids (无消息数据) 、聊天名称/ID (无消息数据)  |
| 应用是否支持 TLS 1.1 或更高版本？ | 是 |
| 应用或基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 用户配置文件数据 (名称、电子邮件、Microsoft Graph访问 + 刷新令牌)  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 委托 | 提示用户在应用程序中从任务模块共享内容的通道 | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| ChannelMessage.Send | 委托 | 从应用程序中的任务模块将共享内容发送到频道 | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| Chat.ReadBasic | 委托 | 提示用户进行聊天以从应用程序中的任务模块共享内容 | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| ChatMessage.Send | 委托 | 从应用程序中的任务模块向聊天发送共享内容 | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| Team.ReadBasic.All | 委托 | 必须让用户可以访问的团队能够访问可供用户使用的频道 | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| User.Read | 委托 | 获取有关用户的标识和通信信息 | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
