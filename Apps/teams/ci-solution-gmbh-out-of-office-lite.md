---
title: CI-out-out-Office Lite by ci solution GmbH 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/24/2021
...
description: CI-Out-out-Office Lite 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/e76af3f9-8fb6-4018-84c0-d5444ad72b4c" target="_blank">Teams存储区中的视图</a>
...
ci solution GmbH 提供给 Microsoft 的信息：
...
| 公司的网站 | [https://www.ci-solution.com](https://www.ci-solution.com) |
| 应用的使用条款 | [https://www.ci-solution.com/agb](https://www.ci-solution.com/agb) |
| 应用的核心功能 | 使用 CI-out-Office Lite，可以在整个公司中标准化和集中控制缺勤通知。 通过此屡获殊荣的应用程序 (包括行业奖、创新奖 IT) 可以确保在Microsoft 365内为公司提供符合专业、统一和企业标识的外出管理。 |
| 公司总部位置 | 德国 |
| 应用信息页 | [https://www.ci-solution.com/support/en/ci-oof-lite/](https://www.ci-solution.com/support/en/ci-oof-lite/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
ci 解决方案 GmbH 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| 电子邮件 | 委托 | 查看用户的电子邮件地址 | [fc1e4e41-1e20-49ba-88aa-5f26fa8bc4da](../azure/fc1e4e41-1e20-49ba-88aa-5f26fa8bc4da.md) |
