---
title: Bonusly by Bonusly 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/17/2022
...
description: Bonusly 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "65454992"
---
# <a name="bonusly"></a>Bonusly

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 5 月 16 日</p>

* <a href="https://teams.microsoft.com/l/app/c06753b3-85de-4054-9a99-dcd869dc0836" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | Bonusly |
| 公司的网站 | [https://bonus.ly](https://bonus.ly) |
| 应用的使用条款 | [https://bonus.ly/terms_of_service](https://bonus.ly/terms_of_service) |
| 应用的核心功能 | Spark 通过将 Bonusly 与 Microsoft Teams 集成来频繁、及时地识别 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://bonus.ly/integrations/teams](https://bonus.ly/integrations/teams) |
...
Bonusly 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础结构是否处理与 Microsoft 客户或其设备相关的任何数据？ | 是 |
| 应用会处理哪些数据？ | 电子邮件地址，名字，姓氏，出生日期 (如果功能使用) ，雇用日期 (，如果功能使用)  |
...
| 隐私策略 URL | https://bonus.ly/privacy_policy |
