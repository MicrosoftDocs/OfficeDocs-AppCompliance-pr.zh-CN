---
title: Grafana Labs 的 Grafana OnCall 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: Grafana OnCall 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/ed13a4a6-7d9c-4904-913c-402dbca12d1e" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004307" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Grafana 实验室提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Grafana 实验室 |
| 公司的网站 | [https://grafana.com](https://grafana.com) |
| 应用的使用条款 | [https://grafana.com/legal/terms/](https://grafana.com/legal/terms/) |
| 应用的核心功能 | 执行呼叫管理的最简单方法 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | |
...
Grafana Labs 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
| 隐私策略 URL | https://grafana.com/legal/terms |
