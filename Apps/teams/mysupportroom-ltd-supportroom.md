---
title: 由 MYSUPPORTROOM LTD 提供的 SupportRoom 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/16/2022
...
description: SupportRoom 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/c7004e7c-aa85-4e3e-9b00-47cf3adac85a" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004238" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

MYSUPPORTROOM LTD 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | MYSUPPORTROOM LTD |
| 公司的网站 | [https://mysupportroom.com](https://mysupportroom.com) |
| 应用的使用条款 | [https://mysupportroom.com/terms-and-conditions/](https://mysupportroom.com/terms-and-conditions/) |
| 应用的核心功能 | 为员工提供一体式心理健康支持和见解 |
...
MYSUPPORTROOM LTD 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
