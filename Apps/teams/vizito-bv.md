---
title: Vizito by Vizito BV 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/25/2021
...
description: Vizito 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/b6e2ef19-7612-4ab7-a700-9669d49b88b9" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | Vizito BV |
| 公司的网站 | [https://www.vizito.be](https://www.vizito.be) |
| 应用的使用条款 | [https://www.vizito.be/terms-conditions](https://www.vizito.be/terms-conditions) |
| 应用的核心功能 | 使用Teams通知注册访客的 SaaS 访问者。 |
| 公司总部位置 | 比利时 |
| 应用信息页 | [https://www.vizito.be](https://www.vizito.be) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
Vizito BV 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 两者 | 若要提取和存储租户 ID，以便我们知道为哪个租户安装了Teams机器人。 | [b6e2ef19-7612-4ab7-a700-9669d49b88b9](../azure/b6e2ef19-7612-4ab7-a700-9669d49b88b9.md) |
