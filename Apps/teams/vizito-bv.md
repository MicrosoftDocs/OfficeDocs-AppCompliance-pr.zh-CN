...
| 公司总部位置 | 比利时 |
| 应用信息页面 | [https://www.vizito.be](https://www.vizito.be) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 两者 | 获取和存储租户 ID，以便我们知道为哪个租户安装了Teams自动程序。 | [b6e2ef19-7612-4ab7-a700-9669d49b88b9](../azure/b6e2ef19-7612-4ab7-a700-9669d49b88b9.md) |
