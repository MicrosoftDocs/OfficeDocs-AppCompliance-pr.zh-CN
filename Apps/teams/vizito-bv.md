...
>|:----------------|:------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|:--------------------|
>| User.Read | 两者 | 获取和存储租户 ID，以便我们知道为哪个租户安装了Teams自动程序。 | 租户 ID、用户 UPN、用户 ID、在访问者登录后向用户发送主动邮件的用户名。 | [b6e2ef19-7612-4ab7-a700-9669d49b88b9](https://docs.microsoft.com/microsoft-365-app-certification/azure/b6e2ef19-7612-4ab7-a700-9669d49b88b9) |
...
>|:--------|:-----------------------|:----------------------------|:--------------------------------------|:-------------------|:-----------------------------------|
>| Teams用户登录时向用户发送主动消息的自动程序 API。 | 否 |  |  |  |  |
