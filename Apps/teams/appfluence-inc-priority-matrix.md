...
description: 优先级矩阵的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/5be2b320-a5b7-4221-893c-dee506e4e365" target="_blank">在 Teams 应用商店中查看</a>
...
| Teams 应用程序信息页的 URL | [https://appfluence.com/project-management-integration-for-m...](https://appfluence.com/project-management-integration-for-microsoft-teams/) |
...
>| offline_access | delegated | 我们存储登录令牌是为了代表用户执行请求 | 刷新令牌，无需打扰用户。  (Teams 服务优先级)  | 5be2b320-a5b7-4221-893c-dee506e4e365 |
>| Files.Read.All | delegated | 我们不会存储任何文件信息，除非用户明确且有意创建链接到原始文件的优先级矩阵项。 | 在我们的一对一功能 (（通过 Web 应用和 Outlook/Teams 外接程序) 提供）中，我们使用此功能突出显示在系统中两个用户之间共享的 SharePoint/OneDrive 文件，以便促进会议和总体协作。 | affadfb6-f17b-428f-97f9-9aae3b6175bc |
...
>| Mail.Read | delegated | 我们将系统中创建的任务与原始邮件的链接一起存储。 | 在我们的 Outlook 外接程序中用于将电子邮件转换为任务，以及以 1：1 视图显示共享工作。 | d76f016f-52c7-41b5-835b-900361d7040c |
>| Tasks.Read | delegated | 我们的系统中复制了一些 Outlook/Planner 任务，以帮助新用户。 | 我们使用其 Graph 任务启动新的用户帐户。 | d76f016f-52c7-41b5-835b-900361d7040c |
...
>是的，我们将用户的电子邮件用作他们在系统中的唯一 ID，用于跟踪应用程序错误，并跟踪系统 (下载、登录、应用程序版本等) 以便我们的客户服务团队可以为客户提供查询的提示响应。 作为 GDPR 合规性的一部分，我们将在删除请求的 2 周内删除所有客户数据，尽管实际上我们在同一天这样做，因为我们有内部脚本以半自动方式完成此操作。
