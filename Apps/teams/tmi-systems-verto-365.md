---
title: Verto 365 by TMI Systems 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/14/2021
...
description: Verto 365 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/b27c082b-9d45-490a-b8bb-8dcda46c73f3" target="_blank">Teams存储区中的视图</a>
...
| 合作伙伴公司名称 | TMI 系统 |
| 公司的网站 | [https://www.vertocloud.co.uk](https://www.vertocloud.co.uk) |
| 应用的使用条款 | [https://vertocloud.co.uk/terms-and-conditions/](https://vertocloud.co.uk/terms-and-conditions/) |
| 应用的核心功能 | Verto365 使Microsoft Teams成为完整的项目管理工具 |
| 公司总部位置 | 大不列颠及北爱尔兰联合王国 ()  |
| 应用信息页 | [https://www.vertocloud.com](https://www.vertocloud.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
TMI Systems 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | 一般用户信息，名字，姓氏 &amp; 电子邮件。 用于创建帐户。 | [d8843264-a57b-41e3-aea6-b83ea56f6bd6](../azure/d8843264-a57b-41e3-aea6-b83ea56f6bd6.md) |
>| 电子邮件 | 委托 | 一般用户信息，名字，姓氏 &amp; 电子邮件。 用于创建帐户。 | [d8843264-a57b-41e3-aea6-b83ea56f6bd6](../azure/d8843264-a57b-41e3-aea6-b83ea56f6bd6.md) |
>| offline_access | 委托 | 用于获取刷新令牌和保留登录名 | [d8843264-a57b-41e3-aea6-b83ea56f6bd6](../azure/d8843264-a57b-41e3-aea6-b83ea56f6bd6.md) |
>| openid | 委托 | 一般用户信息，名字，姓氏 &amp; 电子邮件。 用于创建帐户。 | [d8843264-a57b-41e3-aea6-b83ea56f6bd6](../azure/d8843264-a57b-41e3-aea6-b83ea56f6bd6.md) |
>| 个人资料 | 委托 | 一般用户信息，名字，姓氏 &amp; 电子邮件。 用于创建帐户。 | [d8843264-a57b-41e3-aea6-b83ea56f6bd6](../azure/d8843264-a57b-41e3-aea6-b83ea56f6bd6.md) |
