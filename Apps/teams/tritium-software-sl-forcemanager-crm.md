...
| 公司网站 | [https://www.forcemanager.com](https://www.forcemanager.com) |
| 应用的使用条款 | [https://www.forcemanager.com/info/terms-and-conditions/](https://www.forcemanager.com/info/terms-and-conditions/) |
| 应用的核心功能 | ForceManager 是一家领先的 CRM，其完整服务 Web 和移动应用针对一系列工作样式（包括家庭、办公室或现场）创建。 该应用面向需要通过用户友好界面和易于使用的应用管理其日常议程和活动的销售代表。 |
| 公司总部位置 | 西班牙 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
