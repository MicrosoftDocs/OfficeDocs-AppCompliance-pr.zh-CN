---
title: 用于 ForceManager CRM by Tritium Software SL 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/27/2021
...
description: ForceManager CRM 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/f429eb71-607a-4e12-9467-209276404047" target="_blank">Teams存储区中的视图</a>
...
| 公司的网站 | [https://www.forcemanager.com](https://www.forcemanager.com) |
| 应用的使用条款 | [https://www.forcemanager.com/info/terms-and-conditions/](https://www.forcemanager.com/info/terms-and-conditions/) |
| 应用的核心功能 | ForceManager 是领先的 CRM，为一系列工作样式（包括家庭、办公室或字段）创建了完整的服务 Web 和移动应用。 该应用面向需要使用用户友好界面和易于使用的应用管理其日常议程和活动的销售代表。 |
| 公司总部位置 | 西班牙 |
| 应用信息页 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
Tritium Software SL 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
