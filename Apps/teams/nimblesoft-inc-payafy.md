---
title: NimbleSoft Inc. 针对 PayaFy 的应用程序信息
ms.author: elmalova
author: elenamalova
ms.date: 10/28/2021
ms.topic: article
...
description: PayaFy 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/b6ecb389-d613-4d48-8e4b-90b3cc649fc0" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003397" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

NimbleSoft Inc. 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | NimbleSoft Inc. |
| 公司网站 | [https://payafy.com](https://payafy.com) |
| 应用的使用条款 | [https://payafy.com/termsofservice](https://payafy.com/termsofservice) |
| 应用的核心功能 | PayaFy 使企业能够接受付款。 你可以链接现有的带区帐户或注册一个新帐户。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
...
此信息由 NimbleSoft Inc. 提供，用于了解此应用如何收集和存储组织数据，以及您的组织将拥有对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.ReadWrite.All | 两者 | 它将读取用于用户注册的基本信息。 | [1e96a64b-9c1c-4cbc-b015-70243ea06c9b](https://docs.microsoft.com/microsoft-365-app-certification/azure/1e96a64b-9c1c-4cbc-b015-70243ea06c9b) |
