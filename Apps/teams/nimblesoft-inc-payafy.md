---
title: NimbleSoft Inc. 的 PayaFy 应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/28/2021
...
description: PayaFy 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/b6ecb389-d613-4d48-8e4b-90b3cc649fc0" target="_blank">Teams存储区中的视图</a>
...
| 公司的网站 | [https://payafy.com](https://payafy.com) |
| 应用的使用条款 | [https://payafy.com/termsofservice](https://payafy.com/termsofservice) |
| 应用的核心功能 | PayaFy 使企业能够接受付款。 可以链接现有 Stripe 帐户或注册新帐户。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://payafy.com](https://payafy.com) |
...
NimbleSoft Inc. 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
