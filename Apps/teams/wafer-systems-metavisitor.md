---
title: 由用户系统显示 MetaVisitor 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/23/2021
...
description: MetaVisitor 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/372038ea-2ebb-4da0-836e-ae31318fa8c9" target="_blank">在应用商店Teams视图</a>
