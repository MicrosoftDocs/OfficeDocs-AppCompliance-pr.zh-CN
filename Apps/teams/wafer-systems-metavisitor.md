---
title: MetaVisitor by Wafer Systems 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/23/2021
...
description: MetaVisitor 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/372038ea-2ebb-4da0-836e-ae31318fa8c9" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003588" target="_blank">在 AppSource 中查看</a>
