...
description: 通讯组列表的所有可用安全性和合规性信息Pro、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
>| Presence.Read.All | delegated | 在列表中显示人员状态 |
>| Group.Read.All | delegated | 列出通讯组列表 |
