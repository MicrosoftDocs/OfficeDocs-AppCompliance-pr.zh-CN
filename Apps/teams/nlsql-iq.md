...
description: 适用于 IQ 的所有可用安全性和符合性信息、其数据处理策略、Microsoft Cloud App Security 应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/9d0bdc38-2705-4109-835f-3c14534f923f" target="_blank">在 Teams 应用商店中查看</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004126" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

NLSQL 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | NLSQL |
| 公司的网站 | [https://nlsql.com](https://nlsql.com) |
| 应用的使用条款 | [https://www.nlsql.com/terms_of_use](https://www.nlsql.com/terms_of_use) |
| 应用的核心功能 | IQ 支持经理生成面试问题来提问，并支持候选人为面试做准备。 面试问题准备是人工智能软件，根据位置输入生成随机问题，从而完美地了解如何为面试做好充分准备。 考生可以随意生成面试问题，以便更好地准备。 |
| 公司总部位置 | 大不列颠及北爱尔兰联合王国 ()  |
| 应用信息页 | [https://www.nlsql.com/blog/post/interview-questions-to-ask-...](https://www.nlsql.com/blog/post/interview-questions-to-ask-candidates-and-managers/) |
...
NLSQL 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | 登录并读取用户个人资料 | [f9555238-64f3-4ec2-a8fc-3787baa157aa](../azure/f9555238-64f3-4ec2-a8fc-3787baa157aa.md) |
