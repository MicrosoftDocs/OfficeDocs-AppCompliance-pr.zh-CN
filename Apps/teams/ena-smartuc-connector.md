...
* <a href="https://teams.microsoft.com/l/app/029cfd5a-4413-499d-bda6-a2a0a3f5e70e" target="_blank">在应用商店Teams视图</a>
...
| 合作伙伴公司名称 | ENA |
| 公司网站 | [https://www.ena.com](https://www.ena.com) |
| 应用的使用条款 | [https://www.ena.com/legal/aup/](https://www.ena.com/legal/aup/) |
| 应用的核心功能 | 该应用将 ENA SmartUC 产品集连接到 Teams App，从而允许最终用户从 Teams 内拨打 ENA SmartUC 支持的电话。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ | 混合 |
| 应用使用哪些托管云提供商？ | 其他，由 Meta 开关运营的服务部分托管在 Azure 中。 你还应该包括你自己的基础结构如何 (，例如 EAS 服务器) 托管。 |
...
ENA 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及组织将拥有对应用收集的数据的控制有关。
