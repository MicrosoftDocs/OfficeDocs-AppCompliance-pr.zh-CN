...
description: 评估的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/4f037969-20ef-4a41-8330-422b7b115eb6" target="_blank">Teams存储区中的视图</a>
...
| 公司的网站 | [https://www.appraisd.com](https://www.appraisd.com) |
| 应用的使用条款 | [https://www.appraisd.com/terms](https://www.appraisd.com/terms) |
| 应用的核心功能 | 使用性能评审、目标和反馈增强性能文化 |
| 公司总部位置 | 大不列颠及北爱尔兰联合王国 ()  |
| 应用信息页 | [https://www.appraisd.com](https://www.appraisd.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
Appraisd ltd. 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| People.Read | 委托 | 人员选取器向用户显示其团队成员的列表。 这是为了支持 Appraisd 中的核心功能。 | [4f037969-20ef-4a41-8330-422b7b115eb6](../azure/4f037969-20ef-4a41-8330-422b7b115eb6.md) |
>| User.Read | 委托 | 用户的电子邮件地址 (更新) 和用户 ID 用于查找 Appraisd 中的用户并将其链接到其Teams帐户。 | [4f037969-20ef-4a41-8330-422b7b115eb6](../azure/4f037969-20ef-4a41-8330-422b7b115eb6.md) |
>| User.ReadBasic.All | 委托 | 人员选取器向用户提供有关其团队成员的基本信息。 这是为了支持 Appraisd 中的核心功能。 | [4f037969-20ef-4a41-8330-422b7b115eb6](../azure/4f037969-20ef-4a41-8330-422b7b115eb6.md) |
