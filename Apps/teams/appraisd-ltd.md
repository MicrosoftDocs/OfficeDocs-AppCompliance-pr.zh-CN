...
| Teams信息页的 URL | [https://www.appraisd.com](https://www.appraisd.com) |
...
>| User.Read | delegated | 使用用户的电子邮件地址 (upn) 和用户 ID，以在 Appraisd 中查找用户，并链接至Teams帐户。 | 用户的电子邮件地址 (更新) 和用户 ID，以便记住用户的 Appraisd 和 Teams 帐户之间的链接。 | [4f037969-20ef-4a41-8330-422b7b115eb6](https://docs.microsoft.com/microsoft-365-app-certification/azure/4f037969-20ef-4a41-8330-422b7b115eb6) |
