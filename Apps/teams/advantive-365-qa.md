---
title: 365-QA by Advantive 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/03/2022
...
description: 365-QA 的所有可用安全性和符合性信息、其数据处理策略、Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "64881019"
---
# <a name="365-qa"></a>365-QA

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 12 月 28 日</p>

* <a href="https://teams.microsoft.com/l/app/03e51569-33a8-4000-abb6-9a825e33ece2" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001394" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Advantive 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Advantive |
| 公司的网站 | [https://www.advantive.be](https://www.advantive.be) |
| 应用的使用条款 | [https://www.advantive.be/terms-of-service-en/](https://www.advantive.be/terms-of-service-en/) |
| 应用的核心功能 | Advantive 是一个热情的 ICT 专业人员团队，他们使用 Microsoft 技术开发和实施创新的 ICT 解决方案。 我们提供基于标准 Microsoft 功能的优质建议、产品和服务。 这使基督降临&#8217;的客户能够提高效率并利用快速变化的环境。 我们的核心业务是提供包括建议、开发、实施、项目支持和维护的服务。 |
| 公司总部位置 | 比利时 |
| 应用信息页 | [https://www.advantive.be/365-qa-how-to/](https://www.advantive.be/365-qa-how-to/) |
...
Advantive 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
