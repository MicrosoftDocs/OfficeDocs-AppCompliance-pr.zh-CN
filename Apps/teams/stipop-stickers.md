---
title: Stipop 的 Stipop 贴纸的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: 有关 Stipop 贴纸、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息的所有可用安全性和合规性信息。
...
ms.locfileid: "63773674"
---
# <a name="stipop-stickers"></a>Stipop 贴纸

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 3 月 23 日</p>

* <a href="https://teams.microsoft.com/l/app/31c1aadf-4a2e-4465-b1a4-6d4d7d9a284c" target="_blank">在应用商店Teams视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002606" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Stipop 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Stipop |
| 公司网站 | [https://stipop.io](https://stipop.io) |
| 应用的使用条款 | [https://stipop.io/policies/terms](https://stipop.io/policies/terms) |
| 应用的核心功能 | 使用 Stipop 贴纸建立团队风格。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
...
Stipop 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及您的组织将拥有对应用收集的数据的控制有关。
...
| 数据库中存储了哪些数据？ | &#49324;&#50857;&#51088; &#50500;&#51060;&#46356;、 &#49324;&#50857;&#51088; &#51060;&#47492;、 &#44160;&#49353;&#50612;、 &#50616;&#50612;、 &#44397;&#44032; |
| 如果基础结构处理或存储 Microsoft 客户数据，那么此数据在地理位置上存储在哪里？ | 韩国 (韩国)  |
| 你是否已制定数据租用和处置流程？ | 是 |
| 帐户终止后，数据将保留多久？ | 不保留 |
| 您是否已建立数据访问管理流程？ | 是 |
