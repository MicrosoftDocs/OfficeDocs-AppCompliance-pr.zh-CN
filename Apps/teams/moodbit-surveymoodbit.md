---
title: SurveyMoodbit by Moodbit 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/04/2022
...
description: SurveyMoodbit 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://teams.microsoft.com/l/app/86425243-0129-41f7-bf74-971bee7ff3d3" target="_blank">Teams存储区中的视图</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003925" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Moodbit 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Moodbit |
| 公司的网站 | [https://mymoodbit.com](https://mymoodbit.com) |
| 应用的使用条款 | [https://mymoodbit.com/terms](https://mymoodbit.com/terms) |
| 应用的核心功能 | 快速获取反馈&amp;可直接在Microsoft Teams中利用人员分析 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://mymoodbit.com](https://mymoodbit.com) |
...
Moodbit 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
| 隐私策略 URL | https://mymoodbit.com/terms |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | 若要从用户处获取信息，以便在 UI 的应用上显示信息并提供个性化的 UX | [bed944b9-c7f5-459a-b7af-53c421248893](../azure/bed944b9-c7f5-459a-b7af-53c421248893.md) |
>| 电子邮件 | 委托 | Msal Auth | [bed944b9-c7f5-459a-b7af-53c421248893](../azure/bed944b9-c7f5-459a-b7af-53c421248893.md) |
>| openid | 委托 | Msal Auth | [bed944b9-c7f5-459a-b7af-53c421248893](../azure/bed944b9-c7f5-459a-b7af-53c421248893.md) |
>| 个人资料 | 委托 | Msal Auth | [bed944b9-c7f5-459a-b7af-53c421248893](../azure/bed944b9-c7f5-459a-b7af-53c421248893.md) |
