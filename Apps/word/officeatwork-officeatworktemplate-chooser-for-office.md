---
title: 用于按 officeatwork Office的模板选择器的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/25/2022
...
description: officeatwork 的所有可用安全性和符合性信息|用于Office的模板选择器、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "65227966"
---
# <a name="application-information-for-officeatwork--template-chooser-for-office"></a>officeatwork | 的应用程序信息用于Office的模板选择器
...
| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | officeatwork - 适用于Office的模板选择器 |
| ID | WA104380050 |
| 支持Office 365客户端 | Excel iPad、Excel 2016 或更高版本的 Mac、Excel 2013 或更高版本上Windows、Excel web 版、IPad 上的 Word、Word 2016或更高版本的 Mac、Word web 版、Word 2013 或更高版本Windows，iPad、PowerPoint 2016或更高版本在 Mac、PowerPoint web 版、PowerPoint 2013 年或更高版本Windows、2016 Project或更高版本上PowerPointWindows |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | 委托 | 启用收藏夹和OneDrive功能 | [dae2eacf-3eb5-4440-baff-984fbd5cae68](../azure/dae2eacf-3eb5-4440-baff-984fbd5cae68.md) |
>| Group.ReadWrite.All | 委托 | 启用Teams功能 | [dae2eacf-3eb5-4440-baff-984fbd5cae68](../azure/dae2eacf-3eb5-4440-baff-984fbd5cae68.md) |
>| GroupMember.Read.All | 委托 | 启用Teams功能 | [dae2eacf-3eb5-4440-baff-984fbd5cae68](../azure/dae2eacf-3eb5-4440-baff-984fbd5cae68.md) |
>| Sites.Read.All | 委托 | 读取存储在SharePoint中的用户模板文件 | [dae2eacf-3eb5-4440-baff-984fbd5cae68](../azure/dae2eacf-3eb5-4440-baff-984fbd5cae68.md) |
...
>| offline_access | 委托 | 为较旧的Office主机启用自动登录 | [dae2eacf-3eb5-4440-baff-984fbd5cae68](../azure/dae2eacf-3eb5-4440-baff-984fbd5cae68.md) |
