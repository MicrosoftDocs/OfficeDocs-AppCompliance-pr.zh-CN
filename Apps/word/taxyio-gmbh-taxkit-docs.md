---
title: 由 GmbH 分类的 TaxKit 文档 Taxy.io 信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
| 公司网站 | [https://www.taxy.io](https://www.taxy.io) |
| 应用的使用条款 | [https://go.microsoft.com](https://go.microsoft.com) |
| 应用的核心功能 | TaxKit 文档可帮助税务顾问查找文档的相关法律资料，以及他们正在处理的情况。 这有助于他们更有效地为客户提供建议。 |
| 公司总部位置 | 德国 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
