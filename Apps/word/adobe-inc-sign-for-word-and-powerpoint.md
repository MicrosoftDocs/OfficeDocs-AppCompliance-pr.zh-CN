...
| ID | WA104381155 |
| Office 365支持的客户端 | Word 2016 Mac、Word web 版、Word 2013 Service Pack 1 或更高版本（位于 Windows 上）或更高版本、PowerPoint 2016 或更高版本、PowerPoint web 版、PowerPoint 2013 Service Pack 1 或更高版本Windows |
| 合作伙伴公司名称 | Adobe Inc. |
...
| 应用的核心功能 | 在添加 Adobe Sign for Office 时，文档签名工作流保持快速Office。 现在，在 Office 应用（如 Word 和 PowerPoint）中，你可以签署文档、发送文档进行合法绑定电子签名和&#8212;使用 Microsoft 首选电子签名解决方案。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
