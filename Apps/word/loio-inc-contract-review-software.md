---
title: Loio Inc. 的 Loio 合同评审软件的应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Loio Contract Review Software 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "64875239"
---
# <a name="loio-contract-review-software"></a>Loio 合同评审软件
...
| 合作伙伴公司名称 | Loio Inc. |
| 公司的网站 | [https://loio.com](https://loio.com) |
| 应用的使用条款 | [https://loio.com/terms-of-use/](https://loio.com/terms-of-use/) |
| 应用的核心功能 | 使用 Loio 合同助手更快、更准确地查看 &amp; 分析合同。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://loio.com](https://loio.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
Loio Inc. 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
