---
title: Loio Inc. 的 Loio 合同审阅软件的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Loio 合同审阅软件的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "63550461"
---
# <a name="loio-contract-review-software"></a>Loio 合同审阅软件
...
| 合作伙伴公司名称 | Loio Inc. |
| 公司网站 | [https://loio.com](https://loio.com) |
| 应用的使用条款 | [https://loio.com/terms-of-use/](https://loio.com/terms-of-use/) |
| 应用的核心功能 | 使用 &amp; Loio 合同助理更快、更准确地查看合同分析。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://loio.com](https://loio.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
