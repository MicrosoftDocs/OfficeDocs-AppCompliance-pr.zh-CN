---
title: 适用于 Jus2vec by N2VEC TECNOLOGIA 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/18/2022
...
description: Jus2vec 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "64906405"
---
# <a name="jus2vec"></a>Jus2vec

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 4 月 18 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002506" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

N2VEC TECNOLOGIA 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | N2VEC TECNOLOGIA |
| 公司的网站 | [https://info.jus2vec.com](https://info.jus2vec.com) |
| 应用的使用条款 | [https://info.jus2vec.com/termos-de-uso.html](https://info.jus2vec.com/termos-de-uso.html) |
| 应用的核心功能 | 布斯卡 por Jurisprud&#234;ncias usando Intelig&#234;ncia Artificial |
| 公司总部位置 | 巴西 |
| 应用信息页 | |
...
N2VEC TECNOLOGIA 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
