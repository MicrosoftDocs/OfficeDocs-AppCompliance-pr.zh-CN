---
title: Mendeley Cite by ELSEVIER LIMITED 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: Mendeley Cite 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66249947"
---
# <a name="mendeley-cite"></a>门德利·西特

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 6 月 27 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA104382081" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

ELSEVIER LIMITED 提供给 Microsoft 的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | 门德利·西特 |
| ID | WA104382081 |
| 支持Office 365客户端 | iPad 上的 Word、Word 2016或更高版本的 Windows、Word 2016或更高版本的 Mac、Web 上的 Word |
| 合作伙伴公司名称 | ELSEVIER LIMITED |
| 公司的网站 | [https://www.mendeley.com/search/](https://www.mendeley.com/search/) |
| 应用的使用条款 | [https://www.mendeley.com/terms/](https://www.mendeley.com/terms/) |
| 应用的核心功能 | 写入时引用。 生成引文和书目并更改引文样式。 |
| 公司总部位置 | 大不列颠及北爱尔兰联合王国 ()  |
| 应用信息页 | [https://www.mendeley.com/guides/mendeley-cite/](https://www.mendeley.com/guides/mendeley-cite/) |
...
ELSEVIER LIMITED 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
| 隐私策略 URL | https://privacy.elsevier.com |
