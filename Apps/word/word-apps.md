---
title: Microsoft Word Apps 安全性和符合性 - 所有应用
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
Microsoft 与我们的 Microsoft 365 开发人员合作伙伴合作，提供组织加速和告知有关 Microsoft Word Apps 及其使用的加载项的决策所需的信息。 这些有关安全性、数据处理和合规性的信息旨在帮助组织评估和管理使用这些应用时的风险。
...
| [子句簿](./leasepilot-clausebook.md) | LeasePilot | **✓** |  |
...
| [Fabasoft Cloud Office 加载项](./fabasoft-austria-gmbh-cloud-office-add-in.md) | Fabasoft Austria GmbH | **✓** |  |
| [FD Mxmn - 导入业务数据](./maximon-ltd-fd-mxmn-import-business-data.md) | Maximon Ltd. | **✓** |  |
