---
title: RetMig &amp; Kommaforslag by GrammarSoft ApS 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: RetMig &amp; Kommaforslag 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| ID | WA104382003 |
| 支持Office 365客户端 | Word 2016或更高版本的 Mac、Word 2016或更高版本Windows，Word web 版 |
| 合作伙伴公司名称 | GrammarSoft ApS |
| 公司的网站 | [https://retmig.dk](https://retmig.dk) |
...
| 公司总部位置 | 丹麦 |
| 应用信息页 | [https://retmig.dk](https://retmig.dk) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
GrammarSoft ApS 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
