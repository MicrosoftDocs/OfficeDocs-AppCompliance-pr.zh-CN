---
title: RetMig &amp; Kommaforslag 的应用程序信息（按 GrammarSoft ApS）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: RetMig &amp; Kommaforslag 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://appsource.microsoft.com/product/office/WA104382003" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

GrammarSoft ApS 提供给 Microsoft 的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | RetMig &amp; Kommaforslag |
| ID | WA104382003 |
| Office 365客户端 | Word 2016 Mac 或更高版本，Word 2016或更高版本Windows Word web 版 |
| 合作伙伴公司名称 | GrammarSoft ApS |
| 公司网站 | [https://retmig.dk](https://retmig.dk) |
| 应用的使用条款 | [https://retmig.dk/terms](https://retmig.dk/terms) |
| 应用的核心功能 | RetMig er en avanceret stave- og grammatikkontrol for dansk， mens Kommaforslag retter kommafejl. |
| 公司总部位置 | 丹麦 |
| 应用信息页面 | [https://retmig.dk](https://retmig.dk) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
此信息由 GrammarSoft ApS 提供，用于了解此应用如何收集和存储组织数据，以及组织将拥有对应用收集的数据的控制。
