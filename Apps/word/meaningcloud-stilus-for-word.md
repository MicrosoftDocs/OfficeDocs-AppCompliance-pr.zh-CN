---
title: 适用于 Word 的 Stilus 的应用程序信息（按 MeaningCloud）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/01/2021
...
description: 适用于 Word 的 Stilus 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "63549900"
---
# <a name="stilus-for-word"></a>适用于 Word 的 Stilus

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 10 月 28 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003400" target="_blank">在 AppSource 中查看</a>
...
| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | 适用于 Word 的 Stilus |
| ID | WA200003400 |
| Office 365客户端 | Word 2016 Mac、Word web 版、Word 2013 或更高版本（Windows |
| 合作伙伴公司名称 | MeaningCloud |
| 公司网站 | [https://www.mystilus.com/en](https://www.mystilus.com/en) |
| 应用的使用条款 | [https://www.mystilus.com/en/about-stilus/license-agreements](https://www.mystilus.com/en/about-stilus/license-agreements) |
| 应用的核心功能 | 西班牙语的拼写、语法和样式检查器 |
| 公司总部位置 | 西班牙 |
| 应用信息页面 | [https://www.mystilus.com/en/plugins/stilus-for-word-365](https://www.mystilus.com/en/plugins/stilus-for-word-365) |
...
| 隐私策略 URL | https://www.mystilus.com/en/data-protection |
