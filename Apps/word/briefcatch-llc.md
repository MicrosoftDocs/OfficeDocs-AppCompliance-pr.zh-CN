---
title: BriefCatch BY BriefCatch LLC 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/04/2022
...
description: BriefCatch 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://appsource.microsoft.com/product/office/WA200003725" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

BriefCatch LLC 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | BriefCatch LLC |
| 公司的网站 | [https://briefcatch.com](https://briefcatch.com) |
| 应用的使用条款 | [https://briefcatch.com/briefcatch-end-user-license-agreemen...](https://briefcatch.com/briefcatch-end-user-license-agreement/) |
| 应用的核心功能 | 专家法律编辑由你身边。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://briefcatch.com/version-3/](https://briefcatch.com/version-3/) |
...
BriefCatch LLC 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
