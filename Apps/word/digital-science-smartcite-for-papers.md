...
description: SmartCite for Papers 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| 合作伙伴公司名称 | 数字科学 |
| 公司的网站 | [https://papersapp.com](https://papersapp.com) |
| 应用的使用条款 | [https://www.papersapp.com/terms](https://www.papersapp.com/terms) |
| 应用的核心功能 | 从 ReadCube 论文库中自动引用和生成书目！ |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://www.papersapp.com/smartcite-for-word/](https://www.papersapp.com/smartcite-for-word/) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
Digital Science 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
