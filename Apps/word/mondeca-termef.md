...
| 应用的核心功能 | Rechercher les termes r&#233;f&#233;dans le portail TerMef， via son API REST， et afficher leur infobo&#238;te. La recherche peut s'effectuer par la s&#233;lection d'une portion de texte du document， pour la&#224; de termes &#224; recher. |
| 公司总部位置 | 法国 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
