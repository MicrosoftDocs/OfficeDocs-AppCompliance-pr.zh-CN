...
description: Fabasoft Cloud Office 外接程序的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| 公司网站 | [https://www.fabasoft.com](https://www.fabasoft.com) |
| 应用的使用条款 | [https://www.fabasoft.com/terms-of-use](https://www.fabasoft.com/terms-of-use) |
| 应用的核心功能 | 从 Fabasoft 业务流程云共享业务数据 |
| 公司总部位置 | 奥地利 |
| 应用信息页面 | [https://www.fabasoft.com/fabasoft-business-process-cloud](https://www.fabasoft.com/fabasoft-business-process-cloud) |
