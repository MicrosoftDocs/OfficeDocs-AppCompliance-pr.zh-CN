---
title: 按 officeatwork Office的内容选择器的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/25/2022
...
description: officeatwork 的所有可用安全性和符合性信息|用于Office的内容选择器、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "65228528"
---
# <a name="application-information-for-officeatwork"></a>Officeatwork 的应用程序信息
...
| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | officeatwork - Office的内容选择器 |
| ID | WA104380602 |
