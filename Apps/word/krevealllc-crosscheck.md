---
title: kRevealLLC 的 CrossCheck 应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/01/2021
...
description: CrossCheck 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| 合作伙伴公司名称 | kRevealLLC |
| 公司的网站 | [https://kreveal.com](https://kreveal.com) |
| 应用的使用条款 | [https://crosscheck.krevealaddins.com/docs/license.htm](https://crosscheck.krevealaddins.com/docs/license.htm) |
| 应用的核心功能 | CrossCheck 简化了文档审阅，并查明了常见的起草错误。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://admin.krevealaddins.com/help](https://admin.krevealaddins.com/help) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
kRevealLLC 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| openid | 应用程序 | 不会收集或使用任何数据。 | [5edad654-f2d5-41d8-bfc0-92c2735252e1](../azure/5edad654-f2d5-41d8-bfc0-92c2735252e1.md) |
