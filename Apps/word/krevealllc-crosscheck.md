...
| 合作伙伴公司名称 | kRevealLLC |
| 公司网站 | [https://kreveal.com](https://kreveal.com) |
| 应用的使用条款 | [https://crosscheck.krevealaddins.com/docs/license.htm](https://crosscheck.krevealaddins.com/docs/license.htm) |
| 应用的核心功能 | CrossCheck 简化了文档审阅并准确找到常见草稿错误。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://admin.krevealaddins.com/help](https://admin.krevealaddins.com/help) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| openid | 应用程序 | 不收集或使用任何数据。 | [5edad654-f2d5-41d8-bfc0-92c2735252e1](../azure/5edad654-f2d5-41d8-bfc0-92c2735252e1.md) |
