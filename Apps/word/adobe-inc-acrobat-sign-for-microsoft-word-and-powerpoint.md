---
title: Adobe Acrobat Sign for Microsoft Word PowerPoint Adobe Inc. 的应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/23/2022
...
description: Adobe Acrobat Sign for Microsoft Word 和 PowerPoint 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "64602392"
---
# <a name="adobe-acrobat-sign-for-microsoft-word-and-powerpoint"></a>Adobe Acrobat Microsoft Word和 PowerPoint
...
| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | Adobe Acrobat Microsoft Word和 PowerPoint |
| ID | WA104381155 |
| Office 365客户端 | Word 2016 Mac、Word web 版、Word 2013 Service Pack 1 或更高版本（位于 Windows、PowerPoint 2016 或更高版本、PowerPoint web 版、PowerPoint 2013 Service Pack 1 或更高版本Windows |
| 合作伙伴公司名称 | Adobe Inc. |
...
| 应用的核心功能 | 添加 Adobe Sign for Office 时，文档签名工作流保持快速Office。 现在，在 Office 应用（如 Word 和 PowerPoint）中，你可以对文档进行签名，发送文档以合法地绑定电子签名和&#8212; Microsoft 首选电子签名解决方案。 |
| 公司总部位置 | 美国美国 |
