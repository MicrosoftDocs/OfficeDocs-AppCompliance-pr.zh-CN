...
| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | Adobe Acrobat Sign for Microsoft Word 和 PowerPoint |
| ID | WA104381155 |
| 支持Office 365客户端 | Word 2016或更高版本在 Mac、Word web 版、Word 2013 Service Pack 1 或更高版本上Windows、PowerPoint 2016或更高版本的 Mac、PowerPoint web 版、PowerPoint 2013 Service Pack 1 或更高版本Windows |
| 合作伙伴公司名称 | Adobe Inc. |
...
| 应用的核心功能 | 添加 Adobe Sign for Office 时，使文档签名工作流保持快速移动。 现在，在 Word 和 PowerPoint 等Office应用中，可以使用 Microsoft 首选的电子签名解决方案对文档进行签名、发送这些文档以获取具有法律约束力的电子签名和审批&#8212;。 |
| 公司总部位置 | 美国美国 |
