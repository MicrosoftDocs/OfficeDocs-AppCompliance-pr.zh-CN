---
title: 由一台由一台（由一台）的用于一台（由一台）的一台（由一台）的一台用于一台（一台）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/24/2022
...
description: 用于一体机启动板的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "64463715"
---
# <a name="rocketdocs-launchpad"></a>一体机启动板
...
由一些用户向 Microsoft 提供的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | 一体机启动板 |
| ID | WA200003648 |
| Office 365客户端 | Excel 2016 Mac、Excel 2016 或更高版本（在 mac Windows、Excel web 版、Word 2016 或更高版本、Word web 版、Word 2016 或更高版本上Windows |
| 合作伙伴公司名称 | 一体机 |
| 公司网站 | [https://rocketdocs.com](https://rocketdocs.com) |
| 应用的使用条款 | [https://rocketdocs.com/end-user-license-agreement/](https://rocketdocs.com/end-user-license-agreement/) |
| 应用的核心功能 | 使用户能够在一个功能平台中查找内容并将其插入到文档中。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://rocketdocs.com/platform/](https://rocketdocs.com/platform/) |
...
这些信息由一些用户提供，这些信息与此应用程序如何收集和存储组织数据以及组织将拥有对应用收集的数据的控制有关。
