...
| 合作伙伴公司名称 | 印象签名 |
| 公司的网站 | [https://www.impression-signatures.com](https://www.impression-signatures.com) |
| 应用的使用条款 | [https://www.iubenda.com/terms-and-conditions/8039352](https://www.iubenda.com/terms-and-conditions/8039352) |
| 应用的核心功能 | 印象签名提供符合 ECT Act 的 eSignature 和安全文档传递。 管理签名工作流并返回附加到已签名文档的安全托管链。  |
| 公司总部位置 | 南非 |
| 应用信息页 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
此信息由印象签名提供，说明此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
