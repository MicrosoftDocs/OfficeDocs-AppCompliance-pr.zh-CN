---
title: FD Mxmn 的应用程序信息 - 由 Maximon Ltd 导入业务数据。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/07/2022
...
description: FD Mxmn 的所有可用安全性和符合性信息 - 导入业务数据、其数据处理策略、Microsoft Cloud App Security 应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "65943180"
---
# <a name="fd-mxmn---import-business-data"></a>FD Mxmn - 导入业务数据

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 5 月 3 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200004151" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Maximon Ltd. 提供给 Microsoft 的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | FD Mxmn - 导入业务数据 |
| ID | WA200004151 |
| 支持 Office 365 客户端 | Mac 上的 Word 2016 或更高版本、Web 上的 Word、Windows 上的 Word 2013 或更高版本 |
| 合作伙伴公司名称 | Maximon Ltd. |
| 公司的网站 | [https://www.maximon.ltd/fdmxmn/](https://www.maximon.ltd/fdmxmn/) |
| 应用的使用条款 | [https://www.maximon.ltd/legal_tou.php](https://www.maximon.ltd/legal_tou.php) |
| 应用的核心功能 | 通过直接从 ACRA BizFile 提取器导入公司数据来简化法律起草。 |
| 公司总部位置 | 美利坚合众国 |
| 应用信息页 | |
...
Maximon Ltd 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
| 隐私策略 URL | https://www.maximon.ltd/legal_privacy.php |
...
| 是否已查看并遵守 Microsoft 标识平台集成清单中列出的所有适用最佳做法？ | 否 |
