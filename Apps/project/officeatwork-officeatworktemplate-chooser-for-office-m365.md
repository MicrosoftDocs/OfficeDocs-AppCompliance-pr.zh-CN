---
title: officeatwork | 的应用程序信息Office 模板选择器 - M365 by officeatwork
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/25/2022
...
description: officeatwork 的所有可用安全性和符合性信息|Office 模板选择器 - M365、其数据处理策略、Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66655926"
---
# <a name="officeatwork--template-chooser-for-office---m365"></a>officeatwork |Office 模板选择器 - M365
...
| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | officeatwork - Office 模板选择器 - M365 |
| ID | WA104380050 |
| 支持Office 365客户端 | iPad 上的 Excel、Mac 上的 Excel 2016 或更高版本、Windows 上的 Excel 2013 或更高版本、Excel web 版、iPad 上的 Word、Mac 上的 Word 2016 或更高版本、Web 上的 Word、Windows 上的 Word 2013 或更高版本、iPad 上的 PowerPoint、PowerPoint 2016或更高版本的 Mac，PowerPoint web 版、Windows 上的 PowerPoint 2013 或更高版本、Windows 上的 Project 2016 或更高版本 |
...
| 应用信息页 | [https://links.officeatwork.com/templatechooser](https://links.officeatwork.com/templatechooser) |
...
| 应用会处理哪些数据？ | 收集：Microsoft 租户 ID、用户 Azure AD 对象 ID;数据的处理取决于授予的权限，并发生在客户端。 只有权限和登录流所需的数据由 Officeatwork 控制的临时、无服务器和受信任的 PaaS Azure 服务处理。 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | 委托 | 启用收藏夹和 OneDrive 功能 | [dae2eacf-3eb5-4440-baff-984fbd5cae68](../azure/dae2eacf-3eb5-4440-baff-984fbd5cae68.md) |
>| Group.ReadWrite.All | 委托 | 启用 Teams 功能 | [dae2eacf-3eb5-4440-baff-984fbd5cae68](../azure/dae2eacf-3eb5-4440-baff-984fbd5cae68.md) |
>| GroupMember.Read.All | 委托 | 启用 Teams 功能 | [dae2eacf-3eb5-4440-baff-984fbd5cae68](../azure/dae2eacf-3eb5-4440-baff-984fbd5cae68.md) |
>| Sites.Read.All | 委托 | 读取存储在 SharePoint 中的用户模板文件 | [dae2eacf-3eb5-4440-baff-984fbd5cae68](../azure/dae2eacf-3eb5-4440-baff-984fbd5cae68.md) |
>| User.Read | 委托 | 启用已登录用户的显示 | [dae2eacf-3eb5-4440-baff-984fbd5cae68](../azure/dae2eacf-3eb5-4440-baff-984fbd5cae68.md) |
>| User.Read.All | 委托 | 启用显示用户属性 | [dae2eacf-3eb5-4440-baff-984fbd5cae68](../azure/dae2eacf-3eb5-4440-baff-984fbd5cae68.md) |
>| offline_access | 委托 | 为旧版 Office 主机启用自动登录 | [dae2eacf-3eb5-4440-baff-984fbd5cae68](../azure/dae2eacf-3eb5-4440-baff-984fbd5cae68.md) |
>| openid | 委托 | 启用登录 | [dae2eacf-3eb5-4440-baff-984fbd5cae68](../azure/dae2eacf-3eb5-4440-baff-984fbd5cae68.md) |
>| 个人资料 | 委托 | 启用登录 | [dae2eacf-3eb5-4440-baff-984fbd5cae68](../azure/dae2eacf-3eb5-4440-baff-984fbd5cae68.md) |
