---
title: Smarter Business Solutions GmbH 提供的更智能事件预订的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/14/2021
...
description: 适用于 Smarter Event Booking 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| 合作伙伴公司名称 | 更智能的业务解决方案 GmbH |
| 公司的网站 | [https://smarterbusiness.at](https://smarterbusiness.at) |
...
| 应用的核心功能 | 更智能的事件预订允许 Microsoft365 用户注册以前创建的事件。 |
| 公司总部位置 | 奥地利 |
| 应用信息页 | [https://www.smarterbusiness.at/en/smarter-event-booking](https://www.smarterbusiness.at/en/smarter-event-booking) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
Smarter Business Solutions GmbH 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
