---
title: Smarter Business Solutions GmbH 的更智能事件预订的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/14/2021
...
description: 有关 Smarter Event Booking 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "63552211"
---
# <a name="smarter-event-booking"></a>更智能的事件预订

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 7 月 20 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003125" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Smarter Business Solutions GmbH 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Smarter Business Solutions GmbH |
| 公司网站 | [https://smarterbusiness.at](https://smarterbusiness.at) |
| 应用的使用条款 | [https://www.smarterbusiness.at/en/terms-of-use-for-smarter-...](https://www.smarterbusiness.at/en/terms-of-use-for-smarter-event-booking) |
| 应用的核心功能 | Smarter Event Booking 允许 Microsoft365 用户注册之前创建的事件。 |
| 公司总部位置 | 奥地利 |
| 应用信息页面 | [https://www.smarterbusiness.at/en/smarter-event-booking](https://www.smarterbusiness.at/en/smarter-event-booking) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
Smarter Business Solutions GmbH 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及您的组织将拥有对应用收集的数据的控制有关。
