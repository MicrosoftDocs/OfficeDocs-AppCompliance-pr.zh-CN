---
title: 由 SharePoint， Inc. 的 Arc则 ARC适用于应用程序的应用程序信息。
ms.author: elmalova
author: elenamalova
ms.date: 08/04/2021
ms.topic: article
...
description: Arc适用于 SharePoint 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "60428395"
---
# <a name="arcgis-for-sharepoint"></a>Arc适用于 SharePoint
