...
description: 用于 Bid Management System 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "61711454"
---
# <a name="bid-management-system"></a>标书管理系统

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 11 月 16 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200001787" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Beyond Technologies 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | 技术之外 |
| 公司网站 | [https://www.beyondintranet.com](https://www.beyondintranet.com) |
| 应用的使用条款 | [https://www.beyondintranet.com/eula](https://www.beyondintranet.com/eula) |
| 应用的核心功能 | 一SharePoint支持的建议管理/标书管理软件，用于将标书活动数字化。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
...
此信息由超出技术提供，它有关此应用程序如何收集和存储组织数据以及你的组织将拥有对应用收集的数据的控制。
...
| 数据库中存储了哪些数据？ | 用户电子邮件和SharePoint网站 URL |
...
| 您是否具有管理 SLA 服务级别协议的策略 (SLA) 修补程序？ | 不支持 |
...
| 隐私策略 URL | https://www.beyondintranet.com/privacypolicy |
...
| 您是否已查看并遵循了 Microsoft 标识平台清单中列出的所有适用最佳做法？ | 不支持 |
