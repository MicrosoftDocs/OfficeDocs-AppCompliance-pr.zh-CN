...
description: 用于标价管理系统的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://www.beyondintranet.com/bid-management-software](https://www.beyondintranet.com/bid-management-software) |
