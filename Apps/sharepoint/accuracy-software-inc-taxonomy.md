...
| 应用的核心功能 | 通过使 IM 专业人员与不同利益干系人协作创建、审阅文件计划，以及将文件计划发布到整个组织，分类为您提供了管理文件分类计划的有效方式。 此外，分类 允许您生成可导入到 Microsoft 合规中心的 M365 保留标签导出，并可以导入到 SharePoint 术语库的术语集格式导出文件计划。 |
| 公司总部位置 | 加拿大 |
| 应用信息页面 | |
...
| FedRAMP 应用程序是否符合 FedRAMP (授权) 计划？ | 否 |
| 应用是否遵守 FERPA (家庭教育) ？ | 不适用 |
| 该应用是否遵守 COPPA (《儿童在线隐私保护) ？ | 不适用 |
| 应用是否遵守 SOX Sarbanes-Oxley的 (法案) ？ | 不适用 |
