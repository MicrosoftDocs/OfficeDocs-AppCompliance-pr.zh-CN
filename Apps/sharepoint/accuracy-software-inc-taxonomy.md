...
description: 分类的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| 合作伙伴公司名称 | 准确性软件公司。 |
| 公司的网站 | [https://accuracysoftware.ca](https://accuracysoftware.ca) |
| 应用的使用条款 | [https://accuracysoftware.ca/taxonomy-terms-of-service](https://accuracysoftware.ca/taxonomy-terms-of-service) |
| 应用的核心功能 | 分类为你提供了一种管理文件分类计划的有效方法，方法是让 IM 专业人员与不同的利益干系人协作，以创建、查看文件计划并将文件计划发布到整个组织。 此外，分类允许你生成 M365 保留标签导出，可以导入到 Microsoft 合规中心，并以可以导入到术语存储SharePoint的术语集格式导出文件计划。 |
| 公司总部位置 | 加拿大 |
| 应用信息页 | [https://www.accuracysoftware.ca/taxonomy-sharepoint-webpart/](https://www.accuracysoftware.ca/taxonomy-sharepoint-webpart/) |
...
准确性软件公司提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
