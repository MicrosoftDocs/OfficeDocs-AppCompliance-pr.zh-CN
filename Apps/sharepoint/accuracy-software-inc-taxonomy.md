---
title: 由 Accuracy Software Inc. 分类的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/18/2022
...
description: 所有可用的分类安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
Accuracy Software Inc. 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | Accuracy Software Inc. |
| 公司网站 | [https://accuracysoftware.ca](https://accuracysoftware.ca) |
| 应用的使用条款 | [https://accuracysoftware.ca/taxonomy-terms-of-service](https://accuracysoftware.ca/taxonomy-terms-of-service) |
| 应用的核心功能 | 通过使 IM 专业人员与不同利益干系人协作创建、审阅文件计划，以及将文件计划发布到整个组织，分类为您提供了管理文件分类计划的有效方式。 此外，分类 允许您生成可导入到 Microsoft 合规性中心的 M365 保留标签导出，并可以导入到 SharePoint 术语库的术语集格式导出文件计划。 |
| 公司总部位置 | 加拿大 |
| 应用信息页面 | [https://www.accuracysoftware.ca/taxonomy-sharepoint-webpart/](https://www.accuracysoftware.ca/taxonomy-sharepoint-webpart/) |
| 用于运行应用的托管环境或服务模型是什么？ | Paas |
| 应用使用哪些托管云提供商？ | 客户端SharePoint租户 |
...
此信息由 Accuracy Software Inc. 提供，用于了解此应用程序如何收集和存储组织数据，以及您的组织将拥有对应用收集的数据的控制。

| **Information** | **响应** |
|:----------------|:-------------|
| 应用或基础基础结构是否处理与 Microsoft 客户或他们的设备相关的任何数据？ | 否 |
| 应用或基础基础结构是否存储任何 Microsoft 客户数据？ | 是 |
| 数据库中存储了哪些数据？ | 文件计划分类数据 |
