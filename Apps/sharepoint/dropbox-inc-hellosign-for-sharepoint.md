---
title: Dropbox Inc. SharePoint HelloSign for Dropbox 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/10/2021
...
| ID | WA200003245 |
| Office 365客户端 | SharePoint 2013 或更高版本 |
...
| 应用的核心功能 | HelloSign&#8217;数字工作流平台 &#8211; 包括电子签名、数字工作流和电子传真解决方案 &#8212; 可帮助 80，000 多个客户和数百万人更快地进行业务。 我们帮助客户更快完成交易、轻松、完整的文档、无错误地载入新员工等。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://www.hellosign.com/integrations](https://www.hellosign.com/integrations) |
...
此信息由 Dropbox Inc. 提供，用于说明此应用程序如何收集和存储组织数据，以及您的组织将拥有对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | 应用程序 | 将电子签名的文件上载回SharePoint | [6fcff87e-0f86-49c3-81eb-bc028d1ccfe6](../azure/6fcff87e-0f86-49c3-81eb-bc028d1ccfe6.md) |
>| Sites.ReadWrite.All | 应用程序 | 将电子签名的文件上载回SharePoint | [6fcff87e-0f86-49c3-81eb-bc028d1ccfe6](../azure/6fcff87e-0f86-49c3-81eb-bc028d1ccfe6.md) |
>| User.Read | delegated | 获取用户的电子邮件 | [6fcff87e-0f86-49c3-81eb-bc028d1ccfe6](../azure/6fcff87e-0f86-49c3-81eb-bc028d1ccfe6.md) |
