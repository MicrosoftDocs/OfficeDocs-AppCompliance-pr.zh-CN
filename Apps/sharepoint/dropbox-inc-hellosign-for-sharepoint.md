---
title: SharePoint Inc. 的 HelloSign for Dropbox 应用程序信息
ms.author: elmalova
author: elenamalova
ms.date: 12/10/2021
ms.topic: article
...
| 合作伙伴公司名称 | Dropbox Inc. |
| 公司网站 | [https://hellosign.com](https://hellosign.com) |
| 应用的使用条款 | [https://hellosign.com/terms](https://hellosign.com/terms) |
| 应用的核心功能 | HelloSign&#8217;数字工作流平台 &#8211;包括电子签名、数字工作流和电子传真解决方案 &#8212; 可帮助 80，000 多个客户和数百万人更快地完成业务。 我们帮助客户更快完成交易、轻松、完整的文档、无错误地载入新员工等。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
...
| 数据库中存储了哪些数据？ | 租户 ID， 网站 ID， 电子邮件， 驱动器 ID， 驱动器项 ID |
...
| 隐私策略 URL | https://www.hellosign.com/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | 应用程序 | 将电子签名的文件上载回SharePoint | [6fcff87e-0f86-49c3-81eb-bc028d1ccfe6](https://docs.microsoft.com/microsoft-365-app-certification/azure/6fcff87e-0f86-49c3-81eb-bc028d1ccfe6) |
>| Sites.ReadWrite.All | 应用程序 | 将电子签名的文件上载回SharePoint | [6fcff87e-0f86-49c3-81eb-bc028d1ccfe6](https://docs.microsoft.com/microsoft-365-app-certification/azure/6fcff87e-0f86-49c3-81eb-bc028d1ccfe6) |
>| User.Read | delegated | 获取用户的电子邮件 | [6fcff87e-0f86-49c3-81eb-bc028d1ccfe6](https://docs.microsoft.com/microsoft-365-app-certification/azure/6fcff87e-0f86-49c3-81eb-bc028d1ccfe6) |
