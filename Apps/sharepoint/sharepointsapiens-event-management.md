---
title: SharePointSapiens SharePoint|事件管理的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: SharePoint|事件管理的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "63778406"
---
# <a name="sharepointsapiens-event-management"></a>SharePoint|sapiens 事件管理

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 3 月 22 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA104380834" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

SharePointSapiens 提供给 Microsoft 的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | SharePoint-sapiens 事件管理 |
| ID | WA104380834 |
| Office 365客户端 | SharePoint 2016 或更高版本 |
| 合作伙伴公司名称 | SharePointSapiens |
| 公司网站 | [https://www.sharepointsapiens.com](https://www.sharepointsapiens.com) |
| 应用的使用条款 | [https://addins.sharepointsapiens.com/licensing/services-agr...](https://addins.sharepointsapiens.com/licensing/services-agreement.html) |
| 应用的核心功能 | 事件管理加载项可帮助你组织各种类型的事件。 在几个简单的步骤中，几乎无需任何时间就安排事件。 参与者只需单击一下即可在线注册。 作为组织者，您还可以代表内部或外部用户注册或通过电子邮件发送邀请。 参与者通过电子邮件接收会议请求和更新，以确保他们始终在日历中Outlook信息。 加载项在一个地方跟踪所有与会者。 |
| 公司总部位置 | 奥地利 |
| 应用信息页面 | [https://www.sharepointsapiens.com/event-management-office36...](https://www.sharepointsapiens.com/event-management-office365/) |
...
此信息由 SharePointSapiens 提供，用于了解此应用程序如何收集和存储组织数据，以及您的组织将拥有对应用程序收集的数据的控制。
...
| 外部网络边界上是否安装了防火墙？ | 否 |
| 您是否已建立变更管理流程，用于在将更改请求部署到生产环境之前审阅和批准更改请求？ | 否 |
...
| 隐私策略 URL | https://addins.sharepointsapiens.com/licensing/data-processing-agreement.html |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.ReadBasic.All | delegated | 读取基本用户信息以启用Exchange预订 | [9e8e113c-8a08-4606-b08a-de4decc7252f](../azure/9e8e113c-8a08-4606-b08a-de4decc7252f.md) |
