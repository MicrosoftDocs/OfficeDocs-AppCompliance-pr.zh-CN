...
| 合作伙伴公司名称 | Ataira |
| 公司网站 | [https://www.ataira.com](https://www.ataira.com) |
| 应用的使用条款 | [https://www.ataira.com/TermsofUse](https://www.ataira.com/TermsofUse) |
| 应用的核心功能 | Ataira 外接程序允许你查看Power BI和报表。 向公司组和团队发送通知、添加后续操作、嵌入 Power BI 公共链接、向报告中的数据点添加注释以及将数据文件作为数据源添加到 Power BI 报告和实时更新。 允许商业智能团队更加紧密地协作处理商业智能工作。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://www.ataira.com/Microsoft/PowerBI/Collaboration](https://www.ataira.com/Microsoft/PowerBI/Collaboration) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegated | Also permissions for ChannelMessage.Send Team.ReadBasic.All User.Read. 它们用于允许用户选择通知Teams组和频道 | [00738e07-f9a4-4bf5-b6f9-851ec7ea31d5](../azure/00738e07-f9a4-4bf5-b6f9-851ec7ea31d5.md) |
