...
| 应用的核心功能 | Ataira 外接程序允许你查看Power BI和报表。 向公司组和团队发送通知、添加后续操作、嵌入 Power BI 公共链接、向报告中的数据点添加注释以及将数据文件作为数据源添加到 Power BI 报告和实时更新。 允许商业智能团队在一个位置商业智能更加紧密地协作处理您的工作。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegated | Also permissions for ChannelMessage.Send Team.ReadBasic.All User.Read. 它们用于允许用户选择通知Teams组和频道 | [00738e07-f9a4-4bf5-b6f9-851ec7ea31d5](https://docs.microsoft.com/microsoft-365-app-certification/azure/00738e07-f9a4-4bf5-b6f9-851ec7ea31d5) |
