...
description: 用于Power BI协作的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "65227987"
---
# <a name="ataira-power-bi-collaboration-overview"></a>Ataira Power BI协作概述

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 6 月 14 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA104380739" target="_blank">在 AppSource 中查看</a>
...
| 合作伙伴公司名称 | Ataira |
| 公司的网站 | [https://www.ataira.com](https://www.ataira.com) |
| 应用的使用条款 | [https://www.ataira.com/TermsofUse](https://www.ataira.com/TermsofUse) |
| 应用的核心功能 | 使用 Ataira 加载项可以查看Power BI仪表板和报表。 将通知发送到公司组和团队，添加后续操作，嵌入Power BI公共链接，向报表中的数据点添加注释，并将数据文件作为数据源添加到Power BI报表并实时更新。 允许商业智能团队在一个位置更紧密地协作处理商业智能工作。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://www.ataira.com/Microsoft/PowerBI/Collaboration](https://www.ataira.com/Microsoft/PowerBI/Collaboration) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
...
Ataira 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
...
| 应用是否支持条件访问策略？ | 是 |
| 列出支持的策略类型 | 多重身份验证仅允许Intune已注册设备访问限制用户位置和 IP 范围的特定服务 |
| 你的应用是否请求方案的最低特权权限？ | 是 |
| 应用是否支持持续访问评估 (CAE)  |  |
| 应用是否在代码中存储任何凭据？ |  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委托 | 还有 ChannelMessage.Send Team.ReadBasic.All User.Read 的权限。 这些选项用于允许用户选择通知的Teams组和通道 | [00738e07-f9a4-4bf5-b6f9-851ec7ea31d5](../azure/00738e07-f9a4-4bf5-b6f9-851ec7ea31d5.md) |
