---
title: SharePointSapiens SharePoint|新式用户界面的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: SharePoint|新式用户界面的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
---
# <a name="sharepointsapiens-modern-user-interface"></a>SharePoint|新式用户界面

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 3 月 30 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003529" target="_blank">在 AppSource 中查看</a>
...
| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | SharePoint-sapiens 新式用户界面 |
| ID | WA200003529 |
...
| 应用的核心功能 | 此应用必须结合我们的应用SharePoint|sapiens 事件管理应用 (WA104380834) 或 SharePoint|sapiens 员工培训管理 (WA104380833) 。  此应用程序提供了一个直观的用户界面，允许你在 SharePoint 中创建和管理事件、主题、课程和课程、注册用户或允许用户自行注册，并跟踪所有与会者、作业和成就。 |
| 公司总部位置 | 奥地利 |
| 应用信息页面 | |
