---
title: SharePointSapiens SharePoint|员工培训管理的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: 适用于员工培训管理SharePoint|所有可用的安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "63778402"
---
# <a name="sharepointsapiens-employee-training-management"></a>SharePoint|员工培训管理

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 3 月 22 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA104380833" target="_blank">在 AppSource 中查看</a>
...
| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | SharePoint-sapiens 员工培训管理 |
| ID | WA104380833 |
...
| 应用的核心功能 | 员工培训管理外接程序使组织和管理员工继续专业开发对所有人来说都很简单。 从设置和安排培训计划、管理学生及其作业和注册，到跟踪成就和反馈，涵盖所有内容。 加载项可帮助你实现合规性法规和安全策略。 它使你能够分配所需的培训、跟踪成就、管理过期时间等。 |
| 公司总部位置 | 奥地利 |
| 应用信息页面 | [https://www.sharepointsapiens.com/employee-training-managem...](https://www.sharepointsapiens.com/employee-training-management-office365/) |
