---
title: 4Mata 的应用程序信息 - CLOUDIGNITE LLC 列出格式设置设计器
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: 4Mata - 列表格式设计器、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息的所有可用安全性和符合性信息。
...
ms.locfileid: "66112989"
---
# <a name="4mata---list-formatting-designer"></a>4Mata - 列表格式设计器

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 5 月 31 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002892" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

CLOUDIGNITE LLC 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | CLOUDIGNITE LLC |
| 公司的网站 | [https://4mata.com](https://4mata.com) |
| 应用的使用条款 | [https://docs.4mata.com/legal/terms-of-service](https://docs.4mata.com/legal/terms-of-service) |
| 应用的核心功能 | 4Mata by CloudIgnite 是一组工具，通过设计和格式化SharePoint列表和窗体，使企业能够可视化数据。  使用此应用程序，用户可以直观地配置高度自定义的复杂SharePoint表单和列表，用于报表、发票、产品详细信息发布和联系信息收集，以方便地与业务流程要求集成。  |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://4mata.com](https://4mata.com) |
...
CLOUDIGNITE LLC 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
