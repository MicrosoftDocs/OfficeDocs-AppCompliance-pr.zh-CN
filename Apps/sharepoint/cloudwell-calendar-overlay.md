...
description: 日历覆盖的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| 应用的核心功能 | 使用日历覆盖 Web 部件，可以在一个位置查看所有 Microsoft SharePoint、Planner 和Exchange事件！ |
| 公司总部位置 | 美国美国 |
