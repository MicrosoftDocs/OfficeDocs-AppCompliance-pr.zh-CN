...
description: 日历覆盖的所有可用安全性和符合性信息、其数据处理策略、Microsoft Cloud App Security 应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
---
# <a name="calendar-overlay"></a>日历覆盖
...
Cloudwell 提供给 Microsoft 的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | 日历覆盖 |
| ID | WA200003806 |
| 支持 Office 365 客户端 | SharePoint 2016 或更高版本 |
| 合作伙伴公司名称 | Cloudwell |
| 公司的网站 | [https://cloudwell.io](https://cloudwell.io) |
...
| 应用的核心功能 | 日历覆盖 Web 部件允许你在一个位置查看所有 Microsoft SharePoint、Planner 和 Exchange 事件！ |
| 公司总部位置 | 美利坚合众国 |
| 应用信息页 | [https://cloudwell.io/products/calendar-overlay](https://cloudwell.io/products/calendar-overlay) |
...
Cloudwell 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
