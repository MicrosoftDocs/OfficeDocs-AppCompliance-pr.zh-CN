---
title: Adobe Sign for SharePoint Adobe Inc. 的应用程序信息
ms.author: elmalova
author: elenamalova
ms.date: 10/04/2021
ms.topic: article
...
description: Adobe Sign for SharePoint 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | Adobe Sign for SharePoint |
| ID | WA104381012 |
...
>|:----------------|:------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|:--------------------|
>| Directory.Read.All | delegated | 获取用户角色并验证用户是否被授予了应用程序功能的某些权限。 | 在当前令牌过期时刷新访问令牌。  | [99a3ad8d-8682-4f2a-9c2c-b4b27e99585c](https://docs.microsoft.com/microsoft-365-app-certification/azure/99a3ad8d-8682-4f2a-9c2c-b4b27e99585c) |
...
>|:--------|:-----------------------|:----------------------------|:--------------------------------------|:-------------------|:-----------------------------------|
>| SharePoint REST API | 是 | SharePoint用户角色 | 基于要授予/拒绝对列表项的访问权限的用户角色 | 不在 DB 中存储 | 不适用 |
...
>在我们的系统中，Microsoft Outlook没有任何客户管理员交互。
