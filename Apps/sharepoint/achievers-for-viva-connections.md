---
title: 实现者Viva Connections的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/06/2022
...
description: 适用于Viva Connections的 Achievers 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "66655902"
---
# <a name="achievers-for-viva-connections"></a>Viva Connections的实现者

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 6 月 10 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200004313" target="_blank">在 AppSource 中查看</a>
...
| 应用的核心功能 | 使用“成就者”平台为成员签名庆祝卡、查看自我识别和热门识别的快速操作卡片 |
| 公司总部位置 | 加拿大 |
| 应用信息页 | |
