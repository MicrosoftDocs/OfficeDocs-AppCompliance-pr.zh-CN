---
title: Indicadores Economicos Chile byBird 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: 适用于智利 Indicadores Economicos 的所有可用安全性和合规性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "65818433"
---
# <a name="indicadores-economicos-chile"></a>Indicadores Economicos 智利

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 5 月 30 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA104381100" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Bird 提供给 Microsoft 的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | Indicadores Economicos 智利 |
| ID | WA104381100 |
| 支持Office 365客户端 | Excel Mac 上Windows、Excel web 版、Excel 2016或更高版本上的 2013 Service Pack 1 或更高版本 |
| 合作伙伴公司名称 | 小鸟 |
| 公司的网站 | [https://www.birdie.cl](https://www.birdie.cl) |
| 应用的使用条款 | [https://www.birdie.cl/software/privacidad](https://www.birdie.cl/software/privacidad) |
| 应用的核心功能 | Obt&#233;n el valor de la Unidad de Fomento (UF) ， 欧元， D&#243;lar y UTM de 智利 de manera sencilla |
| 公司总部位置 | 智利 |
| 应用信息页 | |
...
此信息由 Birdie 提供，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
