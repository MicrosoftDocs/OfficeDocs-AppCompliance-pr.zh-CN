...
| 应用的核心功能 | 借助超几何图形，企业可以聚合来自 70 多个营销和销售平台（如 Facebook 广告、Google Analytics、Instagram 等）的孤立数据，并直接将数据传输至 Excel 以用于报告目的。 这允许您：- 自动执行手动数据导入任务;- 使用 Excel 中已有的公式和工具分析和可视化营销数据; - 通过直接在 Excel 中查看多个数据源，获取全局信息。 |
| 公司总部位置 | 芬兰 |
| 应用信息页面 | [https://supermetrics.com/product/excel](https://supermetrics.com/product/excel) |
