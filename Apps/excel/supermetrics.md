...
description: Supermetrics 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
* <a href="https://appsource.microsoft.com/product/office/WA104381807" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Supermetrics 提供给 Microsoft 的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | Supermetrics |
| ID | WA104381807 |
| Office 365客户端 | Excel 2016或更高版本，Windows、Excel 2016 Mac 或更高版本，Excel web 版 |
| 合作伙伴公司名称 | Supermetrics |
| 公司网站 | [https://supermetrics.com](https://supermetrics.com) |
| 应用的使用条款 | [https://supermetrics.com/terms-of-service](https://supermetrics.com/terms-of-service) |
| 应用的核心功能 | 借助超几何图形，企业可以聚合来自 70 多个市场营销和销售平台（如 Facebook 广告、Google Analytics、Instagram 等）的孤立数据，并出于报告目的将数据直接传输至 Excel。 这允许您：- 自动执行手动数据导入任务;- 使用现有公式和工具Excel和可视化营销数据;- 通过直接在数据源中查看多个数据源，Excel。 |
| 公司总部位置 | 芬兰 |
| 应用信息页面 | |
...
此信息由 Supermetrics 提供，它有关此应用程序如何收集和存储组织数据，以及组织将拥有对应用收集的数据的控制。
...
| 你是否具有在支持 (网络边界) 部署的入侵检测和防护 IDPS 软件？ | 是 |
...
| 应用是否遵守 SOC 1 (服务组织) ？ | 是 |
| 最新 SOC1 认证日期 |  2020-12-15 |
| 应用是否遵守 SOC 2 (服务组织) ？ | 是 |
| 你获得哪种 SOC 2 认证？ |  type2 |
| 最新 SOC2 认证日期 |  2021-07-07 |
| 应用是否遵守 SOC 3 (服务组织) ？ | 否 |
| 最新 SOC3 认证日期 | |
...
| 应用是否符合 SOX Sarbanes-Oxley的 (法案) ？ | 否 |
...
| 隐私策略 URL | https://supermetrics.com/privacy-policy |
| 应用是否执行自动决策制定，包括可能具有法律效果或类似影响的分析？ | 否 |
| 应用是否出于次要目的处理客户数据，如 (、分析或) ？ | 否 |
| 你是否处理特殊类别的敏感数据 (，即种族或族裔、政治观点、宗教或宗教宗教、基因或生物识别数据、健康) 或受违反通知法限制的数据类别？ | 否 |
