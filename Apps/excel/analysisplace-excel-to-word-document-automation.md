...
description: 用于Excel到 Word 文档自动化、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息的所有可用安全性和符合性信息。
...
ms.locfileid: "64784206"
---
# <a name="excel-to-word-document-automation-overview"></a>Excel到 Word 文档自动化概述

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 2 月 25 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA104380955" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

AnalysisPlace 提供给 Microsoft 的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | Excel到 Word 文档自动化 |
| ID | WA104380955 |
| 支持Office 365客户端 | Excel 2016或更高版本的 Mac，Excel 2016或更高版本的Windows，Word 2016或更高版本的 Mac，Word 2016或更高版本的Windows，PowerPoint 2016或更高版本的 Mac，PowerPoint 2016或更高版本Windows、Excel web 版、Word web 版、PowerPoint web 版 |
| 合作伙伴公司名称 | AnalysisPlace |
| 公司的网站 | [https://analysisplace.com](https://analysisplace.com) |
| 应用的使用条款 | [https://analysisplace.com/Terms](https://analysisplace.com/Terms) |
| 应用的核心功能 | AnalysisPlace 提供用于自动更新Microsoft Office文档的服务 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://analysisplace.com/Document-Automation](https://analysisplace.com/Document-Automation) |
...
AnalysisPlace 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
| 隐私策略 URL | https://analysisplace.com/Privacy |
