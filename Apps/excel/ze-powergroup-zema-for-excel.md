---
title: 由 ZE PowerGroup Excel的 ZEMA 应用程序信息
ms.author: elmalova
author: elenamalova
ms.date: 02/17/2022
ms.topic: article
...
description: 用于 ZEMA 的所有可用安全性和合规性信息Excel、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "62884727"
---
# <a name="zema-for-excel"></a>用于 Excel 的 ZEMA

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 2 月 17 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002229" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

由 ZE PowerGroup 提供给 Microsoft 的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | 用于 Excel 的 ZEMA |
| ID | WA200002229 |
| Office 365支持的客户端 | Excel 2016 Mac 或更高版本，Excel 2016或更高版本Windows、Excel web 版 |
| 合作伙伴公司名称 | ZE PowerGroup |
| 公司网站 | [https://www.ze.com](https://www.ze.com) |
| 应用的使用条款 | [https://www.ze.com/terms-of-use/](https://www.ze.com/terms-of-use/) |
| 应用的核心功能 | 快速轻松地将 ZEMA 数据和分析导入到Excel工作簿。 |
| 公司总部位置 | 加拿大 |
| 应用信息页面 | |
...
由 ZE PowerGroup 提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及组织将拥有对应用收集的数据的控制有关。
...
| 应用是否遵守 SOX Sarbanes-Oxley的 (法案) ？ | 否 |
