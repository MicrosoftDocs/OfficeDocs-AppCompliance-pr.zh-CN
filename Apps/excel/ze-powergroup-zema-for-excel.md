...
description: 用于用于 EXCEL 的 ZEMA 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "63543490"
---
# <a name="zema-for-excel"></a>用于Excel
...
| 应用名称 | 用于Excel |
| ID | WA200002229 |
| Office 365客户端 | Excel 2016 Mac 或更高版本，Excel 2016或更高版本Windows Excel web 版 |
