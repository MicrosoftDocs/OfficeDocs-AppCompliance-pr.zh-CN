...
description: For一的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "62200582"
---
# <a name="forbury"></a>For一

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 11 月 19 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002916" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

For一属性提供给 Microsoft 的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | For一 |
| ID | WA200002916 |
| Office 365支持的客户端 | Excel 2016 Mac 或更高版本，Excel 2016或更高版本Windows或Excel web 版 |
| 合作伙伴公司名称 | For一属性 |
| 公司网站 | [https://www.forbury.com](https://www.forbury.com) |
| 应用的使用条款 | [https://www.forbury.com/terms-of-use](https://www.forbury.com/terms-of-use) |
| 应用的核心功能 | 为商业房地产提供电源的最快方法 (For，) 软件中的分析功能。 |
| 公司总部位置 | 新西兰 |
| 应用信息页面 | |
...
For一属性提供了此信息，这些信息与此应用程序如何收集和存储组织数据以及组织将拥有对应用收集的数据的控制有关。
...
| 隐私策略 URL | https://www.forbury.com/privacy-policy |
