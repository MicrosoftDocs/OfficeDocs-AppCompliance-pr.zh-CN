---
title: Adobe Inc. Report Builder的应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/02/2021
...
description: 适用于Report Builder的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| 合作伙伴公司名称 | Adobe Inc. |
| 公司的网站 | [https://experiencecloud.adobe.com](https://experiencecloud.adobe.com) |
| 应用的使用条款 | [https://wwwimages.adobe.com/content/dam/acom/en/legal/licen...](https://wwwimages.adobe.com/content/dam/acom/en/legal/licenses-terms/pdf/EULA-en_US-20190910_1413.pdf) |
| 应用的核心功能 | 使用 Adobe Customer Journey Analytics 数据创建Excel报表。 |
| 公司总部位置 | 美国美国 |
| 应用信息页 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | Azure |
