...
| ID | WA104381787 |
| Office 365支持的客户端 | Excel 2016或更高版本、Windows、Excel web 版、Word 2016 或更高版本的 Excel 2016 Mac、Word web 版、Word 2016 或更高版本、mac 上的 Windows PowerPoint 2016 或更高版本、PowerPoint web 版、PowerPoint 2016 或更高版本Windows |
| 合作伙伴公司名称 | iGlobe |
...
>| Group.ReadWrite.All | delegated | 应用程序数据库中不存储任何数据。 | 访问所选的邮件并获取附件。 From the mail or add from SharePoint groups site to the mail. | [5971c986-9d39-409c-a6f8-1385b1f690ef](https://docs.microsoft.com/microsoft-365-app-certification/azure/5971c986-9d39-409c-a6f8-1385b1f690ef) |
>| Mail.ReadWrite | delegated | 应用程序数据库中不存储任何数据。 | 访问所选的邮件并获取附件。 From the mail or add from SharePoint groups site to the mail. | [5971c986-9d39-409c-a6f8-1385b1f690ef](https://docs.microsoft.com/microsoft-365-app-certification/azure/5971c986-9d39-409c-a6f8-1385b1f690ef) |
...
>| User.Read | delegated | 应用程序数据库中不存储任何数据。 | 获取用户对SharePoint网站、OneDrive和组网站的信息。 | [5971c986-9d39-409c-a6f8-1385b1f690ef](https://docs.microsoft.com/microsoft-365-app-certification/azure/5971c986-9d39-409c-a6f8-1385b1f690ef) |
