...
| 应用的核心功能 | Sheetgo 是一个工作流自动化平台，使用户能够连接联机电子表格和构建自动化数据管理系统。 Sheetgo Web 应用程序提供了一个用于创建和管理工作流以及一系列模板的平台。 借助适用于 Excel 的 Sheetgo 外接程序和 Google Sheets 加载项，用户可以直接从电子表格内连接和自动执行，而 Teams 应用使工作流创建者可以在频道和群聊中与同事共享其连接的文件。 |
| 公司总部位置 | 西班牙 |
| 应用信息页面 | |
