...
description: Sheetgo 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| 公司的网站 | [https://www.sheetgo.com](https://www.sheetgo.com) |
| 应用的使用条款 | [https://www.sheetgo.com/legal/terms/](https://www.sheetgo.com/legal/terms/) |
| 应用的核心功能 | Sheetgo 是一个工作流自动化平台，使用户能够连接联机电子表格并生成自动化数据管理系统。 Sheetgo Web 应用提供了一个用于创建和管理工作流的平台，以及一系列模板。 适用于 Google Sheets Excel和加载项的 Sheetgo 加载项允许用户直接在电子表格内进行连接和自动执行，而Teams应用使工作流创建者能够在频道和群组聊天中与同事共享其连接的文件。 |
| 公司总部位置 | 西班牙 |
| 应用信息页 | [https://www.sheetgo.com](https://www.sheetgo.com) |
...
| 数据库中存储了哪些数据？ | 电子表格元数据，如文件大小、电子表格所有者、电子表格用户、上次修改日期、文件名等。我们不存储电子表格数据 |
...
| 隐私策略 URL | https://www.sheetgo.com/legal/privacy |
