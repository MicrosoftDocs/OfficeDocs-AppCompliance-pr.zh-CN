---
title: Jira Cloud for Excel的应用程序信息（按 Atlassian.com）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/26/2021
...
description: 适用于 Excel 的 Jira Cloud 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
Atlassian.com 提供给 Microsoft 的信息：
...
| 应用的核心功能 | 规划、跟踪、发布软件。 管理支持、客户服务和项目。 |
| 公司总部位置 | 澳大利亚 |
| 应用信息页 | |
...
Atlassian.com 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
