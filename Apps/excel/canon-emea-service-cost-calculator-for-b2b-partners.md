---
title: Canon EMEA 为 B2B 合作伙伴提供的 Canon EMEA 服务成本计算器的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: 适用于 B2B 合作伙伴的 Canon EMEA 服务成本计算器的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
佳能 EMEA 提供给 Microsoft 的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | B2B 合作伙伴的 Canon EMEA 服务成本计算器 |
| ID | WA200003098 |
| 支持Office 365客户端 | Excel 2016或更高版本的 Mac，Excel 2013 或更高版本Windows，Excel web 版 |
| 合作伙伴公司名称 | Canon EMEA |
| 公司的网站 | [https://www.canon-europe.com](https://www.canon-europe.com) |
| 应用的使用条款 | [https://partners.canon-europe.com/partners/s/Terms%20and%20...](https://partners.canon-europe.com/partners/s/Terms%20and%20Conditions%20-%20English%20(Partner%20Portal)) |
| 应用的核心功能 | 准确、透明和高效地计算佳能打印机的服务成本 (B2B)  |
| 公司总部位置 | 荷兰 ()  |
| 应用信息页 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
...
Canon EMEA 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
