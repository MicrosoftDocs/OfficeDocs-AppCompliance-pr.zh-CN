---
title: Excel officeatwork |的应用程序信息按 officeatwork Office的图像选择器
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/25/2022
...
description: Microsoft 已针对安全性、合规性和数据处理做法的行业标准和控制措施审查了Excel。 此页显示 officeatwork |的可用安全性和符合性信息用于Office的映像选择器、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
---
# <a name="excel-information-for-officeatwork--image-chooser-for-office"></a>Excel officeatwork |的信息Office的图像选择器
