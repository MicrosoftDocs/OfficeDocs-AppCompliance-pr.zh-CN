---
title: Celigo CloudExtend 针对 NetSuite 的 CloudExtend Analytics 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/17/2022
...
Celigo CloudExtend 提供给 Microsoft 的信息：
...
Celigo CloudExtend 提供了此信息，了解此应用如何收集和存储组织数据以及组织对应用收集的数据的控制。
