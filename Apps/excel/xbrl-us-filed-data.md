...
| 合作伙伴公司名称 | XBRL US |
| 公司网站 | [https://xbrl.us](https://xbrl.us) |
| 应用的使用条款 | [https://xbrl.us/terms-of-agreement](https://xbrl.us/terms-of-agreement) |
| 应用的核心功能 | XBRL US 是一家非营利组织，它在美国 XBR Exchange L US 中构建和支持免费、开放、非专业商业报告标准，引导了政府机构（美国证券交易委员会 (SEC () 、联邦能源委员会 (FERC) 和能源部）制定和实施数据标准。 XBRL US 监视数据并帮助构建 SEC 使用的数据质量标准，以帮助公共公司创建高质量的 XBRL 财务报表。  |
| 公司总部位置 | 美国 |
| 应用信息页面 | [https://xbrl.us/xbrl-api-community](https://xbrl.us/xbrl-api-community) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | GitHub |
