---
title: XBRL US 提交的 XBRL 文件数据的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: XBRL 归档数据的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
---
# <a name="xbrl-filed-data"></a>XBRL 已提交数据

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 8 月 2 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002591" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

XBRL US 提供给 Microsoft 的信息：
...
| 合作伙伴公司名称 | XBRL US |
| 公司的网站 | [https://xbrl.us](https://xbrl.us) |
| 应用的使用条款 | [https://xbrl.us/terms-of-agreement](https://xbrl.us/terms-of-agreement) |
| 应用的核心功能 | XBRL 美国公司是非营利性财团，在美国构建和支持免费、开放、非私人业务报告标准。 XBRL 美国已率先制定和实施政府机构的数据标准- 美国证券和Exchange委员会 (SEC) 、联邦能源监管委员会 (FERC) 和能源部。 XBRL US 监视数据，并帮助构建 SEC 使用的数据质量标准来帮助上市公司创建高质量的 XBRL 财务报表。  |
| 公司总部位置 | 美国美国 |
| 应用信息页 | [https://xbrl.us/xbrl-api-community](https://xbrl.us/xbrl-api-community) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | GitHub |
...
XBRL US 提供了此信息，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
