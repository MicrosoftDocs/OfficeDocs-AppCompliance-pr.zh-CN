...
>| GroupMember.Read.All | delegated | 不存储任何数据。 | SharePoint Online - 安全组支持：允许应用列出组、读取基本组属性和读取登录用户有权访问的所有组的成员身份。 | f5c9f179-b9a5-4364-8f99-18d203b902ad |
>| Sites.Read.All | delegated | 不存储任何数据。 | SharePoint Online：若要在 SharePoint Online 中读取数据，登录用户有权访问。 启用将数据上载到 SharePoint Online | f5c9f179-b9a5-4364-8f99-18d203b902ad |
