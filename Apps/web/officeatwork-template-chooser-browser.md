...
description: 模板选择器浏览器的所有可用安全性和符合性信息、其数据处理策略、Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
---
# <a name="application-information-for-template-chooser-browser-by-officeatwork"></a>按 officeatwork 提供的模板选择器浏览器的应用程序信息
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Files.ReadWrite.All | 委托 | 不存储任何数据。 | 收藏夹：能够将数据读取和写入用户OneDrive;OneDrive：能够读取和写入OneDrive用户的数据。 | dae2eacf-3eb5-4440-baff-984fbd5cae68 |
>| Group.ReadWrite.All | 委托 | 不存储任何数据。 | Teams：能够将数据读取和写入组。 | dae2eacf-3eb5-4440-baff-984fbd5cae68 |
>| GroupMember.Read.All | 委托 | 不存储任何数据。 | SharePoint联机：用户允许从 SharePoint Online 读取数据。 | dae2eacf-3eb5-4440-baff-984fbd5cae68 |
>| Sites.Read.All | 委托 | 不存储任何数据。 | SharePoint联机：启用从 SharePoint Online 读取数据。 | dae2eacf-3eb5-4440-baff-984fbd5cae68 |
>| User.Read | 委托 | 不存储任何数据。 | 单接：使 officeatwork 应用能够读取用户的基本属性。 | dae2eacf-3eb5-4440-baff-984fbd5cae68 |
>| User.Read.All | 委托 | 不存储任何数据。 | Teams：了解用户所属的组。 | dae2eacf-3eb5-4440-baff-984fbd5cae68 |
>| offline_access | 委托 | 不存储任何数据。 | 单一登录：若要通过刷新令牌启用自动登录，用户每次启动 officeatwork 应用时都必须手动登录。 此范围仅适用于未启用 SSO 的主机应用程序。 | dae2eacf-3eb5-4440-baff-984fbd5cae68 |
>| openid | 委托 | 不存储任何数据。 | 单击：使用户能够使用其组织和/或 Microsoft 帐户登录 Officeatwork 应用 | dae2eacf-3eb5-4440-baff-984fbd5cae68 |
>| 个人资料 | 委托 | 不存储任何数据。 | 登录：在 officeatwork 应用中显示已登录用户。 这有助于向用户保证/确认用于登录 officeatwork 应用的帐户。 | dae2eacf-3eb5-4440-baff-984fbd5cae68 |
...
<iframe height='1020' title='Microsoft Cloud App Security信息' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/35385' frameborder='no'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/35385" target="_blank">在新选项卡中查看</a>
