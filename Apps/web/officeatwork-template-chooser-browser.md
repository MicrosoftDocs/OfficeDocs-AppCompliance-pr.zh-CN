...
>| GroupMember.Read.All | delegated | 不存储任何数据。 | SharePoint联机：允许用户从 SharePoint Online 中读取数据的权限。 | dae2eacf-3eb5-4440-baff-984fbd5cae68 |
...
>| User.Read.All | delegated | 不存储任何数据。 | Teams：了解用户属于哪些组。 | dae2eacf-3eb5-4440-baff-984fbd5cae68 |
