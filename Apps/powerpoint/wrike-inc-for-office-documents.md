...
| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | 用于文档Office Wrike |
| ID | WA104379841 |
| Office 365支持的客户端 | Excel 2016 Windows、Windows 上的 Word 2013 或更高版本、Windows 上的 PowerPoint 2013 或更高版本、Mac 上的 Excel 2016 或更高版本、mac 上的 Excel web 版、Word 2016 或更高版本、mac 上的 Word web 版、PowerPoint 2016 或更高版本PowerPoint web 版 |
| 合作伙伴公司名称 | Wrike Inc. |
...
<iframe height='1020' title='Microsoft Cloud App Security信息' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/21522' frameborder='no' style='width: 100%;'></iframe>
