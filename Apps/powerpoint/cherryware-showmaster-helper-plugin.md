---
title: Showmaster (帮助程序插件) 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/19/2022
...
description: Showmaster (Helper 插件) 、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息的所有可用安全性和符合性信息。
...
此信息由樱桃软件提供，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
