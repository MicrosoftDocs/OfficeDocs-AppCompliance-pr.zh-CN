---
title: Showmaster 应用程序信息 (软件) 帮助程序插件
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/19/2022
...
description: Showmaster (Helper Plugin) 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
ms.locfileid: "63545240"
---
# <a name="showmaster-helper-plugin"></a>Showmaster (帮助程序插件) 

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2021 年 12 月 8 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003676" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

由wareware提供给 Microsoft 的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | Showmaster (帮助程序插件)  |
| ID | WA200003676 |
| Office 365客户端 | PowerPoint 2016 Mac、PowerPoint web 版、PowerPoint 2013 或更高版本的 Windows 或更高版本Windows |
| 合作伙伴公司名称 | 一些 |
| 公司网站 | [https://www.cherryware.com](https://www.cherryware.com) |
| 应用的使用条款 | [https://showmaster.app/terms/](https://showmaster.app/terms/) |
| 应用的核心功能 | Showmaster 是一PowerPoint外接程序，它在等待期间围绕你的说话创建一个激动人心的框架，并中断标题、倒计时、音乐等。 |
| 公司总部位置 | 德国 |
| 应用信息页面 | [https://showmaster.app](https://showmaster.app) |
...
此信息由关于此应用如何收集和存储组织数据以及你的组织将拥有对应用收集的数据的控制的恶意软件提供。
