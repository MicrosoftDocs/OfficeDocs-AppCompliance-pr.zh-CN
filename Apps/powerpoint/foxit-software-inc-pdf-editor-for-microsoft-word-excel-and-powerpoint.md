---
title: 适用于 Foxit Software Inc. Microsoft Word、Excel 和 PowerPoint 的 Foxit PDF 编辑器的应用程序信息。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: 适用于 Microsoft Word、Excel 和 PowerPoint 的 Foxit PDF 编辑器的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security 应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
---
# <a name="foxit-pdf-editor-for-microsoft-word-excel-and-powerpoint"></a>适用于 Microsoft Word、Excel 和 PowerPoint 的 Foxit PDF 编辑器

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>开发人员上次更新时间：2022 年 3 月 17 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003206" target="_blank">在 AppSource 中查看</a>

::: zone pivot="general"

### <a name="general-information"></a>一般信息

Foxit Software Inc. 提供给 Microsoft 的信息：

| **Information** | **响应** |
|:----------------|:-------------|
| 应用名称 | 适用于 Microsoft Word、Excel 和 PowerPoint 的 Foxit PDF 编辑器 |
| ID | WA200003206 |
| Office 365客户端 | Excel 2016 Mac、Excel 2013 或更高版本（在 mac 上的 Windows、Excel web 版、Word 2016 或更高版本、Word web 版、Windows 上的 Word 2013 或更高版本、mac PowerPoint 2016 或更高版本上）PowerPoint web 版 2013 PowerPoint 2013 或更高版本Windows |
| 合作伙伴公司名称 | Foxit Software Inc. |
| 公司网站 | [https://www.foxit.com](https://www.foxit.com) |
| 应用的使用条款 | [https://www.foxit.com/product/terms-of-service.html](https://www.foxit.com/product/terms-of-service.html) |
| 应用的核心功能 | 使用适用于 Microsoft Teams 的 Foxit PDF 编辑器，无需离开 Microsoft Teams 即可对文档执行更多操作：1.保护协作-共享 PDF 并与频道中的每个人协作，并与 Microsoft SharePoint 或一个驱动器&#65307; 2 中存储的文档进行协作。高质量查看 - 通过安全且轻松地查看 PDFMicrosoft Teams&#65307; 3.注释PDF-Provide标记对文档的反馈，并注释 PDF 工具; |
| 公司总部位置 | 中国 |
| 应用信息页面 | |
...
此信息由 Foxit Software Inc. 提供，用于了解此应用程序如何收集和存储组织数据，以及您的组织将拥有对应用收集的数据的控制。
...
| 隐私策略 URL | https://www.foxit.com/company/privacy-policy.html |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | delegated | 读取用户文档并保存文档。 | [959a79dd-69d0-4d05-b9a8-b9f02e28c049](../azure/959a79dd-69d0-4d05-b9a8-b9f02e28c049.md) |
