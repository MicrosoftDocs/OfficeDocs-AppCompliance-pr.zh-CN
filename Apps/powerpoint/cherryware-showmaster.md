---
title: Showmaster 的应用程序信息（通过恶意软件）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/27/2022
...
description: Showmaster 的所有可用安全性和合规性信息、其数据处理策略、Microsoft Cloud App Security应用程序目录信息以及 CSA STAR 注册表中的安全/合规性信息。
