...
| ID | WA104381787 |
| Office 365客户端 | Excel 2016 Mac、Excel 2016 或更高版本（在 mac Windows、Excel web 版、Word 2016 或更高版本、Word web 版、Word 2016 或 Windows 或更高版本PowerPoint 2016 Mac 或更高版本、PowerPoint web 版、PowerPoint 2016或更高版本Windows |
| 合作伙伴公司名称 | iGlobe |
...
| 应用的核心功能 | Office2SharePoint - 使用SharePoint Teams和Outlook Office和轻松处理。 打破团队成员之间的 &amp; 通信障碍，使所有团队成员均可访问文档和SharePoint Teams。 将电子邮件和邮件附件直接从 Outlook 保存到SharePoint或Teams和平台上。 Office2SharePoint 应用程序服务权限级别为 Outlook 和 Office 外接程序设置。 |
| 公司总部位置 | 丹麦 |
| 应用信息页面 | |
| 用于运行应用的托管环境或服务模型是什么？ |  |
