...
| ID | WA104381155 |
| Office 365支持的客户端 | Word 2016 Mac、Word web 版、Windows 上的 Word 2013 Service Pack 1 或更高版本、Mac 上的 PowerPoint 2016 或更高版本、PowerPoint web 版、PowerPoint 2013 Service Pack 1 或更高版本Windows |
| 合作伙伴公司名称 | Adobe Inc. |
...
| 应用的核心功能 | 添加 Adobe Sign for Office 时，文档签名工作流保持快速Office。 现在，在 Office 应用（如 Word 和 PowerPoint）中，你可以签署文档，发送文档进行合法绑定电子签名和&#8212; Microsoft 首选电子签名解决方案。 |
| 公司总部位置 | 美国 |
| 应用信息页面 | |
...
>| offline_access | delegated | 在当前令牌过期时刷新访问令牌。 例如，当用户在签名发送窗口中将其保持非活动状态的时间太长时，我们需要在用户处于活动状态时 &quot; &quot; 刷新新令牌。 | [a9b0c190-bafb-49ca-a61a-dab99cf2c43b](https://docs.microsoft.com/microsoft-365-app-certification/azure/a9b0c190-bafb-49ca-a61a-dab99cf2c43b) |
