---
title: SlideHub by nomorehours 的应用程序信息
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: SlideHub 的所有可用安全性和符合性信息、其数据处理策略、其Microsoft Cloud App Security应用目录信息以及 CSA STAR 注册表中的安全/合规性信息。
...
| 应用名称 | SlideHub |
| ID | WA200001625 |
| 支持Office 365客户端 | PowerPoint 2016或更高版本的 Mac、PowerPoint web 版、PowerPoint 2013 或更高版本Windows |
| 合作伙伴公司名称 | nomorehours |
| 公司的网站 | [https://nomorehours.com](https://nomorehours.com) |
| 应用的使用条款 | [https://nomorehours.com/eula](https://nomorehours.com/eula) |
| 应用的核心功能 | NoMore 为业务用户提供PowerPoint设计服务和PowerPoint加载项，这两者都旨在使他们在PowerPoint中更高效。 作为设计服务的一部分，NoMore 将粗略草稿转换为客户端就绪幻灯片，只需 8 小时。 外接程序有助于更快地访问服务，但也允许用户访问预制幻灯片设计和公司特定的幻灯片库，以及包含不同工作效率工具的&#8220;咨询工具包&#8221;。 |
| 公司总部位置 | 丹麦 |
| 应用信息页 | [https://nomorehours.com](https://nomorehours.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
此信息已由 nomorehours 提供，了解此应用如何收集和存储组织数据，以及组织对应用收集的数据的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 应用程序 | 电子邮件和名称。 电子邮件用作应用程序中的用户名。 收集电子邮件有助于更快地注册和登录到应用程序。 在注册事件中使用该名称。 | [33ccef75-8248-44e8-88d3-24526ca9c2d3](../azure/33ccef75-8248-44e8-88d3-24526ca9c2d3.md) |
