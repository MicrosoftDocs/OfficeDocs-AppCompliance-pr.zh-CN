...
| 公司网站 | [https://nomorehours.com](https://nomorehours.com) |
| 应用的使用条款 | [https://nomorehours.com/eula](https://nomorehours.com/eula) |
| 应用的核心功能 | NoMore 为业务用户提供PowerPoint设计服务和PowerPoint外接程序，旨在帮助他们更有效地PowerPoint。 作为设计服务的一部分，NoMore 在 8 小时内将粗略草稿转换为客户端就绪幻灯片。 加载项可帮助用户更快地访问服务，还允许用户访问预先设计的幻灯片设计和公司特定的幻灯片库，以及包含不同生产力工具的 &#8220;咨询工具包&#8221;。 |
| 公司总部位置 | 丹麦 |
| 应用信息页面 | [https://nomorehours.com](https://nomorehours.com) |
| 用于运行应用的托管环境或服务模型是什么？ |  |
| 应用使用哪些托管云提供商？ | AWS |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 应用程序 | 电子邮件和名称。 电子邮件在应用程序中用作用户名。 收集电子邮件有助于更快地注册和登录应用程序。 在注册事件的情况下使用名称。 | [33ccef75-8248-44e8-88d3-24526ca9c2d3](../azure/33ccef75-8248-44e8-88d3-24526ca9c2d3.md) |
